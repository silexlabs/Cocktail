...
var Test = $hxClasses["Test"] = function() {
	...
	test += "<div style=\"overflow: hidden; width: 100px; height: 100px; background-color: green; position: absolute;\">";
	test += "<div style=\"width: 100px; height: 100px; margin-top: 100px; margin-left: 100px; background-color: red;\"></div>";
	test += "<div style=\"width: 100px; height: 100px; margin-top: 100px; margin-left: 100px; background-color: red; position: absolute;\"></div>";
	test += "</div>";
	test += "</div>";
