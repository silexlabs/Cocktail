...
class Test 
{
	...
	public function new()
	{
		...
		test += 	'<div style="overflow: hidden; width: 100px; height: 100px;">';
		test += 		'<div style="width: 100px; height: 100px; margin-top: 100px; margin-left: 100px; background-color: red;"></div>';
		test += 		'<div style="width: 100px; height: 100px; background-color: green; position: absolute; left:150px; top: 100px;"></div>';
		test += 	'</div>';
		test += '</div>';
