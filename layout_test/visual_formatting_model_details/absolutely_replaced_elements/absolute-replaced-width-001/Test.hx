...
class Test 
{
	...
	public function new()
	{
		...
		//test += 	'<div id="div1" style="border: solid black; height: 2in; width: 2in;">';
		test += 	'<div id="div1" style="height: 2in; width: 2in;">';
		test += 		'<img alt="blue 15x15" src="blue15x15.png" style="margin-left: auto; margin-right: auto; position: absolute;"/>';
