...
var Test = $hxClasses["Test"] = function() {
	...
	test += "<img alt=\"blue 15x15\" src=\"blue15x15.png\" style=\"left: 0.5in; margin-left: 0.5in; margin-right: 0.25in; position: absolute; right: 0.25in; width:50%;\"/>";
	test += "<div style=\"background: orange; height: 1in; margin-left: 0.5in; margin-right: 0.5in; margin-top: 1in; width: 1in;\"></div>";
	test += "</div>";
	test += "</div>";
