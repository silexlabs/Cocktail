...
Test = function(p) {
	...
	test += "<div style=\"background-color:blue; height:1in; width:1in;\"></div>";
	test += "<div style=\"background-color:orange; left:auto; height:1in; width:1in; position:relative; right:1in; top:-1in;\"></div>";
	test += "</div></div>";
