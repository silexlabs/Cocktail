		...
		else
		{
			...
			if (previousNormalFlowSibling == null)
			{
				...
				else
				{
					...
					_childStaticOrigin.x = lastInlineBox.bounds.x + lastInlineBox.lineBox.bounds.x + lastInlineBox.bounds.width + lastInlineBox.marginLeft + lastInlineBox.marginRight;
					_childStaticOrigin.x += elementRenderer.coreStyle.usedValues.marginLeft;
