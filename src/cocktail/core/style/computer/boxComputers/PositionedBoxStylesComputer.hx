...
class PositionedBoxStylesComputer extends BoxStylesComputer
{
	 ...
	 */
	override public function applyContentHeight(style:CoreStyle, containingHTMLElementData:ContainingHTMLElementData, childrenHeight:Int):Int
	{
		var height:Int;
	 ...
	 */
	override private function measureWidth(style:CoreStyle, containingHTMLElementData:ContainingHTMLElementData):Void
	{
		var computedStyle:ComputedStyleData = style.computedStyle;
	 ...
	 */
	private function doShrinkToFit(style:CoreStyle, containingHTMLElementData:ContainingHTMLElementData, minimumWidth:Int):Int
	{
		/**
