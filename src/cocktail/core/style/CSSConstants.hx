...
class CSSConstants 
{
	...
	public static inline var DISPLAY_STYLE_NAME:String = "display";
	
	public static inline var POSITION_STYLE_NAME:String = "position";
	
	public static inline var FLOAT_STYLE_NAME:String = "float";
	
	public static inline var CLEAR_STYLE_NAME:String = "clear";
	
	public static inline var Z_INDEX_STYLE_NAME:String = "z-index";
	
	public static inline var MARGIN_LEFT_STYLE_NAME:String = "margin-left";
	
	public static inline var MARGIN_RIGHT_STYLE_NAME:String = "margin-right";
	
	public static inline var MARGIN_TOP_STYLE_NAME:String = "margin-top";
	
	public static inline var MARGIN_BOTTOM_STYLE_NAME:String = "margin-bottom";
	
	public static inline var PADDING_LEFT_STYLE_NAME:String = "padding-left";
	
	public static inline var PADDING_RIGHT_STYLE_NAME:String = "padding-right";
	
	public static inline var PADDING_TOP_STYLE_NAME:String = "padding-top";
	
	public static inline var PADDING_BOTTOM_STYLE_NAME:String = "padding-bottom";
	
	public static inline var WIDTH_STYLE_NAME:String = "width";
