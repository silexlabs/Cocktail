...
//////////////////////////////////////////////////////////////////////////////////////////
// Graphic DOMObject structures and enums
//////////////////////////////////////////////////////////////////////////////////////////
	...
	enum FillStyleValue {
		...
		//a bitmap fill, created with the data of an image DOMObject.
		//The fill might be repeated (tiled)
		bitmap(imageDOMObject:DOMObject, repeat:Bool);
	}
	...
	enum LineStyleValue {
		...
		//a bitmap line, created with the data of an image DOMObject.
		//The line fill might be repeated (tiled)
		bitmap(imageDOMObject:DOMObject, lineStyle:LineStyleData, repeat:Bool);
	}
