...
core.nativeElement.NativeElementManager = function(p) {
}
...
core.dom.Node.prototype.firstChild = null;
core.dom.Node.prototype.lastChild = null;
core.dom.Node.prototype.nextSibling = null;
core.dom.Node.prototype.previousSibling = null;
core.dom.Node.prototype.hasChildNodes = null;
...
core.dom.Node.prototype.get_previousSibling = function() {
...
core.dom.Node.prototype.get_hasChildNodes = function() {
...
core.dom.Element = function(tagName) {
	if( tagName === $_ ) return;
...
core.html.AbstractHTMLElement = function(tagName) {
	if( tagName === $_ ) return;
...
port.browser.HTMLElement = function(tagName) {
	if( tagName === $_ ) return;
...
core.html.AbstractHTMLInputElement = function(p) {
	if( p === $_ ) return;
...
port.browser.HTMLInputElement = function(p) {
	if( p === $_ ) return;
...
core.style.formatter.FormattingContext = function(formattingContextRoot) {
...
core.style.formatter.InlineFormattingContext = function(formattingContextRoot) {
	if( formattingContextRoot === $_ ) return;
...
cocktailCore.focus.abstract.AbstractFocusManagerImpl = function(p) {
	if( p === $_ ) return;
...
core.style.AbstractStyle = function(htmlElement) {
...
core.style.AbstractStyle.getDefaultStyle = function() {
	return { fontFamily : [core.style.FontFamily.genericFamily(core.style.GenericFontFamily.serif)], color : core.unit.CSSColor.keyword(core.unit.ColorKeyword.black)};
}
...
core.style.AbstractStyle.prototype._cursor = null;
core.style.AbstractStyle.prototype.cursor = null;
...
core.style.AbstractStyle.prototype.initDefaultStyleValues = function() {
	...
	this._backgroundColor = core.unit.CSSColor.transparent;
...
core.style.AbstractStyle.prototype.applyDefaultHTMLStyles = function() {
	...
	case "sub":
		this._fontSize = core.style.FontSize.length(core.unit.Length.em(0.83));
		this._verticalAlign = core.style.VerticalAlign.sub;
		break;
	case "sup":
		this._fontSize = core.style.FontSize.length(core.unit.Length.em(0.83));
		this._verticalAlign = core.style.VerticalAlign.cssSuper;
		break;
	}
}
...
core.style.AbstractStyle.prototype.setCursor = function(value) {
	return this._cursor = value;
}
core.style.AbstractStyle.prototype.getCursor = function() {
	return this._cursor;
}
core.style.AbstractStyle.prototype.__class__ = core.style.AbstractStyle;
if(!core.style.floats) core.style.floats = {}
core.style.floats.FloatsManager = function(p) {
	if( p === $_ ) return;
...
core.drawing.AbstractDrawingManager = function(nativeElement,width,height) {
...
port.browser.DrawingManager = function(nativeElement,width,height) {
	if( nativeElement === $_ ) return;
...
core.dom.CharacterData = function(p) {
	if( p === $_ ) return;
	core.dom.Node.call(this);
}
...
core.style.positioner.BoxPositioner = function(p) {
}
...
core.style.positioner.RelativePositioner = function(p) {
	if( p === $_ ) return;
...
core.mouse.MouseCursorManager = function(p) {
}
...
core.mouse.MouseCursorManager.prototype.__class__ = core.mouse.MouseCursorManager;
Hash = function(p) {
	if( p === $_ ) return;
	this.h = {}
...
core.geom.Matrix = function(data) {
	if( data === $_ ) return;
	this.setData(data);
}
...
if(!org.lexa) org.lexa = {}
if(!org.lexa.demo) org.lexa.demo = {}
org.lexa.demo.Lexa = function() { }
org.lexa.demo.Lexa.__name__ = ["org","lexa","demo","Lexa"];
org.lexa.demo.Lexa.main = function() {
	...
	title.get_style().setColor(core.unit.CSSColor.keyword(core.unit.ColorKeyword.orange));
	...
	logo.get_style().setBackgroundColor(core.unit.CSSColor.keyword(core.unit.ColorKeyword.gray));
	...
	text.get_style().setBackgroundColor(core.unit.CSSColor.keyword(core.unit.ColorKeyword.orange));
	text.get_style().setColor(core.unit.CSSColor.hex("#FFFFFF"));
...
port.browser.Style = function(htmlElement) {
	if( htmlElement === $_ ) return;
...
port.browser.Style.prototype.getCSSCursor = function(value) {
	var cssCursorValue;
	switch( (value)[1] ) {
	case 0:
		cssCursorValue = "auto";
...
port.browser.Style.prototype.getCSSColor = function(value) {
	...
	case 3:
		var value1 = $e[2];
		cssColor = this.getColorFromKeyword(value1);
		break;
	case 4:
...
port.browser.Style.prototype.setCursor = function(value) {
...
core.style.AbstractEmbeddedStyle = function(htmlElement) {
	if( htmlElement === $_ ) return;
...
core.event.Event = function(type,target) {
	if( type === $_ ) return;
	this._type = type;
	this._target = target;
}
...
core.event.UIEvent = function(type,target,detail) {
	if( type === $_ ) return;
	this._detail = detail;
...
core.event.KeyboardEvent = function(type,target,detail,keyChar,key,ctrlKey,shiftKey,altKey) {
	if( type === $_ ) return;
...
core.event.KeyboardEvent.prototype._keyChar = null;
core.event.KeyboardEvent.prototype.keyChar = null;
...
core.event.KeyboardEvent.prototype.get_keyChar = function() {
...
core.renderer.ElementRenderer = function(style) {
	if( style === $_ ) return;
	core.dom.Node.call(this);
	this._style = style;
...
for(var k in core.dom.Node.prototype ) core.renderer.ElementRenderer.prototype[k] = core.dom.Node.prototype[k];
...
core.renderer.BoxRenderer = function(style) {
	if( style === $_ ) return;
...
core.renderer.FlowBoxRenderer = function(style) {
	if( style === $_ ) return;
...
core.mouse.AbstractMouseCursor = function(p) {
	if( p === $_ ) return;
...
core.mouse.AbstractMouseCursor.prototype._nativeMouseCursor = null;
core.mouse.AbstractMouseCursor.prototype.nativeMouseCursor = null;
core.mouse.AbstractMouseCursor.prototype.setNativeMouseCursor = function(value) {
...
core.mouse.AbstractMouseCursor.prototype.getNativeMouseCursor = function() {
	return this._nativeMouseCursor;
}
core.mouse.AbstractMouseCursor.prototype.setBitmapCursor = function(imageHTMLElement,hotSpot) {
}
core.mouse.AbstractMouseCursor.prototype.hideCursor = function() {
}
core.mouse.AbstractMouseCursor.prototype.setDefaultCursor = function() {
}
core.mouse.AbstractMouseCursor.prototype.setNativeOSCursor = function(value) {
}
core.mouse.AbstractMouseCursor.prototype.__class__ = core.mouse.AbstractMouseCursor;
port.browser.MouseCursor = function(p) {
	if( p === $_ ) return;
...
for(var k in core.mouse.AbstractMouseCursor.prototype ) port.browser.MouseCursor.prototype[k] = core.mouse.AbstractMouseCursor.prototype[k];
port.browser.MouseCursor.prototype.setBitmapCursor = function(imageHTMLElement,hotSpot) {
...
port.browser.MouseCursor.prototype.hideCursor = function() {
	this.setCursorStyle("none");
}
port.browser.MouseCursor.prototype.setDefaultCursor = function() {
	this.setCursorStyle("auto");
}
port.browser.MouseCursor.prototype.setNativeOSCursor = function(value) {
	switch( (value)[1] ) {
	case 0:
...
port.browser.MouseCursor.prototype.setCursorStyle = function(style) {
	js.Lib.document.body.style.cursor = style;
}
port.browser.MouseCursor.prototype.__class__ = port.browser.MouseCursor;
core.nativeElement.AbstractNativeElementCreator = function(p) {
}
...
core.style.computer.boxComputers.BoxStylesComputer = function(p) {
}
...
core.style.computer.boxComputers.InlineBlockBoxStylesComputer = function(p) {
	if( p === $_ ) return;
...
core.style.computer.boxComputers.FloatBoxStylesComputer = function(p) {
	if( p === $_ ) return;
...
core.resource.XMLHTTPRequest = function(p) {
	if( p === $_ ) return;
...
core.style.AbstractContainerStyle = function(htmlElement) {
	if( htmlElement === $_ ) return;
	port.browser.Style.call(this,htmlElement);
}
...
core.style.computer.boxComputers.InLineBoxStylesComputer = function(p) {
	if( p === $_ ) return;
	core.style.computer.boxComputers.BoxStylesComputer.call(this);
}
...
core.html.HTMLBodyElement = function(p) {
	if( p === $_ ) return;
...
core.style.positioner.FixedPositioner = function(p) {
	if( p === $_ ) return;
	core.style.positioner.BoxPositioner.call(this);
}
...
cocktailCore.focus.FocusManager = function(p) {
	if( p === $_ ) return;
...
core.resource.AbstractResourceLoader = function(p) {
}
...
core.resource.AbstractMediaLoader = function(nativeElement) {
	if( nativeElement === $_ ) return;
	this._nativeElement = nativeElement;
...
port.browser.MediaLoader = function(nativeElement) {
	if( nativeElement === $_ ) return;
...
core.window.AbstractWindow = function(document) {
...
port.browser.Window = function(document) {
	if( document === $_ ) return;
...
core.style.computer.VisualEffectStylesComputer = function(p) {
}
...
core.nativeElement.AbstractNativeElementPathManager = function(p) {
}
...
port.browser.NativeElementPathManager = function(p) {
	if( p === $_ ) return;
...
core.keyboard.AbstractKeyboard = function(htmlElement) {
	if( htmlElement === $_ ) return;
	this._htmlElement = htmlElement;
}
...
port.browser.Keyboard = function(htmlElement) {
	if( htmlElement === $_ ) return;
...
core.renderer.TextRenderer = function(style,nativeElement,textToken) {
	if( style === $_ ) return;
...
core.style.computer.boxComputers.EmbeddedBlockBoxStylesComputer = function(p) {
	if( p === $_ ) return;
	core.style.computer.boxComputers.BoxStylesComputer.call(this);
}
...
core.style.computer.boxComputers.EmbeddedInlineBoxStylesComputer = function(p) {
	if( p === $_ ) return;
...
core.style.computer.boxComputers.EmbeddedFloatBoxStylesComputer = function(p) {
	if( p === $_ ) return;
...
cocktailCore.focus.js.FocusManagerImpl = function(p) {
	if( p === $_ ) return;
...
core.renderer.InlineBoxRenderer = function(style) {
	if( style === $_ ) return;
...
core.style.AbstractBodyStyle = function(htmlElement) {
	if( htmlElement === $_ ) return;
...
port.browser.BodyStyle = function(htmlElement) {
	if( htmlElement === $_ ) return;
...
core.style.computer.boxComputers.BlockBoxStylesComputer = function(p) {
	if( p === $_ ) return;
	core.style.computer.boxComputers.BoxStylesComputer.call(this);
}
...
port.browser.NativeElementCreator = function(p) {
	if( p === $_ ) return;
...
core.style.positioner.AbsolutePositioner = function(p) {
	if( p === $_ ) return;
	core.style.positioner.BoxPositioner.call(this);
}
...
core.background.BackgroundManager = function(p) {
	if( p === $_ ) return;
...
core.background.BackgroundManager.prototype.render = function(backgroundBox,style) {
	...
	while(_g1 < _g) {
		...
		case 1:
			...
			case 0:
				var value1 = $e[2];
				var imageDeclaration = { urls : [value1], fallbackColor : core.unit.CSSColor.transparent};
...
core.background.BackgroundManager.prototype.onBackgroundImageLoadError = function(error,backgroundColor,backgroundImageNativeElement,style,backgroundBox,backgroundPosition,backgroundSize,backgroundOrigin,backgroundClip,backgroundRepeat,backgroundImage) {
	this.drawBackgroundColor(style,core.unit.UnitManager.getColorDataFromCSSColor(backgroundColor),backgroundImageNativeElement,backgroundBox,backgroundPosition,backgroundSize,backgroundOrigin,backgroundClip,backgroundRepeat,backgroundImage);
}
...
core.renderer.EmbeddedBoxRenderer = function(style) {
	if( style === $_ ) return;
	core.renderer.BoxRenderer.call(this,style);
...
core.event.MouseEvent = function(type,target,detail,screenX,screenY,clientX,clientY,ctrlKey,shiftKey,altKey) {
	if( type === $_ ) return;
	core.event.UIEvent.call(this,type,target,detail);
...
core.html.AbstractHTMLAnchorElement = function(p) {
	if( p === $_ ) return;
...
for(var k in port.browser.HTMLElement.prototype ) core.html.AbstractHTMLAnchorElement.prototype[k] = port.browser.HTMLElement.prototype[k];
core.html.AbstractHTMLAnchorElement.prototype._href = null;
core.html.AbstractHTMLAnchorElement.prototype.href = null;
core.html.AbstractHTMLAnchorElement.prototype._target = null;
core.html.AbstractHTMLAnchorElement.prototype.target = null;
core.html.AbstractHTMLAnchorElement.prototype.initNativeElement = function() {
...
core.html.AbstractHTMLAnchorElement.prototype.set_onMouseDown = function(value) {
	this._onMouseDown = value;
	this._mouse.setOnMouseDown($closure(this,"onMouseDownCallback"));
	return this._onMouseDown;
}
core.html.AbstractHTMLAnchorElement.prototype.set_onMouseOver = function(value) {
	this._onMouseOver = value;
	this._mouse.setOnMouseOver($closure(this,"onMouseOverCallback"));
	return this._onMouseOver;
}
core.html.AbstractHTMLAnchorElement.prototype.set_onMouseOut = function(value) {
	this._onMouseOut = value;
	this._mouse.setOnMouseOut($closure(this,"onMouseOutCallback"));
	return this._onMouseOut;
}
core.html.AbstractHTMLAnchorElement.prototype.onMouseDownCallback = function(mouseEvent) {
	if(this._onMouseDown != null) this._onMouseDown(mouseEvent);
	if(mouseEvent.get_defaultPrevented() == false) this.openDocument();
}
core.html.AbstractHTMLAnchorElement.prototype.onMouseOverCallback = function(mouseEvent) {
	if(this._onMouseOver != null) this._onMouseOver(mouseEvent);
	this.displayPointerCursor();
}
core.html.AbstractHTMLAnchorElement.prototype.onMouseOutCallback = function(mouseEvent) {
	if(this._onMouseOut != null) this._onMouseOut(mouseEvent);
	this.hidePointerCursor();
}
core.html.AbstractHTMLAnchorElement.prototype.openDocument = function() {
}
core.html.AbstractHTMLAnchorElement.prototype.displayPointerCursor = function() {
...
core.html.AbstractHTMLAnchorElement.prototype.hidePointerCursor = function() {
	core.mouse.MouseCursorManager.setMouseCursor(core.mouse.MouseCursorValue.cssAuto);
}
core.html.AbstractHTMLAnchorElement.prototype.getTargetAsString = function(value) {
	var target;
	switch( (value)[1] ) {
	case 0:
		target = "_blank";
...
core.html.AbstractHTMLAnchorElement.prototype.set_href = function(value) {
	this._href = value;
...
core.html.AbstractHTMLAnchorElement.prototype.get_href = function() {
	return this._href;
}
core.html.AbstractHTMLAnchorElement.prototype.set_target = function(value) {
	this._target = value;
	this.set_onMouseDown(this._onMouseDown);
	this.set_onMouseOver(this._onMouseOver);
	this.set_onMouseOut(this._onMouseOut);
...
core.html.AbstractHTMLAnchorElement.prototype.get_target = function() {
	return this._target;
}
core.html.AbstractHTMLAnchorElement.prototype.__class__ = core.html.AbstractHTMLAnchorElement;
core.mouse.AbstractMouse = function(htmlElement) {
	if( htmlElement === $_ ) return;
	this._htmlElement = htmlElement;
}
...
core.style.computer.boxComputers.EmbeddedPositionedBoxStylesComputer = function(p) {
	if( p === $_ ) return;
	core.style.computer.boxComputers.EmbeddedBlockBoxStylesComputer.call(this);
}
...
core.style.computer.FontAndTextStylesComputer = function(p) {
}
...
core.style.computer.FontAndTextStylesComputer.getComputedColor = function(style) {
	return core.unit.UnitManager.getColorDataFromCSSColor(style.getColor());
}
...
core.html.EmbeddedElement = function(tagName) {
	if( tagName === $_ ) return;
...
core.style.computer.boxComputers.EmbeddedInlineBlockBoxStylesComputer = function(p) {
	if( p === $_ ) return;
	core.style.computer.boxComputers.EmbeddedInlineBoxStylesComputer.call(this);
}
...
core.unit.CSSColor = { __ename__ : ["core","unit","CSSColor"], __constructs__ : ["rgb","rgba","hex","keyword","transparent"] }
core.unit.CSSColor.rgb = function(red,green,blue) { var $x = ["rgb",0,red,green,blue]; $x.__enum__ = core.unit.CSSColor; $x.toString = $estr; return $x; }
core.unit.CSSColor.rgba = function(red,green,blue,alpha) { var $x = ["rgba",1,red,green,blue,alpha]; $x.__enum__ = core.unit.CSSColor; $x.toString = $estr; return $x; }
core.unit.CSSColor.hex = function(value) { var $x = ["hex",2,value]; $x.__enum__ = core.unit.CSSColor; $x.toString = $estr; return $x; }
core.unit.CSSColor.keyword = function(value) { var $x = ["keyword",3,value]; $x.__enum__ = core.unit.CSSColor; $x.toString = $estr; return $x; }
core.unit.CSSColor.transparent = ["transparent",4];
core.unit.CSSColor.transparent.toString = $estr;
core.unit.CSSColor.transparent.__enum__ = core.unit.CSSColor;
...
core.unit.UnitManager = function(p) {
}
...
core.unit.UnitManager.getColorDataFromCSSColor = function(value) {
	var colorValue;
	var alphaValue;
	var $e = (value);
	switch( $e[1] ) {
	...
	case 3:
		var value1 = $e[2];
		colorValue = core.unit.UnitManager.getColorDataFromColorKeyword(value1).color;
		alphaValue = 1.0;
		break;
	case 4:
		colorValue = 16777215;
...
core.unit.UnitManager.getColorDataFromColorKeyword = function(value) {
	var hexColor;
	switch( (value)[1] ) {
	case 0:
		hexColor = "#00FFFF";
	...
	return core.unit.UnitManager.getColorDataFromCSSColor(core.unit.CSSColor.hex(hexColor));
}
...
port.browser.HTMLAnchorElement = function(p) {
	if( p === $_ ) return;
...
for(var k in core.html.AbstractHTMLAnchorElement.prototype ) port.browser.HTMLAnchorElement.prototype[k] = core.html.AbstractHTMLAnchorElement.prototype[k];
port.browser.HTMLAnchorElement.prototype.set_href = function(value) {
	this._nativeElement.href = value;
	core.html.AbstractHTMLAnchorElement.prototype.set_href.call(this,value);
	return value;
}
port.browser.HTMLAnchorElement.prototype.set_target = function(value) {
...
port.browser.HTMLAnchorElement.prototype.__class__ = port.browser.HTMLAnchorElement;
...
core.style.VerticalAlign = { __ename__ : ["core","style","VerticalAlign"], __constructs__ : ["baseline","sub","cssSuper","top","textTop","middle","bottom","textBottom","percent","length"] }
...
core.style.VerticalAlign.cssSuper = ["cssSuper",2];
core.style.VerticalAlign.cssSuper.toString = $estr;
core.style.VerticalAlign.cssSuper.__enum__ = core.style.VerticalAlign;
...
core.style.Cursor = { __ename__ : ["core","style","Cursor"], __constructs__ : ["auto","crosshair","cssDefault","pointer"] }
...
core.renderer.BlockBoxRenderer = function(style) {
	if( style === $_ ) return;
	core.renderer.FlowBoxRenderer.call(this,style);
}
...
core.renderer.InitialBlockRenderer = function(style) {
	if( style === $_ ) return;
...
core.html.AbstractHTMLImageElement = function(p) {
	if( p === $_ ) return;
...
core.background.InitialBlockBackgroundManager = function(p) {
	if( p === $_ ) return;
...
core.style.computer.DisplayStylesComputer = function(p) {
}
...
core.resource.AbstractImageLoader = function(p) {
	if( p === $_ ) return;
...
core.style.formatter.BlockFormattingContext = function(formattingContextRoot) {
	if( formattingContextRoot === $_ ) return;
	core.style.formatter.FormattingContext.call(this,formattingContextRoot);
}
...
core.style.formatter.BlockFormattingContext.prototype.doFormat2 = function(elementRenderer,concatenatedX) {
...
core.style.formatter.BlockFormattingContext.prototype.getCollapsedMarginBottom = function(child) {
...
core.html.HTMLCanvasElement = function(p) {
	if( p === $_ ) return;
...
core.renderer.LayerRenderer = function(rootRenderer) {
...
core.background.BackgroundDrawingManager = function(nativeElement,backgroundBox) {
	if( nativeElement === $_ ) return;
...
core.background.BackgroundDrawingManager.prototype.getGradientStops = function(value) {
	...
	while(_g1 < _g) {
		...
		var color = core.unit.UnitManager.getColorDataFromCSSColor(value[i].color);
...
port.browser.Mouse = function(htmlElement) {
	if( htmlElement === $_ ) return;
...
core.style.computer.BackgroundStylesComputer = function(p) {
}
...
core.style.computer.BackgroundStylesComputer.getComputedBackgroundColor = function(style) {
	var computedColor;
	computedColor = core.unit.UnitManager.getColorDataFromCSSColor(style.getBackgroundColor());
...
port.browser.HTMLImageElement = function(p) {
	if( p === $_ ) return;
...
core.html.HTMLDocument = function(p) {
	if( p === $_ ) return;
...
core.style.computer.boxComputers.PositionedBoxStylesComputer = function(p) {
	if( p === $_ ) return;
	core.style.computer.boxComputers.BoxStylesComputer.call(this);
}
