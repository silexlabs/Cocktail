...
org.lexa.demo.Lexa = function(p) {
}
org.lexa.demo.Lexa.__name__ = ["org","lexa","demo","Lexa"];
org.lexa.demo.Lexa.main = function() {
	var lx = new org.lexa.demo.Lexa();
	lx.prezCocktail();
}
org.lexa.demo.Lexa.prototype.prezCocktail = function() {
	cocktail.Lib.get_document().get_body().set_innerHTML("<div style=\"width: 50%; margin-right: auto; margin-left: auto; background-color: rgba(255, 255, 255, 0.5);\"><h1 style=\"word-spacing: 10px; color: orange; font-family: arial;\">Hello Cocktail</h1><p>Cocktail is a cross-platform library for the haXe programming language. It focuses on UIs and bridges the gap between all the targets supported by haXe.<img id=\"pic\" src=\"cocktail.jpg\" /></p></div>");
	var pic = cocktail.Lib.get_document().getElementById("pic");
	pic.set_onClick(function(e) {
		cocktail.Lib.get_document().get_body().get_style().set_backgroundImage("url(bg.png)");
	});
}
