...
::cocktail::core::style::FontStyle FontStyle_obj::italic;

::cocktail::core::style::FontStyle FontStyle_obj::normal;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.style.FontStyle"), hx::TCanCast< FontStyle_obj >,sStaticFields,sMemberFields,
