...
::cocktail::core::dom::TextTokenValue TextTokenValue_obj::lineFeed;

::cocktail::core::dom::TextTokenValue TextTokenValue_obj::space;

::cocktail::core::dom::TextTokenValue TextTokenValue_obj::tab;

::cocktail::core::dom::TextTokenValue  TextTokenValue_obj::word(::String value)
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.dom.TextTokenValue"), hx::TCanCast< TextTokenValue_obj >,sStaticFields,sMemberFields,
