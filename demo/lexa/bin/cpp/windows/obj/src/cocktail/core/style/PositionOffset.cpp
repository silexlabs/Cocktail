...
::cocktail::core::style::PositionOffset PositionOffset_obj::cssAuto;

::cocktail::core::style::PositionOffset  PositionOffset_obj::length(::cocktail::core::unit::Length value)
	{ return hx::CreateEnum< PositionOffset_obj >(HX_CSTRING("length"),0,hx::DynamicArray(0,1).Add(value)); }

::cocktail::core::style::PositionOffset  PositionOffset_obj::percent(int value)
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.style.PositionOffset"), hx::TCanCast< PositionOffset_obj >,sStaticFields,sMemberFields,
