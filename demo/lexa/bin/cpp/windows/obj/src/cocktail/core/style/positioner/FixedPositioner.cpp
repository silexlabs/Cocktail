...
{
{
	HX_SOURCE_POS("../../src/cocktail/core/style/positioner/FixedPositioner.hx",23)
	super::__construct();
}
;
	return null();
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.style.positioner.FixedPositioner"), hx::TCanCast< FixedPositioner_obj> ,sStaticFields,sMemberFields,
