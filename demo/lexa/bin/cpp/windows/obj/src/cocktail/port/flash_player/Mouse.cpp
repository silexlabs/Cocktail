...
Void Mouse_obj::__construct(::cocktail::port::flash_player::HTMLElement htmlElement)
{
{
	HX_SOURCE_POS("../../src/cocktail/port/flash_player/Mouse.hx",31)
	super::__construct(htmlElement);
	HX_SOURCE_POS("../../src/cocktail/port/flash_player/Mouse.hx",34)
...
hx::ObjectPtr< Mouse_obj > Mouse_obj::__new(::cocktail::port::flash_player::HTMLElement htmlElement)
...
Void Mouse_obj::updateListeners( ::String mouseEvent,Dynamic nativeCallback,Dynamic htmlElementCallback){
{
		...
		HX_SOURCE_POS("../../src/cocktail/port/flash_player/Mouse.hx",54)
		this->_htmlElement->get_nativeElement()->__Field(HX_CSTRING("removeEventListener"))(mouseEvent,nativeCallback);
		HX_SOURCE_POS("../../src/cocktail/port/flash_player/Mouse.hx",56)
...
::cocktail::core::event::MouseEvent Mouse_obj::getMouseEvent( Dynamic event){
	...
	HX_SOURCE_POS("../../src/cocktail/port/flash_player/Mouse.hx",70)
	::nme::events::MouseEvent typedEvent = event;
	HX_SOURCE_POS("../../src/cocktail/port/flash_player/Mouse.hx",72)
	::String eventType;
	HX_SOURCE_POS("../../src/cocktail/port/flash_player/Mouse.hx",74)
	::String _switch_1 = (typedEvent->nmeGetType());
	if (  ( _switch_1==::nme::events::MouseEvent_obj::CLICK)){
		HX_SOURCE_POS("../../src/cocktail/port/flash_player/Mouse.hx",76)
		eventType = HX_CSTRING("click");
	}
	else if (  ( _switch_1==::nme::events::MouseEvent_obj::MOUSE_DOWN)){
		HX_SOURCE_POS("../../src/cocktail/port/flash_player/Mouse.hx",79)
		eventType = HX_CSTRING("mousedown");
	}
	else if (  ( _switch_1==::nme::events::MouseEvent_obj::MOUSE_UP)){
		HX_SOURCE_POS("../../src/cocktail/port/flash_player/Mouse.hx",82)
		eventType = HX_CSTRING("mouseup");
	}
	else if (  ( _switch_1==::nme::events::MouseEvent_obj::MOUSE_OVER)){
		HX_SOURCE_POS("../../src/cocktail/port/flash_player/Mouse.hx",85)
		eventType = HX_CSTRING("mouseover");
	}
	else if (  ( _switch_1==::nme::events::MouseEvent_obj::MOUSE_OUT)){
		HX_SOURCE_POS("../../src/cocktail/port/flash_player/Mouse.hx",88)
		eventType = HX_CSTRING("mouseout");
	}
	else if (  ( _switch_1==::nme::events::MouseEvent_obj::MOUSE_MOVE)){
		HX_SOURCE_POS("../../src/cocktail/port/flash_player/Mouse.hx",91)
		eventType = HX_CSTRING("mousemove");
	}
	else  {
		HX_SOURCE_POS("../../src/cocktail/port/flash_player/Mouse.hx",94)
		eventType = typedEvent->nmeGetType();
	}
;
;
	HX_SOURCE_POS("../../src/cocktail/port/flash_player/Mouse.hx",98)
	...
	HX_SOURCE_POS("../../src/cocktail/port/flash_player/Mouse.hx",101)
	return mouseEvent;
}
