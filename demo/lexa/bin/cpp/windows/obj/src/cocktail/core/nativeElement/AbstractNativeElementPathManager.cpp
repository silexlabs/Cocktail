...
Dynamic AbstractNativeElementPathManager_obj::getRoot( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/nativeElement/AbstractNativeElementPathManager.hx",33)
	return null();
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.nativeElement.AbstractNativeElementPathManager"), hx::TCanCast< AbstractNativeElementPathManager_obj> ,sStaticFields,sMemberFields,
