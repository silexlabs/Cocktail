...
Dynamic TextRenderer_obj::render( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/renderer/TextRenderer.hx",72)
	...
	HX_SOURCE_POS("../../src/cocktail/core/renderer/TextRenderer.hx",78)
	...
	HX_SOURCE_POS("../../src/cocktail/core/renderer/TextRenderer.hx",81)
	ret->__Field(HX_CSTRING("push"))(this->_nativeElement);
	HX_SOURCE_POS("../../src/cocktail/core/renderer/TextRenderer.hx",83)
	return ret;
}
...
int TextRenderer_obj::getOffsetWidth( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/renderer/TextRenderer.hx",127)
	return ret;
}
...
int TextRenderer_obj::getOffsetHeight( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/renderer/TextRenderer.hx",154)
	return (int)50;
}
...
bool TextRenderer_obj::isFloat( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/renderer/TextRenderer.hx",162)
	return false;
}
...
bool TextRenderer_obj::isPositioned( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/renderer/TextRenderer.hx",167)
	return false;
}
...
bool TextRenderer_obj::isText( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/renderer/TextRenderer.hx",172)
	return true;
}
...
::cocktail::core::dom::TextTokenValue _switch_1 = (this->_textToken);
		switch((_switch_1)->GetIndex()){
			case 1: {
				HX_SOURCE_POS("../../src/cocktail/core/renderer/TextRenderer.hx",182)
				isSpace = true;
			}
			;break;
			default: {
				HX_SOURCE_POS("../../src/cocktail/core/renderer/TextRenderer.hx",185)
				isSpace = false;
			}
		}
	}
	HX_SOURCE_POS("../../src/cocktail/core/renderer/TextRenderer.hx",189)
	return isSpace;
}
...
::cocktail::core::dom::TextTokenValue _switch_2 = (this->_textToken);
		switch((_switch_2)->GetIndex()){
			case 3: {
				HX_SOURCE_POS("../../src/cocktail/core/renderer/TextRenderer.hx",198)
				isLineFeed = true;
			}
			;break;
			default: {
				HX_SOURCE_POS("../../src/cocktail/core/renderer/TextRenderer.hx",201)
				isLineFeed = false;
			}
		}
	}
	HX_SOURCE_POS("../../src/cocktail/core/renderer/TextRenderer.hx",205)
	return isLineFeed;
}
...
::cocktail::core::dom::TextTokenValue _switch_3 = (this->_textToken);
		switch((_switch_3)->GetIndex()){
			case 2: {
				HX_SOURCE_POS("../../src/cocktail/core/renderer/TextRenderer.hx",214)
				isTab = true;
			}
			;break;
			default: {
				HX_SOURCE_POS("../../src/cocktail/core/renderer/TextRenderer.hx",217)
				isTab = false;
			}
		}
	}
	HX_SOURCE_POS("../../src/cocktail/core/renderer/TextRenderer.hx",221)
	return isTab;
}
