...
{
{
	HX_SOURCE_POS("../../src/cocktail/core/resource/AbstractMediaLoader.hx",53)
	this->_nativeElement = nativeElement;
	HX_SOURCE_POS("../../src/cocktail/core/resource/AbstractMediaLoader.hx",54)
	super::__construct();
}
;
	return null();
...
Dynamic AbstractMediaLoader_obj::getNativeElement( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/resource/AbstractMediaLoader.hx",62)
...
int AbstractMediaLoader_obj::getIntrinsicWidth( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/resource/AbstractMediaLoader.hx",67)
...
int AbstractMediaLoader_obj::getIntrinsicHeight( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/resource/AbstractMediaLoader.hx",72)
...
double AbstractMediaLoader_obj::getIntrinsicRatio( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/resource/AbstractMediaLoader.hx",77)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.resource.AbstractMediaLoader"), hx::TCanCast< AbstractMediaLoader_obj> ,sStaticFields,sMemberFields,
