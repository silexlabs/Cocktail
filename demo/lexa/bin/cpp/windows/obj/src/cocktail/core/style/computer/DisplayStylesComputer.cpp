...
Void DisplayStylesComputer_obj::compute( ::cocktail::core::style::AbstractCoreStyle style){
{
		HX_SOURCE_PUSH("DisplayStylesComputer_obj::compute")
		HX_SOURCE_POS("../../src/cocktail/core/style/computer/DisplayStylesComputer.hx",53)
		Dynamic computedStyle = style->getComputedStyle();
		HX_SOURCE_POS("../../src/cocktail/core/style/computer/DisplayStylesComputer.hx",56)
		...
		HX_SOURCE_POS("../../src/cocktail/core/style/computer/DisplayStylesComputer.hx",59)
		...
		HX_SOURCE_POS("../../src/cocktail/core/style/computer/DisplayStylesComputer.hx",62)
		...
		HX_SOURCE_POS("../../src/cocktail/core/style/computer/DisplayStylesComputer.hx",65)
...
::cocktail::core::style::Position DisplayStylesComputer_obj::getComputedPosition( ::cocktail::core::style::AbstractCoreStyle style){
	HX_SOURCE_PUSH("DisplayStylesComputer_obj::getComputedPosition")
	HX_SOURCE_POS("../../src/cocktail/core/style/computer/DisplayStylesComputer.hx",77)
...
::cocktail::core::style::CSSFloat DisplayStylesComputer_obj::getComputedFloat( ::cocktail::core::style::AbstractCoreStyle style,::cocktail::core::style::Position computedPosition){
	HX_SOURCE_PUSH("DisplayStylesComputer_obj::getComputedFloat")
	HX_SOURCE_POS("../../src/cocktail/core/style/computer/DisplayStylesComputer.hx",89)
	...
	if (((bool((computedPosition == ::cocktail::core::style::Position_obj::absolute_dyn())) || bool((computedPosition == ::cocktail::core::style::Position_obj::fixed_dyn()))))){
		HX_SOURCE_POS("../../src/cocktail/core/style/computer/DisplayStylesComputer.hx",96)
		ret = ::cocktail::core::style::CSSFloat_obj::none_dyn();
	}
	else{
		HX_SOURCE_POS("../../src/cocktail/core/style/computer/DisplayStylesComputer.hx",100)
		ret = style->getCSSFloat();
	}
	HX_SOURCE_POS("../../src/cocktail/core/style/computer/DisplayStylesComputer.hx",104)
	return ret;
}
...
::cocktail::core::style::Display DisplayStylesComputer_obj::getComputedDisplay( ::cocktail::core::style::AbstractCoreStyle style,::cocktail::core::style::CSSFloat computedFloat){
	HX_SOURCE_PUSH("DisplayStylesComputer_obj::getComputedDisplay")
	HX_SOURCE_POS("../../src/cocktail/core/style/computer/DisplayStylesComputer.hx",116)
	...
	if (((computedFloat != ::cocktail::core::style::CSSFloat_obj::none_dyn()))){
		HX_SOURCE_POS("../../src/cocktail/core/style/computer/DisplayStylesComputer.hx",121)
		{
::cocktail::core::style::Display _switch_1 = (style->getDisplay());
			switch((_switch_1)->GetIndex()){
				case 2: case 1: {
					HX_SOURCE_POS("../../src/cocktail/core/style/computer/DisplayStylesComputer.hx",125)
					ret = ::cocktail::core::style::Display_obj::block_dyn();
				}
				;break;
				default: {
					HX_SOURCE_POS("../../src/cocktail/core/style/computer/DisplayStylesComputer.hx",129)
		...
		HX_SOURCE_POS("../../src/cocktail/core/style/computer/DisplayStylesComputer.hx",134)
		ret = style->getDisplay();
	}
	HX_SOURCE_POS("../../src/cocktail/core/style/computer/DisplayStylesComputer.hx",138)
	return ret;
}
...
::cocktail::core::style::Clear DisplayStylesComputer_obj::getComputedClear( ::cocktail::core::style::AbstractCoreStyle style,::cocktail::core::style::Position computedPosition,::cocktail::core::style::Display computedDisplay){
	HX_SOURCE_PUSH("DisplayStylesComputer_obj::getComputedClear")
	HX_SOURCE_POS("../../src/cocktail/core/style/computer/DisplayStylesComputer.hx",154)
	...
	if (((bool((computedDisplay == ::cocktail::core::style::Display_obj::cssInline_dyn())) || bool((computedDisplay == ::cocktail::core::style::Display_obj::inlineBlock_dyn()))))){
		HX_SOURCE_POS("../../src/cocktail/core/style/computer/DisplayStylesComputer.hx",157)
		ret = ::cocktail::core::style::Clear_obj::none_dyn();
	}
	else{
		HX_SOURCE_POS("../../src/cocktail/core/style/computer/DisplayStylesComputer.hx",160)
		if (((bool((computedPosition == ::cocktail::core::style::Position_obj::absolute_dyn())) || bool((computedPosition == ::cocktail::core::style::Position_obj::fixed_dyn()))))){
			HX_SOURCE_POS("../../src/cocktail/core/style/computer/DisplayStylesComputer.hx",161)
			ret = ::cocktail::core::style::Clear_obj::none_dyn();
		}
		else{
			HX_SOURCE_POS("../../src/cocktail/core/style/computer/DisplayStylesComputer.hx",165)
			ret = style->getClear();
		}
	}
	HX_SOURCE_POS("../../src/cocktail/core/style/computer/DisplayStylesComputer.hx",169)
	return ret;
}
