...
::cocktail::core::style::LetterSpacing  LetterSpacing_obj::length(::cocktail::core::unit::Length value)
	{ return hx::CreateEnum< LetterSpacing_obj >(HX_CSTRING("length"),1,hx::DynamicArray(0,1).Add(value)); }

::cocktail::core::style::LetterSpacing LetterSpacing_obj::normal;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.style.LetterSpacing"), hx::TCanCast< LetterSpacing_obj >,sStaticFields,sMemberFields,
