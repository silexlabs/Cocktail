...
{
{
	HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedInlineBlockBoxStylesComputer.hx",23)
	super::__construct();
}
;
	return null();
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.style.computer.boxComputers.EmbeddedInlineBlockBoxStylesComputer"), hx::TCanCast< EmbeddedInlineBlockBoxStylesComputer_obj> ,sStaticFields,sMemberFields,
