...
::cocktail::core::unit::GradientSideValue GradientSideValue_obj::bottom;

::cocktail::core::unit::GradientSideValue GradientSideValue_obj::left;

::cocktail::core::unit::GradientSideValue GradientSideValue_obj::right;

::cocktail::core::unit::GradientSideValue GradientSideValue_obj::top;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.unit.GradientSideValue"), hx::TCanCast< GradientSideValue_obj >,sStaticFields,sMemberFields,
