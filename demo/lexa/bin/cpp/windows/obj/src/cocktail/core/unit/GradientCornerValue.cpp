...
::cocktail::core::unit::GradientCornerValue GradientCornerValue_obj::bottomLeft;

::cocktail::core::unit::GradientCornerValue GradientCornerValue_obj::bottomRight;

::cocktail::core::unit::GradientCornerValue GradientCornerValue_obj::topLeft;

::cocktail::core::unit::GradientCornerValue GradientCornerValue_obj::topRight;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.unit.GradientCornerValue"), hx::TCanCast< GradientCornerValue_obj >,sStaticFields,sMemberFields,
