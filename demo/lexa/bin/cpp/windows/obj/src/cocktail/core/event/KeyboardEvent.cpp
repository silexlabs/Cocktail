...
Void KeyboardEvent_obj::__construct(::String type,::cocktail::port::flash_player::HTMLElement target,double detail,int keyChar,int key,bool ctrlKey,bool shiftKey,bool altKey)
{
{
...
hx::ObjectPtr< KeyboardEvent_obj > KeyboardEvent_obj::__new(::String type,::cocktail::port::flash_player::HTMLElement target,double detail,int keyChar,int key,bool ctrlKey,bool shiftKey,bool altKey)
