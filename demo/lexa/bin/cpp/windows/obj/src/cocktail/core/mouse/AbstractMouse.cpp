...
Void AbstractMouse_obj::__construct(::cocktail::port::flash_player::HTMLElement htmlElement)
{
{
	HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouse.hx",90)
...
hx::ObjectPtr< AbstractMouse_obj > AbstractMouse_obj::__new(::cocktail::port::flash_player::HTMLElement htmlElement)
...
Void AbstractMouse_obj::onNativeClick( Dynamic event){
{
		...
		HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouse.hx",104)
		if (((this->get_onClick() != null()))){
			HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouse.hx",106)
...
Void AbstractMouse_obj::onNativeMouseDown( Dynamic event){
{
		...
		HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouse.hx",116)
		if (((this->getOnMouseDown() != null()))){
			HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouse.hx",118)
...
Void AbstractMouse_obj::onNativeMouseUp( Dynamic event){
{
		...
		HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouse.hx",128)
		if (((this->getOnMouseUp() != null()))){
			HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouse.hx",130)
...
Void AbstractMouse_obj::onNativeMouseOver( Dynamic event){
{
		...
		HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouse.hx",140)
		if (((this->getOnMouseOver() != null()))){
			HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouse.hx",142)
...
Void AbstractMouse_obj::onNativeMouseOut( Dynamic event){
{
		...
		HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouse.hx",152)
		if (((this->getOnMouseOut() != null()))){
			HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouse.hx",154)
...
Void AbstractMouse_obj::onNativeMouseMove( Dynamic event){
{
		...
		HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouse.hx",165)
		if (((this->getOnMouseMove() != null()))){
			HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouse.hx",167)
...
::cocktail::core::event::MouseEvent AbstractMouse_obj::getMouseEvent( Dynamic event){
	HX_SOURCE_PUSH("AbstractMouse_obj::getMouseEvent")
	HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouse.hx",195)
	return null();
}
...
Dynamic AbstractMouse_obj::set_onClick( Dynamic value){
	...
	HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouse.hx",205)
	this->updateListeners(this->_clickEvent,this->onNativeClick_dyn(),value);
	HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouse.hx",206)
...
Dynamic AbstractMouse_obj::get_onClick( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouse.hx",210)
...
Dynamic AbstractMouse_obj::setOnMouseDown( Dynamic value){
	...
	HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouse.hx",216)
	this->updateListeners(this->_mouseDownEvent,this->onNativeMouseDown_dyn(),value);
	HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouse.hx",217)
...
Dynamic AbstractMouse_obj::getOnMouseDown( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouse.hx",221)
...
Dynamic AbstractMouse_obj::setOnMouseUp( Dynamic value){
	...
	HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouse.hx",227)
	this->updateListeners(this->_mouseUpEvent,this->onNativeMouseUp_dyn(),value);
	HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouse.hx",228)
...
Dynamic AbstractMouse_obj::getOnMouseUp( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouse.hx",232)
...
Dynamic AbstractMouse_obj::setOnMouseOver( Dynamic value){
	...
	HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouse.hx",238)
	this->updateListeners(this->_mouseOverEvent,this->onNativeMouseOver_dyn(),value);
	HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouse.hx",239)
...
Dynamic AbstractMouse_obj::getOnMouseOver( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouse.hx",243)
...
Dynamic AbstractMouse_obj::setOnMouseOut( Dynamic value){
	...
	HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouse.hx",249)
	this->updateListeners(this->_mouseOutEvent,this->onNativeMouseOut_dyn(),value);
	HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouse.hx",250)
...
Dynamic AbstractMouse_obj::getOnMouseOut( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouse.hx",254)
...
Dynamic AbstractMouse_obj::setOnMouseMove( Dynamic value){
	...
	HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouse.hx",260)
	this->updateListeners(this->_mouseMoveEvent,this->onNativeMouseMove_dyn(),value);
	HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouse.hx",261)
...
Dynamic AbstractMouse_obj::getOnMouseMove( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouse.hx",265)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.mouse.AbstractMouse"), hx::TCanCast< AbstractMouse_obj> ,sStaticFields,sMemberFields,
