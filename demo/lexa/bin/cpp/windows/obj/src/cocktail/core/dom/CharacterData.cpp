...
{
{
	HX_SOURCE_POS("../../src/cocktail/core/dom/CharacterData.hx",35)
	super::__construct();
}
;
	return null();
...
int CharacterData_obj::get_nodeType( ){
	HX_SOURCE_PUSH("CharacterData_obj::get_nodeType")
	HX_SOURCE_POS("../../src/cocktail/core/dom/CharacterData.hx",44)
	return (int)3;
}
...
::String CharacterData_obj::get_data( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/CharacterData.hx",53)
	return this->_data;
}
...
::String CharacterData_obj::set_data( ::String value){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/CharacterData.hx",58)
