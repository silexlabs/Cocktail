...
::cocktail::core::style::Translation  Translation_obj::length(::cocktail::core::unit::Length value)
	{ return hx::CreateEnum< Translation_obj >(HX_CSTRING("length"),0,hx::DynamicArray(0,1).Add(value)); }

::cocktail::core::style::Translation  Translation_obj::percent(int value)
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.style.Translation"), hx::TCanCast< Translation_obj >,sStaticFields,sMemberFields,
