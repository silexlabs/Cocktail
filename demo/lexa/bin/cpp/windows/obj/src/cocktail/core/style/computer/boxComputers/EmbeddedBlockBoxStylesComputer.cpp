...
{
{
	HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",32)
	super::__construct();
}
;
	return null();
...
Void EmbeddedBlockBoxStylesComputer_obj::measureAutoWidth( ::cocktail::core::style::CoreStyle style,Dynamic containingHTMLElementData){
{
		...
		HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",46)
		style->getComputedStyle()->__FieldRef(HX_CSTRING("marginLeft")) = this->getComputedMarginLeft(style,containingHTMLElementData);
		HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",48)
...
int EmbeddedBlockBoxStylesComputer_obj::getComputedAutoWidth( ::cocktail::core::style::CoreStyle style,Dynamic containingHTMLElementData){
	...
	int ret = (int)0;
	HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",60)
	::cocktail::core::html::EmbeddedElement embeddedHTMLElement = style->get_htmlElement();
	HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",63)
	if (((style->getHeight() == ::cocktail::core::style::Dimension_obj::cssAuto_dyn()))){
		HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",64)
		if (((embeddedHTMLElement->get_intrinsicWidth() != null()))){
			HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",69)
			ret = embeddedHTMLElement->get_intrinsicWidth();
		}
		else{
			HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",73)
			if (((bool((embeddedHTMLElement->get_intrinsicHeight() != null())) && bool((embeddedHTMLElement->get_intrinsicRatio() != null()))))){
				HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",74)
				ret = ::Math_obj::round((embeddedHTMLElement->get_intrinsicHeight() * embeddedHTMLElement->get_intrinsicRatio()));
			}
			else{
				HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",77)
				if (((embeddedHTMLElement->get_intrinsicRatio() != null()))){
					HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",78)
					if (((containingHTMLElementData->__Field(HX_CSTRING("isWidthAuto")) == false))){
						HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",88)
						Dynamic computedStyle = style->getComputedStyle();
						HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",90)
						...
						HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",93)
						ret = (int)0;
					}
				}
			}
		...
		HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",103)
		...
		HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",104)
		this->setComputedHeight(style,computedHeight);
		HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",107)
		if (((embeddedHTMLElement->get_intrinsicRatio() != null()))){
			HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",108)
			ret = ::Math_obj::round((computedHeight * embeddedHTMLElement->get_intrinsicRatio()));
		}
		else{
			HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",112)
			if (((embeddedHTMLElement->get_intrinsicWidth() != null()))){
				HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",113)
				ret = embeddedHTMLElement->get_intrinsicWidth();
			}
			else{
				HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",117)
				ret = (int)300;
			}
		}
	}
	HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",125)
	return ret;
}
...
int EmbeddedBlockBoxStylesComputer_obj::getComputedAutoHeight( ::cocktail::core::style::CoreStyle style,Dynamic containingHTMLElementData){
	...
	int ret = (int)0;
	HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",137)
	::cocktail::core::html::EmbeddedElement embeddedHTMLElement = style->get_htmlElement();
	HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",140)
	if (((style->getWidth() == ::cocktail::core::style::Dimension_obj::cssAuto_dyn()))){
		HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",141)
		if (((embeddedHTMLElement->get_intrinsicHeight() != null()))){
			HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",144)
			ret = embeddedHTMLElement->get_intrinsicHeight();
		}
	}
	else{
		HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",152)
		...
		HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",153)
		this->setComputedWidth(style,computedWidth);
		HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",156)
		if (((embeddedHTMLElement->get_intrinsicRatio() != null()))){
			HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",157)
			ret = ::Math_obj::round((double(style->getComputedStyle()->__Field(HX_CSTRING("width"))) / double(embeddedHTMLElement->get_intrinsicRatio())));
		}
		else{
			HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",161)
			ret = (int)150;
		}
	}
	HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",169)
	return ret;
}
...
int EmbeddedBlockBoxStylesComputer_obj::getComputedAutoMargin( ::cocktail::core::style::Margin marginStyleValue,::cocktail::core::style::Margin opositeMargin,int containingHTMLElementDimension,int computedDimension,bool isDimensionAuto,int computedPaddingsDimension,double fontSize,double xHeight,bool isHorizontalMargin){
	HX_SOURCE_PUSH("EmbeddedBlockBoxStylesComputer_obj::getComputedAutoMargin")
	HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",178)
	int computedMargin;
	HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",180)
	if (((isHorizontalMargin == false))){
		HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",181)
		computedMargin = (int)0;
	}
	else{
		HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",185)
	...
	HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedBlockBoxStylesComputer.hx",191)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.style.computer.boxComputers.EmbeddedBlockBoxStylesComputer"), hx::TCanCast< EmbeddedBlockBoxStylesComputer_obj> ,sStaticFields,sMemberFields,
