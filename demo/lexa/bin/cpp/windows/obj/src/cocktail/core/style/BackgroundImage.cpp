...
::cocktail::core::style::BackgroundImage  BackgroundImage_obj::image(::cocktail::core::unit::ImageValue value)
	{ return hx::CreateEnum< BackgroundImage_obj >(HX_CSTRING("image"),1,hx::DynamicArray(0,1).Add(value)); }

::cocktail::core::style::BackgroundImage BackgroundImage_obj::none;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.style.BackgroundImage"), hx::TCanCast< BackgroundImage_obj >,sStaticFields,sMemberFields,
