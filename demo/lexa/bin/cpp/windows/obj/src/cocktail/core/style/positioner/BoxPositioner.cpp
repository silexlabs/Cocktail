...
::cocktail::core::renderer::ElementRenderer BoxPositioner_obj::position( ::cocktail::core::renderer::ElementRenderer elementRenderer,Dynamic containingHTMLElementData,Dynamic staticPosition){
	...
	::cocktail::port::flash_player::HTMLElement htmlElement = elementRenderer->getCoreStyle()->get_htmlElement();
...
int BoxPositioner_obj::getLeftOffset( ::cocktail::port::flash_player::HTMLElement htmlElement,int staticPosition){
...
int BoxPositioner_obj::getRightOffset( ::cocktail::port::flash_player::HTMLElement htmlElement,int containingHTMLElementWidth,int staticPosition){
...
int BoxPositioner_obj::getTopOffset( ::cocktail::port::flash_player::HTMLElement htmlElement,int staticPosition){
...
int BoxPositioner_obj::getBottomOffset( ::cocktail::port::flash_player::HTMLElement htmlElement,int containingHTMLElementHeight,int staticPosition){
