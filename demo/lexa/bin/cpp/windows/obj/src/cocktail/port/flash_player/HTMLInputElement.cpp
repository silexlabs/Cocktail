...
{
{
	HX_SOURCE_POS("../../src/cocktail/port/flash_player/HTMLInputElement.hx",25)
	super::__construct();
}
;
	return null();
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.port.flash_player.HTMLInputElement"), hx::TCanCast< HTMLInputElement_obj> ,sStaticFields,sMemberFields,
