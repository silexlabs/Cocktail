...
::cocktail::core::style::VerticalAlign VerticalAlign_obj::baseline;

::cocktail::core::style::VerticalAlign VerticalAlign_obj::bottom;

::cocktail::core::style::VerticalAlign VerticalAlign_obj::cssSuper;

::cocktail::core::style::VerticalAlign  VerticalAlign_obj::length(::cocktail::core::unit::Length value)
	{ return hx::CreateEnum< VerticalAlign_obj >(HX_CSTRING("length"),9,hx::DynamicArray(0,1).Add(value)); }

::cocktail::core::style::VerticalAlign VerticalAlign_obj::middle;

::cocktail::core::style::VerticalAlign  VerticalAlign_obj::percent(int value)
	{ return hx::CreateEnum< VerticalAlign_obj >(HX_CSTRING("percent"),8,hx::DynamicArray(0,1).Add(value)); }

::cocktail::core::style::VerticalAlign VerticalAlign_obj::sub;

::cocktail::core::style::VerticalAlign VerticalAlign_obj::textBottom;

::cocktail::core::style::VerticalAlign VerticalAlign_obj::textTop;

::cocktail::core::style::VerticalAlign VerticalAlign_obj::top;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.style.VerticalAlign"), hx::TCanCast< VerticalAlign_obj >,sStaticFields,sMemberFields,
