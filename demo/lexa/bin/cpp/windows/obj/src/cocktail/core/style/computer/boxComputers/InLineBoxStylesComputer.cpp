...
{
{
	HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/InLineBoxStylesComputer.hx",26)
	super::__construct();
}
;
	return null();
...
Void InLineBoxStylesComputer_obj::measureVerticalPaddings( ::cocktail::core::style::CoreStyle style,Dynamic containingHTMLElementData){
{
		...
		HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/InLineBoxStylesComputer.hx",38)
...
Void InLineBoxStylesComputer_obj::measureAutoHeight( ::cocktail::core::style::CoreStyle style,Dynamic containingHTMLElementData){
{
		...
		HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/InLineBoxStylesComputer.hx",50)
		style->getComputedStyle()->__FieldRef(HX_CSTRING("marginTop")) = (int)0;
		HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/InLineBoxStylesComputer.hx",52)
...
int InLineBoxStylesComputer_obj::getComputedAutoMargin( ::cocktail::core::style::Margin marginStyleValue,::cocktail::core::style::Margin opositeMargin,int containingHTMLElementDimension,int computedDimension,bool isDimensionAuto,int computedPaddingsDimension,double fontSize,double xHeight,bool isHorizontalMargin){
	HX_SOURCE_PUSH("InLineBoxStylesComputer_obj::getComputedAutoMargin")
	HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/InLineBoxStylesComputer.hx",73)
	return (int)0;
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.style.computer.boxComputers.InLineBoxStylesComputer"), hx::TCanCast< InLineBoxStylesComputer_obj> ,sStaticFields,sMemberFields,
