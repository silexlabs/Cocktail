...
Void AbstractStyle_obj::__construct(::cocktail::core::style::CoreStyle coreStyle)
{
{
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",118)
...
hx::ObjectPtr< AbstractStyle_obj > AbstractStyle_obj::__new(::cocktail::core::style::CoreStyle coreStyle)
...
::String AbstractStyle_obj::get_opacity( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_opacity")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",127)
	return ::cocktail::core::unit::UnitManager_obj::getCSSOpacity(this->_coreStyle->getOpacity());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_opacity,return )

::String AbstractStyle_obj::set_opacity( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_opacity")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",134)
	this->_coreStyle->setOpacity(::Std_obj::parseFloat(value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",135)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_opacity,return )

::String AbstractStyle_obj::get_visibility( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_visibility")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",139)
	return ::cocktail::core::unit::UnitManager_obj::getCSSVisibility(this->_coreStyle->getVisibility());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_visibility,return )

::String AbstractStyle_obj::set_visibility( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_visibility")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",145)
	this->_coreStyle->setVisibility(::cocktail::core::unit::UnitManager_obj::visibilityEnum(value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",146)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_visibility,return )

::String AbstractStyle_obj::get_marginLeft( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_marginLeft")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",150)
	return ::cocktail::core::unit::UnitManager_obj::getCSSMargin(this->_coreStyle->getMarginLeft());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_marginLeft,return )

::String AbstractStyle_obj::set_marginLeft( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_marginLeft")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",156)
	...
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",157)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_marginLeft,return )

::String AbstractStyle_obj::get_marginRight( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_marginRight")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",161)
	return ::cocktail::core::unit::UnitManager_obj::getCSSMargin(this->_coreStyle->getMarginRight());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_marginRight,return )

::String AbstractStyle_obj::set_marginRight( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_marginRight")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",167)
	...
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",168)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_marginRight,return )

::String AbstractStyle_obj::get_marginTop( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_marginTop")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",172)
	return ::cocktail::core::unit::UnitManager_obj::getCSSMargin(this->_coreStyle->getMarginTop());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_marginTop,return )

::String AbstractStyle_obj::set_marginTop( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_marginTop")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",178)
	this->_coreStyle->setMarginTop(::cocktail::core::unit::UnitManager_obj::boxStyleEnum(hx::ClassOf< ::cocktail::core::style::Margin >(),value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",179)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_marginTop,return )

::String AbstractStyle_obj::get_marginBottom( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_marginBottom")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",183)
	return ::cocktail::core::unit::UnitManager_obj::getCSSMargin(this->_coreStyle->getMarginBottom());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_marginBottom,return )

::String AbstractStyle_obj::set_marginBottom( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_marginBottom")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",189)
	...
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",190)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_marginBottom,return )

::String AbstractStyle_obj::get_paddingLeft( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_paddingLeft")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",194)
	return ::cocktail::core::unit::UnitManager_obj::getCSSPadding(this->_coreStyle->getPaddingLeft());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_paddingLeft,return )

::String AbstractStyle_obj::set_paddingLeft( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_paddingLeft")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",200)
	...
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",201)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_paddingLeft,return )

::String AbstractStyle_obj::get_paddingRight( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_paddingRight")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",205)
	return ::cocktail::core::unit::UnitManager_obj::getCSSPadding(this->_coreStyle->getPaddingRight());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_paddingRight,return )

::String AbstractStyle_obj::set_paddingRight( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_paddingRight")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",211)
	...
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",212)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_paddingRight,return )

::String AbstractStyle_obj::get_paddingTop( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_paddingTop")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",216)
	return ::cocktail::core::unit::UnitManager_obj::getCSSPadding(this->_coreStyle->getPaddingTop());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_paddingTop,return )

::String AbstractStyle_obj::set_paddingTop( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_paddingTop")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",222)
	...
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",223)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_paddingTop,return )

::String AbstractStyle_obj::get_paddingBottom( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_paddingBottom")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",227)
	return ::cocktail::core::unit::UnitManager_obj::getCSSPadding(this->_coreStyle->getPaddingBottom());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_paddingBottom,return )

::String AbstractStyle_obj::set_paddingBottom( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_paddingBottom")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",233)
	...
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",234)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_paddingBottom,return )

::String AbstractStyle_obj::get_display( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_display")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",238)
	return ::cocktail::core::unit::UnitManager_obj::getCSSDisplay(this->_coreStyle->getDisplay());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_display,return )

::String AbstractStyle_obj::set_display( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_display")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",244)
	this->_coreStyle->setDisplay(::cocktail::core::unit::UnitManager_obj::displayEnum(value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",245)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_display,return )

::String AbstractStyle_obj::get_position( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_position")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",249)
	return ::cocktail::core::unit::UnitManager_obj::getCSSPosition(this->_coreStyle->getPosition());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_position,return )

::String AbstractStyle_obj::set_position( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_position")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",255)
	this->_coreStyle->setPosition(::cocktail::core::unit::UnitManager_obj::positionEnum(value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",256)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_position,return )

::String AbstractStyle_obj::get_width( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_width")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",260)
	return ::cocktail::core::unit::UnitManager_obj::getCSSDimension(this->_coreStyle->getWidth());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_width,return )

::String AbstractStyle_obj::set_width( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_width")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",266)
	this->_coreStyle->setWidth(::cocktail::core::unit::UnitManager_obj::boxStyleEnum(hx::ClassOf< ::cocktail::core::style::Dimension >(),value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",267)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_width,return )

::String AbstractStyle_obj::get_height( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_height")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",271)
	return ::cocktail::core::unit::UnitManager_obj::getCSSDimension(this->_coreStyle->getHeight());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_height,return )

::String AbstractStyle_obj::set_height( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_height")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",277)
	this->_coreStyle->setHeight(::cocktail::core::unit::UnitManager_obj::boxStyleEnum(hx::ClassOf< ::cocktail::core::style::Dimension >(),value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",278)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_height,return )

::String AbstractStyle_obj::get_minHeight( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_minHeight")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",282)
	return ::cocktail::core::unit::UnitManager_obj::getCSSConstrainedDimension(this->_coreStyle->getMinHeight());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_minHeight,return )

::String AbstractStyle_obj::set_minHeight( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_minHeight")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",288)
	this->_coreStyle->setMinHeight(::cocktail::core::unit::UnitManager_obj::constrainedDimensionEnum(value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",289)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_minHeight,return )

::String AbstractStyle_obj::get_maxHeight( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_maxHeight")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",293)
	return ::cocktail::core::unit::UnitManager_obj::getCSSConstrainedDimension(this->_coreStyle->getMaxHeight());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_maxHeight,return )

::String AbstractStyle_obj::set_maxHeight( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_maxHeight")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",299)
	this->_coreStyle->setMaxHeight(::cocktail::core::unit::UnitManager_obj::constrainedDimensionEnum(value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",300)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_maxHeight,return )

::String AbstractStyle_obj::get_minWidth( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_minWidth")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",304)
	return ::cocktail::core::unit::UnitManager_obj::getCSSConstrainedDimension(this->_coreStyle->getMinWidth());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_minWidth,return )

::String AbstractStyle_obj::set_minWidth( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_minWidth")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",310)
	this->_coreStyle->setMinWidth(::cocktail::core::unit::UnitManager_obj::constrainedDimensionEnum(value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",311)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_minWidth,return )

::String AbstractStyle_obj::get_maxWidth( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_maxWidth")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",315)
	return ::cocktail::core::unit::UnitManager_obj::getCSSConstrainedDimension(this->_coreStyle->getMaxWidth());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_maxWidth,return )

::String AbstractStyle_obj::set_maxWidth( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_maxWidth")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",321)
	this->_coreStyle->setMaxWidth(::cocktail::core::unit::UnitManager_obj::constrainedDimensionEnum(value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",322)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_maxWidth,return )

::String AbstractStyle_obj::get_top( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_top")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",326)
	return ::cocktail::core::unit::UnitManager_obj::getCSSPositionOffset(this->_coreStyle->getTop());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_top,return )

::String AbstractStyle_obj::set_top( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_top")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",332)
	...
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",333)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_top,return )

::String AbstractStyle_obj::get_left( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_left")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",337)
	return ::cocktail::core::unit::UnitManager_obj::getCSSPositionOffset(this->_coreStyle->getLeft());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_left,return )

::String AbstractStyle_obj::set_left( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_left")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",343)
	...
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",344)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_left,return )

::String AbstractStyle_obj::get_bottom( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_bottom")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",348)
	return ::cocktail::core::unit::UnitManager_obj::getCSSPositionOffset(this->_coreStyle->getBottom());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_bottom,return )

::String AbstractStyle_obj::set_bottom( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_bottom")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",354)
	...
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",355)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_bottom,return )

::String AbstractStyle_obj::get_right( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_right")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",359)
	return ::cocktail::core::unit::UnitManager_obj::getCSSPositionOffset(this->_coreStyle->getRight());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_right,return )

::String AbstractStyle_obj::set_right( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_right")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",365)
	...
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",366)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_right,return )

::String AbstractStyle_obj::get_CSSFloat( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_CSSFloat")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",370)
	return ::cocktail::core::unit::UnitManager_obj::getCSSFloatAsString(this->_coreStyle->getCSSFloat());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_CSSFloat,return )

::String AbstractStyle_obj::set_CSSFloat( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_CSSFloat")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",376)
	this->_coreStyle->setCSSFloat(::cocktail::core::unit::UnitManager_obj::cssFloatEnum(value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",377)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_CSSFloat,return )

::String AbstractStyle_obj::get_clear( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_clear")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",381)
	return ::cocktail::core::unit::UnitManager_obj::getCSSClear(this->_coreStyle->getClear());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_clear,return )

::String AbstractStyle_obj::set_clear( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_clear")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",387)
	this->_coreStyle->setClear(::cocktail::core::unit::UnitManager_obj::clearEnum(value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",388)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_clear,return )

::String AbstractStyle_obj::get_fontSize( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_fontSize")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",392)
	return ::cocktail::core::unit::UnitManager_obj::getCSSFontSize(this->_coreStyle->getFontSize());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_fontSize,return )

::String AbstractStyle_obj::set_fontSize( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_fontSize")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",397)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_fontSize,return )

::String AbstractStyle_obj::get_fontWeight( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_fontWeight")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",402)
	return ::cocktail::core::unit::UnitManager_obj::getCSSFontWeight(this->_coreStyle->getFontWeight());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_fontWeight,return )

::String AbstractStyle_obj::set_fontWeight( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_fontWeight")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",408)
	this->_coreStyle->setFontWeight(::cocktail::core::unit::UnitManager_obj::fontWeightEnum(value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",409)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_fontWeight,return )

::String AbstractStyle_obj::get_fontStyle( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_fontStyle")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",413)
	return ::cocktail::core::unit::UnitManager_obj::getCSSFontStyle(this->_coreStyle->getFontStyle());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_fontStyle,return )

::String AbstractStyle_obj::set_fontStyle( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_fontStyle")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",419)
	this->_coreStyle->setFontStyle(::cocktail::core::unit::UnitManager_obj::fontStyleEnum(value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",420)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_fontStyle,return )

::String AbstractStyle_obj::get_fontFamily( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_fontFamily")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",424)
	return ::cocktail::core::unit::UnitManager_obj::getCSSFontFamily(this->_coreStyle->getFontFamily());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_fontFamily,return )

::String AbstractStyle_obj::set_fontFamily( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_fontFamily")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",430)
	this->_coreStyle->setFontFamily(::cocktail::core::unit::UnitManager_obj::fontFamilyEnum(value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",431)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_fontFamily,return )

::String AbstractStyle_obj::get_fontVariant( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_fontVariant")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",435)
	return ::cocktail::core::unit::UnitManager_obj::getCSSFontVariant(this->_coreStyle->getFontVariant());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_fontVariant,return )

::String AbstractStyle_obj::set_fontVariant( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_fontVariant")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",441)
	this->_coreStyle->setFontVariant(::cocktail::core::unit::UnitManager_obj::fontVariantEnum(value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",442)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_fontVariant,return )

::String AbstractStyle_obj::get_textTransform( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_textTransform")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",446)
	return ::cocktail::core::unit::UnitManager_obj::getCSSTextTransform(this->_coreStyle->getTextTransform());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_textTransform,return )

::String AbstractStyle_obj::set_textTransform( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_textTransform")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",452)
	this->_coreStyle->setTextTransform(::cocktail::core::unit::UnitManager_obj::textTransformEnum(value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",453)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_textTransform,return )

::String AbstractStyle_obj::get_letterSpacing( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_letterSpacing")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",457)
	return ::cocktail::core::unit::UnitManager_obj::getCSSLetterSpacing(this->_coreStyle->getLetterSpacing());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_letterSpacing,return )

::String AbstractStyle_obj::set_letterSpacing( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_letterSpacing")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",463)
	this->_coreStyle->setLetterSpacing(::cocktail::core::unit::UnitManager_obj::letterSpacingEnum(value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",464)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_letterSpacing,return )

::String AbstractStyle_obj::get_color( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_color")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",468)
	return ::cocktail::core::unit::UnitManager_obj::getCSSColor(this->_coreStyle->getColor());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_color,return )

::String AbstractStyle_obj::set_color( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_color")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",474)
	this->_coreStyle->setColor(::cocktail::core::unit::UnitManager_obj::colorEnum(value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",475)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_color,return )

::String AbstractStyle_obj::get_wordSpacing( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_wordSpacing")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",479)
	return ::cocktail::core::unit::UnitManager_obj::getCSSWordSpacing(this->_coreStyle->getWordSpacing());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_wordSpacing,return )

::String AbstractStyle_obj::set_wordSpacing( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_wordSpacing")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",485)
	this->_coreStyle->setWordSpacing(::cocktail::core::unit::UnitManager_obj::wordSpacingEnum(value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",486)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_wordSpacing,return )

::String AbstractStyle_obj::get_lineHeight( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_lineHeight")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",490)
	return ::cocktail::core::unit::UnitManager_obj::getCSSLineHeight(this->_coreStyle->getLineHeight());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_lineHeight,return )

::String AbstractStyle_obj::set_lineHeight( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_lineHeight")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",496)
	this->_coreStyle->setLineHeight(::cocktail::core::unit::UnitManager_obj::lineHeightEnum(value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",497)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_lineHeight,return )

::String AbstractStyle_obj::get_verticalAlign( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_verticalAlign")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",501)
	return ::cocktail::core::unit::UnitManager_obj::getCSSVerticalAlign(this->_coreStyle->getVerticalAlign());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_verticalAlign,return )

::String AbstractStyle_obj::set_verticalAlign( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_verticalAlign")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",507)
	this->_coreStyle->setVerticalAlign(::cocktail::core::unit::UnitManager_obj::verticalAlignEnum(value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",508)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_verticalAlign,return )

::String AbstractStyle_obj::get_textIndent( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_textIndent")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",512)
	return ::cocktail::core::unit::UnitManager_obj::getCSSTextIndent(this->_coreStyle->getTextIndent());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_textIndent,return )

::String AbstractStyle_obj::set_textIndent( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_textIndent")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",518)
	this->_coreStyle->setTextIndent(::cocktail::core::unit::UnitManager_obj::textIndentEnum(value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",519)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_textIndent,return )

::String AbstractStyle_obj::get_whiteSpace( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_whiteSpace")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",523)
	return ::cocktail::core::unit::UnitManager_obj::getCSSWhiteSpace(this->_coreStyle->getWhiteSpace());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_whiteSpace,return )

::String AbstractStyle_obj::set_whiteSpace( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_whiteSpace")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",529)
	this->_coreStyle->setWhiteSpace(::cocktail::core::unit::UnitManager_obj::whiteSpaceEnum(value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",530)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_whiteSpace,return )

::String AbstractStyle_obj::get_textAlign( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_textAlign")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",534)
	return ::cocktail::core::unit::UnitManager_obj::getCSSTextAlign(this->_coreStyle->getTextAlign());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_textAlign,return )

::String AbstractStyle_obj::set_textAlign( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_textAlign")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",540)
	this->_coreStyle->setTextAlign(::cocktail::core::unit::UnitManager_obj::textAlignEnum(value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",541)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_textAlign,return )

::String AbstractStyle_obj::set_backgroundColor( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_backgroundColor")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",546)
	this->_coreStyle->setBackgroundColor(::cocktail::core::unit::UnitManager_obj::colorEnum(value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",547)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_backgroundColor,return )

::String AbstractStyle_obj::get_backgroundColor( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_backgroundColor")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",551)
	return ::cocktail::core::unit::UnitManager_obj::getCSSColor(this->_coreStyle->getBackgroundColor());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_backgroundColor,return )

::String AbstractStyle_obj::set_backgroundImage( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_backgroundImage")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",557)
	this->_coreStyle->setBackgroundImage(::cocktail::core::unit::UnitManager_obj::backgroundImageEnum(value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",558)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_backgroundImage,return )

::String AbstractStyle_obj::get_backgroundImage( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_backgroundImage")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",562)
	return ::cocktail::core::unit::UnitManager_obj::getCSSBackgroundImage(this->_coreStyle->getBackgroundImage());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_backgroundImage,return )

::String AbstractStyle_obj::set_backgroundRepeat( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_backgroundRepeat")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",568)
	this->_coreStyle->setBackgroundRepeat(::cocktail::core::unit::UnitManager_obj::backgroundRepeatEnum(value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",569)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_backgroundRepeat,return )

::String AbstractStyle_obj::get_backgroundRepeat( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_backgroundRepeat")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",573)
	return ::cocktail::core::unit::UnitManager_obj::getCSSBackgroundRepeat(this->_coreStyle->getBackgroundRepeat());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_backgroundRepeat,return )

::String AbstractStyle_obj::set_backgroundSize( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_backgroundSize")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",579)
	this->_coreStyle->setBackgroundSize(::cocktail::core::unit::UnitManager_obj::backgroundSizeEnum(value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",580)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_backgroundSize,return )

::String AbstractStyle_obj::get_backgroundSize( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_backgroundSize")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",584)
	return ::cocktail::core::unit::UnitManager_obj::getCSSBackgroundSize(this->_coreStyle->getBackgroundSize());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_backgroundSize,return )

::String AbstractStyle_obj::set_backgroundClip( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_backgroundClip")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",590)
	this->_coreStyle->setBackgroundClip(::cocktail::core::unit::UnitManager_obj::backgroundClipEnum(value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",591)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_backgroundClip,return )

::String AbstractStyle_obj::get_backgroundClip( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_backgroundClip")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",595)
	return ::cocktail::core::unit::UnitManager_obj::getCSSBackgroundClip(this->_coreStyle->getBackgroundClip());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_backgroundClip,return )

::String AbstractStyle_obj::set_backgroundPosition( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_backgroundPosition")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",601)
	this->_coreStyle->setBackgroundPosition(::cocktail::core::unit::UnitManager_obj::backgroundPositionEnum(value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",602)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_backgroundPosition,return )

::String AbstractStyle_obj::get_backgroundPosition( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_backgroundPosition")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",606)
	return ::cocktail::core::unit::UnitManager_obj::getCSSBackgroundPosition(this->_coreStyle->getBackgroundPosition());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_backgroundPosition,return )

::String AbstractStyle_obj::set_backgroundOrigin( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_backgroundOrigin")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",612)
	this->_coreStyle->setBackgroundOrigin(::cocktail::core::unit::UnitManager_obj::backgroundOriginEnum(value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",613)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_backgroundOrigin,return )

::String AbstractStyle_obj::get_backgroundOrigin( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_backgroundOrigin")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",617)
	return ::cocktail::core::unit::UnitManager_obj::getCSSBackgroundOrigin(this->_coreStyle->getBackgroundOrigin());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_backgroundOrigin,return )

::String AbstractStyle_obj::get_overflowX( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_overflowX")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",622)
	return ::cocktail::core::unit::UnitManager_obj::getCSSOverflow(this->_coreStyle->getOverflowX());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_overflowX,return )

::String AbstractStyle_obj::set_overflowX( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_overflowX")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",628)
	this->_coreStyle->setOverflowX(::cocktail::core::unit::UnitManager_obj::overflowEnum(value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",629)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_overflowX,return )

::String AbstractStyle_obj::get_overflowY( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_overflowY")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",633)
	return ::cocktail::core::unit::UnitManager_obj::getCSSOverflow(this->_coreStyle->getOverflowY());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_overflowY,return )

::String AbstractStyle_obj::set_overflowY( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_overflowY")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",639)
	this->_coreStyle->setOverflowY(::cocktail::core::unit::UnitManager_obj::overflowEnum(value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",640)
	return ::cocktail::core::unit::UnitManager_obj::getCSSOverflow(this->_coreStyle->getOverflowY());
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_overflowY,return )

::String AbstractStyle_obj::set_cursor( ::String value){
	HX_SOURCE_PUSH("AbstractStyle_obj::set_cursor")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",645)
	this->_coreStyle->setCursor(::cocktail::core::unit::UnitManager_obj::cursorEnum(value));
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",646)
	return value;
}


HX_DEFINE_DYNAMIC_FUNC1(AbstractStyle_obj,set_cursor,return )

::String AbstractStyle_obj::get_cursor( ){
	HX_SOURCE_PUSH("AbstractStyle_obj::get_cursor")
	HX_SOURCE_POS("../../src/cocktail/core/style/adapter/AbstractStyle.hx",650)
	return ::cocktail::core::unit::UnitManager_obj::getCSSCursor(this->_coreStyle->getCursor());
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractStyle_obj,get_cursor,return )
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.style.adapter.AbstractStyle"), hx::TCanCast< AbstractStyle_obj> ,sStaticFields,sMemberFields,
