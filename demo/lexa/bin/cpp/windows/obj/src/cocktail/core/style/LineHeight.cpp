...
::cocktail::core::style::LineHeight  LineHeight_obj::length(::cocktail::core::unit::Length value)
	{ return hx::CreateEnum< LineHeight_obj >(HX_CSTRING("length"),2,hx::DynamicArray(0,1).Add(value)); }

::cocktail::core::style::LineHeight LineHeight_obj::normal;

::cocktail::core::style::LineHeight  LineHeight_obj::number(double value)
	{ return hx::CreateEnum< LineHeight_obj >(HX_CSTRING("number"),1,hx::DynamicArray(0,1).Add(value)); }

::cocktail::core::style::LineHeight  LineHeight_obj::percentage(int value)
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.style.LineHeight"), hx::TCanCast< LineHeight_obj >,sStaticFields,sMemberFields,
