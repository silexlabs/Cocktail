...
::core::html::HTMLDocument Lib_obj::_document;

::core::html::HTMLDocument Lib_obj::document;

::port::flash_player::Window Lib_obj::_window;

::port::flash_player::Window Lib_obj::window;

Void Lib_obj::init( ){
{
		HX_SOURCE_PUSH("Lib_obj::init")
		HX_SOURCE_POS("../../src/cocktail/Lib.hx",52)
		::cocktail::Lib_obj::_document = ::core::html::HTMLDocument_obj::__new();
		HX_SOURCE_POS("../../src/cocktail/Lib.hx",53)
		::cocktail::Lib_obj::_window = ::port::flash_player::Window_obj::__new(::cocktail::Lib_obj::_document);
	}
return null();
}
...
::core::html::HTMLDocument Lib_obj::get_document( ){
	...
	HX_SOURCE_POS("../../src/cocktail/Lib.hx",66)
...
::port::flash_player::Window Lib_obj::get_window( ){
	HX_SOURCE_PUSH("Lib_obj::get_window")
	HX_SOURCE_POS("../../src/cocktail/Lib.hx",71)
	if (((::cocktail::Lib_obj::_window == null()))){
		HX_SOURCE_POS("../../src/cocktail/Lib.hx",72)
		::cocktail::Lib_obj::init();
	}
	HX_SOURCE_POS("../../src/cocktail/Lib.hx",75)
...
Dynamic Lib_obj::__SetField(const ::String &inName,const Dynamic &inValue)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"window") ) { window=inValue.Cast< ::port::flash_player::Window >(); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"_window") ) { _window=inValue.Cast< ::port::flash_player::Window >(); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"document") ) { document=inValue.Cast< ::core::html::HTMLDocument >(); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"_document") ) { _document=inValue.Cast< ::core::html::HTMLDocument >(); return inValue; }
	}
