...
{
{
	HX_SOURCE_POS("../../src/cocktail/core/style/positioner/AbsolutePositioner.hx",24)
	super::__construct();
}
;
	return null();
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.style.positioner.AbsolutePositioner"), hx::TCanCast< AbsolutePositioner_obj> ,sStaticFields,sMemberFields,
