...
{
{
	HX_SOURCE_POS("../../src/cocktail/core/html/EmbeddedElement.hx",76)
...
::cocktail::core::dom::Node EmbeddedElement_obj::removeChild( ::cocktail::core::dom::Node oldChild){
	...
	HX_SOURCE_POS("../../src/cocktail/core/html/EmbeddedElement.hx",121)
	return oldChild;
}
...
Dynamic EmbeddedElement_obj::get_embeddedAsset( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/html/EmbeddedElement.hx",131)
...
Dynamic EmbeddedElement_obj::get_intrinsicHeight( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/html/EmbeddedElement.hx",136)
...
Dynamic EmbeddedElement_obj::get_intrinsicWidth( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/html/EmbeddedElement.hx",141)
...
Dynamic EmbeddedElement_obj::get_intrinsicRatio( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/html/EmbeddedElement.hx",146)
...
int EmbeddedElement_obj::set_width( int value){
	...
	HX_SOURCE_POS("../../src/cocktail/core/html/EmbeddedElement.hx",153)
...
int EmbeddedElement_obj::get_width( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/html/EmbeddedElement.hx",158)
	return this->_width;
}
...
int EmbeddedElement_obj::set_height( int value){
	...
	HX_SOURCE_POS("../../src/cocktail/core/html/EmbeddedElement.hx",163)
...
int EmbeddedElement_obj::get_height( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/html/EmbeddedElement.hx",168)
	return this->_height;
}
