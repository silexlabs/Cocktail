...
{
{
	HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/InlineBlockBoxStylesComputer.hx",25)
	super::__construct();
}
;
	return null();
...
int InlineBlockBoxStylesComputer_obj::getComputedAutoMargin( ::cocktail::core::style::Margin marginStyleValue,::cocktail::core::style::Margin opositeMargin,int containingHTMLElementDimension,int computedDimension,bool isDimensionAuto,int computedPaddingsDimension,double fontSize,double xHeight,bool isHorizontalMargin){
	HX_SOURCE_PUSH("InlineBlockBoxStylesComputer_obj::getComputedAutoMargin")
	HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/InlineBlockBoxStylesComputer.hx",33)
	return (int)0;
}
...
int InlineBlockBoxStylesComputer_obj::shrinkToFit( ::cocktail::core::style::AbstractCoreStyle style,Dynamic containingHTMLElementData,int minimumWidth){
	...
	int shrinkedWidth;
	HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/InlineBlockBoxStylesComputer.hx",52)
	if (((minimumWidth < containingHTMLElementData->__Field(HX_CSTRING("width"))))){
		HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/InlineBlockBoxStylesComputer.hx",53)
		shrinkedWidth = minimumWidth;
	}
	else{
		HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/InlineBlockBoxStylesComputer.hx",57)
		shrinkedWidth = containingHTMLElementData->__Field(HX_CSTRING("width"));
	}
	HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/InlineBlockBoxStylesComputer.hx",61)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.style.computer.boxComputers.InlineBlockBoxStylesComputer"), hx::TCanCast< InlineBlockBoxStylesComputer_obj> ,sStaticFields,sMemberFields,
