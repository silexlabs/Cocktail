...
::cocktail::core::mouse::NativeOSMouseCursorValue NativeOSMouseCursorValue_obj::pointer;

::cocktail::core::mouse::NativeOSMouseCursorValue NativeOSMouseCursorValue_obj::text;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.mouse.NativeOSMouseCursorValue"), hx::TCanCast< NativeOSMouseCursorValue_obj >,sStaticFields,sMemberFields,
