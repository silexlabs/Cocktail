...
#include <cocktail/core/style/GenericFontFamily.h>
#endif
namespace cocktail{
namespace core{
namespace style{

::cocktail::core::style::GenericFontFamily GenericFontFamily_obj::monospace;

::cocktail::core::style::GenericFontFamily GenericFontFamily_obj::sansSerif;

::cocktail::core::style::GenericFontFamily GenericFontFamily_obj::serif;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.style.GenericFontFamily"), hx::TCanCast< GenericFontFamily_obj >,sStaticFields,sMemberFields,
