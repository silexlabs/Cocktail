...
{
{
	HX_SOURCE_POS("../../src/cocktail/core/style/computer/boxComputers/EmbeddedFloatBoxStylesComputer.hx",23)
	super::__construct();
}
;
	return null();
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.style.computer.boxComputers.EmbeddedFloatBoxStylesComputer"), hx::TCanCast< EmbeddedFloatBoxStylesComputer_obj> ,sStaticFields,sMemberFields,
