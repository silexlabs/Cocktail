...
::cocktail::core::style::WhiteSpace WhiteSpace_obj::normal;

::cocktail::core::style::WhiteSpace WhiteSpace_obj::nowrap;

::cocktail::core::style::WhiteSpace WhiteSpace_obj::pre;

::cocktail::core::style::WhiteSpace WhiteSpace_obj::preLine;

::cocktail::core::style::WhiteSpace WhiteSpace_obj::preWrap;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.style.WhiteSpace"), hx::TCanCast< WhiteSpace_obj >,sStaticFields,sMemberFields,
