...
Dynamic AbstractNativeElementCreator_obj::createNativeElement( ::cocktail::core::nativeElement::NativeElementTypeValue nativeElementType){
	HX_SOURCE_PUSH("AbstractNativeElementCreator_obj::createNativeElement")
	HX_SOURCE_POS("../../src/cocktail/core/nativeElement/AbstractNativeElementCreator.hx",36)
	return null();
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.nativeElement.AbstractNativeElementCreator"), hx::TCanCast< AbstractNativeElementCreator_obj> ,sStaticFields,sMemberFields,
