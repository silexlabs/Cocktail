...
::cocktail::core::dom::JointStyleValue JointStyleValue_obj::bevel;

::cocktail::core::dom::JointStyleValue JointStyleValue_obj::miter;

::cocktail::core::dom::JointStyleValue JointStyleValue_obj::round;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.dom.JointStyleValue"), hx::TCanCast< JointStyleValue_obj >,sStaticFields,sMemberFields,
