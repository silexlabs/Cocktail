...
::cocktail::core::style::Dimension Dimension_obj::cssAuto;

::cocktail::core::style::Dimension  Dimension_obj::length(::cocktail::core::unit::Length value)
	{ return hx::CreateEnum< Dimension_obj >(HX_CSTRING("length"),0,hx::DynamicArray(0,1).Add(value)); }

::cocktail::core::style::Dimension  Dimension_obj::percent(int value)
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.style.Dimension"), hx::TCanCast< Dimension_obj >,sStaticFields,sMemberFields,
