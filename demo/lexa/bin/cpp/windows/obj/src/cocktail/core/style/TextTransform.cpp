...
::cocktail::core::style::TextTransform TextTransform_obj::capitalize;

::cocktail::core::style::TextTransform TextTransform_obj::lowercase;

::cocktail::core::style::TextTransform TextTransform_obj::none;

::cocktail::core::style::TextTransform TextTransform_obj::uppercase;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.style.TextTransform"), hx::TCanCast< TextTransform_obj >,sStaticFields,sMemberFields,
