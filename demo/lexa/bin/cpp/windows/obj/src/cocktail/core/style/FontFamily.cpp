...
#include <cocktail/core/style/FontFamily.h>
#endif
...
::cocktail::core::style::FontFamily  FontFamily_obj::familyName(::String name)
	{ return hx::CreateEnum< FontFamily_obj >(HX_CSTRING("familyName"),0,hx::DynamicArray(0,1).Add(name)); }

::cocktail::core::style::FontFamily  FontFamily_obj::genericFamily(::cocktail::core::style::GenericFontFamily genericName)
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.style.FontFamily"), hx::TCanCast< FontFamily_obj >,sStaticFields,sMemberFields,
