...
Void MouseEvent_obj::__construct(::String type,::cocktail::port::flash_player::HTMLElement target,double detail,double screenX,double screenY,double clientX,double clientY,bool ctrlKey,bool shiftKey,bool altKey)
{
{
	HX_SOURCE_POS("../../src/cocktail/core/event/MouseEvent.hx",125)
	super::__construct(type,target,detail);
	HX_SOURCE_POS("../../src/cocktail/core/event/MouseEvent.hx",127)
	this->_screenX = screenX;
	HX_SOURCE_POS("../../src/cocktail/core/event/MouseEvent.hx",128)
	this->_screenY = screenY;
	HX_SOURCE_POS("../../src/cocktail/core/event/MouseEvent.hx",129)
	this->_clientX = clientX;
	HX_SOURCE_POS("../../src/cocktail/core/event/MouseEvent.hx",130)
	this->_clientY = clientY;
	HX_SOURCE_POS("../../src/cocktail/core/event/MouseEvent.hx",131)
	this->_ctrlKey = ctrlKey;
	HX_SOURCE_POS("../../src/cocktail/core/event/MouseEvent.hx",132)
	this->_shiftKey = shiftKey;
	HX_SOURCE_POS("../../src/cocktail/core/event/MouseEvent.hx",133)
	this->_altKey = altKey;
}
;
	return null();
...
hx::ObjectPtr< MouseEvent_obj > MouseEvent_obj::__new(::String type,::cocktail::port::flash_player::HTMLElement target,double detail,double screenX,double screenY,double clientX,double clientY,bool ctrlKey,bool shiftKey,bool altKey)
...
bool MouseEvent_obj::get_altKey( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/event/MouseEvent.hx",141)
	return this->_altKey;
}
...
bool MouseEvent_obj::get_shiftKey( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/event/MouseEvent.hx",146)
...
bool MouseEvent_obj::get_ctrlKey( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/event/MouseEvent.hx",151)
...
double MouseEvent_obj::get_clientY( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/event/MouseEvent.hx",156)
...
double MouseEvent_obj::get_clientX( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/event/MouseEvent.hx",161)
...
double MouseEvent_obj::get_screenX( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/event/MouseEvent.hx",166)
...
double MouseEvent_obj::get_screenY( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/event/MouseEvent.hx",171)
