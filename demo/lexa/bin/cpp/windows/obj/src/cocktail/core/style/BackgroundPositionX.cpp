...
::cocktail::core::style::BackgroundPositionX BackgroundPositionX_obj::center;

::cocktail::core::style::BackgroundPositionX BackgroundPositionX_obj::left;

::cocktail::core::style::BackgroundPositionX  BackgroundPositionX_obj::length(::cocktail::core::unit::Length value)
	{ return hx::CreateEnum< BackgroundPositionX_obj >(HX_CSTRING("length"),0,hx::DynamicArray(0,1).Add(value)); }

::cocktail::core::style::BackgroundPositionX  BackgroundPositionX_obj::percent(int value)
	{ return hx::CreateEnum< BackgroundPositionX_obj >(HX_CSTRING("percent"),1,hx::DynamicArray(0,1).Add(value)); }

::cocktail::core::style::BackgroundPositionX BackgroundPositionX_obj::right;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.style.BackgroundPositionX"), hx::TCanCast< BackgroundPositionX_obj >,sStaticFields,sMemberFields,
