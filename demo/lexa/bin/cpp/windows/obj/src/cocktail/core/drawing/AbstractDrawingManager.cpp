...
{
{
	HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",48)
	this->_nativeElement = nativeElement;
	HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",49)
	this->_width = width;
	HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",50)
	this->_height = height;
}
;
	return null();
...
Void AbstractDrawingManager_obj::beginFill( ::cocktail::core::dom::FillStyleValue fillStyle,::cocktail::core::dom::LineStyleValue lineStyle){
{
		HX_SOURCE_PUSH("AbstractDrawingManager_obj::beginFill")
		HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",72)
		if (((fillStyle == null()))){
			HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",73)
			fillStyle = ::cocktail::core::dom::FillStyleValue_obj::none_dyn();
		}
		HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",77)
		if (((lineStyle == null()))){
			HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",78)
			lineStyle = ::cocktail::core::dom::LineStyleValue_obj::none_dyn();
		}
		HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",83)
		this->setFillStyle(fillStyle);
		HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",86)
...
Void AbstractDrawingManager_obj::setLineStyle( ::cocktail::core::dom::LineStyleValue lineStyle){
{
...
Void AbstractDrawingManager_obj::setFillStyle( ::cocktail::core::dom::FillStyleValue fillStyle){
{
...
Void AbstractDrawingManager_obj::drawRect( int x,int y,int width,int height,Dynamic cornerRadiuses){
{
		...
		HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",145)
		if (((cornerRadiuses == null()))){
			...
			HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",146)
			cornerRadiuses = _Function_2_1::Block();
		}
		HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",155)
		this->moveTo((cornerRadiuses->__Field(HX_CSTRING("tlCornerRadius")) + x),y);
		HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",156)
		this->lineTo(((width - cornerRadiuses->__Field(HX_CSTRING("trCornerRadius"))) + x),y);
		HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",159)
		this->curveTo((width + x),y,(width + x),(cornerRadiuses->__Field(HX_CSTRING("trCornerRadius")) + y));
		HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",161)
		this->lineTo((width + x),(cornerRadiuses->__Field(HX_CSTRING("trCornerRadius")) + y));
		HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",162)
		this->lineTo((width + x),((height - cornerRadiuses->__Field(HX_CSTRING("brCornerRadius"))) + y));
		HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",163)
		this->curveTo((width + x),(height + y),((width - cornerRadiuses->__Field(HX_CSTRING("brCornerRadius"))) + x),(height + y));
		HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",164)
		this->lineTo(((width - cornerRadiuses->__Field(HX_CSTRING("brCornerRadius"))) + x),(height + y));
		HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",165)
		this->lineTo((cornerRadiuses->__Field(HX_CSTRING("blCornerRadius")) + x),(height + y));
		HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",166)
		this->curveTo(x,(height + y),x,((height - cornerRadiuses->__Field(HX_CSTRING("blCornerRadius"))) + y));
		HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",167)
		this->lineTo(x,((height - cornerRadiuses->__Field(HX_CSTRING("blCornerRadius"))) + y));
		HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",168)
		this->lineTo(x,(cornerRadiuses->__Field(HX_CSTRING("tlCornerRadius")) + y));
		HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",169)
		this->curveTo(x,y,(cornerRadiuses->__Field(HX_CSTRING("tlCornerRadius")) + x),y);
		HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",170)
...
Void AbstractDrawingManager_obj::drawEllipse( int x,int y,int width,int height){
{
		...
		HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",184)
		double xRadius = (double(width) / double((int)2));
		HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",185)
		double yRadius = (double(height) / double((int)2));
		HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",187)
		double xCenter = ((double(width) / double((int)2)) + x);
		HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",188)
		double yCenter = ((double(height) / double((int)2)) + y);
		HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",190)
		double angleDelta = (double(::Math_obj::PI) / double((int)4));
		HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",191)
		double xCtrlDist = (double(xRadius) / double(::Math_obj::cos((double(angleDelta) / double((int)2)))));
		HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",192)
		double yCtrlDist = (double(yRadius) / double(::Math_obj::cos((double(angleDelta) / double((int)2)))));
		HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",195)
		this->moveTo((xCenter + xRadius),yCenter);
		HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",196)
		double angle = (int)0;
		HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",198)
		double rx;
		double ry;
		double ax;
		double ay;
		HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",200)
		{
			HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",200)
			int _g = (int)0;
			HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",200)
			while(((_g < (int)8))){
				HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",200)
				int i = (_g)++;
				HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",201)
				hx::AddEq(angle,angleDelta);
				HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",202)
				rx = (xCenter + (::Math_obj::cos((angle - (double(angleDelta) / double((int)2)))) * xCtrlDist));
				HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",203)
				ry = (yCenter + (::Math_obj::sin((angle - (double(angleDelta) / double((int)2)))) * yCtrlDist));
				HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",204)
				ax = (xCenter + (::Math_obj::cos(angle) * xRadius));
				HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",205)
				ay = (yCenter + (::Math_obj::sin(angle) * yRadius));
				HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",206)
...
Void AbstractDrawingManager_obj::drawImage( Dynamic source,::cocktail::core::geom::Matrix matrix,Dynamic sourceRect){
{
...
Dynamic AbstractDrawingManager_obj::toNativeAlpha( double genericAlpa){
	...
	HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",279)
	return null();
}
...
Dynamic AbstractDrawingManager_obj::toNativeColor( int genericColor){
	...
	HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",289)
	return null();
}
...
Dynamic AbstractDrawingManager_obj::toNativeRatio( int genericRatio){
	...
	HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",299)
	return null();
}
...
Dynamic AbstractDrawingManager_obj::toNativeCapStyle( ::cocktail::core::dom::CapsStyleValue genericCapStyle){
	HX_SOURCE_PUSH("AbstractDrawingManager_obj::toNativeCapStyle")
	HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",309)
	return null();
}
...
Dynamic AbstractDrawingManager_obj::toNativeJointStyle( ::cocktail::core::dom::JointStyleValue genericJointStyle){
	HX_SOURCE_PUSH("AbstractDrawingManager_obj::toNativeJointStyle")
	HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",319)
	return null();
}
...
Dynamic AbstractDrawingManager_obj::getNativeElement( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",328)
...
int AbstractDrawingManager_obj::setWidth( int value){
	...
	HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",333)
...
int AbstractDrawingManager_obj::getWidth( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",338)
	return this->_width;
}
...
int AbstractDrawingManager_obj::setHeight( int value){
	...
	HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",343)
...
int AbstractDrawingManager_obj::getHeight( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/drawing/AbstractDrawingManager.hx",348)
	return this->_height;
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.drawing.AbstractDrawingManager"), hx::TCanCast< AbstractDrawingManager_obj> ,sStaticFields,sMemberFields,
