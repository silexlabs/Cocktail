...
{
{
	HX_SOURCE_POS("../../src/port/flash_player/HTMLElement.hx",22)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("port.flash_player.HTMLElement"), hx::TCanCast< HTMLElement_obj> ,sStaticFields,sMemberFields,
