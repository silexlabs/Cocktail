...
{
{
	HX_SOURCE_POS("../../src/port/flash_player/MouseCursor.hx",38)
	super::__construct();
}
;
	return null();
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("port.flash_player.MouseCursor"), hx::TCanCast< MouseCursor_obj> ,sStaticFields,sMemberFields,
