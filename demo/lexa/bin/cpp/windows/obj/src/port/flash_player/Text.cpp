...
{
{
	HX_SOURCE_POS("../../src/port/flash_player/Text.hx",26)
	super::__construct();
}
;
	return null();
...
::String Text_obj::set_data( ::String value){
	...
	HX_SOURCE_POS("../../src/port/flash_player/Text.hx",37)
	this->super::set_data(value);
	HX_SOURCE_POS("../../src/port/flash_player/Text.hx",39)
	this->reset();
	HX_SOURCE_POS("../../src/port/flash_player/Text.hx",40)
	this->_textFragments = Dynamic( Array_obj<Dynamic>::__new() );
	HX_SOURCE_POS("../../src/port/flash_player/Text.hx",42)
	if (((this->_parentNode != null()))){
		HX_SOURCE_POS("../../src/port/flash_player/Text.hx",44)
		::port::flash_player::HTMLElement parent = this->_parentNode;
		HX_SOURCE_POS("../../src/port/flash_player/Text.hx",45)
		parent->get_style()->invalidateText();
	}
	HX_SOURCE_POS("../../src/port/flash_player/Text.hx",48)
	return value;
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("port.flash_player.Text"), hx::TCanCast< Text_obj> ,sStaticFields,sMemberFields,
