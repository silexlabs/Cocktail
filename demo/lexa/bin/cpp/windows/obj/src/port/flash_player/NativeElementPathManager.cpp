...
{
{
	HX_SOURCE_POS("../../src/port/flash_player/NativeElementPathManager.hx",26)
	super::__construct();
}
;
	return null();
...
Dynamic NativeElementPathManager_obj::getRoot( ){
	...
	HX_SOURCE_POS("../../src/port/flash_player/NativeElementPathManager.hx",34)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("port.flash_player.NativeElementPathManager"), hx::TCanCast< NativeElementPathManager_obj> ,sStaticFields,sMemberFields,
