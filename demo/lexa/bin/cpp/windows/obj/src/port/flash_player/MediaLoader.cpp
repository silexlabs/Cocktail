...
{
{
	HX_SOURCE_POS("../../src/port/flash_player/MediaLoader.hx",38)
...
Void MediaLoader_obj::doLoad( ::String url){
{
		...
		HX_SOURCE_POS("../../src/port/flash_player/MediaLoader.hx",52)
		::nme::display::Loader loader = this->_nativeElement;
		HX_SOURCE_POS("../../src/port/flash_player/MediaLoader.hx",54)
		loader->unload();
		HX_SOURCE_POS("../../src/port/flash_player/MediaLoader.hx",57)
		loader->contentLoaderInfo->addEventListener(::nme::events::Event_obj::COMPLETE,this->onNativeLoadComplete_dyn(),null(),null(),null());
		HX_SOURCE_POS("../../src/port/flash_player/MediaLoader.hx",58)
		...
		HX_SOURCE_POS("../../src/port/flash_player/MediaLoader.hx",61)
		::nme::net::URLRequest request = ::nme::net::URLRequest_obj::__new(url);
		HX_SOURCE_POS("../../src/port/flash_player/MediaLoader.hx",73)
		loader->load(request);
	}
return null();
}
...
Void MediaLoader_obj::onNativeLoadComplete( ::nme::events::Event event){
{
		...
		HX_SOURCE_POS("../../src/port/flash_player/MediaLoader.hx",88)
		::nme::display::Loader loader = this->_nativeElement;
		HX_SOURCE_POS("../../src/port/flash_player/MediaLoader.hx",89)
		this->removeLoaderListeners(loader);
		HX_SOURCE_POS("../../src/port/flash_player/MediaLoader.hx",90)
		this->setIntrinsicDimensions(loader);
		HX_SOURCE_POS("../../src/port/flash_player/MediaLoader.hx",91)
...
Void MediaLoader_obj::onNativeLoadIOError( ::nme::events::IOErrorEvent event){
{
		...
		HX_SOURCE_POS("../../src/port/flash_player/MediaLoader.hx",101)
		::nme::display::Loader loader = this->_nativeElement;
		HX_SOURCE_POS("../../src/port/flash_player/MediaLoader.hx",102)
		this->removeLoaderListeners(loader);
		HX_SOURCE_POS("../../src/port/flash_player/MediaLoader.hx",103)
...
Void MediaLoader_obj::setIntrinsicDimensions( ::nme::display::Loader loader){
{
		...
		HX_SOURCE_POS("../../src/port/flash_player/MediaLoader.hx",125)
		this->_intrinsicHeight = ::Math_obj::round(loader->content->nmeGetHeight());
		HX_SOURCE_POS("../../src/port/flash_player/MediaLoader.hx",126)
		this->_intrinsicWidth = ::Math_obj::round(loader->content->nmeGetWidth());
		HX_SOURCE_POS("../../src/port/flash_player/MediaLoader.hx",127)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("port.flash_player.MediaLoader"), hx::TCanCast< MediaLoader_obj> ,sStaticFields,sMemberFields,
