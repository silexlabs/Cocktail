...
{
{
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",55)
	super::__construct(nativeElement,width,height);
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",57)
	this->_typedNativeElement = this->_nativeElement;
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",60)
	...
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",61)
...
Void DrawingManager_obj::setFillStyle( ::core::dom::FillStyleValue fillStyle){
{
		HX_SOURCE_PUSH("DrawingManager_obj::setFillStyle")
		HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",127)
		{
::core::dom::FillStyleValue _switch_1 = (fillStyle);
			switch((_switch_1)->GetIndex()){
				case 0: {
					HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",132)
...
{
						HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",136)
...
{
						HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",140)
...
{
						HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",152)
...
Void DrawingManager_obj::setLineStyle( ::core::dom::LineStyleValue lineStyle){
{
		HX_SOURCE_PUSH("DrawingManager_obj::setLineStyle")
		HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",162)
		{
::core::dom::LineStyleValue _switch_2 = (lineStyle);
...
{
						HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",169)
...
{
						HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",185)
						...
						HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",195)
				...
				case 3: {
					...
					Dynamic lineStyleData = _switch_2->__Param(1);
					::core::html::AbstractHTMLImageElement imageHTMLElement = _switch_2->__Param(0);
{
						HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",208)
						this->_typedNativeElement->nmeGetGraphics()->lineStyle(lineStyleData->__Field(HX_CSTRING("thickness")),(int)0,(int)1,true,::nme::display::LineScaleMode_obj::NONE_dyn(),this->toNativeCapStyle(lineStyleData->__Field(HX_CSTRING("capStyle"))),this->toNativeJointStyle(lineStyleData->__Field(HX_CSTRING("jointStyle"))),lineStyleData->__Field(HX_CSTRING("miterLimit")));
						HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",219)
...
Void DrawingManager_obj::drawImage( Dynamic source,::core::geom::Matrix matrix,Dynamic sourceRect){
{
		HX_SOURCE_PUSH("DrawingManager_obj::drawImage")
		HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",234)
		if (((matrix == null()))){
			HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",235)
			matrix = ::core::geom::Matrix_obj::__new(null());
		}
		HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",239)
		if (((sourceRect == null()))){
			HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",241)
			double width = source->__Field(HX_CSTRING("width"));
			HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",242)
			...
			HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",243)
			sourceRect = _Function_2_1::Block(width,height);
		}
		HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",252)
		::nme::display::BitmapData sourceBitmapData = this->getBitmapData(source);
		HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",253)
		::nme::display::BitmapData currentBitmapData = this->_bitmapDrawing->bitmapData;
		HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",256)
		...
		HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",258)
		Dynamic matrixData = matrix->getData();
		HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",259)
		...
		HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",262)
...
Void DrawingManager_obj::lineTo( double x,double y){
{
		...
		HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",273)
...
Void DrawingManager_obj::moveTo( double x,double y){
{
		...
		HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",281)
...
Void DrawingManager_obj::curveTo( double controlX,double controlY,double x,double y){
{
		...
		HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",289)
...
Dynamic DrawingManager_obj::toNativeAlpha( double genericAlpha){
	...
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",301)
	return genericAlpha;
}
...
Dynamic DrawingManager_obj::toNativeRatio( int genericRatio){
	...
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",310)
	if (((genericRatio == (int)0))){
		HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",311)
		return (int)0;
	}
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",314)
...
Dynamic DrawingManager_obj::toNativeCapStyle( ::core::dom::CapsStyleValue genericCapStyle){
	HX_SOURCE_PUSH("DrawingManager_obj::toNativeCapStyle")
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",323)
	::nme::display::CapsStyle capStyle = ::nme::display::CapsStyle_obj::ROUND_dyn();
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",325)
	{
::core::dom::CapsStyleValue _switch_3 = (genericCapStyle);
		switch((_switch_3)->GetIndex()){
			case 2: {
				HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",327)
				capStyle = ::nme::display::CapsStyle_obj::ROUND_dyn();
			}
			;break;
			case 1: {
				HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",330)
				capStyle = ::nme::display::CapsStyle_obj::SQUARE_dyn();
			}
			;break;
			case 0: {
				HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",333)
				capStyle = ::nme::display::CapsStyle_obj::NONE_dyn();
			}
			;break;
		}
	}
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",337)
	return capStyle;
}
...
Dynamic DrawingManager_obj::toNativeJointStyle( ::core::dom::JointStyleValue genericJointStyle){
	HX_SOURCE_PUSH("DrawingManager_obj::toNativeJointStyle")
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",346)
	::nme::display::JointStyle jointStyle = ::nme::display::JointStyle_obj::BEVEL_dyn();
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",348)
	{
::core::dom::JointStyleValue _switch_4 = (genericJointStyle);
		switch((_switch_4)->GetIndex()){
			case 0: {
				HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",350)
				jointStyle = ::nme::display::JointStyle_obj::MITER_dyn();
			}
			;break;
			case 1: {
				HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",353)
				jointStyle = ::nme::display::JointStyle_obj::ROUND_dyn();
			}
			;break;
			case 2: {
				HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",356)
				jointStyle = ::nme::display::JointStyle_obj::BEVEL_dyn();
			}
			;break;
		}
	}
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",360)
	return jointStyle;
}
...
::nme::display::GradientType DrawingManager_obj::getGradientType( ::core::dom::GradientTypeValue genericGradientType){
	HX_SOURCE_PUSH("DrawingManager_obj::getGradientType")
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",374)
	::nme::display::GradientType gradientType = ::nme::display::GradientType_obj::LINEAR_dyn();
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",376)
	{
::core::dom::GradientTypeValue _switch_5 = (genericGradientType);
		switch((_switch_5)->GetIndex()){
			case 0: {
				HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",378)
				gradientType = ::nme::display::GradientType_obj::LINEAR_dyn();
			}
			;break;
			case 1: {
				HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",381)
				gradientType = ::nme::display::GradientType_obj::RADIAL_dyn();
			}
			;break;
		}
	}
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",385)
	return gradientType;
}
...
Array< int > DrawingManager_obj::getGradientColors( Dynamic gradientStops){
	...
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",410)
	Array< int > ret = Array_obj< int >::__new();
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",412)
	{
		HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",412)
		int _g1 = (int)0;
		...
		while(((_g1 < _g))){
			HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",412)
			int i = (_g1)++;
			HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",414)
			ret[i] = gradientStops->__GetItem(i)->__Field(HX_CSTRING("colorStop"))->__Field(HX_CSTRING("color"));
		}
	}
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",417)
	return ret;
}
...
Array< double > DrawingManager_obj::getGradientAlphas( Dynamic gradientStops){
	...
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",427)
	Array< double > ret = Array_obj< double >::__new();
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",429)
	{
		HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",429)
		int _g1 = (int)0;
		int _g = gradientStops->__Field(HX_CSTRING("length"));
		...
		while(((_g1 < _g))){
			HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",429)
			int i = (_g1)++;
			HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",431)
			ret[i] = this->toNativeAlpha(gradientStops->__GetItem(i)->__Field(HX_CSTRING("colorStop"))->__Field(HX_CSTRING("alpha")));
		}
	}
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",434)
	return ret;
}
...
Array< int > DrawingManager_obj::getGradientRatios( Dynamic gradientStops){
	...
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",444)
	Array< int > ret = Array_obj< int >::__new();
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",446)
	{
		HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",446)
		int _g1 = (int)0;
		int _g = gradientStops->__Field(HX_CSTRING("length"));
		...
		while(((_g1 < _g))){
			HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",446)
			int i = (_g1)++;
			HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",448)
			ret[i] = this->toNativeRatio(gradientStops->__GetItem(i)->__Field(HX_CSTRING("ratio")));
		}
	}
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",450)
	return ret;
}
...
::nme::geom::Matrix DrawingManager_obj::getGradientBox( Dynamic gradientStyle){
	...
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",460)
	::nme::geom::Matrix gradientBox = ::nme::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",461)
	...
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",462)
	return gradientBox;
}
...
int DrawingManager_obj::setWidth( int value){
	...
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",472)
	this->super::setWidth(value);
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",473)
	...
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",474)
	this->_nativeElement->__Field(HX_CSTRING("addChild"))(this->_bitmapDrawing);
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",475)
...
int DrawingManager_obj::setHeight( int value){
	...
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",481)
	this->super::setHeight(value);
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",482)
	...
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",483)
	this->_nativeElement->__Field(HX_CSTRING("addChild"))(this->_bitmapDrawing);
	HX_SOURCE_POS("../../src/port/flash_player/DrawingManager.hx",484)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("port.flash_player.DrawingManager"), hx::TCanCast< DrawingManager_obj> ,sStaticFields,sMemberFields,
