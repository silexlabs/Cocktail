...
{
{
	HX_SOURCE_POS("../../src/port/flash_player/HTMLAnchorElement.hx",25)
	super::__construct();
}
;
	return null();
...
Void HTMLAnchorElement_obj::openDocument( ){
{
		...
		HX_SOURCE_POS("../../src/port/flash_player/HTMLAnchorElement.hx",33)
		if (((this->_href != null()))){
			HX_SOURCE_POS("../../src/port/flash_player/HTMLAnchorElement.hx",35)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("port.flash_player.HTMLAnchorElement"), hx::TCanCast< HTMLAnchorElement_obj> ,sStaticFields,sMemberFields,
