...
{
{
	HX_SOURCE_POS("../../src/port/flash_player/NativeElementCreator.hx",31)
	super::__construct();
}
;
	return null();
...
Dynamic NativeElementCreator_obj::createNativeElement( ::core::nativeElement::NativeElementTypeValue nativeElementType){
	HX_SOURCE_PUSH("NativeElementCreator_obj::createNativeElement")
	HX_SOURCE_POS("../../src/port/flash_player/NativeElementCreator.hx",41)
	Dynamic nativeElement;
	HX_SOURCE_POS("../../src/port/flash_player/NativeElementCreator.hx",43)
	{
::core::nativeElement::NativeElementTypeValue _switch_1 = (nativeElementType);
		switch((_switch_1)->GetIndex()){
			case 3: case 4: case 5: {
				HX_SOURCE_POS("../../src/port/flash_player/NativeElementCreator.hx",46)
				nativeElement = ::nme::display::Loader_obj::__new();
			}
			;break;
			case 2: case 1: case 0: case 6: case 7: {
				HX_SOURCE_POS("../../src/port/flash_player/NativeElementCreator.hx",50)
...
{
					HX_SOURCE_POS("../../src/port/flash_player/NativeElementCreator.hx",52)
					nativeElement = ::nme::display::Sprite_obj::__new();
				}
			}
			;break;
	...
	HX_SOURCE_POS("../../src/port/flash_player/NativeElementCreator.hx",57)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("port.flash_player.NativeElementCreator"), hx::TCanCast< NativeElementCreator_obj> ,sStaticFields,sMemberFields,
