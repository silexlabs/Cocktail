...
Void Window_obj::__construct(::core::dom::Document document)
{
{
	HX_SOURCE_POS("../../src/port/flash_player/Window.hx",27)
...
hx::ObjectPtr< Window_obj > Window_obj::__new(::core::dom::Document document)
...
Dynamic Window_obj::set_onResize( Dynamic value){
	...
	HX_SOURCE_POS("../../src/port/flash_player/Window.hx",41)
	if (((value == null()))){
		HX_SOURCE_POS("../../src/port/flash_player/Window.hx",42)
		::nme::Lib_obj::nmeGetCurrent()->nmeGetStage()->removeEventListener(::nme::events::Event_obj::RESIZE,this->onNativeResize_dyn(),null());
	}
	else{
		HX_SOURCE_POS("../../src/port/flash_player/Window.hx",46)
	...
	HX_SOURCE_POS("../../src/port/flash_player/Window.hx",50)
...
int Window_obj::get_innerHeight( ){
	...
	HX_SOURCE_POS("../../src/port/flash_player/Window.hx",57)
...
int Window_obj::get_innerWidth( ){
	...
	HX_SOURCE_POS("../../src/port/flash_player/Window.hx",65)
...
Void Window_obj::onNativeResize( Dynamic event){
{
		...
		HX_SOURCE_POS("../../src/port/flash_player/Window.hx",77)
		if (((this->_onResize_dyn() != null()))){
			HX_SOURCE_POS("../../src/port/flash_player/Window.hx",79)
			this->_onResize(::core::event::Event_obj::__new(HX_CSTRING("resize"),hx::ObjectPtr<OBJ_>(this)));
		}
	}
return null();
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("port.flash_player.Window"), hx::TCanCast< Window_obj> ,sStaticFields,sMemberFields,
