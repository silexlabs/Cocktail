...
{
{
	HX_SOURCE_POS("../../src/core/style/computer/boxComputers/BlockBoxStylesComputer.hx",26)
	super::__construct();
}
;
	return null();
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.style.computer.boxComputers.BlockBoxStylesComputer"), hx::TCanCast< BlockBoxStylesComputer_obj> ,sStaticFields,sMemberFields,
