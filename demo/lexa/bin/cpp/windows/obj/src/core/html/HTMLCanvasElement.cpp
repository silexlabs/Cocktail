...
{
{
	HX_SOURCE_POS("../../src/core/html/HTMLCanvasElement.hx",32)
	super::__construct(HX_CSTRING("canvas"));
	HX_SOURCE_POS("../../src/core/html/HTMLCanvasElement.hx",34)
	this->_intrinsicHeight = (int)150;
	HX_SOURCE_POS("../../src/core/html/HTMLCanvasElement.hx",35)
	this->_intrinsicWidth = (int)300;
	HX_SOURCE_POS("../../src/core/html/HTMLCanvasElement.hx",36)
	this->_intrinsicRatio = (double(this->_intrinsicWidth) / double(this->_intrinsicHeight));
	HX_SOURCE_POS("../../src/core/html/HTMLCanvasElement.hx",38)
	this->_drawingManager = ::port::flash_player::DrawingManager_obj::__new(this->_nativeElement,this->_intrinsicHeight,this->_intrinsicWidth);
}
;
	return null();
}
...
Void HTMLCanvasElement_obj::initEmbeddedAsset( ){
{
		...
		HX_SOURCE_POS("../../src/core/html/HTMLCanvasElement.hx",42)
...
::port::flash_player::DrawingManager HTMLCanvasElement_obj::getContext( ::String contextID){
	HX_SOURCE_PUSH("HTMLCanvasElement_obj::getContext")
	HX_SOURCE_POS("../../src/core/html/HTMLCanvasElement.hx",48)
...
int HTMLCanvasElement_obj::set_width( int value){
	...
	HX_SOURCE_POS("../../src/core/html/HTMLCanvasElement.hx",58)
	this->_drawingManager->setWidth(value);
	HX_SOURCE_POS("../../src/core/html/HTMLCanvasElement.hx",59)
...
int HTMLCanvasElement_obj::set_height( int value){
	...
	HX_SOURCE_POS("../../src/core/html/HTMLCanvasElement.hx",64)
	this->_drawingManager->setHeight(value);
	HX_SOURCE_POS("../../src/core/html/HTMLCanvasElement.hx",65)
...
Dynamic HTMLCanvasElement_obj::__SetField(const ::String &inName,const Dynamic &inValue)
{
	switch(inName.length) {
	case 15:
		if (HX_FIELD_EQ(inName,"_drawingManager") ) { _drawingManager=inValue.Cast< ::port::flash_player::DrawingManager >(); return inValue; }
		break;
	case 20:
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.html.HTMLCanvasElement"), hx::TCanCast< HTMLCanvasElement_obj> ,sStaticFields,sMemberFields,
