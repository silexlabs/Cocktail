...
{
{
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",40)
	Dynamic floatsLeft = Dynamic( Array_obj<Dynamic>::__new() );
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",41)
	...
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",43)
...
Void FloatsManager_obj::dispose( ){
{
		...
		HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",51)
		this->_floats->__FieldRef(HX_CSTRING("left")) = null();
		HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",52)
		this->_floats->__FieldRef(HX_CSTRING("right")) = null();
		HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",53)
		this->_floats = null();
	}
return null();
}
...
int FloatsManager_obj::clearFloat( ::core::style::Clear clear,Dynamic formattingContextData){
	HX_SOURCE_PUSH("FloatsManager_obj::clearFloat")
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",73)
	int ret;
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",75)
	{
::core::style::Clear _switch_1 = (clear);
		switch((_switch_1)->GetIndex()){
			case 1: {
				HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",78)
				ret = this->clearLeft(formattingContextData);
				HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",79)
				this->_floats->__FieldRef(HX_CSTRING("left")) = Dynamic( Array_obj<Dynamic>::__new() );
			}
			;break;
			case 2: {
				HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",82)
				ret = this->clearRight(formattingContextData);
				HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",83)
				this->_floats->__FieldRef(HX_CSTRING("right")) = Dynamic( Array_obj<Dynamic>::__new() );
			}
			;break;
			case 3: {
				HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",86)
				ret = this->clearBoth(formattingContextData);
				HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",87)
				this->_floats->__FieldRef(HX_CSTRING("right")) = Dynamic( Array_obj<Dynamic>::__new() );
				HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",88)
				this->_floats->__FieldRef(HX_CSTRING("left")) = Dynamic( Array_obj<Dynamic>::__new() );
			}
			;break;
			case 0: {
				HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",90)
				ret = formattingContextData->__Field(HX_CSTRING("y"));
			}
			;break;
		}
	}
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",94)
	return ret;
}
...
int FloatsManager_obj::clearLeft( Dynamic formattingContextData){
	...
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",101)
...
int FloatsManager_obj::clearRight( Dynamic formattingContextData){
	...
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",109)
...
int FloatsManager_obj::clearBoth( Dynamic formattingContextData){
	...
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",118)
	int leftY = this->doClearFloat(formattingContextData,this->_floats->__Field(HX_CSTRING("left")));
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",119)
	int rightY = this->doClearFloat(formattingContextData,this->_floats->__Field(HX_CSTRING("right")));
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",121)
	if (((leftY > rightY))){
		HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",122)
		return leftY;
	}
	else{
		HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",126)
		return rightY;
	}
}
...
int FloatsManager_obj::doClearFloat( Dynamic formattingContextData,Dynamic floats){
	...
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",141)
	if (((floats->__Field(HX_CSTRING("length")) > (int)0))){
		HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",146)
		Dynamic highestFloat = floats->__GetItem((int)0);
		HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",148)
		{
			HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",148)
			int _g1 = (int)0;
			...
			while(((_g1 < _g))){
				HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",148)
				int i = (_g1)++;
				HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",150)
				if ((((floats->__GetItem(i)->__Field(HX_CSTRING("y")) + floats->__GetItem(i)->__Field(HX_CSTRING("height"))) > (highestFloat->__Field(HX_CSTRING("y")) + highestFloat->__Field(HX_CSTRING("height")))))){
					HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",151)
					highestFloat = floats->__GetItem(i);
				}
			}
		}
		HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",156)
		return (highestFloat->__Field(HX_CSTRING("y")) + highestFloat->__Field(HX_CSTRING("height")));
	}
	else{
		HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",162)
...
Dynamic FloatsManager_obj::computeFloatData( ::core::renderer::ElementRenderer elementRenderer,Dynamic formattingContextData,int containingBlockWidth){
	HX_SOURCE_PUSH("FloatsManager_obj::computeFloatData")
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",183)
	Dynamic ret;
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",185)
	{
::core::style::CSSFloat _switch_2 = (elementRenderer->getStyle()->getComputedStyle()->__Field(HX_CSTRING("cssFloat")));
		switch((_switch_2)->GetIndex()){
			case 0: {
				HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",188)
				ret = this->getLeftFloatData(elementRenderer,formattingContextData,containingBlockWidth);
				HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",189)
				this->_floats->__Field(HX_CSTRING("left"))->__Field(HX_CSTRING("push"))(ret);
			}
			;break;
			case 1: {
				HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",192)
				ret = this->getRightFloatData(elementRenderer,formattingContextData,containingBlockWidth);
				HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",193)
				this->_floats->__Field(HX_CSTRING("right"))->__Field(HX_CSTRING("push"))(ret);
			}
			;break;
			default: {
				HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",195)
				ret = null();
			}
		}
	}
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",199)
	return ret;
}
...
Dynamic FloatsManager_obj::getLeftFloatData( ::core::renderer::ElementRenderer elementRenderer,Dynamic formattingContextData,int containingBlockWidth){
	HX_SOURCE_PUSH("FloatsManager_obj::getLeftFloatData")
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",210)
	Dynamic floatData = this->getFloatData(elementRenderer,formattingContextData,containingBlockWidth);
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",214)
	floatData->__FieldRef(HX_CSTRING("x")) = this->getLeftFloatOffset(floatData->__Field(HX_CSTRING("y")));
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",216)
	return floatData;
}
...
Dynamic FloatsManager_obj::getRightFloatData( ::core::renderer::ElementRenderer elementRenderer,Dynamic formattingContextData,int containingBlockWidth){
	HX_SOURCE_PUSH("FloatsManager_obj::getRightFloatData")
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",225)
	Dynamic floatData = this->getFloatData(elementRenderer,formattingContextData,containingBlockWidth);
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",229)
	...
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",231)
	return floatData;
}
...
Dynamic FloatsManager_obj::getFloatData( ::core::renderer::ElementRenderer elementRenderer,Dynamic formattingContextData,int containingBlockWidth){
	HX_SOURCE_PUSH("FloatsManager_obj::getFloatData")
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",244)
	int floatWidth = elementRenderer->getStyle()->get_htmlElement()->get_offsetWidth();
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",245)
	int floatHeight = elementRenderer->getStyle()->get_htmlElement()->get_offsetHeight();
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",248)
	int floatY = this->getFirstAvailableY(formattingContextData,floatWidth,containingBlockWidth);
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",251)
	int floatX = (int)0;
	struct _Function_1_1{
	...
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",253)
...
int FloatsManager_obj::getFirstAvailableY( Dynamic formattingContextData,int elementWidth,int containingBlockWidth){
	...
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",275)
	int retY = formattingContextData->__Field(HX_CSTRING("y"));
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",279)
	while(((((this->getLeftFloatOffset(retY) + this->getRightFloatOffset(retY,containingBlockWidth)) + elementWidth) > containingBlockWidth))){
		HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",283)
		Dynamic afterFloats = Dynamic( Array_obj<Dynamic>::__new() );
		HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",286)
		{
			HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",286)
			int _g1 = (int)0;
			...
			while(((_g1 < _g))){
				HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",286)
				int i = (_g1)++;
				HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",288)
				if (((bool((this->_floats->__Field(HX_CSTRING("left"))->__GetItem(i)->__Field(HX_CSTRING("y")) <= retY)) && bool(((this->_floats->__Field(HX_CSTRING("left"))->__GetItem(i)->__Field(HX_CSTRING("height")) + this->_floats->__Field(HX_CSTRING("left"))->__GetItem(i)->__Field(HX_CSTRING("y"))) > retY))))){
					HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",289)
					afterFloats->__Field(HX_CSTRING("push"))(this->_floats->__Field(HX_CSTRING("left"))->__GetItem(i));
				}
			}
		}
		HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",295)
		{
			HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",295)
			int _g1 = (int)0;
			...
			while(((_g1 < _g))){
				HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",295)
				int i = (_g1)++;
				HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",297)
				if (((bool((this->_floats->__Field(HX_CSTRING("right"))->__GetItem(i)->__Field(HX_CSTRING("y")) <= retY)) && bool(((this->_floats->__Field(HX_CSTRING("right"))->__GetItem(i)->__Field(HX_CSTRING("height")) + this->_floats->__Field(HX_CSTRING("right"))->__GetItem(i)->__Field(HX_CSTRING("y"))) > retY))))){
					HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",298)
					afterFloats->__Field(HX_CSTRING("push"))(this->_floats->__Field(HX_CSTRING("right"))->__GetItem(i));
				}
			}
		}
		HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",306)
		if (((afterFloats->__Field(HX_CSTRING("length")) == (int)0))){
			HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",307)
			break;
		}
		else{
			HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",319)
			int nextY = (int)1000000;
			HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",322)
			{
				HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",322)
				int _g1 = (int)0;
				...
				while(((_g1 < _g))){
					HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",322)
					int i = (_g1)++;
					HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",324)
					if (((((afterFloats->__GetItem(i)->__Field(HX_CSTRING("y")) + afterFloats->__GetItem(i)->__Field(HX_CSTRING("height"))) - retY) < nextY))){
						HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",325)
						nextY = ((afterFloats->__GetItem(i)->__Field(HX_CSTRING("y")) + afterFloats->__GetItem(i)->__Field(HX_CSTRING("height"))) - retY);
					}
				}
			}
			HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",334)
			hx::AddEq(retY,nextY);
		}
	}
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",340)
	return retY;
}
...
Void FloatsManager_obj::removeFloats( int flowY){
{
		...
		HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",355)
		this->_floats->__FieldRef(HX_CSTRING("left")) = this->doRemoveFloat(this->_floats->__Field(HX_CSTRING("left")),flowY);
		HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",356)
...
Dynamic FloatsManager_obj::doRemoveFloat( Dynamic floats,int flowY){
	...
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",365)
	Dynamic newFloats = Dynamic( Array_obj<Dynamic>::__new() );
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",367)
	{
		HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",367)
		int _g1 = (int)0;
		int _g = floats->__Field(HX_CSTRING("length"));
		...
		while(((_g1 < _g))){
			HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",367)
			int i = (_g1)++;
			HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",371)
			if ((((floats->__GetItem(i)->__Field(HX_CSTRING("y")) + floats->__GetItem(i)->__Field(HX_CSTRING("height"))) > flowY))){
				HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",372)
				newFloats->__Field(HX_CSTRING("push"))(floats->__GetItem(i));
			}
		}
	}
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",377)
	return newFloats;
}
...
int FloatsManager_obj::getRightFloatOffset( int y,int containingWidth){
	...
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",392)
	int rightFloatOffset = (int)0;
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",395)
	{
		HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",395)
		int _g1 = (int)0;
		int _g = this->_floats->__Field(HX_CSTRING("right"))->__Field(HX_CSTRING("length"));
		...
		while(((_g1 < _g))){
			HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",395)
			int i = (_g1)++;
			HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",398)
...
int FloatsManager_obj::getLeftFloatOffset( int y){
	...
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",422)
	int leftFloatOffset = (int)0;
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",425)
	{
		HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",425)
		int _g1 = (int)0;
		int _g = this->_floats->__Field(HX_CSTRING("left"))->__Field(HX_CSTRING("length"));
		...
		while(((_g1 < _g))){
			HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",425)
			int i = (_g1)++;
			HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",428)
			if (((bool(((this->_floats->__Field(HX_CSTRING("left"))->__GetItem(i)->__Field(HX_CSTRING("y")) + this->_floats->__Field(HX_CSTRING("left"))->__GetItem(i)->__Field(HX_CSTRING("height"))) > y)) && bool((this->_floats->__Field(HX_CSTRING("left"))->__GetItem(i)->__Field(HX_CSTRING("y")) <= y))))){
				HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",430)
				if ((((this->_floats->__Field(HX_CSTRING("left"))->__GetItem(i)->__Field(HX_CSTRING("x")) + this->_floats->__Field(HX_CSTRING("left"))->__GetItem(i)->__Field(HX_CSTRING("width"))) > leftFloatOffset))){
					HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",435)
	...
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",441)
...
Dynamic FloatsManager_obj::getFloats( ){
	...
	HX_SOURCE_POS("../../src/core/style/floats/FloatsManager.hx",449)
	return this->_floats;
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.style.floats.FloatsManager"), hx::TCanCast< FloatsManager_obj> ,sStaticFields,sMemberFields,
