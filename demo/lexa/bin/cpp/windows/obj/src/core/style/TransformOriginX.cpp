...
::core::style::TransformOriginX TransformOriginX_obj::center;

::core::style::TransformOriginX TransformOriginX_obj::left;

::core::style::TransformOriginX  TransformOriginX_obj::length(::core::unit::Length value)
	{ return hx::CreateEnum< TransformOriginX_obj >(HX_CSTRING("length"),0,hx::DynamicArray(0,1).Add(value)); }

::core::style::TransformOriginX  TransformOriginX_obj::percent(int value)
	{ return hx::CreateEnum< TransformOriginX_obj >(HX_CSTRING("percent"),1,hx::DynamicArray(0,1).Add(value)); }

::core::style::TransformOriginX TransformOriginX_obj::right;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.style.TransformOriginX"), hx::TCanCast< TransformOriginX_obj >,sStaticFields,sMemberFields,
