...
{
{
	HX_SOURCE_POS("../../src/core/dom/Text.hx",68)
	super::__construct();
	HX_SOURCE_POS("../../src/core/dom/Text.hx",69)
...
Void Text_obj::reset( ){
{
		...
		HX_SOURCE_POS("../../src/core/dom/Text.hx",84)
		int _g1 = (int)0;
		...
		while(((_g1 < _g))){
			HX_SOURCE_POS("../../src/core/dom/Text.hx",84)
			int i = (_g1)++;
			HX_SOURCE_POS("../../src/core/dom/Text.hx",86)
...
Dynamic Text_obj::getTextFragments( ::String text){
	...
	HX_SOURCE_POS("../../src/core/dom/Text.hx",98)
	if (((this->_textFragments->__Field(HX_CSTRING("length")) == (int)0))){
		HX_SOURCE_POS("../../src/core/dom/Text.hx",99)
		this->_textFragments = ::core::dom::Text_obj::doGetTextFragments(text);
	}
	HX_SOURCE_POS("../../src/core/dom/Text.hx",103)
...
Dynamic Text_obj::get_nativeElement( ){
	...
	HX_SOURCE_POS("../../src/core/dom/Text.hx",277)
...
::String Text_obj::get_nodeValue( ){
	...
	HX_SOURCE_POS("../../src/core/dom/Text.hx",282)
	return this->_data;
}
...
::String Text_obj::set_nodeValue( ::String value){
	...
	HX_SOURCE_POS("../../src/core/dom/Text.hx",287)
...
::String Text_obj::applyTextTransform( ::String text,::core::style::TextTransform textTransform){
	HX_SOURCE_PUSH("Text_obj::applyTextTransform")
	HX_SOURCE_POS("../../src/core/dom/Text.hx",118)
	{
::core::style::TextTransform _switch_1 = (textTransform);
		switch((_switch_1)->GetIndex()){
			case 1: {
				HX_SOURCE_POS("../../src/core/dom/Text.hx",120)
				text = text.toUpperCase();
			}
			;break;
			case 2: {
				HX_SOURCE_POS("../../src/core/dom/Text.hx",123)
				text = text.toLowerCase();
			}
			;break;
			case 0: {
				HX_SOURCE_POS("../../src/core/dom/Text.hx",126)
				text = ::core::dom::Text_obj::capitalizeText(text);
			}
			;break;
			case 3: {
			}
	...
	HX_SOURCE_POS("../../src/core/dom/Text.hx",132)
	return text;
}
...
::String Text_obj::capitalizeText( ::String text){
	...
	HX_SOURCE_POS("../../src/core/dom/Text.hx",143)
	::String capitalizedText = text.charAt((int)0);
	HX_SOURCE_POS("../../src/core/dom/Text.hx",149)
	{
		HX_SOURCE_POS("../../src/core/dom/Text.hx",149)
		int _g1 = (int)1;
		int _g = text.length;
		...
		while(((_g1 < _g))){
			HX_SOURCE_POS("../../src/core/dom/Text.hx",149)
			int i = (_g1)++;
			HX_SOURCE_POS("../../src/core/dom/Text.hx",151)
			if (((text.charAt((i - (int)1)) == HX_CSTRING(" ")))){
				HX_SOURCE_POS("../../src/core/dom/Text.hx",152)
				hx::AddEq(capitalizedText,text.charAt(i).toUpperCase());
			}
			else{
				HX_SOURCE_POS("../../src/core/dom/Text.hx",156)
				hx::AddEq(capitalizedText,text.charAt(i));
			}
		}
	}
	HX_SOURCE_POS("../../src/core/dom/Text.hx",160)
...
Dynamic Text_obj::doGetTextFragments( ::String text){
	...
	HX_SOURCE_POS("../../src/core/dom/Text.hx",178)
	Dynamic textFragments = Dynamic( Array_obj<Dynamic>::__new() );
	HX_SOURCE_POS("../../src/core/dom/Text.hx",181)
	::String textFragment = HX_CSTRING("");
	HX_SOURCE_POS("../../src/core/dom/Text.hx",183)
	int i = (int)0;
	HX_SOURCE_POS("../../src/core/dom/Text.hx",186)
	while(((i < text.length))){
		HX_SOURCE_POS("../../src/core/dom/Text.hx",189)
		if (((text.charAt(i) == HX_CSTRING("\\")))){
			HX_SOURCE_POS("../../src/core/dom/Text.hx",190)
			if (((i < (text.length - (int)1)))){
				HX_SOURCE_POS("../../src/core/dom/Text.hx",192)
				if (((text.charAt((i + (int)1)) == HX_CSTRING("n")))){
					HX_SOURCE_POS("../../src/core/dom/Text.hx",196)
					if (((textFragment != null()))){
						HX_SOURCE_POS("../../src/core/dom/Text.hx",199)
						textFragments->__Field(HX_CSTRING("push"))(::core::dom::Text_obj::insertTextToken(::core::dom::TextTokenValue_obj::word(textFragment)));
						HX_SOURCE_POS("../../src/core/dom/Text.hx",200)
						textFragment = null();
					}
					HX_SOURCE_POS("../../src/core/dom/Text.hx",203)
					textFragments->__Field(HX_CSTRING("push"))(::core::dom::Text_obj::insertTextToken(::core::dom::TextTokenValue_obj::lineFeed_dyn()));
					HX_SOURCE_POS("../../src/core/dom/Text.hx",204)
					(i)++;
				}
				else{
					HX_SOURCE_POS("../../src/core/dom/Text.hx",207)
					if (((text.charAt((i + (int)1)) == HX_CSTRING("t")))){
						HX_SOURCE_POS("../../src/core/dom/Text.hx",209)
						if (((textFragment != null()))){
							HX_SOURCE_POS("../../src/core/dom/Text.hx",212)
							textFragments->__Field(HX_CSTRING("push"))(::core::dom::Text_obj::insertTextToken(::core::dom::TextTokenValue_obj::word(textFragment)));
							HX_SOURCE_POS("../../src/core/dom/Text.hx",213)
							textFragment = null();
						}
						HX_SOURCE_POS("../../src/core/dom/Text.hx",216)
						textFragments->__Field(HX_CSTRING("push"))(::core::dom::Text_obj::insertTextToken(::core::dom::TextTokenValue_obj::tab_dyn()));
						HX_SOURCE_POS("../../src/core/dom/Text.hx",217)
						(i)++;
					}
				}
			}
		}
		HX_SOURCE_POS("../../src/core/dom/Text.hx",223)
		if (((::StringTools_obj::isSpace(text,i) == true))){
			HX_SOURCE_POS("../../src/core/dom/Text.hx",228)
			if (((textFragment != null()))){
				HX_SOURCE_POS("../../src/core/dom/Text.hx",231)
				textFragments->__Field(HX_CSTRING("push"))(::core::dom::Text_obj::insertTextToken(::core::dom::TextTokenValue_obj::word(textFragment)));
				HX_SOURCE_POS("../../src/core/dom/Text.hx",232)
				textFragment = null();
			}
			HX_SOURCE_POS("../../src/core/dom/Text.hx",236)
			textFragments->__Field(HX_CSTRING("push"))(::core::dom::Text_obj::insertTextToken(::core::dom::TextTokenValue_obj::space_dyn()));
		}
		else{
			HX_SOURCE_POS("../../src/core/dom/Text.hx",243)
			if (((textFragment == null()))){
				HX_SOURCE_POS("../../src/core/dom/Text.hx",244)
				textFragment = HX_CSTRING("");
			}
			HX_SOURCE_POS("../../src/core/dom/Text.hx",247)
			hx::AddEq(textFragment,text.charAt(i));
		}
		HX_SOURCE_POS("../../src/core/dom/Text.hx",250)
		(i)++;
	}
	HX_SOURCE_POS("../../src/core/dom/Text.hx",255)
	if (((textFragment != null()))){
		HX_SOURCE_POS("../../src/core/dom/Text.hx",256)
		textFragments->__Field(HX_CSTRING("push"))(::core::dom::Text_obj::insertTextToken(::core::dom::TextTokenValue_obj::word(textFragment)));
	}
	HX_SOURCE_POS("../../src/core/dom/Text.hx",260)
...
Dynamic Text_obj::insertTextToken( ::core::dom::TextTokenValue textToken){
	HX_SOURCE_PUSH("Text_obj::insertTextToken")
	struct _Function_1_1{
		inline static Dynamic Block( ::core::dom::TextTokenValue &textToken){
	...
	HX_SOURCE_POS("../../src/core/dom/Text.hx",268)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.dom.Text"), hx::TCanCast< Text_obj> ,sStaticFields,sMemberFields,
