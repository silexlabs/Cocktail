...
::core::style::Overflow Overflow_obj::cssAuto;

::core::style::Overflow Overflow_obj::hidden;

::core::style::Overflow Overflow_obj::scroll;

::core::style::Overflow Overflow_obj::visible;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.style.Overflow"), hx::TCanCast< Overflow_obj >,sStaticFields,sMemberFields,
