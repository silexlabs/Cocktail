...
::core::style::BackgroundOrigin BackgroundOrigin_obj::borderBox;

::core::style::BackgroundOrigin BackgroundOrigin_obj::contentBox;

::core::style::BackgroundOrigin BackgroundOrigin_obj::paddingBox;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.style.BackgroundOrigin"), hx::TCanCast< BackgroundOrigin_obj >,sStaticFields,sMemberFields,
