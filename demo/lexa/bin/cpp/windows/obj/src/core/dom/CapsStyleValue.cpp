...
::core::dom::CapsStyleValue CapsStyleValue_obj::none;

::core::dom::CapsStyleValue CapsStyleValue_obj::round;

::core::dom::CapsStyleValue CapsStyleValue_obj::square;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.dom.CapsStyleValue"), hx::TCanCast< CapsStyleValue_obj >,sStaticFields,sMemberFields,
