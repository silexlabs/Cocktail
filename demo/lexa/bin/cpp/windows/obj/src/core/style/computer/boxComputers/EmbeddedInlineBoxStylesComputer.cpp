...
{
{
	HX_SOURCE_POS("../../src/core/style/computer/boxComputers/EmbeddedInlineBoxStylesComputer.hx",28)
	super::__construct();
}
;
	return null();
...
int EmbeddedInlineBoxStylesComputer_obj::getComputedAutoMargin( ::core::style::Margin marginStyleValue,::core::style::Margin opositeMargin,int containingHTMLElementDimension,int computedDimension,bool isDimensionAuto,int computedPaddingsDimension,double fontSize,double xHeight,bool isHorizontalMargin){
	HX_SOURCE_PUSH("EmbeddedInlineBoxStylesComputer_obj::getComputedAutoMargin")
	HX_SOURCE_POS("../../src/core/style/computer/boxComputers/EmbeddedInlineBoxStylesComputer.hx",36)
	return (int)0;
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.style.computer.boxComputers.EmbeddedInlineBoxStylesComputer"), hx::TCanCast< EmbeddedInlineBoxStylesComputer_obj> ,sStaticFields,sMemberFields,
