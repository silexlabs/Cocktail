...
#endif
#ifndef INCLUDED_core_resource_XMLHTTPRequest
...
{
{
	HX_SOURCE_POS("../../src/core/resource/XMLHTTPRequest.hx",97)
	this->_http = ::haxe::Http_obj::__new(HX_CSTRING(""));
	HX_SOURCE_POS("../../src/core/resource/XMLHTTPRequest.hx",99)
	this->_http->onData = this->onHTTPData_dyn();
	HX_SOURCE_POS("../../src/core/resource/XMLHTTPRequest.hx",100)
	this->_http->onStatus = this->onHTTPStatus_dyn();
	HX_SOURCE_POS("../../src/core/resource/XMLHTTPRequest.hx",101)
	this->_http->onError = this->onHTTPError_dyn();
	HX_SOURCE_POS("../../src/core/resource/XMLHTTPRequest.hx",102)
...
Void XMLHTTPRequest_obj::open( ::String method,::String url){
{
		...
		HX_SOURCE_POS("../../src/core/resource/XMLHTTPRequest.hx",117)
		this->_http->url = url;
		HX_SOURCE_POS("../../src/core/resource/XMLHTTPRequest.hx",118)
		this->_method = method;
		HX_SOURCE_POS("../../src/core/resource/XMLHTTPRequest.hx",119)
...
Void XMLHTTPRequest_obj::send( ::String content){
{
		...
		HX_SOURCE_POS("../../src/core/resource/XMLHTTPRequest.hx",130)
		bool post = false;
		HX_SOURCE_POS("../../src/core/resource/XMLHTTPRequest.hx",133)
		::String _switch_1 = (this->_method.toUpperCase());
		if (  ( _switch_1==HX_CSTRING("POST"))){
			HX_SOURCE_POS("../../src/core/resource/XMLHTTPRequest.hx",135)
			post = true;
		}
		HX_SOURCE_POS("../../src/core/resource/XMLHTTPRequest.hx",139)
		this->_http->request(post);
		HX_SOURCE_POS("../../src/core/resource/XMLHTTPRequest.hx",141)
...
Void XMLHTTPRequest_obj::setRequestHeader( ::String name,::String value){
{
		...
		HX_SOURCE_POS("../../src/core/resource/XMLHTTPRequest.hx",148)
...
Void XMLHTTPRequest_obj::onHTTPStatus( int status){
{
		...
		HX_SOURCE_POS("../../src/core/resource/XMLHTTPRequest.hx",160)
		this->_status = status;
	}
return null();
}
...
Void XMLHTTPRequest_obj::onHTTPData( ::String data){
{
		...
		HX_SOURCE_POS("../../src/core/resource/XMLHTTPRequest.hx",169)
		this->_responseText = data;
		HX_SOURCE_POS("../../src/core/resource/XMLHTTPRequest.hx",170)
...
Void XMLHTTPRequest_obj::onHTTPError( ::String data){
{
		...
		HX_SOURCE_POS("../../src/core/resource/XMLHTTPRequest.hx",178)
		this->_responseText = data;
		HX_SOURCE_POS("../../src/core/resource/XMLHTTPRequest.hx",179)
		this->setReadyState((int)4);
	}
return null();
}
...
Void XMLHTTPRequest_obj::setReadyState( int value){
{
		...
		HX_SOURCE_POS("../../src/core/resource/XMLHTTPRequest.hx",188)
		this->_readyState = value;
		HX_SOURCE_POS("../../src/core/resource/XMLHTTPRequest.hx",189)
		if (((this->onReadyStateChange_dyn() != null()))){
			HX_SOURCE_POS("../../src/core/resource/XMLHTTPRequest.hx",190)
			this->onReadyStateChange(::core::event::Event_obj::__new(HX_CSTRING("readystatechange"),hx::ObjectPtr<OBJ_>(this)));
		}
	}
return null();
}
...
int XMLHTTPRequest_obj::get_readyState( ){
	...
	HX_SOURCE_POS("../../src/core/resource/XMLHTTPRequest.hx",200)
...
int XMLHTTPRequest_obj::get_status( ){
	...
	HX_SOURCE_POS("../../src/core/resource/XMLHTTPRequest.hx",205)
	return this->_status;
}
...
::String XMLHTTPRequest_obj::get_responseText( ){
	...
	HX_SOURCE_POS("../../src/core/resource/XMLHTTPRequest.hx",210)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.resource.XMLHTTPRequest"), hx::TCanCast< XMLHTTPRequest_obj> ,sStaticFields,sMemberFields,
