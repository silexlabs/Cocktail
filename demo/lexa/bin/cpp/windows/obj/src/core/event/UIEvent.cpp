...
Void UIEvent_obj::__construct(::String type,::port::flash_player::HTMLElement target,double detail)
{
{
	HX_SOURCE_POS("../../src/core/event/UIEvent.hx",28)
	this->_detail = detail;
	HX_SOURCE_POS("../../src/core/event/UIEvent.hx",29)
...
hx::ObjectPtr< UIEvent_obj > UIEvent_obj::__new(::String type,::port::flash_player::HTMLElement target,double detail)
...
double UIEvent_obj::get_detail( ){
	...
	HX_SOURCE_POS("../../src/core/event/UIEvent.hx",37)
	return this->_detail;
}
...
double UIEvent_obj::set_detail( double value){
	...
	HX_SOURCE_POS("../../src/core/event/UIEvent.hx",42)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.event.UIEvent"), hx::TCanCast< UIEvent_obj> ,sStaticFields,sMemberFields,
