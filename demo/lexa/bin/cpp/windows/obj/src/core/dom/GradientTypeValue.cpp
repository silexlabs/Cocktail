...
::core::dom::GradientTypeValue GradientTypeValue_obj::linear;

::core::dom::GradientTypeValue GradientTypeValue_obj::radial;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.dom.GradientTypeValue"), hx::TCanCast< GradientTypeValue_obj >,sStaticFields,sMemberFields,
