...
::core::style::FontVariant FontVariant_obj::normal;

::core::style::FontVariant FontVariant_obj::smallCaps;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.style.FontVariant"), hx::TCanCast< FontVariant_obj >,sStaticFields,sMemberFields,
