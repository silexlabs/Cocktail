...
::core::style::BackgroundSize BackgroundSize_obj::contain;

::core::style::BackgroundSize BackgroundSize_obj::cover;

::core::style::BackgroundSize  BackgroundSize_obj::dimensions(Dynamic value)
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.style.BackgroundSize"), hx::TCanCast< BackgroundSize_obj >,sStaticFields,sMemberFields,
