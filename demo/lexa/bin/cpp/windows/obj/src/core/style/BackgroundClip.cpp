...
::core::style::BackgroundClip BackgroundClip_obj::borderBox;

::core::style::BackgroundClip BackgroundClip_obj::contentBox;

::core::style::BackgroundClip BackgroundClip_obj::paddingBox;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.style.BackgroundClip"), hx::TCanCast< BackgroundClip_obj >,sStaticFields,sMemberFields,
