...
{
{
	HX_SOURCE_POS("../../src/core/style/positioner/RelativePositioner.hx",33)
	super::__construct();
}
;
	return null();
...
int RelativePositioner_obj::getLeftOffset( ::port::flash_player::HTMLElement htmlElement,int staticPosition){
	HX_SOURCE_PUSH("RelativePositioner_obj::getLeftOffset")
	HX_SOURCE_POS("../../src/core/style/positioner/RelativePositioner.hx",42)
	return (staticPosition + htmlElement->get_style()->getComputedStyle()->__Field(HX_CSTRING("left")));
}


HX_DEFINE_DYNAMIC_FUNC2(RelativePositioner_obj,getLeftOffset,return )

int RelativePositioner_obj::getRightOffset( ::port::flash_player::HTMLElement htmlElement,int containingHTMLElementWidth,int staticPosition){
	HX_SOURCE_PUSH("RelativePositioner_obj::getRightOffset")
	HX_SOURCE_POS("../../src/core/style/positioner/RelativePositioner.hx",47)
	return (staticPosition - htmlElement->get_style()->getComputedStyle()->__Field(HX_CSTRING("right")));
}


HX_DEFINE_DYNAMIC_FUNC3(RelativePositioner_obj,getRightOffset,return )

int RelativePositioner_obj::getTopOffset( ::port::flash_player::HTMLElement htmlElement,int staticPosition){
	HX_SOURCE_PUSH("RelativePositioner_obj::getTopOffset")
	HX_SOURCE_POS("../../src/core/style/positioner/RelativePositioner.hx",52)
	return (staticPosition + htmlElement->get_style()->getComputedStyle()->__Field(HX_CSTRING("top")));
}


HX_DEFINE_DYNAMIC_FUNC2(RelativePositioner_obj,getTopOffset,return )

int RelativePositioner_obj::getBottomOffset( ::port::flash_player::HTMLElement htmlElement,int containingHTMLElementHeight,int staticPosition){
	HX_SOURCE_PUSH("RelativePositioner_obj::getBottomOffset")
	HX_SOURCE_POS("../../src/core/style/positioner/RelativePositioner.hx",57)
	return (staticPosition - htmlElement->get_style()->getComputedStyle()->__Field(HX_CSTRING("bottom")));
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.style.positioner.RelativePositioner"), hx::TCanCast< RelativePositioner_obj> ,sStaticFields,sMemberFields,
