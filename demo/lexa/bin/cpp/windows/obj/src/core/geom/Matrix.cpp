...
{
{
	HX_SOURCE_POS("../../src/core/geom/Matrix.hx",36)
	this->setData(data);
}
;
	return null();
...
Void Matrix_obj::identity( ){
{
		...
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",48)
...
Dynamic Matrix_obj::setData( Dynamic data){
	...
	HX_SOURCE_POS("../../src/core/geom/Matrix.hx",67)
	this->_data = data;
	HX_SOURCE_POS("../../src/core/geom/Matrix.hx",70)
	if (((this->_data == null()))){
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",71)
		this->identity();
	}
	HX_SOURCE_POS("../../src/core/geom/Matrix.hx",75)
	return this->_data;
}
...
Dynamic Matrix_obj::getData( ){
	...
	HX_SOURCE_POS("../../src/core/geom/Matrix.hx",83)
	return this->_data;
}
...
Void Matrix_obj::concatenate( ::core::geom::Matrix matrix){
{
		HX_SOURCE_PUSH("Matrix_obj::concatenate")
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",101)
		Dynamic currentMatrixData = this->_data;
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",102)
		Dynamic targetMatrixData = matrix->getData();
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",105)
		...
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",106)
		...
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",107)
		...
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",108)
		...
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",109)
		...
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",110)
		...
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",113)
		Dynamic concatenatedMatrixData = _Function_1_1::Block(b,e,a,d,c,f);
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",123)
...
Void Matrix_obj::translate( double x,double y){
{
		...
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",140)
		Dynamic translationMatrixData = _Function_1_1::Block(x,y);
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",150)
		::core::geom::Matrix translationMatrix = ::core::geom::Matrix_obj::__new(translationMatrixData);
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",154)
...
Void Matrix_obj::rotate( double angle,Dynamic registrationPoint){
{
		...
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",168)
		::core::geom::Matrix rotatedMatrix = ::core::geom::Matrix_obj::__new(null());
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",171)
		rotatedMatrix->translate(registrationPoint->__Field(HX_CSTRING("x")),registrationPoint->__Field(HX_CSTRING("y")));
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",173)
		double a = 0.0;
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",174)
		double b = 0.0;
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",175)
		double c = 0.0;
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",176)
		double d = 0.0;
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",180)
		if (((angle == (double(::Math_obj::PI) / double((int)2))))){
			HX_SOURCE_POS("../../src/core/geom/Matrix.hx",182)
			a = d = 0.0;
			HX_SOURCE_POS("../../src/core/geom/Matrix.hx",183)
			c = b = 1.0;
		}
		else{
			HX_SOURCE_POS("../../src/core/geom/Matrix.hx",186)
			if (((angle == ::Math_obj::PI))){
				HX_SOURCE_POS("../../src/core/geom/Matrix.hx",188)
				a = d = -1.0;
				HX_SOURCE_POS("../../src/core/geom/Matrix.hx",189)
				c = b = 0.0;
			}
			else{
				HX_SOURCE_POS("../../src/core/geom/Matrix.hx",191)
				if (((angle == (double((::Math_obj::PI * (int)3)) / double((int)2))))){
					HX_SOURCE_POS("../../src/core/geom/Matrix.hx",193)
					a = d = 0.0;
					HX_SOURCE_POS("../../src/core/geom/Matrix.hx",194)
					c = b = -1.0;
				}
				else{
					HX_SOURCE_POS("../../src/core/geom/Matrix.hx",198)
					a = d = ::Math_obj::cos(angle);
					HX_SOURCE_POS("../../src/core/geom/Matrix.hx",199)
		...
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",204)
		Dynamic rotationMatrixData = _Function_1_1::Block(b,a,d,c);
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",214)
		::core::geom::Matrix rotationMatrix = ::core::geom::Matrix_obj::__new(rotationMatrixData);
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",218)
		rotatedMatrix->concatenate(rotationMatrix);
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",221)
		rotatedMatrix->translate((registrationPoint->__Field(HX_CSTRING("x")) * (int)-1),(registrationPoint->__Field(HX_CSTRING("y")) * (int)-1));
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",225)
...
Void Matrix_obj::scale( double scaleX,double scaleY,Dynamic registrationPoint){
{
		...
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",240)
		::core::geom::Matrix scaledMatrix = ::core::geom::Matrix_obj::__new(null());
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",243)
		...
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",247)
		Dynamic scalingMatrixData = _Function_1_1::Block(scaleX,scaleY);
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",257)
		::core::geom::Matrix scalingMatrix = ::core::geom::Matrix_obj::__new(scalingMatrixData);
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",261)
		scaledMatrix->concatenate(scalingMatrix);
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",264)
		scaledMatrix->translate((registrationPoint->__Field(HX_CSTRING("x")) * (int)-1),(registrationPoint->__Field(HX_CSTRING("y")) * (int)-1));
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",268)
...
Void Matrix_obj::skew( double skewX,double skewY,Dynamic registrationPoint){
{
		...
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",283)
		::core::geom::Matrix skewedMatrix = ::core::geom::Matrix_obj::__new(null());
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",286)
		...
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",290)
		Dynamic skewingMatrixData = _Function_1_1::Block(skewY,skewX);
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",300)
		::core::geom::Matrix skewingMatrix = ::core::geom::Matrix_obj::__new(skewingMatrixData);
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",304)
		skewedMatrix->concatenate(skewingMatrix);
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",307)
		skewedMatrix->translate((registrationPoint->__Field(HX_CSTRING("x")) * (int)-1),(registrationPoint->__Field(HX_CSTRING("y")) * (int)-1));
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",311)
...
Void Matrix_obj::setRotation( double angle,Dynamic registrationPoint){
{
		...
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",327)
		double currentRotation = this->getRotation();
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",330)
		double resetAngle = ((::Math_obj::PI * (int)2) - currentRotation);
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",333)
		this->rotate(resetAngle,registrationPoint);
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",336)
...
double Matrix_obj::getRotation( ){
	...
	HX_SOURCE_POS("../../src/core/geom/Matrix.hx",346)
	int flip = this->getFlip();
	HX_SOURCE_POS("../../src/core/geom/Matrix.hx",349)
	double scaleX = this->getScaleX();
	HX_SOURCE_POS("../../src/core/geom/Matrix.hx",350)
	double skewX = this->getSkewX();
	HX_SOURCE_POS("../../src/core/geom/Matrix.hx",353)
	double actualScaleX = ::Math_obj::sqrt(((scaleX * scaleX) + (skewX * skewX)));
	HX_SOURCE_POS("../../src/core/geom/Matrix.hx",356)
	double scaleY = this->getScaleY();
	HX_SOURCE_POS("../../src/core/geom/Matrix.hx",357)
	double skewY = (this->getSkewY() * flip);
	HX_SOURCE_POS("../../src/core/geom/Matrix.hx",359)
	double actualScaleY = ::Math_obj::sqrt(((scaleY * scaleY) + (skewY * skewY)));
	HX_SOURCE_POS("../../src/core/geom/Matrix.hx",362)
	...
	HX_SOURCE_POS("../../src/core/geom/Matrix.hx",366)
	if (((rotationInRad < (int)0))){
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",367)
		rotationInRad = (::Math_obj::PI + rotationInRad);
	}
	HX_SOURCE_POS("../../src/core/geom/Matrix.hx",371)
...
int Matrix_obj::getFlip( ){
	...
	HX_SOURCE_POS("../../src/core/geom/Matrix.hx",383)
	double scaleX = this->getScaleX();
	HX_SOURCE_POS("../../src/core/geom/Matrix.hx",384)
	int scaleXSign = (int)0;
	HX_SOURCE_POS("../../src/core/geom/Matrix.hx",388)
	if (((scaleX >= (int)0))){
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",389)
		scaleXSign = (int)1;
	}
	else{
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",393)
		scaleXSign = (int)-1;
	}
	HX_SOURCE_POS("../../src/core/geom/Matrix.hx",398)
	double scaleY = this->getScaleY();
	HX_SOURCE_POS("../../src/core/geom/Matrix.hx",399)
	int scaleYSign = (  (((scaleY >= (int)0))) ? int((int)1) : int((int)-1) );
	HX_SOURCE_POS("../../src/core/geom/Matrix.hx",401)
	double skewX = this->getSkewX();
	HX_SOURCE_POS("../../src/core/geom/Matrix.hx",402)
	int skewXSign = (  (((skewX >= (int)0))) ? int((int)1) : int((int)-1) );
	HX_SOURCE_POS("../../src/core/geom/Matrix.hx",404)
	double skewY = this->getSkewY();
	HX_SOURCE_POS("../../src/core/geom/Matrix.hx",405)
	int skewYSign = (  (((skewY >= (int)0))) ? int((int)1) : int((int)-1) );
	HX_SOURCE_POS("../../src/core/geom/Matrix.hx",408)
	if (((bool((scaleXSign == scaleYSign)) && bool((skewXSign == (skewYSign * (int)-1)))))){
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",409)
		return (int)1;
	}
	HX_SOURCE_POS("../../src/core/geom/Matrix.hx",413)
	if (((bool((scaleXSign == (scaleYSign * (int)-1))) && bool((skewXSign == skewYSign))))){
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",414)
		return (int)-1;
	}
	HX_SOURCE_POS("../../src/core/geom/Matrix.hx",419)
	return (int)1;
}
...
Void Matrix_obj::setScaleX( double scaleXFactor,Dynamic registrationPoint){
{
		...
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",431)
		double currentScaleX = this->getScaleX();
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",434)
		double resetScaleX = (double((int)1) / double(currentScaleX));
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",437)
		this->scale(resetScaleX,(int)1,registrationPoint);
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",440)
...
double Matrix_obj::getScaleX( ){
	...
	HX_SOURCE_POS("../../src/core/geom/Matrix.hx",447)
...
Void Matrix_obj::setScaleY( double scaleYFactor,Dynamic registrationPoint){
{
		...
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",459)
		double currentScaleY = this->getScaleY();
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",462)
		double resetScaleY = (double((int)1) / double(currentScaleY));
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",465)
		this->scale((int)1,resetScaleY,registrationPoint);
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",468)
...
double Matrix_obj::getScaleY( ){
	...
	HX_SOURCE_POS("../../src/core/geom/Matrix.hx",475)
...
Void Matrix_obj::setTranslationX( double translationX){
{
		...
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",486)
		double currentTranslationX = this->getTranslationX();
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",489)
		double resetTranslationX = (currentTranslationX * (int)-1);
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",491)
		this->translate(resetTranslationX,(int)0);
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",494)
...
double Matrix_obj::getTranslationX( ){
	...
	HX_SOURCE_POS("../../src/core/geom/Matrix.hx",501)
...
Void Matrix_obj::setTranslationY( double translationY){
{
		...
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",512)
		double currentTranslationY = this->getTranslationY();
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",515)
		double resetTranslationY = (currentTranslationY * (int)-1);
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",517)
		this->translate((int)0,resetTranslationY);
		HX_SOURCE_POS("../../src/core/geom/Matrix.hx",520)
...
double Matrix_obj::getTranslationY( ){
	...
	HX_SOURCE_POS("../../src/core/geom/Matrix.hx",527)
...
double Matrix_obj::getSkewX( ){
	...
	HX_SOURCE_POS("../../src/core/geom/Matrix.hx",535)
...
double Matrix_obj::getSkewY( ){
	...
	HX_SOURCE_POS("../../src/core/geom/Matrix.hx",543)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.geom.Matrix"), hx::TCanCast< Matrix_obj> ,sStaticFields,sMemberFields,
