...
::core::style::Position Position_obj::absolute;

::core::style::Position Position_obj::cssStatic;

::core::style::Position Position_obj::fixed;

::core::style::Position Position_obj::relative;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.style.Position"), hx::TCanCast< Position_obj >,sStaticFields,sMemberFields,
