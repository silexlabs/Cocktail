...
Void AbstractWindow_obj::__construct(::core::dom::Document document)
{
{
	HX_SOURCE_POS("../../src/core/window/AbstractWindow.hx",55)
...
hx::ObjectPtr< AbstractWindow_obj > AbstractWindow_obj::__new(::core::dom::Document document)
...
Dynamic AbstractWindow_obj::set_onResize( Dynamic value){
	...
	HX_SOURCE_POS("../../src/core/window/AbstractWindow.hx",64)
...
Dynamic AbstractWindow_obj::get_onResize( ){
	...
	HX_SOURCE_POS("../../src/core/window/AbstractWindow.hx",69)
...
int AbstractWindow_obj::get_innerHeight( ){
	...
	HX_SOURCE_POS("../../src/core/window/AbstractWindow.hx",74)
	return (int)-1;
}
...
int AbstractWindow_obj::get_innerWidth( ){
	...
	HX_SOURCE_POS("../../src/core/window/AbstractWindow.hx",79)
	return (int)-1;
}
...
::core::dom::Document AbstractWindow_obj::get_document( ){
	HX_SOURCE_PUSH("AbstractWindow_obj::get_document")
	HX_SOURCE_POS("../../src/core/window/AbstractWindow.hx",84)
...
Dynamic AbstractWindow_obj::__SetField(const ::String &inName,const Dynamic &inValue)
{
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"document") ) { document=inValue.Cast< ::core::dom::Document >(); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"_onResize") ) { _onResize=inValue.Cast< Dynamic >(); return inValue; }
		if (HX_FIELD_EQ(inName,"_document") ) { _document=inValue.Cast< ::core::dom::Document >(); return inValue; }
		break;
	case 10:
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.window.AbstractWindow"), hx::TCanCast< AbstractWindow_obj> ,sStaticFields,sMemberFields,
