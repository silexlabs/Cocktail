...
Void KeyboardEvent_obj::__construct(::String type,::port::flash_player::HTMLElement target,double detail,int keyChar,int key,bool ctrlKey,bool shiftKey,bool altKey)
{
{
	HX_SOURCE_POS("../../src/core/event/KeyboardEvent.hx",65)
	super::__construct(type,target,detail);
	HX_SOURCE_POS("../../src/core/event/KeyboardEvent.hx",67)
	this->_keyChar = keyChar;
	HX_SOURCE_POS("../../src/core/event/KeyboardEvent.hx",68)
	this->_key = key;
	HX_SOURCE_POS("../../src/core/event/KeyboardEvent.hx",69)
	this->_ctrlKey = ctrlKey;
	HX_SOURCE_POS("../../src/core/event/KeyboardEvent.hx",70)
	this->_shiftKey = shiftKey;
	HX_SOURCE_POS("../../src/core/event/KeyboardEvent.hx",71)
	this->_altKey = altKey;
}
;
	return null();
...
hx::ObjectPtr< KeyboardEvent_obj > KeyboardEvent_obj::__new(::String type,::port::flash_player::HTMLElement target,double detail,int keyChar,int key,bool ctrlKey,bool shiftKey,bool altKey)
...
bool KeyboardEvent_obj::get_altKey( ){
	...
	HX_SOURCE_POS("../../src/core/event/KeyboardEvent.hx",79)
	return this->_altKey;
}
...
bool KeyboardEvent_obj::get_shiftKey( ){
	...
	HX_SOURCE_POS("../../src/core/event/KeyboardEvent.hx",84)
...
bool KeyboardEvent_obj::get_ctrlKey( ){
	...
	HX_SOURCE_POS("../../src/core/event/KeyboardEvent.hx",89)
...
int KeyboardEvent_obj::get_keyChar( ){
	...
	HX_SOURCE_POS("../../src/core/event/KeyboardEvent.hx",94)
...
int KeyboardEvent_obj::get_key( ){
	...
	HX_SOURCE_POS("../../src/core/event/KeyboardEvent.hx",99)
	return this->_key;
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.event.KeyboardEvent"), hx::TCanCast< KeyboardEvent_obj> ,sStaticFields,sMemberFields,
