...
::port::flash_player::MouseCursor MouseCursorManager_obj::_mouseCursor;

Void MouseCursorManager_obj::setMouseCursor( ::core::mouse::MouseCursorValue mouseCursorValue){
{
		HX_SOURCE_PUSH("MouseCursorManager_obj::setMouseCursor")
		HX_SOURCE_POS("../../src/core/mouse/MouseCursorManager.hx",61)
		if (((::core::mouse::MouseCursorManager_obj::_mouseCursor == null()))){
			HX_SOURCE_POS("../../src/core/mouse/MouseCursorManager.hx",62)
			::core::mouse::MouseCursorManager_obj::_mouseCursor = ::port::flash_player::MouseCursor_obj::__new();
		}
		HX_SOURCE_POS("../../src/core/mouse/MouseCursorManager.hx",66)
		::core::mouse::MouseCursorManager_obj::_mouseCursor->setNativeMouseCursor(mouseCursorValue);
	}
return null();
}
...
::core::mouse::MouseCursorValue MouseCursorManager_obj::getMousecursor( ){
	HX_SOURCE_PUSH("MouseCursorManager_obj::getMousecursor")
	HX_SOURCE_POS("../../src/core/mouse/MouseCursorManager.hx",75)
	if (((::core::mouse::MouseCursorManager_obj::_mouseCursor == null()))){
		HX_SOURCE_POS("../../src/core/mouse/MouseCursorManager.hx",76)
		::core::mouse::MouseCursorManager_obj::_mouseCursor = ::port::flash_player::MouseCursor_obj::__new();
	}
	HX_SOURCE_POS("../../src/core/mouse/MouseCursorManager.hx",80)
	return ::core::mouse::MouseCursorManager_obj::_mouseCursor->getNativeMouseCursor();
}
...
Dynamic MouseCursorManager_obj::__SetField(const ::String &inName,const Dynamic &inValue)
{
	switch(inName.length) {
	case 12:
		if (HX_FIELD_EQ(inName,"_mouseCursor") ) { _mouseCursor=inValue.Cast< ::port::flash_player::MouseCursor >(); return inValue; }
	}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.mouse.MouseCursorManager"), hx::TCanCast< MouseCursorManager_obj> ,sStaticFields,sMemberFields,
