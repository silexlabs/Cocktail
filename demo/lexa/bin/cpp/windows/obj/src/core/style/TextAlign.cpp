...
::core::style::TextAlign TextAlign_obj::center;

::core::style::TextAlign TextAlign_obj::justify;

::core::style::TextAlign TextAlign_obj::left;

::core::style::TextAlign TextAlign_obj::right;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.style.TextAlign"), hx::TCanCast< TextAlign_obj >,sStaticFields,sMemberFields,
