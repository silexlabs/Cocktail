...
::core::style::Margin Margin_obj::cssAuto;

::core::style::Margin  Margin_obj::length(::core::unit::Length value)
	{ return hx::CreateEnum< Margin_obj >(HX_CSTRING("length"),0,hx::DynamicArray(0,1).Add(value)); }

::core::style::Margin  Margin_obj::percent(int value)
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.style.Margin"), hx::TCanCast< Margin_obj >,sStaticFields,sMemberFields,
