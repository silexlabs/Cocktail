...
::core::style::Clear Clear_obj::both;

::core::style::Clear Clear_obj::left;

::core::style::Clear Clear_obj::none;

::core::style::Clear Clear_obj::right;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.style.Clear"), hx::TCanCast< Clear_obj >,sStaticFields,sMemberFields,
