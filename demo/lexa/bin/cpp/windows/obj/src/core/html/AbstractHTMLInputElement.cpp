...
{
{
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLInputElement.hx",72)
...
Void AbstractHTMLInputElement_obj::init( ){
{
		...
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLInputElement.hx",88)
		this->super::init();
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLInputElement.hx",90)
		this->_disabled = false;
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLInputElement.hx",91)
...
Void AbstractHTMLInputElement_obj::initStyle( ){
{
		HX_SOURCE_PUSH("AbstractHTMLInputElement_obj::initStyle")
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLInputElement.hx",101)
...
HX_DEFINE_DYNAMIC_FUNC0(AbstractHTMLInputElement_obj,initStyle,(void))

Dynamic AbstractHTMLInputElement_obj::set_onChange( Dynamic value){
	HX_SOURCE_PUSH("AbstractHTMLInputElement_obj::set_onChange")
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLInputElement.hx",111)
...
Dynamic AbstractHTMLInputElement_obj::get_onChange( ){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLInputElement.hx",116)
...
Void AbstractHTMLInputElement_obj::onChangeCallback( ){
{
		...
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLInputElement.hx",126)
		if (((this->_onChange_dyn() != null()))){
			HX_SOURCE_POS("../../src/core/html/AbstractHTMLInputElement.hx",128)
			this->_onChange();
		}
	}
return null();
...
bool AbstractHTMLInputElement_obj::set_disabled( bool value){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLInputElement.hx",138)
...
bool AbstractHTMLInputElement_obj::get_disabled( ){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLInputElement.hx",143)
...
int AbstractHTMLInputElement_obj::set_maxLength( int value){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLInputElement.hx",148)
...
int AbstractHTMLInputElement_obj::get_maxLength( ){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLInputElement.hx",153)
...
::String AbstractHTMLInputElement_obj::set_value( ::String value){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLInputElement.hx",158)
...
::String AbstractHTMLInputElement_obj::get_value( ){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLInputElement.hx",163)
	return this->_value;
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.html.AbstractHTMLInputElement"), hx::TCanCast< AbstractHTMLInputElement_obj> ,sStaticFields,sMemberFields,
