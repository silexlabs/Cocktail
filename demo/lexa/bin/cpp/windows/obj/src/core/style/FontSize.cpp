...
::core::style::FontSize  FontSize_obj::absoluteSize(::core::unit::FontSizeAbsoluteSize value)
	{ return hx::CreateEnum< FontSize_obj >(HX_CSTRING("absoluteSize"),2,hx::DynamicArray(0,1).Add(value)); }

::core::style::FontSize  FontSize_obj::length(::core::unit::Length value)
	{ return hx::CreateEnum< FontSize_obj >(HX_CSTRING("length"),0,hx::DynamicArray(0,1).Add(value)); }

::core::style::FontSize  FontSize_obj::percentage(int value)
	{ return hx::CreateEnum< FontSize_obj >(HX_CSTRING("percentage"),1,hx::DynamicArray(0,1).Add(value)); }

::core::style::FontSize  FontSize_obj::relativeSize(::core::unit::FontSizeRelativeSize value)
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.style.FontSize"), hx::TCanCast< FontSize_obj >,sStaticFields,sMemberFields,
