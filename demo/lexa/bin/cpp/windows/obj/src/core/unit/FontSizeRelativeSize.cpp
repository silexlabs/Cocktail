...
::core::unit::FontSizeRelativeSize FontSizeRelativeSize_obj::larger;

::core::unit::FontSizeRelativeSize FontSizeRelativeSize_obj::smaller;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.unit.FontSizeRelativeSize"), hx::TCanCast< FontSizeRelativeSize_obj >,sStaticFields,sMemberFields,
