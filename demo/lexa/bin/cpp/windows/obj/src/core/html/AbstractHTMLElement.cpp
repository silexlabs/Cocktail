...
{
{
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",256)
	super::__construct(tagName);
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",257)
	this->init();
}
;
	return null();
...
hx::Object *AbstractHTMLElement_obj::__ToInterface(const type_info &inType) {
	if (inType==typeid( ::core::event::IEventTarget_obj)) return operator ::core::event::IEventTarget_obj *();
...
Void AbstractHTMLElement_obj::init( ){
{
		...
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",266)
		this->initNativeElement();
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",269)
		this->initMouse();
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",272)
		this->initKeyboard();
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",275)
		this->initStyle();
	}
return null();
}
...
Void AbstractHTMLElement_obj::initNativeElement( ){
{
		...
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",282)
		this->_nativeElement = ::core::nativeElement::NativeElementManager_obj::createNativeElement(::core::nativeElement::NativeElementTypeValue_obj::custom(this->_tagName));
	}
return null();
}
...
Void AbstractHTMLElement_obj::initMouse( ){
{
		...
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",291)
		this->_mouse = ::port::flash_player::Mouse_obj::__new(hx::ObjectPtr<OBJ_>(this));
	}
return null();
}
...
Void AbstractHTMLElement_obj::initKeyboard( ){
{
		...
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",301)
		this->_keyboard = ::port::flash_player::Keyboard_obj::__new(hx::ObjectPtr<OBJ_>(this));
	}
return null();
}
...
Void AbstractHTMLElement_obj::initStyle( ){
{
		...
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",311)
		this->_style = ::port::flash_player::ContainerStyle_obj::__new(hx::ObjectPtr<OBJ_>(this));
	}
return null();
}
...
::core::dom::Node AbstractHTMLElement_obj::appendChild( ::core::dom::Node newChild){
	HX_SOURCE_PUSH("AbstractHTMLElement_obj::appendChild")
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",324)
	this->super::appendChild(newChild);
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",325)
	this->_style->invalidate();
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",326)
	return newChild;
}
...
::core::dom::Node AbstractHTMLElement_obj::removeChild( ::core::dom::Node oldChild){
	HX_SOURCE_PUSH("AbstractHTMLElement_obj::removeChild")
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",334)
	this->super::removeChild(oldChild);
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",335)
	this->_style->invalidate();
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",336)
	return oldChild;
}
...
Dynamic AbstractHTMLElement_obj::set_onClick( Dynamic value){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",346)
	this->_onClick = value;
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",348)
	if (((this->_onClick_dyn() == null()))){
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",349)
		this->_mouse->set_onClick(null());
	}
	else{
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",353)
		this->_mouse->set_onClick(this->onClickCallback_dyn());
	}
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",357)
	return value;
}
...
Dynamic AbstractHTMLElement_obj::get_onClick( ){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",361)
...
Dynamic AbstractHTMLElement_obj::set_onMouseDown( Dynamic value){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",367)
	this->_onMouseDown = value;
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",369)
	if (((this->_onMouseDown_dyn() == null()))){
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",370)
		this->_mouse->setOnMouseDown(null());
	}
	else{
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",374)
		this->_mouse->setOnMouseDown(this->onMouseDownCallback_dyn());
	}
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",378)
	return value;
}
...
Dynamic AbstractHTMLElement_obj::get_onMouseDown( ){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",382)
...
Dynamic AbstractHTMLElement_obj::set_onMouseUp( Dynamic value){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",388)
	this->_onMouseUp = value;
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",390)
	if (((this->_onMouseUp_dyn() == null()))){
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",391)
		this->_mouse->setOnMouseUp(null());
	}
	else{
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",395)
		this->_mouse->setOnMouseUp(this->onMouseUpCallback_dyn());
	}
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",399)
	return value;
}
...
Dynamic AbstractHTMLElement_obj::get_onMouseUp( ){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",403)
...
Dynamic AbstractHTMLElement_obj::set_onMouseOver( Dynamic value){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",409)
	this->_onMouseOver = value;
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",411)
	if (((this->_onMouseOver_dyn() == null()))){
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",412)
		this->_mouse->setOnMouseOver(null());
	}
	else{
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",416)
		this->_mouse->setOnMouseOver(this->onMouseOverCallback_dyn());
	}
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",420)
	return value;
}
...
Dynamic AbstractHTMLElement_obj::get_onMouseOver( ){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",424)
...
Dynamic AbstractHTMLElement_obj::set_onMouseOut( Dynamic value){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",430)
	this->_onMouseOut = value;
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",432)
	if (((this->_onMouseOut_dyn() == null()))){
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",433)
		this->_mouse->setOnMouseOut(null());
	}
	else{
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",437)
		this->_mouse->setOnMouseOut(this->onMouseOutCallback_dyn());
	}
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",441)
	return value;
}
...
Dynamic AbstractHTMLElement_obj::get_onMouseOut( ){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",445)
...
Dynamic AbstractHTMLElement_obj::set_onMouseMove( Dynamic value){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",451)
	this->_onMouseMove = value;
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",453)
	if (((this->_onMouseMove_dyn() == null()))){
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",454)
		this->_mouse->setOnMouseMove(null());
	}
	else{
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",458)
		this->_mouse->setOnMouseMove(this->onMouseMoveCallback_dyn());
	}
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",462)
	return value;
}
...
Dynamic AbstractHTMLElement_obj::get_onMouseMove( ){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",466)
...
Void AbstractHTMLElement_obj::onClickCallback( ::core::event::MouseEvent mouseEvent){
{
		HX_SOURCE_PUSH("AbstractHTMLElement_obj::onClickCallback")
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",477)
...
Void AbstractHTMLElement_obj::onMouseDownCallback( ::core::event::MouseEvent mouseEvent){
{
		HX_SOURCE_PUSH("AbstractHTMLElement_obj::onMouseDownCallback")
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",482)
...
Void AbstractHTMLElement_obj::onMouseUpCallback( ::core::event::MouseEvent mouseEvent){
{
		HX_SOURCE_PUSH("AbstractHTMLElement_obj::onMouseUpCallback")
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",487)
...
Void AbstractHTMLElement_obj::onMouseMoveCallback( ::core::event::MouseEvent mouseEvent){
{
		HX_SOURCE_PUSH("AbstractHTMLElement_obj::onMouseMoveCallback")
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",492)
...
Void AbstractHTMLElement_obj::onMouseOverCallback( ::core::event::MouseEvent mouseEvent){
{
		HX_SOURCE_PUSH("AbstractHTMLElement_obj::onMouseOverCallback")
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",497)
...
Void AbstractHTMLElement_obj::onMouseOutCallback( ::core::event::MouseEvent mouseEvent){
{
		HX_SOURCE_PUSH("AbstractHTMLElement_obj::onMouseOutCallback")
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",502)
...
Dynamic AbstractHTMLElement_obj::set_onKeyDown( Dynamic value){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",513)
	this->_onKeyDown = value;
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",515)
	if (((this->_onKeyDown_dyn() == null()))){
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",516)
		this->_keyboard->setOnKeyDown(null());
	}
	else{
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",520)
		this->_keyboard->setOnKeyDown(this->onKeyDownCallback_dyn());
	}
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",524)
	return value;
}
...
Dynamic AbstractHTMLElement_obj::get_onKeyDown( ){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",528)
...
Dynamic AbstractHTMLElement_obj::set_onKeyUp( Dynamic value){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",534)
	this->_onKeyUp = value;
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",536)
	if (((this->_onKeyUp_dyn() == null()))){
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",537)
		this->_keyboard->setOnKeyUp(null());
	}
	else{
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",541)
		this->_keyboard->setOnKeyUp(this->onKeyUpCallback_dyn());
	}
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",545)
	return value;
}
...
Dynamic AbstractHTMLElement_obj::get_onKeyUp( ){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",549)
...
Void AbstractHTMLElement_obj::onKeyDownCallback( ::core::event::KeyboardEvent keyEventData){
{
		HX_SOURCE_PUSH("AbstractHTMLElement_obj::onKeyDownCallback")
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",560)
...
Void AbstractHTMLElement_obj::onKeyUpCallback( ::core::event::KeyboardEvent keyEventData){
{
		HX_SOURCE_PUSH("AbstractHTMLElement_obj::onKeyUpCallback")
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",565)
...
bool AbstractHTMLElement_obj::get_isDefaultFocusable( ){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",605)
	return false;
}
...
Dynamic AbstractHTMLElement_obj::set_onFocus( Dynamic value){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",610)
...
Dynamic AbstractHTMLElement_obj::get_onFocus( ){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",615)
...
Dynamic AbstractHTMLElement_obj::set_onBlur( Dynamic value){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",620)
...
Dynamic AbstractHTMLElement_obj::get_onBlur( ){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",625)
...
Dynamic AbstractHTMLElement_obj::set_tabIndex( Dynamic value){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",635)
...
Dynamic AbstractHTMLElement_obj::get_tabIndex( ){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",641)
...
Dynamic AbstractHTMLElement_obj::set_onScroll( Dynamic value){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",650)
...
Dynamic AbstractHTMLElement_obj::get_onScroll( ){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",655)
...
Void AbstractHTMLElement_obj::onScrollCallback( ::core::event::Event event){
{
		HX_SOURCE_PUSH("AbstractHTMLElement_obj::onScrollCallback")
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",665)
		if (((this->_onScroll_dyn() != null()))){
			HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",667)
...
int AbstractHTMLElement_obj::get_scrollHeight( ){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",674)
	return (int)-1;
}
...
int AbstractHTMLElement_obj::get_scrollWidth( ){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",679)
	return (int)-1;
}
...
int AbstractHTMLElement_obj::set_scrollLeft( int value){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",684)
	return (int)-1;
}
...
int AbstractHTMLElement_obj::get_scrollLeft( ){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",689)
	return (int)-1;
}
...
int AbstractHTMLElement_obj::set_scrollTop( int value){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",694)
	return (int)-1;
}
...
int AbstractHTMLElement_obj::get_scrollTop( ){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",699)
	return (int)-1;
}
...
Dynamic AbstractHTMLElement_obj::get_nativeElement( ){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",712)
...
::port::flash_player::HTMLElement AbstractHTMLElement_obj::get_offsetParent( ){
	HX_SOURCE_PUSH("AbstractHTMLElement_obj::get_offsetParent")
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",728)
...
int AbstractHTMLElement_obj::get_offsetWidth( ){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",734)
	Dynamic computedStyle = this->_style->getComputedStyle();
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",735)
...
int AbstractHTMLElement_obj::get_offsetHeight( ){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",740)
	Dynamic computedStyle = this->_style->getComputedStyle();
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",741)
...
int AbstractHTMLElement_obj::get_offsetLeft( ){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",747)
	::port::flash_player::HTMLElement firstPositionedAncestor = this->get_offsetParent();
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",749)
	int offsetLeft = (int)0;
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",751)
	if (((firstPositionedAncestor != null()))){
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",753)
		::port::flash_player::HTMLElement parent = this->get_parentNode();
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",755)
		while(((parent != firstPositionedAncestor))){
			HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",757)
			hx::AddEq(offsetLeft,(parent->get_style()->getComputedStyle()->__Field(HX_CSTRING("paddingLeft")) + parent->get_style()->getComputedStyle()->__Field(HX_CSTRING("marginLeft"))));
			HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",758)
			parent = parent->get_parentNode();
		}
	}
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",762)
	return offsetLeft;
}
...
int AbstractHTMLElement_obj::get_offsetTop( ){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",767)
	::port::flash_player::HTMLElement firstPositionedAncestor = this->get_offsetParent();
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",769)
	int offsetTop = (int)0;
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",771)
	if (((firstPositionedAncestor != null()))){
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",773)
		::port::flash_player::HTMLElement parent = this->get_parentNode();
		HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",775)
		while(((parent != firstPositionedAncestor))){
			HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",777)
			hx::AddEq(offsetTop,(parent->get_style()->getComputedStyle()->__Field(HX_CSTRING("paddingTop")) + parent->get_style()->getComputedStyle()->__Field(HX_CSTRING("marginTop"))));
			HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",778)
			parent = parent->get_parentNode();
		}
	}
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",782)
	return offsetTop;
}
...
int AbstractHTMLElement_obj::get_clientWidth( ){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",786)
	return this->_style->getComputedStyle()->__Field(HX_CSTRING("width"));
}
...
int AbstractHTMLElement_obj::get_clientHeight( ){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",791)
	return this->_style->getComputedStyle()->__Field(HX_CSTRING("height"));
}
...
int AbstractHTMLElement_obj::get_clientTop( ){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",796)
	return this->_style->getComputedStyle()->__Field(HX_CSTRING("paddingTop"));
}
...
int AbstractHTMLElement_obj::get_clientLeft( ){
	...
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",801)
	return this->_style->getComputedStyle()->__Field(HX_CSTRING("paddingLeft"));
}


HX_DEFINE_DYNAMIC_FUNC0(AbstractHTMLElement_obj,get_clientLeft,return )

::port::flash_player::Style AbstractHTMLElement_obj::get_style( ){
	HX_SOURCE_PUSH("AbstractHTMLElement_obj::get_style")
	HX_SOURCE_POS("../../src/core/html/AbstractHTMLElement.hx",810)
	return this->_style;
}
...
Dynamic AbstractHTMLElement_obj::__SetField(const ::String &inName,const Dynamic &inValue)
{
	...
	case 5:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"_mouse") ) { _mouse=inValue.Cast< ::port::flash_player::Mouse >(); return inValue; }
	...
	case 9:
		...
		if (HX_FIELD_EQ(inName,"_keyboard") ) { _keyboard=inValue.Cast< ::port::flash_player::Keyboard >(); return inValue; }
	...
	case 12:
		...
		if (HX_FIELD_EQ(inName,"offsetParent") ) { offsetParent=inValue.Cast< ::port::flash_player::HTMLElement >(); return inValue; }
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.html.AbstractHTMLElement"), hx::TCanCast< AbstractHTMLElement_obj> ,sStaticFields,sMemberFields,
