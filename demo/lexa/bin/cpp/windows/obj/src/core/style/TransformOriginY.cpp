...
::core::style::TransformOriginY TransformOriginY_obj::bottom;

::core::style::TransformOriginY TransformOriginY_obj::center;

::core::style::TransformOriginY  TransformOriginY_obj::length(::core::unit::Length value)
	{ return hx::CreateEnum< TransformOriginY_obj >(HX_CSTRING("length"),0,hx::DynamicArray(0,1).Add(value)); }

::core::style::TransformOriginY  TransformOriginY_obj::percent(int value)
	{ return hx::CreateEnum< TransformOriginY_obj >(HX_CSTRING("percent"),1,hx::DynamicArray(0,1).Add(value)); }

::core::style::TransformOriginY TransformOriginY_obj::top;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.style.TransformOriginY"), hx::TCanCast< TransformOriginY_obj >,sStaticFields,sMemberFields,
