...
{
{
	HX_SOURCE_POS("../../src/core/style/computer/boxComputers/FloatBoxStylesComputer.hx",26)
	super::__construct();
}
;
	return null();
...
int FloatBoxStylesComputer_obj::getComputedAutoWidth( ::core::style::AbstractStyle style,Dynamic containingHTMLElementData){
	HX_SOURCE_PUSH("FloatBoxStylesComputer_obj::getComputedAutoWidth")
	HX_SOURCE_POS("../../src/core/style/computer/boxComputers/FloatBoxStylesComputer.hx",35)
	return (int)0;
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.style.computer.boxComputers.FloatBoxStylesComputer"), hx::TCanCast< FloatBoxStylesComputer_obj> ,sStaticFields,sMemberFields,
