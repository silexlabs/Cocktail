...
::core::unit::GradientStopValue  GradientStopValue_obj::length(::core::unit::Length value)
	{ return hx::CreateEnum< GradientStopValue_obj >(HX_CSTRING("length"),0,hx::DynamicArray(0,1).Add(value)); }

::core::unit::GradientStopValue  GradientStopValue_obj::percent(int value)
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.unit.GradientStopValue"), hx::TCanCast< GradientStopValue_obj >,sStaticFields,sMemberFields,
