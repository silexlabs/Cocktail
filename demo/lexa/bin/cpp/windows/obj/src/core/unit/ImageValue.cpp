...
::core::unit::ImageValue  ImageValue_obj::gradient(::core::unit::GradientValue value)
	{ return hx::CreateEnum< ImageValue_obj >(HX_CSTRING("gradient"),2,hx::DynamicArray(0,1).Add(value)); }

::core::unit::ImageValue  ImageValue_obj::imageList(Dynamic value)
	{ return hx::CreateEnum< ImageValue_obj >(HX_CSTRING("imageList"),1,hx::DynamicArray(0,1).Add(value)); }

::core::unit::ImageValue  ImageValue_obj::url(::String value)
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.unit.ImageValue"), hx::TCanCast< ImageValue_obj >,sStaticFields,sMemberFields,
