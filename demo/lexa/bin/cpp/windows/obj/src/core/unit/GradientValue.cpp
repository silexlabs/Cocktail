...
::core::unit::GradientValue  GradientValue_obj::linear(Dynamic value)
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.unit.GradientValue"), hx::TCanCast< GradientValue_obj >,sStaticFields,sMemberFields,
