...
::core::style::TextIndent  TextIndent_obj::length(::core::unit::Length value)
	{ return hx::CreateEnum< TextIndent_obj >(HX_CSTRING("length"),0,hx::DynamicArray(0,1).Add(value)); }

::core::style::TextIndent  TextIndent_obj::percentage(int value)
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.style.TextIndent"), hx::TCanCast< TextIndent_obj >,sStaticFields,sMemberFields,
