...
Void FormattingContext_obj::__construct(::core::renderer::BlockBoxRenderer formattingContextRoot)
{
{
	HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",91)
	this->_formattingContextRoot = formattingContextRoot;
	HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",94)
	this->_floatsManager = ::core::style::floats::FloatsManager_obj::__new();
	HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",95)
	this->initFormattingContextData();
	HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",96)
	this->_elementsInFormattingContext = Array_obj< ::core::renderer::ElementRenderer >::__new();
}
;
	return null();
}
...
hx::ObjectPtr< FormattingContext_obj > FormattingContext_obj::__new(::core::renderer::BlockBoxRenderer formattingContextRoot)
...
Void FormattingContext_obj::initFormattingContextData( ){
{
		...
		HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",104)
...
Void FormattingContext_obj::dispose( ){
{
		...
		HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",118)
		this->_elementsInFormattingContext = null();
		HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",119)
		this->_formattingContextData = null();
		HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",120)
		this->_lastInsertedElement = null();
		HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",122)
		this->_floatsManager->dispose();
		HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",123)
		this->_floatsManager = null();
		HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",124)
...
Void FormattingContext_obj::insertElement( ::core::renderer::ElementRenderer element){
{
		HX_SOURCE_PUSH("FormattingContext_obj::insertElement")
		HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",135)
...
Void FormattingContext_obj::format( ){
{
		...
		HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",144)
		this->_layOutLastLine = true;
		HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",145)
...
Dynamic FormattingContext_obj::getStaticPosition( ::core::renderer::ElementRenderer element){
	HX_SOURCE_PUSH("FormattingContext_obj::getStaticPosition")
	HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",156)
	this->_layOutLastLine = true;
	HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",157)
	Array< ::core::renderer::ElementRenderer > elementsToFormat = Array_obj< ::core::renderer::ElementRenderer >::__new();
	HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",159)
	{
		HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",159)
		int _g1 = (int)0;
		...
		while(((_g1 < _g))){
			HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",159)
			int i = (_g1)++;
			HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",161)
			elementsToFormat->push(this->_elementsInFormattingContext->__get(i));
		}
	}
	HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",164)
	elementsToFormat->push(element);
	HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",166)
	this->doFormat(elementsToFormat);
	HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",168)
	double x = element->getBounds()->__Field(HX_CSTRING("x"));
	HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",169)
	...
	HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",171)
...
int FormattingContext_obj::getChildrenHeight( ::core::renderer::FlowBoxRenderer elementRenderer){
	HX_SOURCE_PUSH("FormattingContext_obj::getChildrenHeight")
	HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",185)
	int height = (int)0;
	HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",188)
	Array< ::core::renderer::ElementRenderer > elementRenderers = this->getChildElementRenderers(elementRenderer);
	HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",189)
	height = ::Math_obj::round(this->getBounds(elementRenderers)->__Field(HX_CSTRING("height")));
	HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",192)
	return height;
}
...
Dynamic FormattingContext_obj::getBounds( Array< ::core::renderer::ElementRenderer > elements){
	HX_SOURCE_PUSH("FormattingContext_obj::getBounds")
	HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",203)
	Dynamic bounds;
	HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",205)
	double left = (int)50000;
	HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",206)
	double top = (int)50000;
	HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",207)
	double right = (int)-50000;
	HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",208)
	double bottom = (int)-50000;
	HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",211)
	{
		HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",211)
		int _g1 = (int)0;
		...
		while(((_g1 < _g))){
			HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",211)
			int i = (_g1)++;
			HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",213)
			if (((elements->__get(i)->getBounds()->__Field(HX_CSTRING("x")) < left))){
				HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",214)
				left = elements->__get(i)->getBounds()->__Field(HX_CSTRING("x"));
			}
			HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",217)
			if (((elements->__get(i)->getBounds()->__Field(HX_CSTRING("y")) < top))){
				HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",218)
				if (((elements->__get(i)->isText() == false))){
					HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",220)
					top = elements->__get(i)->getBounds()->__Field(HX_CSTRING("y"));
				}
				else{
					HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",226)
					double htmlElementAscent = elements->__get(i)->getStyle()->getFontMetricsData()->__Field(HX_CSTRING("ascent"));
					HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",227)
					double htmlElementDescent = elements->__get(i)->getStyle()->getFontMetricsData()->__Field(HX_CSTRING("descent"));
					HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",231)
					double leading = (elements->__get(i)->getStyle()->getComputedStyle()->__Field(HX_CSTRING("lineHeight")) - ((htmlElementAscent + htmlElementDescent)));
					HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",234)
					htmlElementAscent = ::Math_obj::round((htmlElementAscent + (double(leading) / double((int)2))));
					HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",235)
					htmlElementDescent = ::Math_obj::round((htmlElementDescent + (double(leading) / double((int)2))));
					HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",237)
					top = (elements->__get(i)->getBounds()->__Field(HX_CSTRING("y")) - htmlElementAscent);
				}
			}
			HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",241)
			if ((((elements->__get(i)->getBounds()->__Field(HX_CSTRING("x")) + elements->__get(i)->getBounds()->__Field(HX_CSTRING("width"))) > right))){
				HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",242)
				right = (elements->__get(i)->getBounds()->__Field(HX_CSTRING("x")) + elements->__get(i)->getBounds()->__Field(HX_CSTRING("width")));
			}
			HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",245)
			if ((((elements->__get(i)->getBounds()->__Field(HX_CSTRING("y")) + elements->__get(i)->getBounds()->__Field(HX_CSTRING("height"))) > bottom))){
				HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",246)
				if (((elements->__get(i)->isText() == false))){
					HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",248)
					bottom = (elements->__get(i)->getBounds()->__Field(HX_CSTRING("y")) + elements->__get(i)->getBounds()->__Field(HX_CSTRING("height")));
				}
				else{
					HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",256)
					double htmlElementAscent = elements->__get(i)->getStyle()->getFontMetricsData()->__Field(HX_CSTRING("ascent"));
					HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",257)
					double htmlElementDescent = elements->__get(i)->getStyle()->getFontMetricsData()->__Field(HX_CSTRING("descent"));
					HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",261)
					double leading = (elements->__get(i)->getStyle()->getComputedStyle()->__Field(HX_CSTRING("lineHeight")) - ((htmlElementAscent + htmlElementDescent)));
					HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",264)
					htmlElementAscent = ::Math_obj::round((htmlElementAscent + (double(leading) / double((int)2))));
					HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",265)
					htmlElementDescent = ::Math_obj::round((htmlElementDescent + (double(leading) / double((int)2))));
					HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",267)
	...
	HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",272)
	bounds = _Function_1_1::Block(right,left,bottom,top);
	HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",279)
	return bounds;
}
...
Void FormattingContext_obj::doFormat( Array< ::core::renderer::ElementRenderer > elementsInFormattingContext){
{
		HX_SOURCE_PUSH("FormattingContext_obj::doFormat")
		HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",287)
		this->initFormattingContextData();
		HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",290)
		{
			HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",290)
			int _g1 = (int)0;
			...
			while(((_g1 < _g))){
				HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",290)
				int i = (_g1)++;
				HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",292)
...
Void FormattingContext_obj::doInsertElement( ::core::renderer::ElementRenderer element,bool isNextElementALineFeed){
{
		HX_SOURCE_PUSH("FormattingContext_obj::doInsertElement")
		HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",297)
		if (((element->isFloat() == true))){
			HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",299)
			this->insertFloat(element);
		}
		else{
			HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",302)
			if (((element->canHaveChildren() == true))){
				HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",303)
				if (((element->getStyle()->establishesNewFormattingContext() == true))){
					HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",305)
					this->insertFormattingContextRootElement(element);
				}
				else{
					HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",309)
					this->insertContainerElement(element);
				}
			}
			else{
				HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",314)
				if (((element->isText() == true))){
					HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",316)
					if (((element->isSpace() == true))){
						HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",318)
						this->insertSpace(element,isNextElementALineFeed);
					}
					else{
						HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",322)
						this->insertText(element);
					}
				}
				else{
					HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",328)
...
Array< ::core::renderer::ElementRenderer > FormattingContext_obj::getChildElementRenderers( ::core::renderer::FlowBoxRenderer elementRenderer){
	HX_SOURCE_PUSH("FormattingContext_obj::getChildElementRenderers")
	HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",336)
	Array< ::core::renderer::ElementRenderer > elementRenderers = Array_obj< ::core::renderer::ElementRenderer >::__new();
	HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",338)
	{
		HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",338)
		int _g1 = (int)0;
		int _g = this->_elementsInFormattingContext->length;
		...
		while(((_g1 < _g))){
			HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",338)
			int i = (_g1)++;
			HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",340)
			if (((this->_elementsInFormattingContext->__get(i)->get_parentNode() == elementRenderer))){
				HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",341)
				elementRenderers->push(this->_elementsInFormattingContext->__get(i));
			}
		}
	}
	HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",346)
...
Void FormattingContext_obj::insertEmbeddedElement( ::core::renderer::ElementRenderer element){
{
...
Void FormattingContext_obj::insertFormattingContextRootElement( ::core::renderer::ElementRenderer element){
{
...
Void FormattingContext_obj::insertContainerElement( ::core::renderer::ElementRenderer element){
{
...
Void FormattingContext_obj::insertText( ::core::renderer::ElementRenderer element){
{
...
Void FormattingContext_obj::insertSpace( ::core::renderer::ElementRenderer element,bool isNextElementALineFeed){
{
...
Void FormattingContext_obj::insertHorizontalOffset( ::core::renderer::ElementRenderer element){
{
...
Void FormattingContext_obj::insertTab( ::core::renderer::ElementRenderer element,bool isNextElementALineFeed){
{
...
Void FormattingContext_obj::insertLineFeed( ::core::renderer::ElementRenderer element){
{
...
Void FormattingContext_obj::insertFloat( ::core::renderer::ElementRenderer element){
{
...
Void FormattingContext_obj::clearFloat( ::core::style::Clear clear){
{
		HX_SOURCE_PUSH("FormattingContext_obj::clearFloat")
		HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",427)
...
Void FormattingContext_obj::removeFloats( ){
{
		...
		HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",439)
...
bool FormattingContext_obj::isNextElementALineFeed( Array< ::core::renderer::ElementRenderer > elementsInFormattingContext,int currentIndex){
	HX_SOURCE_PUSH("FormattingContext_obj::isNextElementALineFeed")
	HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",448)
	bool isNextElementALineFeed;
	HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",451)
	if ((((currentIndex + (int)1) >= elementsInFormattingContext->length))){
		HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",452)
		isNextElementALineFeed = false;
	}
	else{
		HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",457)
		isNextElementALineFeed = elementsInFormattingContext->__get((currentIndex + (int)1))->isLineFeed();
	}
	HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",461)
...
int FormattingContext_obj::getMaxWidth( ){
	...
	HX_SOURCE_POS("../../src/core/style/formatter/FormattingContext.hx",469)
...
Dynamic FormattingContext_obj::__SetField(const ::String &inName,const Dynamic &inValue)
{
	...
	case 8:
		...
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"_floatsManager") ) { _floatsManager=inValue.Cast< ::core::style::floats::FloatsManager >(); return inValue; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"_layOutLastLine") ) { _layOutLastLine=inValue.Cast< bool >(); return inValue; }
		break;
	case 20:
		if (HX_FIELD_EQ(inName,"_lastInsertedElement") ) { _lastInsertedElement=inValue.Cast< ::core::renderer::ElementRenderer >(); return inValue; }
		break;
	case 22:
		if (HX_FIELD_EQ(inName,"_formattingContextRoot") ) { _formattingContextRoot=inValue.Cast< ::core::renderer::BlockBoxRenderer >(); return inValue; }
		if (HX_FIELD_EQ(inName,"_formattingContextData") ) { _formattingContextData=inValue.Cast< Dynamic >(); return inValue; }
		break;
	case 28:
		if (HX_FIELD_EQ(inName,"_elementsInFormattingContext") ) { _elementsInFormattingContext=inValue.Cast< Array< ::core::renderer::ElementRenderer > >(); return inValue; }
	}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.style.formatter.FormattingContext"), hx::TCanCast< FormattingContext_obj> ,sStaticFields,sMemberFields,
