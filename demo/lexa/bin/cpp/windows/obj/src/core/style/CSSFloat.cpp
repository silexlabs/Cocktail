...
::core::style::CSSFloat CSSFloat_obj::left;

::core::style::CSSFloat CSSFloat_obj::none;

::core::style::CSSFloat CSSFloat_obj::right;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.style.CSSFloat"), hx::TCanCast< CSSFloat_obj >,sStaticFields,sMemberFields,
