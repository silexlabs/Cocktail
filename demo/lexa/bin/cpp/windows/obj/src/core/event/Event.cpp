...
Void Event_obj::__construct(::String type,::core::event::IEventTarget target)
{
{
	HX_SOURCE_POS("../../src/core/event/Event.hx",66)
	this->_type = type;
	HX_SOURCE_POS("../../src/core/event/Event.hx",67)
	this->_target = target;
}
;
	return null();
...
hx::ObjectPtr< Event_obj > Event_obj::__new(::String type,::core::event::IEventTarget target)
...
Void Event_obj::preventDefault( ){
{
		...
		HX_SOURCE_POS("../../src/core/event/Event.hx",90)
...
bool Event_obj::get_defaultPrevented( ){
	...
	HX_SOURCE_POS("../../src/core/event/Event.hx",99)
...
::String Event_obj::get_type( ){
	...
	HX_SOURCE_POS("../../src/core/event/Event.hx",104)
	return this->_type;
}
...
::core::event::IEventTarget Event_obj::get_target( ){
	HX_SOURCE_PUSH("Event_obj::get_target")
	HX_SOURCE_POS("../../src/core/event/Event.hx",109)
	return this->_target;
}
...
Dynamic Event_obj::__SetField(const ::String &inName,const Dynamic &inValue)
{
	...
	case 6:
		...
		if (HX_FIELD_EQ(inName,"target") ) { target=inValue.Cast< ::core::event::IEventTarget >(); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"_target") ) { _target=inValue.Cast< ::core::event::IEventTarget >(); return inValue; }
		break;
	case 16:
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.event.Event"), hx::TCanCast< Event_obj> ,sStaticFields,sMemberFields,
