...
{
{
	HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",40)
...
Void BackgroundDrawingManager_obj::drawBackgroundImage( Dynamic nativeImage,Dynamic backgroundPositioningBox,Dynamic backgroundPaintingBox,int intrinsicWidth,int intrinsicHeight,double intrinsicRatio,Dynamic computedBackgroundSize,Dynamic computedBackgroundPosition,Dynamic backgroundRepeat){
{
		...
		HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",66)
		...
		HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",67)
		int maxWidth = ::Math_obj::round((backgroundPaintingBox->__Field(HX_CSTRING("x")) + backgroundPaintingBox->__Field(HX_CSTRING("width"))));
		HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",68)
		int imageWidth = ::Math_obj::round(computedBackgroundSize->__Field(HX_CSTRING("width")));
		HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",70)
		{
::core::style::BackgroundRepeatValue _switch_1 = (backgroundRepeat->__Field(HX_CSTRING("x")));
			switch((_switch_1)->GetIndex()){
				case 3: {
					HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",72)
					maxWidth = (totalWidth + imageWidth);
				}
				;break;
				case 0: {
					HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",75)
					while(((totalWidth > backgroundPaintingBox->__Field(HX_CSTRING("x"))))){
						HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",77)
						hx::SubEq(totalWidth,imageWidth);
					}
				}
				;break;
				case 1: {
					HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",82)
					...
					HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",83)
					while(((totalWidth > backgroundPaintingBox->__Field(HX_CSTRING("x"))))){
						HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",84)
						hx::SubEq(totalWidth,imageWidth);
					}
				}
				;break;
				case 2: {
					HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",88)
					while(((totalWidth > backgroundPaintingBox->__Field(HX_CSTRING("x"))))){
						HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",90)
						hx::SubEq(totalWidth,imageWidth);
					}
				}
				;break;
		...
		HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",94)
		int initialWidth = totalWidth;
		HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",96)
		...
		HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",97)
		double maxHeight = (backgroundPaintingBox->__Field(HX_CSTRING("y")) + backgroundPaintingBox->__Field(HX_CSTRING("height")));
		HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",98)
		double imageHeight = computedBackgroundSize->__Field(HX_CSTRING("height"));
		HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",100)
		{
::core::style::BackgroundRepeatValue _switch_2 = (backgroundRepeat->__Field(HX_CSTRING("y")));
			switch((_switch_2)->GetIndex()){
				case 3: {
					HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",102)
					maxHeight = (totalHeight + imageHeight);
				}
				;break;
				case 0: {
					HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",105)
					while(((totalHeight > backgroundPaintingBox->__Field(HX_CSTRING("y"))))){
						HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",107)
						hx::SubEq(totalHeight,imageHeight);
					}
				}
				;break;
				case 1: {
					HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",112)
					...
					HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",113)
					while(((totalHeight > backgroundPaintingBox->__Field(HX_CSTRING("y"))))){
						HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",114)
						hx::SubEq(totalHeight,imageHeight);
					}
				}
				;break;
				case 2: {
					HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",118)
					while(((totalHeight > backgroundPaintingBox->__Field(HX_CSTRING("y"))))){
						HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",120)
						hx::SubEq(totalHeight,imageHeight);
					}
				}
				;break;
		...
		HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",125)
		double initialHeight = totalHeight;
		HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",127)
		while(((totalHeight < maxHeight))){
			HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",129)
			::core::geom::Matrix matrix = ::core::geom::Matrix_obj::__new(null());
			HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",131)
			...
			HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",133)
			matrix->scale((double(imageWidth) / double(intrinsicWidth)),(double(imageHeight) / double(intrinsicHeight)),_Function_2_1::Block());
			HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",135)
			this->drawImage(nativeImage,matrix,backgroundPaintingBox);
			HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",137)
			hx::AddEq(totalWidth,imageWidth);
			HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",139)
			if (((totalWidth >= maxWidth))){
				HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",141)
				totalWidth = initialWidth;
				HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",142)
...
Void BackgroundDrawingManager_obj::drawBackgroundColor( Dynamic color,Dynamic backgroundPaintingBox){
{
		...
		HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",156)
		::core::dom::FillStyleValue fillStyle = ::core::dom::FillStyleValue_obj::monochrome(color);
		HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",157)
		::core::dom::LineStyleValue lineStyle = ::core::dom::LineStyleValue_obj::none_dyn();
		HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",159)
		this->beginFill(fillStyle,lineStyle);
		HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",160)
		...
		HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",162)
		this->endFill();
	}
return null();
}
...
Void BackgroundDrawingManager_obj::drawBackgroundGradient( ::core::unit::GradientValue gradient,Dynamic backgroundPositioningBox,Dynamic backgroundPaintingBox,Dynamic computedBackgroundSize,Dynamic computedBackgroundPosition,Dynamic backgroundRepeat){
{
		HX_SOURCE_PUSH("BackgroundDrawingManager_obj::drawBackgroundGradient")
		HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",183)
		::port::flash_player::DrawingManager gradientSurface = ::port::flash_player::DrawingManager_obj::__new(::core::nativeElement::NativeElementManager_obj::createNativeElement(::core::nativeElement::NativeElementTypeValue_obj::graphic_dyn()),computedBackgroundSize->__Field(HX_CSTRING("width")),computedBackgroundSize->__Field(HX_CSTRING("height")));
		HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",185)
		::core::dom::FillStyleValue fillStyle;
		HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",186)
		::core::dom::LineStyleValue lineStyle = ::core::dom::LineStyleValue_obj::none_dyn();
		HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",188)
		{
::core::unit::GradientValue _switch_3 = (gradient);
			switch((_switch_3)->GetIndex()){
				case 0: {
					Dynamic value = _switch_3->__Param(0);
{
						struct _Function_2_1{
							inline static Dynamic Block( ::core::background::BackgroundDrawingManager_obj *__this,Dynamic &value){
								hx::Anon __result = hx::Anon_obj::Create();
								__result->Add(HX_CSTRING("gradientType") , ::core::dom::GradientTypeValue_obj::linear_dyn(),false);
						...
						HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",192)
						Dynamic gradientStyle = _Function_2_1::Block(this,value);
						HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",198)
						fillStyle = ::core::dom::FillStyleValue_obj::gradient(gradientStyle);
					}
				}
				;break;
			}
		}
		HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",201)
		gradientSurface->beginFill(fillStyle,lineStyle);
		HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",202)
		...
		HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",203)
		gradientSurface->endFill();
		HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",205)
...
Dynamic BackgroundDrawingManager_obj::getGradientStops( Dynamic value){
	...
	HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",216)
	Dynamic gradientStopsData = Dynamic( Array_obj<Dynamic>::__new() );
	HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",218)
	{
		HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",218)
		int _g1 = (int)0;
		...
		while(((_g1 < _g))){
			HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",218)
			int i = (_g1)++;
			HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",220)
			int ratio;
			HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",222)
			{
::core::unit::GradientStopValue _switch_4 = (value->__GetItem(i)->__Field(HX_CSTRING("stop")));
				switch((_switch_4)->GetIndex()){
					case 0: {
						::core::unit::Length value1 = _switch_4->__Param(0);
{
							HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",224)
							ratio = (int)0;
						}
					}
					;break;
...
{
							HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",228)
							ratio = value1;
						}
					}
					;break;
			...
			HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",232)
			Dynamic color = ::core::unit::UnitManager_obj::getColorDataFromCSSColor(value->__GetItem(i)->__Field(HX_CSTRING("color")));
			...
			HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",233)
			gradientStopsData->__Field(HX_CSTRING("push"))(_Function_3_1::Block(color,ratio));
		}
	}
	HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",236)
...
int BackgroundDrawingManager_obj::getRotation( ::core::unit::GradientAngle value){
	HX_SOURCE_PUSH("BackgroundDrawingManager_obj::getRotation")
	HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",242)
	int rotation;
	HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",244)
	{
::core::unit::GradientAngle _switch_5 = (value);
		switch((_switch_5)->GetIndex()){
			case 0: {
				::core::unit::Angle value1 = _switch_5->__Param(0);
{
					HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",246)
					rotation = ::Math_obj::round(::core::unit::UnitManager_obj::getDegreeFromAngle(value1));
				}
			}
			;break;
			case 1: {
				::core::unit::GradientSideValue value1 = _switch_5->__Param(0);
{
					HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",249)
					{
::core::unit::GradientSideValue _switch_6 = (value1);
						switch((_switch_6)->GetIndex()){
							case 0: {
								HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",253)
								rotation = (int)0;
							}
							;break;
							case 3: {
								HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",256)
								rotation = (int)90;
							}
							;break;
							case 2: {
								HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",259)
								rotation = (int)180;
							}
							;break;
							case 1: {
								HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",262)
								rotation = (int)270;
							}
							;break;
						}
			...
			;break;
			case 2: {
				::core::unit::GradientCornerValue value1 = _switch_5->__Param(0);
{
					HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",267)
					{
::core::unit::GradientCornerValue _switch_7 = (value1);
						switch((_switch_7)->GetIndex()){
							case 0: {
								HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",271)
								rotation = (int)45;
							}
							;break;
							case 1: {
								HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",274)
								rotation = (int)135;
							}
							;break;
							case 2: {
								HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",277)
								rotation = (int)225;
							}
							;break;
							case 3: {
								HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",280)
								rotation = (int)315;
							}
							;break;
						}
	...
	HX_SOURCE_POS("../../src/core/background/BackgroundDrawingManager.hx",286)
	return rotation;
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.background.BackgroundDrawingManager"), hx::TCanCast< BackgroundDrawingManager_obj> ,sStaticFields,sMemberFields,
