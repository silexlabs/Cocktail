...
::core::dom::LineStyleValue  LineStyleValue_obj::bitmap(::core::html::AbstractHTMLImageElement htmlImageElement,Dynamic lineStyle,bool repeat)
...
::core::dom::LineStyleValue  LineStyleValue_obj::gradient(Dynamic gradientStyle,Dynamic lineStyle)
	{ return hx::CreateEnum< LineStyleValue_obj >(HX_CSTRING("gradient"),2,hx::DynamicArray(0,2).Add(gradientStyle).Add(lineStyle)); }

::core::dom::LineStyleValue  LineStyleValue_obj::monochrome(Dynamic color,Dynamic lineStyle)
	{ return hx::CreateEnum< LineStyleValue_obj >(HX_CSTRING("monochrome"),1,hx::DynamicArray(0,2).Add(color).Add(lineStyle)); }

::core::dom::LineStyleValue LineStyleValue_obj::none;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.dom.LineStyleValue"), hx::TCanCast< LineStyleValue_obj >,sStaticFields,sMemberFields,
