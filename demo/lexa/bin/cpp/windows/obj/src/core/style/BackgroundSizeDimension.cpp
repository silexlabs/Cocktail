...
::core::style::BackgroundSizeDimension BackgroundSizeDimension_obj::cssAuto;

::core::style::BackgroundSizeDimension  BackgroundSizeDimension_obj::length(::core::unit::Length value)
	{ return hx::CreateEnum< BackgroundSizeDimension_obj >(HX_CSTRING("length"),0,hx::DynamicArray(0,1).Add(value)); }

::core::style::BackgroundSizeDimension  BackgroundSizeDimension_obj::percent(int value)
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.style.BackgroundSizeDimension"), hx::TCanCast< BackgroundSizeDimension_obj >,sStaticFields,sMemberFields,
