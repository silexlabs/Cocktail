...
::port::flash_player::NativeElementCreator NativeElementManager_obj::_nativeElementCreator;

::port::flash_player::NativeElementPathManager NativeElementManager_obj::_nativeElementPathManager;

Dynamic NativeElementManager_obj::getRoot( ){
	HX_SOURCE_PUSH("NativeElementManager_obj::getRoot")
	HX_SOURCE_POS("../../src/core/nativeElement/NativeElementManager.hx",72)
	if (((::core::nativeElement::NativeElementManager_obj::_nativeElementPathManager == null()))){
		HX_SOURCE_POS("../../src/core/nativeElement/NativeElementManager.hx",73)
		::core::nativeElement::NativeElementManager_obj::_nativeElementPathManager = ::port::flash_player::NativeElementPathManager_obj::__new();
	}
	HX_SOURCE_POS("../../src/core/nativeElement/NativeElementManager.hx",76)
	return ::core::nativeElement::NativeElementManager_obj::_nativeElementPathManager->getRoot();
}


STATIC_HX_DEFINE_DYNAMIC_FUNC0(NativeElementManager_obj,getRoot,return )

Dynamic NativeElementManager_obj::createNativeElement( ::core::nativeElement::NativeElementTypeValue nativeElementType){
	HX_SOURCE_PUSH("NativeElementManager_obj::createNativeElement")
	HX_SOURCE_POS("../../src/core/nativeElement/NativeElementManager.hx",86)
	if (((::core::nativeElement::NativeElementManager_obj::_nativeElementCreator == null()))){
		HX_SOURCE_POS("../../src/core/nativeElement/NativeElementManager.hx",87)
		::core::nativeElement::NativeElementManager_obj::_nativeElementCreator = ::port::flash_player::NativeElementCreator_obj::__new();
	}
	HX_SOURCE_POS("../../src/core/nativeElement/NativeElementManager.hx",91)
	return ::core::nativeElement::NativeElementManager_obj::_nativeElementCreator->createNativeElement(nativeElementType);
}
...
Dynamic NativeElementManager_obj::__SetField(const ::String &inName,const Dynamic &inValue)
{
	switch(inName.length) {
	case 21:
		if (HX_FIELD_EQ(inName,"_nativeElementCreator") ) { _nativeElementCreator=inValue.Cast< ::port::flash_player::NativeElementCreator >(); return inValue; }
		break;
	case 25:
		if (HX_FIELD_EQ(inName,"_nativeElementPathManager") ) { _nativeElementPathManager=inValue.Cast< ::port::flash_player::NativeElementPathManager >(); return inValue; }
	}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.nativeElement.NativeElementManager"), hx::TCanCast< NativeElementManager_obj> ,sStaticFields,sMemberFields,
