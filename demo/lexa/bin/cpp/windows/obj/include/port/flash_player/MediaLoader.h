...
#define INCLUDED_port_flash_player_MediaLoader
...
class MediaLoader_obj : public ::core::resource::AbstractMediaLoader_obj{
	public:
		typedef ::core::resource::AbstractMediaLoader_obj super;
...
#endif /* INCLUDED_port_flash_player_MediaLoader */ 
