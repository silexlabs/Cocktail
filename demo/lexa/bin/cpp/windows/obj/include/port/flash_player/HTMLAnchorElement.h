...
#define INCLUDED_port_flash_player_HTMLAnchorElement
...
HX_DECLARE_CLASS2(port,flash_player,HTMLAnchorElement)
HX_DECLARE_CLASS2(port,flash_player,HTMLElement)
namespace port{
namespace flash_player{


class HTMLAnchorElement_obj : public ::core::html::AbstractHTMLAnchorElement_obj{
	public:
		typedef ::core::html::AbstractHTMLAnchorElement_obj super;
...
#endif /* INCLUDED_port_flash_player_HTMLAnchorElement */ 
