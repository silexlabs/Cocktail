...
#define INCLUDED_cocktail_core_style_adapter_AbstractStyle
...
class AbstractStyle_obj : public hx::Object{
	...
	public:
		static hx::ObjectPtr< AbstractStyle_obj > __new(::cocktail::core::style::CoreStyle coreStyle);
...
#endif /* INCLUDED_cocktail_core_style_adapter_AbstractStyle */ 
