...
#define INCLUDED_cocktail_core_style_AbstractCoreStyle
...
class AbstractCoreStyle_obj : public hx::Object{
	public:
		typedef hx::Object super;
		typedef AbstractCoreStyle_obj OBJ_;
		AbstractCoreStyle_obj();
		Void __construct(::cocktail::port::flash_player::HTMLElement htmlElement);

	public:
		static hx::ObjectPtr< AbstractCoreStyle_obj > __new(::cocktail::port::flash_player::HTMLElement htmlElement);
		...
		::String __ToString() const { return HX_CSTRING("AbstractCoreStyle"); }
		...
		::cocktail::port::flash_player::HTMLElement htmlElement; /* REM */ 
		...
		virtual ::cocktail::port::flash_player::HTMLElement get_htmlElement( );
...
#endif /* INCLUDED_cocktail_core_style_AbstractCoreStyle */ 
