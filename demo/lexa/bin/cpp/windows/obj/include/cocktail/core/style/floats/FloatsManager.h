...
#define INCLUDED_cocktail_core_style_floats_FloatsManager
...
class FloatsManager_obj : public hx::Object{
	...
	public:
		...
		virtual int clearFloat( ::cocktail::core::style::Clear clear,Dynamic formattingContextData);
		...
		virtual Dynamic computeFloatData( ::cocktail::core::renderer::ElementRenderer elementRenderer,Dynamic formattingContextData,int containingBlockWidth);
		Dynamic computeFloatData_dyn();

		virtual Dynamic getLeftFloatData( ::cocktail::core::renderer::ElementRenderer elementRenderer,Dynamic formattingContextData,int containingBlockWidth);
		Dynamic getLeftFloatData_dyn();

		virtual Dynamic getRightFloatData( ::cocktail::core::renderer::ElementRenderer elementRenderer,Dynamic formattingContextData,int containingBlockWidth);
		Dynamic getRightFloatData_dyn();

		virtual Dynamic getFloatData( ::cocktail::core::renderer::ElementRenderer elementRenderer,Dynamic formattingContextData,int containingBlockWidth);
...
#endif /* INCLUDED_cocktail_core_style_floats_FloatsManager */ 
