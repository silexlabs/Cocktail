...
class DisplayStylesComputer_obj : public hx::Object{
	...
	public:
		...
		static ::cocktail::core::style::Position getComputedPosition( ::cocktail::core::style::AbstractCoreStyle style);
		static Dynamic getComputedPosition_dyn();

		static ::cocktail::core::style::CSSFloat getComputedFloat( ::cocktail::core::style::AbstractCoreStyle style,::cocktail::core::style::Position computedPosition);
		static Dynamic getComputedFloat_dyn();

		static ::cocktail::core::style::Display getComputedDisplay( ::cocktail::core::style::AbstractCoreStyle style,::cocktail::core::style::CSSFloat computedFloat);
		static Dynamic getComputedDisplay_dyn();

		static ::cocktail::core::style::Clear getComputedClear( ::cocktail::core::style::AbstractCoreStyle style,::cocktail::core::style::Position computedPosition,::cocktail::core::style::Display computedDisplay);
