...
#define INCLUDED_cocktail_core_html_AbstractHTMLInputElement
...
class AbstractHTMLInputElement_obj : public ::cocktail::port::flash_player::HTMLElement_obj{
	public:
...
#endif /* INCLUDED_cocktail_core_html_AbstractHTMLInputElement */ 
