...
class MouseEvent_obj : public ::cocktail::core::event::UIEvent_obj{
	public:
		...
		MouseEvent_obj();
		Void __construct(::String type,::cocktail::port::flash_player::HTMLElement target,double detail,double screenX,double screenY,double clientX,double clientY,bool ctrlKey,bool shiftKey,bool altKey);

	public:
		static hx::ObjectPtr< MouseEvent_obj > __new(::String type,::cocktail::port::flash_player::HTMLElement target,double detail,double screenX,double screenY,double clientX,double clientY,bool ctrlKey,bool shiftKey,bool altKey);
