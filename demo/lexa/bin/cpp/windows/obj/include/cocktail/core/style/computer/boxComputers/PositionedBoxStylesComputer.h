...
class PositionedBoxStylesComputer_obj : public ::cocktail::core::style::computer::boxComputers::BoxStylesComputer_obj{
	...
	public:
		...
		virtual int applyContentHeight( ::cocktail::core::style::AbstractCoreStyle style,Dynamic containingHTMLElementData,int childrenHeight);
		...
		virtual int doShrinkToFit( ::cocktail::core::style::AbstractCoreStyle style,Dynamic containingHTMLElementData,int minimumWidth);
