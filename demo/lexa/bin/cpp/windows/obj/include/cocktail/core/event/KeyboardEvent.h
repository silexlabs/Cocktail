...
class KeyboardEvent_obj : public ::cocktail::core::event::UIEvent_obj{
	public:
		...
		KeyboardEvent_obj();
		Void __construct(::String type,::cocktail::port::flash_player::HTMLElement target,double detail,int keyChar,int key,bool ctrlKey,bool shiftKey,bool altKey);

	public:
		static hx::ObjectPtr< KeyboardEvent_obj > __new(::String type,::cocktail::port::flash_player::HTMLElement target,double detail,int keyChar,int key,bool ctrlKey,bool shiftKey,bool altKey);
