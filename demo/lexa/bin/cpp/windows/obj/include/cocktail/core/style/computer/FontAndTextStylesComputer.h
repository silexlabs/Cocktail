...
class FontAndTextStylesComputer_obj : public hx::Object{
	...
	public:
		...
		static Void compute( ::cocktail::core::style::AbstractCoreStyle style,Dynamic containingHTMLElementData,Dynamic containingHTMLElementFontMetricsData);
		static Dynamic compute_dyn();

		static int getComputedTextIndent( ::cocktail::core::style::AbstractCoreStyle style,Dynamic containingHTMLElementData);
		static Dynamic getComputedTextIndent_dyn();

		static double getComputedVerticalAlign( ::cocktail::core::style::AbstractCoreStyle style,Dynamic containingHTMLElementData,Dynamic containingHTMLElementFontMetricsData);
		static Dynamic getComputedVerticalAlign_dyn();

		static ::cocktail::core::style::TextAlign getComputedTextAlign( ::cocktail::core::style::AbstractCoreStyle style,::cocktail::core::style::WhiteSpace computedWhiteSpace);
		static Dynamic getComputedTextAlign_dyn();

		static Dynamic getComputedColor( ::cocktail::core::style::AbstractCoreStyle style);
		static Dynamic getComputedColor_dyn();

		static int getComputedWordSpacing( ::cocktail::core::style::AbstractCoreStyle style);
		static Dynamic getComputedWordSpacing_dyn();

		static double getComputedLineHeight( ::cocktail::core::style::AbstractCoreStyle style);
		static Dynamic getComputedLineHeight_dyn();

		static int getComputedLetterSpacing( ::cocktail::core::style::AbstractCoreStyle style);
		static Dynamic getComputedLetterSpacing_dyn();

		static double getComputedFontSize( ::cocktail::core::style::AbstractCoreStyle style,double parentFontSize,double parentXHeight);
