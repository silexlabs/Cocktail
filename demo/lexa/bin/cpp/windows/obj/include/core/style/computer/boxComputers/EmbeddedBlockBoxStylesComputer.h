...
#define INCLUDED_core_style_computer_boxComputers_EmbeddedBlockBoxStylesComputer
...
class EmbeddedBlockBoxStylesComputer_obj : public ::core::style::computer::boxComputers::BoxStylesComputer_obj{
	public:
...
#endif /* INCLUDED_core_style_computer_boxComputers_EmbeddedBlockBoxStylesComputer */ 
