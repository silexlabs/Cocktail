...
#define INCLUDED_core_event_MouseEvent
...
class MouseEvent_obj : public ::core::event::UIEvent_obj{
	public:
		typedef ::core::event::UIEvent_obj super;
		typedef MouseEvent_obj OBJ_;
		MouseEvent_obj();
		Void __construct(::String type,::port::flash_player::HTMLElement target,double detail,double screenX,double screenY,double clientX,double clientY,bool ctrlKey,bool shiftKey,bool altKey);

	public:
		static hx::ObjectPtr< MouseEvent_obj > __new(::String type,::port::flash_player::HTMLElement target,double detail,double screenX,double screenY,double clientX,double clientY,bool ctrlKey,bool shiftKey,bool altKey);
...
#endif /* INCLUDED_core_event_MouseEvent */ 
