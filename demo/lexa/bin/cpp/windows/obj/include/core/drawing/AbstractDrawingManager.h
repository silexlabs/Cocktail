...
#define INCLUDED_core_drawing_AbstractDrawingManager
...
class AbstractDrawingManager_obj : public hx::Object{
	...
	public:
		...
		int _height; /* REM */ 
		int height; /* REM */ 
		virtual Void beginFill( ::core::dom::FillStyleValue fillStyle,::core::dom::LineStyleValue lineStyle);
...
#endif /* INCLUDED_core_drawing_AbstractDrawingManager */ 
