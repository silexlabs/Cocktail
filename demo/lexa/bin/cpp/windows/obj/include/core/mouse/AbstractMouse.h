...
#define INCLUDED_core_mouse_AbstractMouse
...
class AbstractMouse_obj : public hx::Object{
	...
	public:
		static hx::ObjectPtr< AbstractMouse_obj > __new(::port::flash_player::HTMLElement htmlElement);
...
#endif /* INCLUDED_core_mouse_AbstractMouse */ 
