...
#define INCLUDED_core_resource_XMLHTTPRequest
...
HX_DECLARE_CLASS2(core,resource,XMLHTTPRequest)
...
class XMLHTTPRequest_obj : public hx::Object{
	...
	public:
		...
		inline operator ::core::event::IEventTarget_obj *()
			{ return new ::core::event::IEventTarget_delegate_< XMLHTTPRequest_obj >(this); }
...
#endif /* INCLUDED_core_resource_XMLHTTPRequest */ 
