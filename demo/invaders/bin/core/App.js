...
org.games.invaders.invaders.InvadersGame = $hxClasses["org.games.invaders.invaders.InvadersGame"] = function(containerDOMElement) {
	...
	org.games.invaders.invaders.InvadersGame.timeline.getStyle().setDisplay(cocktail.style.DisplayStyleValue.block);
	org.games.invaders.invaders.InvadersGame.timeline.getStyle().setWidth(cocktail.style.DimensionStyleValue.percent(100));
	org.games.invaders.invaders.InvadersGame.timeline.getStyle().setHeight(cocktail.style.DimensionStyleValue.percent(100));
	org.games.invaders.invaders.InvadersGame.timeline.setX(0);
	org.games.invaders.invaders.InvadersGame.timeline.setY(0);
	org.games.invaders.invaders.InvadersGame.timeline.setOnKeyDown(this.handle_input.$bind(this));
	this.construct();
}
...
org.games.invaders.invaders.InvadersGame.prototype = {
	player: null
	,bullets: null
	,invaders: null
	,ufo: null
	...
	,state: null
	,wave: null
	,num_alive_invaders: null
	,score: null
	,lives: null
	,timer: null
	,construct: function() {
		haxe.Log.trace("construct",{ fileName : "InvadersGame.hx", lineNumber : 65, className : "org.games.invaders.invaders.InvadersGame", methodName : "construct"});
		this.vblank_count = 0;
		this.shot = false;
	...
	,destruct: function() {
		haxe.Log.trace("destruct " + this,{ fileName : "InvadersGame.hx", lineNumber : 121, className : "org.games.invaders.invaders.InvadersGame", methodName : "destruct"});
		this.player.cleanup();
		this.player = null;
		this.ufo.cleanup();
		this.ufo = null;
	...
	,start: function() {
		haxe.Log.trace("start " + this,{ fileName : "InvadersGame.hx", lineNumber : 149, className : "org.games.invaders.invaders.InvadersGame", methodName : "start"});
		this.state = org.games.invaders.invaders.GameState.GAMESTATE_PLAYING;
		this.update_info_bar();
		this.timer.run = this.game.$bind(this);
	}
	,restart: function() {
		this.construct();
		this.start();
	...
	,end: function() {
		...
		if(this.state == org.games.invaders.invaders.GameState.GAMESTATE_LOST) {
			this.destruct();
			haxe.Timer.delay(this.restart.$bind(this),5000);
			return;
		}
		var the_wave = this.wave + 1;
		var the_score = this.score;
		var the_player_x = this.player.x;
		var the_lives = this.lives;
		this.destruct();
		this.construct();
		this.wave = the_wave;
		this.score = the_score;
		this.player.x = the_player_x;
		this.lives = the_lives;
		this.start();
	}
	,game: function() {
		this.erase(0);
	...
	,handle_input: function(key) {
		...
		if(!this.paused) {
			if(key.value == cocktail.keyboard.KeyboardKeyValue.left || key.value == cocktail.keyboard.KeyboardKeyValue.y) this.player.move_left(16); else if(key.value == cocktail.keyboard.KeyboardKeyValue.right || key.value == cocktail.keyboard.KeyboardKeyValue.a) this.player.move_right(16); else if((key.value == cocktail.keyboard.KeyboardKeyValue.up || key.value == cocktail.keyboard.KeyboardKeyValue.space) && !this.shot) {
				var _g = 0;
				while(_g < 10) {
					var i = _g++;
					if(this.bullets[i] == null) {
		...
		if(key.value == cocktail.keyboard.KeyboardKeyValue.p) {
			if(!this.paused) {
				this.timer.run = null;
				this.draw();
			} else {
	...
	,update: function() {
		...
		if(this.vblank_count % this.speed == 0) {
			...
			if(this.direction == org.games.invaders.invaders.Direction.DIRECTION_DOWN) {
				if(minX <= 64) this.direction = org.games.invaders.invaders.Direction.DIRECTION_RIGHT; else this.direction = org.games.invaders.invaders.Direction.DIRECTION_LEFT;
			} else {
				if(this.direction == org.games.invaders.invaders.Direction.DIRECTION_LEFT && minX <= 64) this.direction = org.games.invaders.invaders.Direction.DIRECTION_DOWN;
				if(this.direction == org.games.invaders.invaders.Direction.DIRECTION_RIGHT && maxX >= 1216) this.direction = org.games.invaders.invaders.Direction.DIRECTION_DOWN;
			}
		}
	...
	,update_info_bar: function() {
	}
	,__class__: org.games.invaders.invaders.InvadersGame
}
...
org.games.invaders.invaders.UfoState = $hxClasses["org.games.invaders.invaders.UfoState"] = { __ename__ : ["org","games","invaders","invaders","UfoState"], __constructs__ : ["UFO_FLYING","UFO_NOT_FLYING","UFO_SHOT_DOWN"] }
org.games.invaders.invaders.UfoState.UFO_FLYING = ["UFO_FLYING",0];
org.games.invaders.invaders.UfoState.UFO_FLYING.toString = $estr;
org.games.invaders.invaders.UfoState.UFO_FLYING.__enum__ = org.games.invaders.invaders.UfoState;
org.games.invaders.invaders.UfoState.UFO_NOT_FLYING = ["UFO_NOT_FLYING",1];
org.games.invaders.invaders.UfoState.UFO_NOT_FLYING.toString = $estr;
org.games.invaders.invaders.UfoState.UFO_NOT_FLYING.__enum__ = org.games.invaders.invaders.UfoState;
org.games.invaders.invaders.UfoState.UFO_SHOT_DOWN = ["UFO_SHOT_DOWN",2];
...
org.games.invaders.engine.MovingObject = $hxClasses["org.games.invaders.engine.MovingObject"] = function(the_data,the_color,the_x,the_y,the_width,the_height,the_num_frames) {
	this.data = the_data;
...
org.games.invaders.engine.MovingObject.prototype = {
	domElement: null
	,oldData: null
	,data: null
	,color: null
	...
	,draw: function() {
		...
		this.domElement.setWidth(this.width);
	...
	,collision: function(sprite) {
		...
		var sprite1_y = this.y;
		var sprite1_width = this.width;
		var sprite1_height = this.height;
		var sprite2_x = sprite.x;
		var sprite2_y = sprite.y;
		var sprite2_width = sprite.width;
		var sprite2_height = sprite.height;
	...
	,__class__: org.games.invaders.engine.MovingObject
}
org.games.invaders.invaders.Ufo = $hxClasses["org.games.invaders.invaders.Ufo"] = function() {
...
org.games.invaders.invaders.Ufo.prototype = $extend(org.games.invaders.engine.MovingObject.prototype,{
	direction: null
	,state: null
	,timer: null
	,last_score: null
	,move: function() {
		if(this.state == org.games.invaders.invaders.UfoState.UFO_FLYING) {
			...
			case 2:
				if(this.x < -this.width) this.state = org.games.invaders.invaders.UfoState.UFO_NOT_FLYING; else this.x -= 16;
				break;
			case 3:
				if(this.x > 1280) this.state = org.games.invaders.invaders.UfoState.UFO_NOT_FLYING; else this.x += 16;
				break;
			default:
			}
		}
	...
	,reset: function() {
		...
		this.state = org.games.invaders.invaders.UfoState.UFO_FLYING;
	}
	,score: function() {
		var possible_scores = [50,100,150,200,250,300];
		this.last_score = possible_scores[Math.round(Math.random() * 5)];
		return this.last_score;
	}
	,__class__: org.games.invaders.invaders.Ufo
});
org.games.invaders.invaders.SpriteData = $hxClasses["org.games.invaders.invaders.SpriteData"] = function() {
}
org.games.invaders.invaders.SpriteData.__name__ = ["org","games","invaders","invaders","SpriteData"];
org.games.invaders.invaders.SpriteData.prototype = {
	__class__: org.games.invaders.invaders.SpriteData
}
...
org.games.invaders.invaders.BulletType = $hxClasses["org.games.invaders.invaders.BulletType"] = { __ename__ : ["org","games","invaders","invaders","BulletType"], __constructs__ : ["BULLET_HUMAN","BULLET_SQUIGGLY","BULLET_CROSS"] }
org.games.invaders.invaders.BulletType.BULLET_HUMAN = ["BULLET_HUMAN",0];
org.games.invaders.invaders.BulletType.BULLET_HUMAN.toString = $estr;
org.games.invaders.invaders.BulletType.BULLET_HUMAN.__enum__ = org.games.invaders.invaders.BulletType;
org.games.invaders.invaders.BulletType.BULLET_SQUIGGLY = ["BULLET_SQUIGGLY",1];
org.games.invaders.invaders.BulletType.BULLET_SQUIGGLY.toString = $estr;
org.games.invaders.invaders.BulletType.BULLET_SQUIGGLY.__enum__ = org.games.invaders.invaders.BulletType;
org.games.invaders.invaders.BulletType.BULLET_CROSS = ["BULLET_CROSS",2];
org.games.invaders.invaders.BulletType.BULLET_CROSS.toString = $estr;
org.games.invaders.invaders.BulletType.BULLET_CROSS.__enum__ = org.games.invaders.invaders.BulletType;
org.games.invaders.invaders.Direction = $hxClasses["org.games.invaders.invaders.Direction"] = { __ename__ : ["org","games","invaders","invaders","Direction"], __constructs__ : ["DIRECTION_UP","DIRECTION_DOWN","DIRECTION_LEFT","DIRECTION_RIGHT"] }
org.games.invaders.invaders.Direction.DIRECTION_UP = ["DIRECTION_UP",0];
org.games.invaders.invaders.Direction.DIRECTION_UP.toString = $estr;
org.games.invaders.invaders.Direction.DIRECTION_UP.__enum__ = org.games.invaders.invaders.Direction;
org.games.invaders.invaders.Direction.DIRECTION_DOWN = ["DIRECTION_DOWN",1];
org.games.invaders.invaders.Direction.DIRECTION_DOWN.toString = $estr;
org.games.invaders.invaders.Direction.DIRECTION_DOWN.__enum__ = org.games.invaders.invaders.Direction;
org.games.invaders.invaders.Direction.DIRECTION_LEFT = ["DIRECTION_LEFT",2];
org.games.invaders.invaders.Direction.DIRECTION_LEFT.toString = $estr;
org.games.invaders.invaders.Direction.DIRECTION_LEFT.__enum__ = org.games.invaders.invaders.Direction;
...
org.games.invaders.invaders.Bullet = $hxClasses["org.games.invaders.invaders.Bullet"] = function() {
...
org.games.invaders.invaders.Bullet.prototype = $extend(org.games.invaders.engine.MovingObject.prototype,{
	type: null
	,direction: null
	,move: function() {
		var speed;
		...
		if(this.y < 30 || this.y > 632 - this.height) return false; else return true;
	}
	,init: function(the_type,the_x,the_y) {
		this.type = the_type;
		var idx = 0;
		switch( (this.type)[1] ) {
		case 0:
	...
	,__class__: org.games.invaders.invaders.Bullet
});
...
org.games.invaders.Main = $hxClasses["org.games.invaders.Main"] = function() {
...
org.games.invaders.Main.prototype = {
	__class__: org.games.invaders.Main
}
...
org.games.invaders.invaders.GameData = $hxClasses["org.games.invaders.invaders.GameData"] = function() {
}
org.games.invaders.invaders.GameData.__name__ = ["org","games","invaders","invaders","GameData"];
org.games.invaders.invaders.GameData.prototype = {
	__class__: org.games.invaders.invaders.GameData
}
org.games.invaders.invaders.GameState = $hxClasses["org.games.invaders.invaders.GameState"] = { __ename__ : ["org","games","invaders","invaders","GameState"], __constructs__ : ["GAMESTATE_WON","GAMESTATE_LOST","GAMESTATE_PLAYING"] }
org.games.invaders.invaders.GameState.GAMESTATE_WON = ["GAMESTATE_WON",0];
org.games.invaders.invaders.GameState.GAMESTATE_WON.toString = $estr;
org.games.invaders.invaders.GameState.GAMESTATE_WON.__enum__ = org.games.invaders.invaders.GameState;
org.games.invaders.invaders.GameState.GAMESTATE_LOST = ["GAMESTATE_LOST",1];
org.games.invaders.invaders.GameState.GAMESTATE_LOST.toString = $estr;
org.games.invaders.invaders.GameState.GAMESTATE_LOST.__enum__ = org.games.invaders.invaders.GameState;
...
org.games.invaders.invaders.Player = $hxClasses["org.games.invaders.invaders.Player"] = function() {
	org.games.invaders.engine.MovingObject.call(this,["assets/invaders/player.png"][0],12544,610.,600,60,32,3);
}
...
org.games.invaders.invaders.Player.prototype = $extend(org.games.invaders.engine.MovingObject.prototype,{
	move_left: function(amount) {
		if(this.x - amount < 64) this.x = 64; else this.x -= amount;
	}
	,move_right: function(amount) {
		if(this.x + amount > 1216 - this.width) this.x = 1216 - this.width; else this.x += amount;
	}
	,__class__: org.games.invaders.invaders.Player
});
...
org.games.invaders.invaders.InvaderType = $hxClasses["org.games.invaders.invaders.InvaderType"] = { __ename__ : ["org","games","invaders","invaders","InvaderType"], __constructs__ : ["INVADER_OCTOPUS","INVADER_CRAB","INVADER_SQUID"] }
org.games.invaders.invaders.InvaderType.INVADER_OCTOPUS = ["INVADER_OCTOPUS",0];
org.games.invaders.invaders.InvaderType.INVADER_OCTOPUS.toString = $estr;
org.games.invaders.invaders.InvaderType.INVADER_OCTOPUS.__enum__ = org.games.invaders.invaders.InvaderType;
org.games.invaders.invaders.InvaderType.INVADER_CRAB = ["INVADER_CRAB",1];
org.games.invaders.invaders.InvaderType.INVADER_CRAB.toString = $estr;
org.games.invaders.invaders.InvaderType.INVADER_CRAB.__enum__ = org.games.invaders.invaders.InvaderType;
org.games.invaders.invaders.InvaderType.INVADER_SQUID = ["INVADER_SQUID",2];
org.games.invaders.invaders.InvaderType.INVADER_SQUID.toString = $estr;
org.games.invaders.invaders.InvaderType.INVADER_SQUID.__enum__ = org.games.invaders.invaders.InvaderType;
org.games.invaders.invaders.InvaderState = $hxClasses["org.games.invaders.invaders.InvaderState"] = { __ename__ : ["org","games","invaders","invaders","InvaderState"], __constructs__ : ["INVADER_OK","INVADER_EXPLODING","INVADER_DEAD"] }
org.games.invaders.invaders.InvaderState.INVADER_OK = ["INVADER_OK",0];
org.games.invaders.invaders.InvaderState.INVADER_OK.toString = $estr;
org.games.invaders.invaders.InvaderState.INVADER_OK.__enum__ = org.games.invaders.invaders.InvaderState;
org.games.invaders.invaders.InvaderState.INVADER_EXPLODING = ["INVADER_EXPLODING",1];
org.games.invaders.invaders.InvaderState.INVADER_EXPLODING.toString = $estr;
org.games.invaders.invaders.InvaderState.INVADER_EXPLODING.__enum__ = org.games.invaders.invaders.InvaderState;
...
org.games.invaders.invaders.Invader = $hxClasses["org.games.invaders.invaders.Invader"] = function() {
...
org.games.invaders.invaders.Invader.prototype = $extend(org.games.invaders.engine.MovingObject.prototype,{
	type: null
	,state: null
	,when_exploded: null
	,init: function(the_type,the_x,the_y) {
	...
	,update: function(vblank_count,animate,direction) {
		if(animate) {
			this.frame++;
			switch( (direction)[1] ) {
			case 0:
		...
		if(this.state == org.games.invaders.invaders.InvaderState.INVADER_EXPLODING) {
			if(this.when_exploded == 0) {
				this.when_exploded = vblank_count;
				this.data = [""][0];
				this.num_frames = 1;
				this.frame = 0;
	...
	,__class__: org.games.invaders.invaders.Invader
});
...
org.games.invaders.invaders.SpriteData.INVADER_WIDTH = 48;
org.games.invaders.invaders.SpriteData.INVADER_HEIGHT = 32;
org.games.invaders.invaders.SpriteData.BUNKER_WIDTH = 96;
org.games.invaders.invaders.SpriteData.BUNKER_HEIGHT = 72;
org.games.invaders.invaders.SpriteData.UFO_WIDTH = 64;
org.games.invaders.invaders.SpriteData.UFO_HEIGHT = 28;
org.games.invaders.invaders.SpriteData.NUM_BULLETS = 3;
org.games.invaders.invaders.SpriteData.BULLET_WIDTH = 9;
org.games.invaders.invaders.SpriteData.BULLET_HEIGHT = 15;
...
org.games.invaders.invaders.Player.PLAYER_X = 610.;
