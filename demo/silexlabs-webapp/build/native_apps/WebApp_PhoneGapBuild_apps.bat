...
ECHO.
ECHO moving iOS app
move %input_dir%\SilexLabs.ipa %output_dir%\WebApp_iOS_PhoneGap.ipa
ECHO moving android app
move %input_dir%\SilexLabs-debug.apk %output_dir%\WebApp_android_PhoneGap.apk
ECHO moving BlackBerry app
move %input_dir%\SilexLabs.jad %output_dir%\WebApp_BlackBerry_PhoneGap.jad
ECHO moving webOS app
move %input_dir%\org.silexlabs.SilexLabs_1.0.0_all.ipk %output_dir%\WebApp_webOS_PhoneGap.ipk
