...
components.lists.ThumbTextList1Style.getCellLineStyle=function(domElement){domElement.style.display="inline";domElement.style.width="100%";domElement.style.height="1px";}
...
components.lists.ListBase.prototype.createCellDOM=function(cellData,listStyle){var cell=js.Lib.document.createElement("li");var cellLink=js.Lib.document.createElement("a");cellLink.style.textAlign="center";cellLink.style.display="block";if(cellData.action=="openUrl"||cellData.action=="goToUrl"){cellLink.href=cellData.actionTarget;cellLink.target="blank";}else{var onCellMouseUpDelegate=$closure(this,"onCellSelected");cell.onmouseup=function(mouseEventData){onCellMouseUpDelegate(cell,cellData);};}
