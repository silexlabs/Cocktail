...
ApplicationStructure.prototype = {
	...
	,createAllPages: function() {
		var pluginsRss = new components.dataProvider.XmlLoader("http://www.silexlabs.org/feed/ep_posts_in_category/?cat=5318&format=rss2&posts_per_page=" + 5);
		pluginsRss.onLoad = this.onPage1RssLoad.$bind(this);
		var blogRss = new components.dataProvider.XmlLoader("http://www.silexlabs.org/feed/ep_posts_in_category/?cat=358&format=rss2&posts_per_page=" + 5);
		blogRss.onLoad = this.onPage2RssLoad.$bind(this);
		var themesRss = new components.dataProvider.XmlLoader("http://www.silexlabs.org/feed/ep_posts_in_category/?cat=642&format=rss2&posts_per_page=" + 5);
		themesRss.onLoad = this.onPage3RssLoad.$bind(this);
		var themesRss1 = new components.dataProvider.XmlLoader("http://www.silexlabs.org/feed/ep_posts_in_category/?cat=646&format=rss2&posts_per_page=" + 5);
		themesRss1.onLoad = this.onPage4RssLoad.$bind(this);
		var pluginsRss1 = new components.dataProvider.XmlLoader("http://www.silexlabs.org/feed/ep_posts_in_category/?cat=657&format=rss2&posts_per_page=" + 5);
...
ApplicationStructure.ITEM_QUANTITY = 5;
