...
org.intermedia.view.DetailView.prototype = $extend(org.intermedia.view.ViewBase.prototype,{
	...
	,resizeNodeChildrenTag: function(node,tagName) {
		...
		while(_g1 < _g) {
			...
			if(Std.parseInt(tagNodes[i].getAttribute("width")) > js.Lib.window.innerWidth) {
...
org.intermedia.view.ViewManager.prototype = {
	...
	,onLoadingError: function(error) {
		haxe.Log.trace("Load error: " + Std.string(error),{ fileName : "ViewManager.hx", lineNumber : 255, className : "org.intermedia.view.ViewManager", methodName : "onLoadingError"});
		haxe.Firebug.trace("Load error: " + Std.string(error),{ fileName : "ViewManager.hx", lineNumber : 256, className : "org.intermedia.view.ViewManager", methodName : "onLoadingError"});
	}
