...
org.intermedia.view.CellStyle.setCellStyle = function(domElement,cellPerLine) {
	if(cellPerLine == null) cellPerLine = 1;
	...
	domElement.getStyle().setWidth(cocktail.style.DimensionStyleValue.percent(cellWidthPercent));
...
org.intermedia.view.CellStyle.addBorder = function(domElement) {
	domElement.getNativeElement().style.borderWidth = "1px";
	domElement.getNativeElement().style.borderColor = "#CCCCCC";
	domElement.getNativeElement().style.borderStyle = "solid";
}
org.intermedia.view.CellStyle.removeBorder = function(domElement) {
	domElement.getNativeElement().style.borderStyle = "none";
}
...
org.intermedia.view.CellTextStyle.setCellStyle = function(domElement) {
	...
	domElement.getNativeElement().style.borderStyle = "none none solid none";
}
org.intermedia.view.CellTextStyle.setCellTextStyle = function(domElement) {
	...
	domElement.getStyle().setPaddingRight(cocktail.style.PaddingStyleValue.length(cocktail.unit.LengthValue.px(0)));
	domElement.getStyle().setFontSize(cocktail.style.FontSizeStyleValue.length(cocktail.unit.LengthValue.px(15)));
...
org.intermedia.view.CellThumbText1.prototype = $extend(org.intermedia.view.CellBase.prototype,{
	...
	,updateView: function() {
		...
		if(this._data.title != "" && this._data.title != null) {
			...
			var textElement = new cocktailCore.textElement.js.TextElement(text);
...
org.intermedia.view.CellThumbText1Style.setThumbnailStyle = function(domElement,maskSize) {
	org.intermedia.view.CellThumbStyle.setThumbnailStyle(domElement,maskSize);
}
...
org.intermedia.view.CroppedImage.prototype = $extend(cocktailCore.domElement.js.ContainerDOMElement.prototype,{
	...
	,onImageLoadSuccess: function(image) {
		image.getStyle().setOpacity(cocktail.style.OpacityStyleValue.number(0));
...
org.intermedia.view.LoadingViewStyle.setLoadingStyle = function(domElement) {
	...
	domElement.getStyle().setTop(cocktail.style.PositionOffsetStyleValue.length(cocktail.unit.LengthValue.px(0)));
	domElement.getStyle().setBottom(cocktail.style.PositionOffsetStyleValue.length(cocktail.unit.LengthValue.px(0)));
	domElement.getStyle().setBackgroundColor(cocktail.style.BackgroundColorStyleValue.colorValue(cocktail.unit.ColorValue.rgba(255,255,255,1)));
	domElement.getNativeElement().style.zIndex = 1000;
}
...
org.intermedia.view.SwippableListView.prototype = $extend(org.intermedia.view.ListViewBase.prototype,{
	...
	,onMoveCallback2: function(event) {
		...
		this.getNativeElement().scrollLeft = this._offsetStart.x - this._offset.x;
...
org.intermedia.view.ViewManager.prototype = {
	...
	,onLoadingError: function(error) {
		haxe.Firebug.trace("Load error: " + Std.string(error),{ fileName : "ViewManager.hx", lineNumber : 229, className : "org.intermedia.view.ViewManager", methodName : "onLoadingError"});
	}
