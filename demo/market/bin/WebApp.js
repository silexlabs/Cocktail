...
org.intermedia.view.CellThumbStyle.setCellStyle = function(node,cellPerLine) {
	...
	node.style.paddingTop = Std.string(2);
...
org.intermedia.view.DetailView.prototype = $extend(org.intermedia.view.ViewBase.prototype,{
	...
	,updateView: function() {
		...
		this._authorContainer.appendChild(this._authorElement);
		if(this._thumbnail.parentNode != null) this.node.removeChild(this._thumbnail);
		if(this._data.thumbUrl != "" && this._data.thumbUrl != null) {
			this._thumbnail.src = this._data.thumbUrl;
			this.node.appendChild(this._thumbnail);
		}
	...
	,html2DOM: function(htmlString) {
		try {
			...
			this.node.appendChild(htmlPageData.htmlDom);
		} catch( $e0 ) {
			if( js.Boot.__instanceof($e0,String) ) {
				var msg = $e0;
				haxe.Firebug.trace("Error, parsing XML tag \n" + msg,{ fileName : "DetailView.hx", lineNumber : 151, className : "org.intermedia.view.DetailView", methodName : "html2DOM"});
			} else {
			var unknown = $e0;
			haxe.Firebug.trace("Error, parsing XML tag \n" + Std.string(unknown),{ fileName : "DetailView.hx", lineNumber : 154, className : "org.intermedia.view.DetailView", methodName : "html2DOM"});
			}
		}
	}
...
org.intermedia.view.ImageUtils.cropImage = function(image,maskSize) {
	var mask = js.Lib.document.createElement("div");
...
org.intermedia.view.ListViewStyle.setListStyle = function(node,listTop) {
	node.style.display = "inline-block";
	node.style.position = "static";
	node.style.marginLeft = "0px";
	node.style.marginRight = "0px";
...
org.intermedia.view.ListViewStyle.loader = function(node) {
	...
	var viewportHeight = js.Lib.window.innerHeight;
	node.style.display = "block";
...
org.intermedia.view.ListViewText = $hxClasses["org.intermedia.view.ListViewText"] = function() {
	...
	org.intermedia.view.ListViewStyle.setListStyle(this.node,78);
};
...
org.intermedia.view.SwippableListView.prototype = $extend(org.intermedia.view.ListViewBase.prototype,{
	...
	,onMoveCallback2: function(event) {
		...
		if(this._direction == org.intermedia.view.Direction.horizontal) event.preventDefault(); else if(this._direction == org.intermedia.view.Direction.vertical) this.node.scrollLeft = this._offsetStart.x;
	}
	...
	,scrollToCurrentList: function() {
		this.node.scrollLeft = Std.parseInt(this._currentListView.node.style.left);
	}
...
org.intermedia.view.SwippableListViewStyle.setSwippableListStyle = function(node) {
	...
	node.style.marginLeft = "0px";
	node.style.marginRight = "0px";
	node.style.marginTop = Std.string(78);
	node.style.marginBottom = "0px";
	node.style.paddingLeft = "0px";
	node.style.paddingRight = "0px";
	node.style.paddingTop = "0px";
...
org.intermedia.view.ViewManager.prototype = {
	...
	,onLoadingError: function(error) {
		haxe.Firebug.trace("Load error: " + Std.string(error),{ fileName : "ViewManager.hx", lineNumber : 230, className : "org.intermedia.view.ViewManager", methodName : "onLoadingError"});
	}
