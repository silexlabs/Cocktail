...
org.intermedia.view.ViewBase.prototype._style = null;
...
org.intermedia.view.CellBase = function(cellPerLine,style) {
...
org.intermedia.view.CellBase.prototype._cellPerLine = null;
org.intermedia.view.CellBase.prototype.initStyle = function() {
	this._style = { cell : org.intermedia.view.CellStyle.setCellStyle};
}
org.intermedia.view.CellBase.prototype.refreshStyles = function() {
...
org.intermedia.view.MenuCellText.prototype.initStyle = function() {
...
org.intermedia.view.DetailView.prototype.unsetTouchEvents = function() {
	this.node.removeEventListener("touchstart",$closure(this,"touchStart"),false);
	this.node.removeEventListener("touchmove",$closure(this._moveHandler,"touchHandler"),false);
	this.node.removeEventListener("touchend",$closure(this._moveHandler,"touchHandler"),false);
	this.node.removeEventListener("touchcancel",$closure(this._moveHandler,"touchHandler"),false);
}
org.intermedia.view.DetailView.prototype.onVerticalScroll = function(y) {
	this.node.scrollTop = this._moveHandler.initialScrollPosition.y - y;
}
org.intermedia.view.DetailView.prototype.refreshStyles = function() {
	org.intermedia.view.DetailStyle.setDetailStyle(this.node);
	this.resizeNodeChildrenTag(this._contentContainer,"iframe");
	this.resizeNodeChildrenTag(this._contentContainer,"img");
}
org.intermedia.view.DetailView.prototype.resizeNodeChildrenTag = function(nodeToResize,tagName) {
...
org.intermedia.view.DetailView.prototype.resizeNode = function(nodeToResize) {
	...
	if(Std.parseInt(nodeToResize.getAttribute("width")) > js.Lib.window.innerWidth) {
		var newWidth = Std["int"](96 * js.Lib.window.innerWidth / 100);
		nodeToResize.style.width = Std.string(96) + "%";
		var newHeight = Std["int"](originalHeight * newWidth / originalWidth);
...
org.intermedia.view.ThumbTextList1BisStyle = function() { }
...
org.intermedia.view.CellText.prototype.initStyle = function() {
...
org.intermedia.view.CellThumbText1 = function(cellPerLine,style) {
	if( cellPerLine === $_ ) return;
	if(cellPerLine == null) cellPerLine = 1;
...
org.intermedia.view.CellThumbText1.prototype._croppedImage = null;
org.intermedia.view.CellThumbText1.prototype.initStyle = function() {
...
org.intermedia.view.CellThumbText1.prototype.refreshStyles = function() {
...
org.intermedia.view.ListViewBase.prototype._bottomLoaderImage = null;
org.intermedia.view.ListViewBase.prototype.initStyle = function() {
	this._style = { list : org.intermedia.view.ListViewStyle.setListStyle};
}
org.intermedia.view.ListViewBase.prototype.buildBottomLoader = function() {
...
org.intermedia.view.ListViewBase.prototype.refreshStyles = function() {
	this._style.list(this.node);
...
org.intermedia.view.MenuListViewText.prototype._menuItem0LeftTarget = null;
org.intermedia.view.MenuListViewText.prototype._menuItem1LeftTarget = null;
org.intermedia.view.MenuListViewText.prototype._menuItem2LeftTarget = null;
org.intermedia.view.MenuListViewText.prototype.initStyle = function() {
...
org.intermedia.view.MenuListViewText.prototype.computeMenuItemsLeftTarget = function(targetIndex) {
	switch(targetIndex) {
	case 0:
		this._menuItem0LeftTarget = Std["int"]((js.Lib.window.innerWidth - this._menuItem0Width) / 2 - 5 / 2);
		this._menuItem1LeftTarget = Std["int"](js.Lib.window.innerWidth - 30);
		this._menuItem2LeftTarget = Std["int"](3 * js.Lib.window.innerWidth / 2);
		break;
	case 1:
		this._menuItem0LeftTarget = Std["int"](-(this._menuItem0Width - 30));
		this._menuItem1LeftTarget = Std["int"]((js.Lib.window.innerWidth - this._menuItem1Width - 5) / 2);
		this._menuItem2LeftTarget = Std["int"](js.Lib.window.innerWidth - 30);
		break;
	case 2:
		this._menuItem0LeftTarget = Std["int"](-js.Lib.window.innerWidth / 2);
		this._menuItem1LeftTarget = Std["int"](-(this._menuItem1Width - 30));
		this._menuItem2LeftTarget = Std["int"]((js.Lib.window.innerWidth - this._menuItem2Width) / 2 - 5 / 2);
		break;
	default:
	}
}
org.intermedia.view.MenuListViewText.prototype.moveHorizontally = function(ratio) {
	if(ratio > 0) this.computeMenuItemsLeftTarget(Std["int"](Math.max(this._index - 1,0))); else if(ratio < 0) this.computeMenuItemsLeftTarget(Std["int"](Math.min(this._index + 1,2)));
...
org.intermedia.view.MenuListViewText.prototype.horizontalTweenEnd = function(newIndex) {
	this.setIndex(newIndex);
	this.refreshStyles();
}
org.intermedia.view.MenuListViewText.prototype.refreshStyles = function() {
...
org.intermedia.view.CellThumb = function(cellPerLine,style) {
	if( cellPerLine === $_ ) return;
	if(cellPerLine == null) cellPerLine = 1;
	org.intermedia.view.CellBase.call(this,cellPerLine,style);
}
...
org.intermedia.view.CellThumb.prototype._croppedImage = null;
org.intermedia.view.CellThumb.prototype.initStyle = function() {
...
org.intermedia.view.CellThumb.prototype.refreshStyles = function() {
	org.intermedia.view.CellBase.prototype.refreshStyles.call(this);
	this._croppedImage.refreshStyles();
}
...
org.intermedia.view.CellThumbText1Style.setTextBlockStyle = function(node) {
	node.style.display = "inline-block";
	node.style.marginTop = Std.string(Std["int"](8 / 2)) + "%";
	node.style.marginLeft = "3%";
	node.style.verticalAlign = "top";
...
org.intermedia.view.ViewManager.prototype._time = null;
org.intermedia.view.ViewManager.prototype.init = function() {
	...
	this._swippableListView.onHorizontalMove = $closure(this._menu,"moveHorizontally");
	this._swippableListView.onHorizontalTweenEnd = $closure(this._menu,"horizontalTweenEnd");
...
org.intermedia.view.ViewManager.prototype.onResizeCallback = function() {
...
org.intermedia.view.CellThumbText1BisStyle = function() { }
...
org.intermedia.view.CroppedImage = function(style) {
	if( style === $_ ) return;
	org.intermedia.view.ViewBase.call(this);
	this._style = style;
	this.node = js.Lib.document.createElement("div");
...
for(var k in org.intermedia.view.ViewBase.prototype ) org.intermedia.view.CroppedImage.prototype[k] = org.intermedia.view.ViewBase.prototype[k];
org.intermedia.view.CroppedImage.prototype._image = null;
org.intermedia.view.CroppedImage.prototype.onImageLoadSuccess = null;
org.intermedia.view.CroppedImage.prototype.updateView = function() {
...
org.intermedia.view.CroppedImage.prototype.loadThumb = function(imageUrl) {
	...
	this._image.onload = $closure(this,"onImageLoadSuccessCallback");
	this._image.src = imageUrl;
}
org.intermedia.view.CroppedImage.prototype.onImageLoadSuccessCallback = function(event) {
	this.refreshStyles();
	this._image.style.opacity = 0;
	this.node.appendChild(this._image);
	haxe.Timer.delay($closure(this,"fadeIn"),Std.random(1500));
...
org.intermedia.view.CroppedImage.prototype.refreshStyles = function() {
...
org.intermedia.view.ThumbTextList1Bis.prototype._homePage = null;
org.intermedia.view.ThumbTextList1Bis.prototype.initStyle = function() {
...
org.intermedia.view.ThumbTextList1Bis.prototype.createCell = function() {
...
org.intermedia.view.HomePage.prototype.cells = null;
...
org.intermedia.Settings = function() { }
...
org.intermedia.view.SwippableListView = function(p) {
	...
	this._scrollHandler.onVerticalScroll = $closure(this,"onVerticalScroll");
	this._scrollHandler.onHorizontalScroll = $closure(this,"onHorizontalScrollCallback");
	this._scrollHandler.onHorizontalUp = $closure(this,"onHorizontalUpCallback");
	this._scrollHandler.onHorizontalTween = $closure(this,"onHorizontalScrollCallback");
	this._scrollHandler.onHorizontalTweenEnd = $closure(this,"onHorizontalTweenEndCallback");
	this.addTouchEvents();
}
...
org.intermedia.view.SwippableListView.prototype._scrollHandler = null;
org.intermedia.view.SwippableListView.prototype.onHorizontalMove = null;
org.intermedia.view.SwippableListView.prototype.onHorizontalTweenEnd = null;
org.intermedia.view.SwippableListView.prototype.onHorizontalUp = null;
org.intermedia.view.SwippableListView.prototype.initStyle = function() {
...
org.intermedia.view.SwippableListView.prototype.updateView = function() {
	var _g = 0, _g1 = this._listViews;
	while(_g < _g1.length) {
		var list = _g1[_g];
		++_g;
...
org.intermedia.view.SwippableListView.prototype.refreshStyles = function() {
...
org.intermedia.view.SwippableListView.prototype.onHorizontalScrollCallback = function(xOffset) {
	this._currentListView.onListItemSelected = null;
...
org.intermedia.view.SwippableListView.prototype.onHorizontalTweenEndCallback = function(xOffset) {
	this._currentListView.onListItemSelected = $closure(this,"onListItemSelectedCallback");
	var horizontalRatio = this.computeHorizontalRatio(xOffset);
	if(this.onHorizontalTweenEnd != null) this.onHorizontalTweenEnd(this._index);
}
org.intermedia.view.SwippableListView.prototype.onVerticalScroll = function(yOffset) {
...
org.intermedia.view.SwippableListView.prototype.addTouchEvents = function() {
	this.node.addEventListener("touchstart",$closure(this,"touchStart"),false);
	this.node.addEventListener("touchmove",$closure(this,"touchMove"),false);
	this.node.addEventListener("touchend",$closure(this,"touchEnd"),false);
	this.node.addEventListener("touchcancel",$closure(this._scrollHandler,"touchHandler"),false);
}
org.intermedia.view.SwippableListView.prototype.unsetTouchEvents = function() {
	this.node.removeEventListener("touchstart",$closure(this,"touchStart"),false);
...
org.intermedia.view.SwippableListView.prototype.touchMove = function(event) {
	this._currentListView.onListItemSelected = null;
	this._scrollHandler.touchHandler(event);
}
org.intermedia.view.SwippableListView.prototype.touchEnd = function(event) {
	this._currentListView.onListItemSelected = $closure(this,"onListItemSelectedCallback");
	this._scrollHandler.touchHandler(event);
}
...
org.intermedia.view.SwippableListView.prototype.resetInitScrollPosition = function() {
...
org.intermedia.view.HeaderView.prototype._image = null;
...
org.intermedia.view.Scroll2D.prototype.onHorizontalTween = null;
...
org.intermedia.view.Scroll2D.prototype._timer = null;
org.intermedia.view.Scroll2D.prototype._time = null;
org.intermedia.view.Scroll2D.prototype._decelerationTimer = null;
org.intermedia.view.Scroll2D.prototype._verticalVelocity = null;
org.intermedia.view.Scroll2D.prototype._previousY = null;
org.intermedia.view.Scroll2D.prototype._verticalReleaseDeceleration = null;
org.intermedia.view.Scroll2D.prototype.init = function() {
	this._initialPosition = { x : 0, y : 0};
	this._offset = { x : 0, y : 0};
...
org.intermedia.view.Scroll2D.prototype.onDownCallback = function(event) {
	...
	this._previousY = 0;
	this._timer.run = $closure(this,"computeVelocity");
...
org.intermedia.view.Scroll2D.prototype.onHorizontalScrollCallback = function(xOffset) {
	if(this.onHorizontalScroll != null) this.onHorizontalScroll(Std["int"](xOffset));
}
org.intermedia.view.Scroll2D.prototype.onHorizontalTweenCallback = function(e) {
	if(this.onHorizontalTween != null) this.onHorizontalTween(Std["int"](e));
}
org.intermedia.view.Scroll2D.prototype.horizontalTweenEnd = function(e) {
	if(this.onHorizontalTweenEnd != null) this.onHorizontalTweenEnd(Std["int"](e));
}
org.intermedia.view.Scroll2D.prototype.verticalReleaseTween = function() {
	...
	this._decelerationTimer.run = $closure(this,"onVerticalReleaseCallback");
}
...
org.intermedia.view.Scroll2D.prototype.onVerticalReleaseCallback = function() {
	if(this.onVerticalScroll != null) {
		...
		var verticalReleaseDelta = this._offset.y + Std["int"](amplitude * (1 - Math.exp(-timeDelta / releaseTime)));
...
org.intermedia.view.Scroll2D.prototype.computeVelocity = function() {
	this._verticalVelocity = (this.deriv(this._previousY,this._offset.y) + this._verticalVelocity) / 2;
	this._previousY = this._offset.y;
}
org.intermedia.view.Scroll2D.prototype.deriv = function(a,b) {
	return (b - a) / 20;
}
...
org.intermedia.model.ApplicationModel.prototype.loadCellData = function(feed) {
	...
	this._dataLoader.loadCellData(feed,15,$closure(this,"onCellsDataLoadComplete"),this.onModelDataLoadError);
}
...
org.intermedia.Settings.ONLINE = true;
