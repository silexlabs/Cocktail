...
org.intermedia.view.ViewManager.prototype = {
	...
	,onLoadingError: function(error) {
		haxe.Log.trace("Load error: " + Std.string(error),{ fileName : "ViewManager.hx", lineNumber : 213, className : "org.intermedia.view.ViewManager", methodName : "onLoadingError"});
		haxe.Firebug.trace("Load error: " + Std.string(error),{ fileName : "ViewManager.hx", lineNumber : 214, className : "org.intermedia.view.ViewManager", methodName : "onLoadingError"});
	}
