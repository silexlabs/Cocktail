...
class UIEvent_obj : public ::cocktail::core::event::Event_obj{
	public:
		...
		UIEvent_obj();
		Void __construct(::String type,::cocktail::core::html::HTMLElement target,double detail);

	public:
		static hx::ObjectPtr< UIEvent_obj > __new(::String type,::cocktail::core::html::HTMLElement target,double detail);
