...
Void ApplicationMain_obj::main( ){
{
		...
		::nme::Lib_obj::setPackage(HX_CSTRING("Silex Labs"),HX_CSTRING("MyApplication"),HX_CSTRING("org.text.demo"),HX_CSTRING("1.0.0"));
		...
		Void run(){
{
		...
		::nme::Lib_obj::create( Dynamic(new _Function_1_1()),(int)1024,(int)768,(int)30,(int)16777215,(int((int((int((int((int((int(::nme::Lib_obj::HARDWARE) | int(::nme::Lib_obj::RESIZABLE))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0)),HX_CSTRING("Cocktail text test"),null());
	}
return null();
}
