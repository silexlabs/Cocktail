...
Void MouseEvent_obj::__construct(::String type,::cocktail::core::html::HTMLElement target,double detail,double screenX,double screenY,double clientX,double clientY,bool ctrlKey,bool shiftKey,bool altKey)
{
{
...
hx::ObjectPtr< MouseEvent_obj > MouseEvent_obj::__new(::String type,::cocktail::core::html::HTMLElement target,double detail,double screenX,double screenY,double clientX,double clientY,bool ctrlKey,bool shiftKey,bool altKey)
