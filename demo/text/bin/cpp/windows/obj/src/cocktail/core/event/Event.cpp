...
Void Event_obj::preventDefault( ){
{
		...
		HX_SOURCE_POS("../../src/cocktail/core/event/Event.hx",87)
...
bool Event_obj::get_defaultPrevented( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/event/Event.hx",96)
...
::String Event_obj::get_type( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/event/Event.hx",101)
	return this->_type;
}
...
::cocktail::core::event::IEventTarget Event_obj::get_target( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/event/Event.hx",106)
	return this->_target;
}
