...
Void AbstractMouse_obj::__construct(::cocktail::core::html::HTMLElement htmlElement)
{
{
...
hx::ObjectPtr< AbstractMouse_obj > AbstractMouse_obj::__new(::cocktail::core::html::HTMLElement htmlElement)
