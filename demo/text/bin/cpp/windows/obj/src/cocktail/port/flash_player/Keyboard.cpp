...
Void Keyboard_obj::__construct(::cocktail::core::html::HTMLElement htmlElement)
{
{
...
hx::ObjectPtr< Keyboard_obj > Keyboard_obj::__new(::cocktail::core::html::HTMLElement htmlElement)
