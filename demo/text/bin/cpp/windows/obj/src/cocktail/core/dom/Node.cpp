...
::cocktail::core::dom::Node Node_obj::appendChild( ::cocktail::core::dom::Node newChild){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",221)
	this->removeFromParentIfNecessary(newChild);
	HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",223)
	newChild->set_parentNode(hx::ObjectPtr<OBJ_>(this));
	HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",224)
	this->_childNodes->push(newChild);
	HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",226)
	return newChild;
}
...
::cocktail::core::dom::Node Node_obj::insertBefore( ::cocktail::core::dom::Node newChild,::cocktail::core::dom::Node refChild){
	...
	if (((refChild == null()))){
		HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",244)
		this->appendChild(newChild);
	}
	else{
		HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",249)
		this->removeFromParentIfNecessary(newChild);
		HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",251)
		Array< ::cocktail::core::dom::Node > newChildNodes = Array_obj< ::cocktail::core::dom::Node >::__new();
		HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",253)
		{
			HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",253)
			int _g1 = (int)0;
			int _g = this->_childNodes->length;
			...
			while(((_g1 < _g))){
				HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",253)
				int i = (_g1)++;
				HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",255)
				if (((this->_childNodes->__get(i) == refChild))){
					HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",256)
					newChildNodes->push(newChild);
				}
				HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",259)
				newChildNodes->push(this->_childNodes->__get(i));
			}
		}
		HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",262)
		this->_childNodes = newChildNodes;
	}
	HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",265)
	return newChild;
}
...
::cocktail::core::dom::Node Node_obj::replaceChild( ::cocktail::core::dom::Node newChild,::cocktail::core::dom::Node oldChild){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",281)
	Array< ::cocktail::core::dom::Node > newChildNodes = Array_obj< ::cocktail::core::dom::Node >::__new();
	HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",283)
	{
		HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",283)
		int _g1 = (int)0;
		int _g = this->_childNodes->length;
		...
		while(((_g1 < _g))){
			HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",283)
			int i = (_g1)++;
			HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",285)
			if (((this->_childNodes->__get(i) == oldChild))){
				HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",286)
				newChildNodes->push(newChild);
			}
			else{
				HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",290)
				newChildNodes->push(this->_childNodes->__get(i));
			}
		}
	}
	HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",295)
	this->_childNodes = newChildNodes;
	HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",297)
	return oldChild;
}
...
bool Node_obj::hasChildNodes( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",322)
...
bool Node_obj::hasAttributes( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",331)
	return false;
}
...
Void Node_obj::removeFromParentIfNecessary( ::cocktail::core::dom::Node newChild){
{
		...
		HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",344)
		if (((newChild->get_parentNode() != null()))){
			HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",347)
			::cocktail::core::dom::Node parentNode = newChild->get_parentNode();
			HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",348)
...
::cocktail::core::dom::Node Node_obj::get_firstChild( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",357)
	if (((this->hasChildNodes() == true))){
		HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",359)
...
::cocktail::core::dom::Node Node_obj::get_lastChild( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",369)
	if (((this->hasChildNodes() == true))){
		HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",371)
		return this->_childNodes->__get((this->_childNodes->length - (int)1));
	}
	else{
		HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",375)
		return null();
	}
}
...
::cocktail::core::dom::Node Node_obj::get_nextSibling( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",384)
	if (((this->_parentNode == null()))){
		HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",385)
		return null();
	}
	else{
		HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",389)
		if (((this->_parentNode->get_lastChild() != hx::ObjectPtr<OBJ_>(this)))){
			HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",393)
			int _g1 = (int)0;
			...
			while(((_g1 < _g))){
				HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",393)
				int i = (_g1)++;
				HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",395)
...
::cocktail::core::dom::Node Node_obj::get_previousSibling( ){
	...
	if (((this->_parentNode == null()))){
		...
		HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",416)
		if (((this->_parentNode->get_firstChild() != hx::ObjectPtr<OBJ_>(this)))){
			HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",418)
			int _g1 = (int)0;
			int _g = this->_parentNode->get_childNodes()->length;
			HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",418)
			while(((_g1 < _g))){
				HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",418)
				int i = (_g1)++;
				HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",420)
				if (((this->isSameNode(this->_parentNode->get_childNodes()->__get(i)) == true))){
					HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",421)
					return this->_parentNode->get_childNodes()->__get((i - (int)1));
				}
			}
		}
	}
	HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",427)
	return null();
}
...
int Node_obj::get_nodeType( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",431)
	return (int)-1;
}
...
::cocktail::core::dom::Node Node_obj::get_parentNode( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",436)
...
::cocktail::core::dom::Node Node_obj::set_parentNode( ::cocktail::core::dom::Node value){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",441)
...
Array< ::cocktail::core::dom::Node > Node_obj::get_childNodes( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",446)
...
::String Node_obj::get_nodeValue( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",451)
	return null();
}
...
::String Node_obj::set_nodeValue( ::String value){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",457)
	if (((value != null()))){
...
::String Node_obj::get_nodeName( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",467)
	return null();
}
...
::cocktail::core::dom::NamedNodeMap Node_obj::get_attributes( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",472)
	return null();
}
...
::cocktail::core::dom::Document Node_obj::get_ownerDocument( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",477)
...
::cocktail::core::dom::Document Node_obj::set_ownerDocument( ::cocktail::core::dom::Document value){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/Node.hx",482)
