...
{
{
	HX_SOURCE_POS("../../src/cocktail/core/background/InitialBlockBackgroundManager.hx",37)
	super::__construct();
}
;
	return null();
...
Dynamic InitialBlockBackgroundManager_obj::getBackgroundPaintingBox( Dynamic computedBackgroundBox){
	...
	HX_SOURCE_POS("../../src/cocktail/core/background/InitialBlockBackgroundManager.hx",49)
...
Dynamic InitialBlockBackgroundManager_obj::getBackgroundPositioningBox( Dynamic computedPositioningBox){
	...
	HX_SOURCE_POS("../../src/cocktail/core/background/InitialBlockBackgroundManager.hx",57)
	return this->getWindowRectangleData();
}
...
Dynamic InitialBlockBackgroundManager_obj::getWindowRectangleData( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/background/InitialBlockBackgroundManager.hx",70)
	double windowWidth = ::cocktail::Lib_obj::get_window()->get_innerWidth();
	HX_SOURCE_POS("../../src/cocktail/core/background/InitialBlockBackgroundManager.hx",71)
	...
	HX_SOURCE_POS("../../src/cocktail/core/background/InitialBlockBackgroundManager.hx",73)
	Dynamic window = _Function_1_1::Block(windowWidth,windowHeight);
	HX_SOURCE_POS("../../src/cocktail/core/background/InitialBlockBackgroundManager.hx",79)
	return window;
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.background.InitialBlockBackgroundManager"), hx::TCanCast< InitialBlockBackgroundManager_obj> ,sStaticFields,sMemberFields,
