...
{
{
	HX_SOURCE_POS("../../src/cocktail/core/dom/NamedNodeMap.hx",33)
...
::cocktail::core::dom::Node NamedNodeMap_obj::getNamedItem( ::String name){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/NamedNodeMap.hx",50)
	{
		HX_SOURCE_POS("../../src/cocktail/core/dom/NamedNodeMap.hx",50)
		int _g1 = (int)0;
		...
		while(((_g1 < _g))){
			...
			if (((this->_nodes->__get(i)->get_nodeName() == name))){
				HX_SOURCE_POS("../../src/cocktail/core/dom/NamedNodeMap.hx",53)
				return this->_nodes->__get(i);
			}
		}
	}
	HX_SOURCE_POS("../../src/cocktail/core/dom/NamedNodeMap.hx",58)
	return null();
}
...
::cocktail::core::dom::Node NamedNodeMap_obj::setNamedItem( ::cocktail::core::dom::Node arg){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/NamedNodeMap.hx",78)
	...
	if (((replacedNode != null()))){
		...
		while(((_g1 < _g))){
			...
			if (((this->_nodes->__get(i)->isSameNode(replacedNode) == true))){
				...
				this->_nodes[i] = arg;
				HX_SOURCE_POS("../../src/cocktail/core/dom/NamedNodeMap.hx",87)
				return replacedNode;
			}
		}
	}
	else{
		HX_SOURCE_POS("../../src/cocktail/core/dom/NamedNodeMap.hx",92)
		this->_nodes->push(arg);
	}
	HX_SOURCE_POS("../../src/cocktail/core/dom/NamedNodeMap.hx",96)
	return replacedNode;
}
...
::cocktail::core::dom::Node NamedNodeMap_obj::removeNamedItem( ::String name){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/NamedNodeMap.hx",114)
	::cocktail::core::dom::Node removedNode = this->getNamedItem(name);
	HX_SOURCE_POS("../../src/cocktail/core/dom/NamedNodeMap.hx",116)
	if (((removedNode == null()))){
		HX_SOURCE_POS("../../src/cocktail/core/dom/NamedNodeMap.hx",117)
		return null();
	}
	HX_SOURCE_POS("../../src/cocktail/core/dom/NamedNodeMap.hx",121)
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/NamedNodeMap.hx",123)
	{
		...
		while(((_g1 < _g))){
			...
			if (((this->_nodes->__get(i)->isSameNode(removedNode) == false))){
				HX_SOURCE_POS("../../src/cocktail/core/dom/NamedNodeMap.hx",126)
				newNodes->push(this->_nodes->__get(i));
			}
		}
	}
	HX_SOURCE_POS("../../src/cocktail/core/dom/NamedNodeMap.hx",131)
...
::cocktail::core::dom::Node NamedNodeMap_obj::item( int index){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/NamedNodeMap.hx",146)
	if (((index > (this->get_length() - (int)1)))){
		HX_SOURCE_POS("../../src/cocktail/core/dom/NamedNodeMap.hx",148)
		return null();
	}
	else{
		HX_SOURCE_POS("../../src/cocktail/core/dom/NamedNodeMap.hx",152)
...
int NamedNodeMap_obj::get_length( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/NamedNodeMap.hx",162)
