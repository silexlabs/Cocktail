...
Void UIEvent_obj::__construct(::String type,::cocktail::core::html::HTMLElement target,double detail)
{
{
...
hx::ObjectPtr< UIEvent_obj > UIEvent_obj::__new(::String type,::cocktail::core::html::HTMLElement target,double detail)
