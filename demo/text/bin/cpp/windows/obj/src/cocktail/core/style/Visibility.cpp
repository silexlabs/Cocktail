...
::cocktail::core::style::Visibility Visibility_obj::hidden;

::cocktail::core::style::Visibility Visibility_obj::visible;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.style.Visibility"), hx::TCanCast< Visibility_obj >,sStaticFields,sMemberFields,
