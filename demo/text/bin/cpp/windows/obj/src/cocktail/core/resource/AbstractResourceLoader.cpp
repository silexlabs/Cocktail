...
Void AbstractResourceLoader_obj::load( Array< ::String > urls,Dynamic onLoadComplete,Dynamic onLoadError){
{
		...
		HX_SOURCE_POS("../../src/cocktail/core/resource/AbstractResourceLoader.hx",67)
		this->_onLoadCompleteCallback = onLoadComplete;
		HX_SOURCE_POS("../../src/cocktail/core/resource/AbstractResourceLoader.hx",68)
...
Void AbstractResourceLoader_obj::onLoadError( ::String msg){
{
		...
		HX_SOURCE_POS("../../src/cocktail/core/resource/AbstractResourceLoader.hx",113)
		(this->_urlToLoadIdx)++;
		HX_SOURCE_POS("../../src/cocktail/core/resource/AbstractResourceLoader.hx",114)
		if (((this->_urlToLoadIdx < (this->_urls->length - (int)1)))){
			HX_SOURCE_POS("../../src/cocktail/core/resource/AbstractResourceLoader.hx",115)
			this->doLoad(this->_urls->__get(this->_urlToLoadIdx));
		}
		else{
			HX_SOURCE_POS("../../src/cocktail/core/resource/AbstractResourceLoader.hx",119)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.resource.AbstractResourceLoader"), hx::TCanCast< AbstractResourceLoader_obj> ,sStaticFields,sMemberFields,
