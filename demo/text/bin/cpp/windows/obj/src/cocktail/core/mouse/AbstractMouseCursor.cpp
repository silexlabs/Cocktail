...
{
{
	HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouseCursor.hx",34)
	this->_nativeMouseCursor = ::cocktail::core::mouse::MouseCursorValue_obj::cssAuto_dyn();
}
;
	return null();
}
...
::cocktail::core::mouse::MouseCursorValue AbstractMouseCursor_obj::setNativeMouseCursor( ::cocktail::core::mouse::MouseCursorValue value){
	HX_SOURCE_PUSH("AbstractMouseCursor_obj::setNativeMouseCursor")
	HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouseCursor.hx",47)
	this->_nativeMouseCursor = value;
	HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouseCursor.hx",49)
	{
::cocktail::core::mouse::MouseCursorValue _switch_1 = (value);
		switch((_switch_1)->GetIndex()){
			case 0: {
				Dynamic hotSpot = _switch_1->__Param(1);
				::cocktail::core::html::HTMLImageElement imageHTMLElement = _switch_1->__Param(0);
{
					HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouseCursor.hx",54)
					this->setBitmapCursor(imageHTMLElement,hotSpot);
				}
			}
			;break;
			case 1: {
				HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouseCursor.hx",58)
				this->setDefaultCursor();
			}
			;break;
			case 2: {
				HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouseCursor.hx",62)
				this->hideCursor();
			}
			;break;
			case 3: {
				::cocktail::core::mouse::NativeOSMouseCursorValue nativeOSMouseCursor = _switch_1->__Param(0);
{
					HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouseCursor.hx",66)
	...
	HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouseCursor.hx",70)
...
::cocktail::core::mouse::MouseCursorValue AbstractMouseCursor_obj::getNativeMouseCursor( ){
	HX_SOURCE_PUSH("AbstractMouseCursor_obj::getNativeMouseCursor")
	HX_SOURCE_POS("../../src/cocktail/core/mouse/AbstractMouseCursor.hx",77)
	return this->_nativeMouseCursor;
}
...
Void AbstractMouseCursor_obj::setBitmapCursor( ::cocktail::core::html::HTMLImageElement imageHTMLElement,Dynamic hotSpot){
{
...
Void AbstractMouseCursor_obj::setNativeOSCursor( ::cocktail::core::mouse::NativeOSMouseCursorValue value){
{
...
Dynamic AbstractMouseCursor_obj::__SetField(const ::String &inName,const Dynamic &inValue)
{
	...
	case 17:
		...
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"_nativeMouseCursor") ) { _nativeMouseCursor=inValue.Cast< ::cocktail::core::mouse::MouseCursorValue >(); return inValue; }
	}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.mouse.AbstractMouseCursor"), hx::TCanCast< AbstractMouseCursor_obj> ,sStaticFields,sMemberFields,
