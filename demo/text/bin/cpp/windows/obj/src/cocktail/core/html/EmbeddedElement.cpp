...
{
{
	HX_SOURCE_POS("../../src/cocktail/core/html/EmbeddedElement.hx",67)
...
Void EmbeddedElement_obj::init( ){
{
		...
		HX_SOURCE_POS("../../src/cocktail/core/html/EmbeddedElement.hx",73)
		this->initEmbeddedAsset();
		HX_SOURCE_POS("../../src/cocktail/core/html/EmbeddedElement.hx",74)
		this->super::init();
	}
return null();
}
...
Void EmbeddedElement_obj::initCoreStyle( ){
{
		...
		HX_SOURCE_POS("../../src/cocktail/core/html/EmbeddedElement.hx",90)
...
HX_DEFINE_DYNAMIC_FUNC0(EmbeddedElement_obj,initCoreStyle,(void))

::cocktail::core::dom::Node EmbeddedElement_obj::appendChild( ::cocktail::core::dom::Node newChild){
	HX_SOURCE_PUSH("EmbeddedElement_obj::appendChild")
	HX_SOURCE_POS("../../src/cocktail/core/html/EmbeddedElement.hx",102)
	return newChild;
}
...
::cocktail::core::dom::Node EmbeddedElement_obj::removeChild( ::cocktail::core::dom::Node oldChild){
	HX_SOURCE_PUSH("EmbeddedElement_obj::removeChild")
	HX_SOURCE_POS("../../src/cocktail/core/html/EmbeddedElement.hx",111)
	return oldChild;
}
...
Dynamic EmbeddedElement_obj::get_embeddedAsset( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/html/EmbeddedElement.hx",120)
...
Dynamic EmbeddedElement_obj::get_intrinsicHeight( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/html/EmbeddedElement.hx",125)
...
Dynamic EmbeddedElement_obj::get_intrinsicWidth( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/html/EmbeddedElement.hx",130)
...
Dynamic EmbeddedElement_obj::get_intrinsicRatio( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/html/EmbeddedElement.hx",135)
...
int EmbeddedElement_obj::set_width( int value){
	...
	HX_SOURCE_POS("../../src/cocktail/core/html/EmbeddedElement.hx",140)
...
int EmbeddedElement_obj::get_width( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/html/EmbeddedElement.hx",145)
	return this->_width;
}
...
int EmbeddedElement_obj::set_height( int value){
	...
	HX_SOURCE_POS("../../src/cocktail/core/html/EmbeddedElement.hx",150)
...
int EmbeddedElement_obj::get_height( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/html/EmbeddedElement.hx",155)
	return this->_height;
}
