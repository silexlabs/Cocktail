...
{
{
	HX_SOURCE_POS("../../src/cocktail/core/dom/Attr.hx",64)
	this->_name = name;
	HX_SOURCE_POS("../../src/cocktail/core/dom/Attr.hx",65)
...
::String Attr_obj::get_nodeName( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/Attr.hx",74)
	return this->_name;
}
...
int Attr_obj::get_nodeType( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/Attr.hx",79)
	return (int)2;
}
...
::String Attr_obj::get_nodeValue( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/Attr.hx",84)
...
::String Attr_obj::set_nodeValue( ::String value){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/Attr.hx",89)
...
::cocktail::core::dom::Element Attr_obj::get_ownerElement( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/Attr.hx",98)
...
::cocktail::core::dom::Element Attr_obj::set_ownerElement( ::cocktail::core::dom::Element value){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/Attr.hx",103)
...
bool Attr_obj::get_isId( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/Attr.hx",108)
	return this->_isId;
}
...
bool Attr_obj::set_isId( bool value){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/Attr.hx",113)
...
::String Attr_obj::get_name( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/Attr.hx",118)
	return this->_name;
}
...
::String Attr_obj::get_value( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/Attr.hx",124)
	if (((this->_value == null()))){
		HX_SOURCE_POS("../../src/cocktail/core/dom/Attr.hx",125)
		return HX_CSTRING("");
	}
...
::String Attr_obj::set_value( ::String value){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/Attr.hx",133)
	this->_specified = true;
	HX_SOURCE_POS("../../src/cocktail/core/dom/Attr.hx",134)
...
bool Attr_obj::get_specified( ){
	...
	HX_SOURCE_POS("../../src/cocktail/core/dom/Attr.hx",138)
