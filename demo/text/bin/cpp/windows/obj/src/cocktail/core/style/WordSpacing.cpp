...
::cocktail::core::style::WordSpacing  WordSpacing_obj::length(::cocktail::core::unit::Length value)
	{ return hx::CreateEnum< WordSpacing_obj >(HX_CSTRING("length"),1,hx::DynamicArray(0,1).Add(value)); }

::cocktail::core::style::WordSpacing WordSpacing_obj::normal;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.style.WordSpacing"), hx::TCanCast< WordSpacing_obj >,sStaticFields,sMemberFields,
