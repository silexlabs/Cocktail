...
{
{
	HX_SOURCE_POS("../../src/cocktail/port/nme/FontManager.hx",53)
	super::__construct();
}
;
	return null();
...
Dynamic FontManager_obj::getFontMetrics( ::String fontFamily,double fontSize){
	...
	HX_SOURCE_POS("../../src/cocktail/port/nme/FontManager.hx",69)
	...
	HX_SOURCE_POS("../../src/cocktail/port/nme/FontManager.hx",72)
	...
	HX_SOURCE_POS("../../src/cocktail/port/nme/FontManager.hx",74)
	textFormat->font = fontFamily;
	HX_SOURCE_POS("../../src/cocktail/port/nme/FontManager.hx",76)
	textField->setTextFormat(textFormat,null(),null());
	HX_SOURCE_POS("../../src/cocktail/port/nme/FontManager.hx",78)
	...
	::haxe::Log_obj::trace(ascent,hx::SourceInfo(HX_CSTRING("FontManager.hx"),81,HX_CSTRING("cocktail.port.nme.FontManager"),HX_CSTRING("getFontMetrics")));
	HX_SOURCE_POS("../../src/cocktail/port/nme/FontManager.hx",82)
	textField->nmeSetText(HX_CSTRING(","));
	HX_SOURCE_POS("../../src/cocktail/port/nme/FontManager.hx",84)
	double descent = (double(textField->nmeGetTextHeight()) / double((int)2));
	HX_SOURCE_POS("../../src/cocktail/port/nme/FontManager.hx",86)
	textField->nmeSetText(HX_CSTRING("x"));
	HX_SOURCE_POS("../../src/cocktail/port/nme/FontManager.hx",88)
	...
	HX_SOURCE_POS("../../src/cocktail/port/nme/FontManager.hx",91)
	...
	HX_SOURCE_POS("../../src/cocktail/port/nme/FontManager.hx",104)
	return fontMetrics;
}
...
Dynamic FontManager_obj::createNativeTextElement( ::String text,Dynamic computedStyle){
	...
	HX_SOURCE_POS("../../src/cocktail/port/nme/FontManager.hx",113)
	::nme::text::TextField textField = ::nme::text::TextField_obj::__new();
	...
	HX_SOURCE_POS("../../src/cocktail/port/nme/FontManager.hx",119)
	return textField;
}
...
::String FontManager_obj::getNativeFontFamily( Array< ::String > value){
	...
	HX_SOURCE_POS("../../src/cocktail/port/nme/FontManager.hx",139)
	::String fontFamily = HX_CSTRING("");
	HX_SOURCE_POS("../../src/cocktail/port/nme/FontManager.hx",141)
	{
		HX_SOURCE_POS("../../src/cocktail/port/nme/FontManager.hx",141)
		int _g1 = (int)0;
		int _g = value->length;
		...
		while(((_g1 < _g))){
			HX_SOURCE_POS("../../src/cocktail/port/nme/FontManager.hx",141)
			int i = (_g1)++;
			HX_SOURCE_POS("../../src/cocktail/port/nme/FontManager.hx",143)
			::String fontName = value->__get(i);
			HX_SOURCE_POS("../../src/cocktail/port/nme/FontManager.hx",145)
			::String _switch_1 = (fontName);
			if (  ( _switch_1==HX_CSTRING("serif"))){
				HX_SOURCE_POS("../../src/cocktail/port/nme/FontManager.hx",147)
				fontName = HX_CSTRING("_serif");
			}
			else if (  ( _switch_1==HX_CSTRING("sans"))){
				HX_SOURCE_POS("../../src/cocktail/port/nme/FontManager.hx",150)
				fontName = HX_CSTRING("_sans");
			}
			else if (  ( _switch_1==HX_CSTRING("typewriter"))){
				HX_SOURCE_POS("../../src/cocktail/port/nme/FontManager.hx",153)
				fontName = HX_CSTRING("_typewriter");
			}
			HX_SOURCE_POS("../../src/cocktail/port/nme/FontManager.hx",157)
			hx::AddEq(fontFamily,fontName);
			HX_SOURCE_POS("../../src/cocktail/port/nme/FontManager.hx",159)
	...
	HX_SOURCE_POS("../../src/cocktail/port/nme/FontManager.hx",165)
	return fontFamily;
}
...
::nme::text::TextFormat FontManager_obj::getTextFormat( Dynamic computedStyle){
	...
	HX_SOURCE_POS("../../src/cocktail/port/nme/FontManager.hx",179)
	textFormat->size = computedStyle->__Field(HX_CSTRING("fontSize"));
	HX_SOURCE_POS("../../src/cocktail/port/nme/FontManager.hx",181)
	bool bold;
	HX_SOURCE_POS("../../src/cocktail/port/nme/FontManager.hx",183)
	{
::cocktail::core::style::FontWeight _switch_2 = (computedStyle->__Field(HX_CSTRING("fontWeight")));
		switch((_switch_2)->GetIndex()){
			case 3: case 0: case 4: case 5: case 6: case 7: {
				HX_SOURCE_POS("../../src/cocktail/port/nme/FontManager.hx",185)
				bold = false;
			}
			;break;
			case 1: case 2: case 8: case 9: case 10: case 11: case 12: {
				HX_SOURCE_POS("../../src/cocktail/port/nme/FontManager.hx",189)
				bold = true;
			}
			;break;
		}
	...
	HX_SOURCE_POS("../../src/cocktail/port/nme/FontManager.hx",195)
	...
	textFormat->letterSpacing = computedStyle->__Field(HX_CSTRING("letterSpacing"));
	HX_SOURCE_POS("../../src/cocktail/port/nme/FontManager.hx",199)
	textFormat->color = computedStyle->__Field(HX_CSTRING("color"))->__Field(HX_CSTRING("color"));
	HX_SOURCE_POS("../../src/cocktail/port/nme/FontManager.hx",200)
	return textFormat;
}
