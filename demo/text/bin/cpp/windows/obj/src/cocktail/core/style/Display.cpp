...
::cocktail::core::style::Display Display_obj::block;

::cocktail::core::style::Display Display_obj::cssInline;

::cocktail::core::style::Display Display_obj::inlineBlock;

::cocktail::core::style::Display Display_obj::none;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("cocktail.core.style.Display"), hx::TCanCast< Display_obj >,sStaticFields,sMemberFields,
