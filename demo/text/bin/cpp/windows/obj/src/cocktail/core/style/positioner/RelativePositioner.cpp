...
int RelativePositioner_obj::getLeftOffset( ::cocktail::core::html::HTMLElement htmlElement,int staticPosition){
...
int RelativePositioner_obj::getRightOffset( ::cocktail::core::html::HTMLElement htmlElement,int containingHTMLElementWidth,int staticPosition){
...
int RelativePositioner_obj::getTopOffset( ::cocktail::core::html::HTMLElement htmlElement,int staticPosition){
...
int RelativePositioner_obj::getBottomOffset( ::cocktail::core::html::HTMLElement htmlElement,int containingHTMLElementHeight,int staticPosition){
