	...
	HX_SOURCE_PUSH("CoreStyle_obj::invalidate");
{
		...
		if (((bool((this->_isDirty == false)) || bool((immediate == true))))){
			...
			if (((this->_htmlElement->get_parentNode() != null()))){
				...
				::cocktail::core::html::HTMLElement parent = this->_htmlElement->get_parentNode();
...
::cocktail::core::html::HTMLElement CoreStyle_obj::getFirstPositionedAncestor( ){
...
Dynamic CoreStyle_obj::getFirstPositionedAncestorData( ){
	...
	::cocktail::core::html::HTMLElement firstPositionedAncestor = this->getFirstPositionedAncestor();
...
::cocktail::core::html::HTMLElement CoreStyle_obj::get_htmlElement( ){
