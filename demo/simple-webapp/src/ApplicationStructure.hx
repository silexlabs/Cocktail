...
class ApplicationStructure 
{
	...
	private function createAllPages()
	{
		...
		_downloadPage = createHeaderListPage(
			...
			{text:"iOS app (Air)", imagePath:"images/chevron.png", action:"goToUrl", actionTarget:BASE_URL + "native_apps/WebApp_iOS_Air.ipa" },
			{text:"iOS app (PhoneGap)", imagePath:"images/chevron.png", action:"goToUrl", actionTarget:BASE_URL + "native_apps/WebApp_iOS_PhoneGap.ipa" },
