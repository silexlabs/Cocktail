...
{
HX_STACK_PUSH("Stdin::new","C:\\Motion-Twin\\Haxe/std/cpp/_std/sys/io/Process.hx",32);
{
	HX_STACK_LINE(33)
	this->p = p;
	HX_STACK_LINE(34)
...
int Stdin_obj::writeBytes( ::haxe::io::Bytes buf,int pos,int len){
	HX_STACK_PUSH("Stdin::writeBytes","C:\\Motion-Twin\\Haxe/std/cpp/_std/sys/io/Process.hx",47);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Stdin::writeByte","C:\\Motion-Twin\\Haxe/std/cpp/_std/sys/io/Process.hx",42);
		HX_STACK_THIS(this);
		HX_STACK_ARG(c,"c");
		HX_STACK_LINE(43)
		this->buf->b[(int)0] = c;
...
{
		HX_STACK_PUSH("Stdin::close","C:\\Motion-Twin\\Haxe/std/cpp/_std/sys/io/Process.hx",37);
		HX_STACK_THIS(this);
		HX_STACK_LINE(38)
		this->super::close();
		HX_STACK_LINE(39)
