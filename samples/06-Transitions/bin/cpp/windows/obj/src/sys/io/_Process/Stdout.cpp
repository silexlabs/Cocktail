...
{
HX_STACK_PUSH("Stdout::new","C:\\Motion-Twin\\Haxe/std/cpp/_std/sys/io/Process.hx",67);
{
	HX_STACK_LINE(68)
	this->p = p;
	HX_STACK_LINE(69)
...
int Stdout_obj::readBytes( ::haxe::io::Bytes str,int pos,int len){
	HX_STACK_PUSH("Stdout::readBytes","C:\\Motion-Twin\\Haxe/std/cpp/_std/sys/io/Process.hx",79);
	HX_STACK_THIS(this);
...
int Stdout_obj::readByte( ){
	HX_STACK_PUSH("Stdout::readByte","C:\\Motion-Twin\\Haxe/std/cpp/_std/sys/io/Process.hx",73);
	HX_STACK_THIS(this);
	HX_STACK_LINE(74)
