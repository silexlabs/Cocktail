...
{
HX_STACK_PUSH("HTMLBRElement::new","cocktail/core/html/HTMLBRElement.hx",28);
{
	HX_STACK_LINE(28)
...
bool HTMLBRElement_obj::isVoidElement( ){
	HX_STACK_PUSH("HTMLBRElement::isVoidElement","cocktail/core/html/HTMLBRElement.hx",42);
	HX_STACK_THIS(this);
	HX_STACK_LINE(42)
	return true;
}
