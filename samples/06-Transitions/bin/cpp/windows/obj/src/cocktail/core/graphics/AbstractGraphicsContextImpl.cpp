...
::neash::display::DisplayObjectContainer AbstractGraphicsContextImpl_obj::get_nativeLayer( ){
...
::neash::display::BitmapData AbstractGraphicsContextImpl_obj::get_nativeBitmapData( ){
...
Void AbstractGraphicsContextImpl_obj::copyPixels( ::neash::display::BitmapData bitmapData,::cocktail::core::geom::RectangleVO sourceRect,::cocktail::core::geom::PointVO destPoint,::cocktail::core::geom::RectangleVO clipRect){
{
...
Void AbstractGraphicsContextImpl_obj::drawImage( ::neash::display::BitmapData bitmapData,::cocktail::core::geom::Matrix matrix,::cocktail::core::geom::RectangleVO sourceRect,::cocktail::core::geom::RectangleVO clipRect){
{
...
Void AbstractGraphicsContextImpl_obj::attachToRoot( ::neash::display::DisplayObjectContainer rootLayer){
{
...
Dynamic AbstractGraphicsContextImpl_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 16:
		...
		if (HX_FIELD_EQ(inName,"nativeBitmapData") ) { nativeBitmapData=inValue.Cast< ::neash::display::BitmapData >(); return inValue; }
		break;
	case 19:
