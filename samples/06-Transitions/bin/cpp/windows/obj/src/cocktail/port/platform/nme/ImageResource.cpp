...
Void ImageResource_obj::setIntrinsicDimensions( ::neash::display::Loader loader){
{
		...
		HX_STACK_LINE(66)
		this->intrinsicHeight = ::Math_obj::round(loader->nmeGetHeight());
		HX_STACK_LINE(67)
		this->intrinsicWidth = ::Math_obj::round(loader->nmeGetWidth());
		HX_STACK_LINE(68)
...
Void ImageResource_obj::load( ::String url){
{
		...
		HX_STACK_LINE(39)
		::neash::display::BitmapData asset = ::nme::installer::Assets_obj::getBitmapData(url,null());		HX_STACK_VAR(asset,"asset");
		HX_STACK_LINE(43)
		if (((asset != null()))){
			HX_STACK_LINE(45)
			this->nativeResource = asset;
			HX_STACK_LINE(46)
			this->intrinsicHeight = asset->nmeGetHeight();
			HX_STACK_LINE(47)
			this->intrinsicWidth = asset->nmeGetWidth();
			HX_STACK_LINE(48)
			this->intrinsicRatio = (Float(this->intrinsicWidth) / Float(this->intrinsicHeight));
			HX_STACK_LINE(49)
			this->onLoadComplete();
