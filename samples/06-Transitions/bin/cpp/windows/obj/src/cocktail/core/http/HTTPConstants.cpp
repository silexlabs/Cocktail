...
{
HX_STACK_PUSH("HTTPConstants::new","cocktail/core/http/HTTPConstants.hx",152);
{
}
;
	return null();
...
Array< ::String > HTTPConstants_obj::FORM_SUBMIT_METHODS;

::String HTTPConstants_obj::URL_ENCODING;

::String HTTPConstants_obj::FORM_DATA;

::String HTTPConstants_obj::PLAIN_TEXT;

Array< ::String > HTTPConstants_obj::FORM_ENCODINGS;

::String HTTPConstants_obj::HTTP;

::String HTTPConstants_obj::HTTPS;
...
Dynamic HTTPConstants_obj::__Field(const ::String &inName,bool inCallProp)
{
	...
	case 4:
		...
		if (HX_FIELD_EQ(inName,"HTTP") ) { return HTTP; }
	...
	case 5:
		...
		if (HX_FIELD_EQ(inName,"HTTPS") ) { return HTTPS; }
	...
	case 8:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"FORM_DATA") ) { return FORM_DATA; }
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"PLAIN_TEXT") ) { return PLAIN_TEXT; }
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"URL_ENCODING") ) { return URL_ENCODING; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"TYPE_DOCUMENT") ) { return TYPE_DOCUMENT; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"FORM_ENCODINGS") ) { return FORM_ENCODINGS; }
	...
	case 17:
		...
		break;
	case 19:
		if (HX_FIELD_EQ(inName,"FORM_SUBMIT_METHODS") ) { return FORM_SUBMIT_METHODS; }
		break;
	case 25:
...
Dynamic HTTPConstants_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 4:
		...
		if (HX_FIELD_EQ(inName,"HTTP") ) { HTTP=inValue.Cast< ::String >(); return inValue; }
	...
	case 5:
		...
		if (HX_FIELD_EQ(inName,"HTTPS") ) { HTTPS=inValue.Cast< ::String >(); return inValue; }
	...
	case 8:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"FORM_DATA") ) { FORM_DATA=inValue.Cast< ::String >(); return inValue; }
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"PLAIN_TEXT") ) { PLAIN_TEXT=inValue.Cast< ::String >(); return inValue; }
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"URL_ENCODING") ) { URL_ENCODING=inValue.Cast< ::String >(); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"TYPE_DOCUMENT") ) { TYPE_DOCUMENT=inValue.Cast< ::String >(); return inValue; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"FORM_ENCODINGS") ) { FORM_ENCODINGS=inValue.Cast< Array< ::String > >(); return inValue; }
	...
	case 17:
		...
		break;
	case 19:
		if (HX_FIELD_EQ(inName,"FORM_SUBMIT_METHODS") ) { FORM_SUBMIT_METHODS=inValue.Cast< Array< ::String > >(); return inValue; }
		break;
	case 25:
...
static ::String sStaticFields[] = {
	...
	HX_CSTRING("TRACE"),
	HX_CSTRING("TRACK"),
	HX_CSTRING("FORM_SUBMIT_METHODS"),
	HX_CSTRING("URL_ENCODING"),
	HX_CSTRING("FORM_DATA"),
	HX_CSTRING("PLAIN_TEXT"),
	HX_CSTRING("FORM_ENCODINGS"),
	HX_CSTRING("HTTP"),
	HX_CSTRING("HTTPS"),
...
static void sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(HTTPConstants_obj::FORM_SUBMIT_METHODS,"FORM_SUBMIT_METHODS");
	HX_MARK_MEMBER_NAME(HTTPConstants_obj::URL_ENCODING,"URL_ENCODING");
	HX_MARK_MEMBER_NAME(HTTPConstants_obj::FORM_DATA,"FORM_DATA");
	HX_MARK_MEMBER_NAME(HTTPConstants_obj::PLAIN_TEXT,"PLAIN_TEXT");
	HX_MARK_MEMBER_NAME(HTTPConstants_obj::FORM_ENCODINGS,"FORM_ENCODINGS");
	HX_MARK_MEMBER_NAME(HTTPConstants_obj::HTTP,"HTTP");
	HX_MARK_MEMBER_NAME(HTTPConstants_obj::HTTPS,"HTTPS");
...
static void sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(HTTPConstants_obj::FORM_SUBMIT_METHODS,"FORM_SUBMIT_METHODS");
	HX_VISIT_MEMBER_NAME(HTTPConstants_obj::URL_ENCODING,"URL_ENCODING");
	HX_VISIT_MEMBER_NAME(HTTPConstants_obj::FORM_DATA,"FORM_DATA");
	HX_VISIT_MEMBER_NAME(HTTPConstants_obj::PLAIN_TEXT,"PLAIN_TEXT");
	HX_VISIT_MEMBER_NAME(HTTPConstants_obj::FORM_ENCODINGS,"FORM_ENCODINGS");
	HX_VISIT_MEMBER_NAME(HTTPConstants_obj::HTTP,"HTTP");
	HX_VISIT_MEMBER_NAME(HTTPConstants_obj::HTTPS,"HTTPS");
...
void HTTPConstants_obj::__boot()
{
	...
	FORM_SUBMIT_METHODS= Array_obj< ::String >::__new().Add(HX_CSTRING("GET")).Add(HX_CSTRING("POST"));
	URL_ENCODING= HX_CSTRING("application/x-www-form-urlencoded");
	FORM_DATA= HX_CSTRING("multipart/form-data");
	PLAIN_TEXT= HX_CSTRING("text/plain");
	FORM_ENCODINGS= Array_obj< ::String >::__new().Add(HX_CSTRING("application/x-www-form-urlencoded")).Add(HX_CSTRING("multipart/form-data")).Add(HX_CSTRING("text/plain"));
	HTTP= HX_CSTRING("http");
	HTTPS= HX_CSTRING("https");
