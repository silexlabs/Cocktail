...
Float NativeAudio_obj::get_currentTime( ){
	...
	HX_STACK_THIS(this);
	HX_STACK_LINE(248)
	return (Float(this->_soundChannel->nmeGetPosition()) / Float((int)1000));
}
...
Float NativeAudio_obj::get_duration( ){
	...
	HX_STACK_THIS(this);
	HX_STACK_LINE(239)
	return (Float(this->_sound->nmeGetLength()) / Float((int)1000));
}
...
Float NativeAudio_obj::set_volume( Float value){
	...
	if (((this->_soundChannel != null()))){
		HX_STACK_LINE(217)
		this->_soundChannel->nmeSetTransform(::neash::media::SoundTransform_obj::__new(value,(int)0));
	}
	HX_STACK_LINE(221)
	return value;
}
...
Void NativeAudio_obj::onIOError( ::neash::events::IOErrorEvent e){
{
...
Void NativeAudio_obj::initSound( ::String src){
{
		...
		HX_STACK_LINE(181)
		this->_sound = ::neash::media::Sound_obj::__new(null(),null(),null());
		HX_STACK_LINE(184)
		this->_sound->addEventListener(::neash::events::Event_obj::ID3,this->onID3DataReceived_dyn(),null(),null(),null());
		HX_STACK_LINE(187)
		this->_sound->addEventListener(::neash::events::Event_obj::COMPLETE,this->onID3DataReceived_dyn(),null(),null(),null());
		HX_STACK_LINE(189)
		this->_sound->addEventListener(::neash::events::IOErrorEvent_obj::IO_ERROR,this->onIOError_dyn(),null(),null(),null());
		HX_STACK_LINE(191)
		this->_sound->load(::neash::net::URLRequest_obj::__new(src),null(),null());
	}
return null();
}
...
Void NativeAudio_obj::onID3DataReceived( ::neash::events::Event event){
{
		...
		HX_STACK_LINE(168)
		this->_sound->removeEventListener(::neash::events::Event_obj::ID3,this->onID3DataReceived_dyn(),null());
		HX_STACK_LINE(169)
		this->_sound->removeEventListener(::neash::events::Event_obj::COMPLETE,this->onID3DataReceived_dyn(),null());
	}
return null();
}
...
Void NativeAudio_obj::seek( Float time){
{
		...
		if (((this->_isPlaying == true))){
			HX_STACK_LINE(126)
			this->_soundChannel = this->_sound->play((time * (int)1000),(int)0,::neash::media::SoundTransform_obj::__new(this->volume,(int)0));
		}
		else{
			HX_STACK_LINE(137)
...
Void NativeAudio_obj::pause( ){
{
		...
		if (((this->_soundChannel != null()))){
			HX_STACK_LINE(100)
			this->_currentTime = this->_soundChannel->nmeGetPosition();
			HX_STACK_LINE(101)
			this->_soundChannel->stop();
		}
	}
...
Dynamic NativeAudio_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"_sound") ) { _sound=inValue.Cast< ::neash::media::Sound >(); return inValue; }
		break;
	case 10:
	...
	case 13:
		...
		if (HX_FIELD_EQ(inName,"_soundChannel") ) { _soundChannel=inValue.Cast< ::neash::media::SoundChannel >(); return inValue; }
	}
