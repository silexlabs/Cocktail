...
{
HX_STACK_PUSH("DOMException::new","cocktail/core/dom/DOMException.hx",123);
{
}
;
	return null();
...
int DOMException_obj::SECURITY_ERR;
...
void DOMException_obj::__Visit(HX_VISIT_PARAMS)
{
}

Dynamic DOMException_obj::__Field(const ::String &inName,bool inCallProp)
{
	...
	case 10:
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"SECURITY_ERR") ) { return SECURITY_ERR; }
		break;
	case 13:
...
Dynamic DOMException_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 10:
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"SECURITY_ERR") ) { SECURITY_ERR=inValue.Cast< int >(); return inValue; }
		break;
	case 13:
...
static void sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(DOMException_obj::__mClass,"__mClass");
	...
	HX_MARK_MEMBER_NAME(DOMException_obj::SECURITY_ERR,"SECURITY_ERR");
	HX_MARK_MEMBER_NAME(DOMException_obj::TYPE_MISMATCH_ERR,"TYPE_MISMATCH_ERR");
};

static void sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(DOMException_obj::__mClass,"__mClass");
	HX_VISIT_MEMBER_NAME(DOMException_obj::INDEX_SIZE_ERR,"INDEX_SIZE_ERR");
	HX_VISIT_MEMBER_NAME(DOMException_obj::DOMSTRING_SIZE_ERR,"DOMSTRING_SIZE_ERR");
	HX_VISIT_MEMBER_NAME(DOMException_obj::HIERARCHY_REQUEST_ERR,"HIERARCHY_REQUEST_ERR");
	HX_VISIT_MEMBER_NAME(DOMException_obj::WRONG_DOCUMENT_ERR,"WRONG_DOCUMENT_ERR");
	HX_VISIT_MEMBER_NAME(DOMException_obj::INVALID_CHARACTER_ERR,"INVALID_CHARACTER_ERR");
	HX_VISIT_MEMBER_NAME(DOMException_obj::NO_DATA_ALLOWED_ERR,"NO_DATA_ALLOWED_ERR");
	HX_VISIT_MEMBER_NAME(DOMException_obj::NO_MODIFICATION_ALLOWED_ERR,"NO_MODIFICATION_ALLOWED_ERR");
	HX_VISIT_MEMBER_NAME(DOMException_obj::NOT_FOUND_ERR,"NOT_FOUND_ERR");
	HX_VISIT_MEMBER_NAME(DOMException_obj::NOT_SUPPORTED_ERR,"NOT_SUPPORTED_ERR");
	HX_VISIT_MEMBER_NAME(DOMException_obj::INUSE_ATTRIBUTE_ERR,"INUSE_ATTRIBUTE_ERR");
	HX_VISIT_MEMBER_NAME(DOMException_obj::INVALID_STATE_ERR,"INVALID_STATE_ERR");
	HX_VISIT_MEMBER_NAME(DOMException_obj::SYNTAX_ERR,"SYNTAX_ERR");
	HX_VISIT_MEMBER_NAME(DOMException_obj::INVALID_MODIFICATION_ERR,"INVALID_MODIFICATION_ERR");
	HX_VISIT_MEMBER_NAME(DOMException_obj::NAMESPACE_ERR,"NAMESPACE_ERR");
	HX_VISIT_MEMBER_NAME(DOMException_obj::INVALID_ACCESS_ERR,"INVALID_ACCESS_ERR");
	HX_VISIT_MEMBER_NAME(DOMException_obj::VALIDATION_ERR,"VALIDATION_ERR");
	HX_VISIT_MEMBER_NAME(DOMException_obj::SECURITY_ERR,"SECURITY_ERR");
	HX_VISIT_MEMBER_NAME(DOMException_obj::TYPE_MISMATCH_ERR,"TYPE_MISMATCH_ERR");
};
