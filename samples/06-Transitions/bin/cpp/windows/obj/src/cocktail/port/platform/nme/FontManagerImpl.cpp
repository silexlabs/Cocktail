...
::neash::text::TextFormat FontManagerImpl_obj::getTextFormat( ::cocktail::core::css::CoreStyle style,::String fontFamily){
	...
	HX_STACK_LINE(167)
	::neash::text::TextFormat textFormat = ::neash::text::TextFormat_obj::__new(null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null());		HX_STACK_VAR(textFormat,"textFormat");
	HX_STACK_LINE(168)
...
Dynamic FontManagerImpl_obj::createNativeTextElement( ::String text,::cocktail::core::css::CoreStyle style,::String fontFamily){
	...
	HX_STACK_ARG(fontFamily,"fontFamily");
	HX_STACK_LINE(105)
	::neash::text::TextField textField = ::neash::text::TextField_obj::__new();		HX_STACK_VAR(textField,"textField");
	HX_STACK_LINE(106)
	textField->nmeSetText(text);
	HX_STACK_LINE(107)
	textField->nmeSetSelectable(false);
	HX_STACK_LINE(108)
	textField->nmeSetAutoSize(::neash::text::TextFieldAutoSize_obj::LEFT_dyn());
	HX_STACK_LINE(109)
...
::cocktail::core::font::FontMetricsVO FontManagerImpl_obj::getFontMetrics( ::String fontFamily,Float fontSize){
	...
	HX_STACK_LINE(84)
	Float ascent = (Float(textField->nmeGetHeight()) / Float((int)2));		HX_STACK_VAR(ascent,"ascent");
	HX_STACK_LINE(86)
	textField->nmeSetText(HX_CSTRING(","));
	HX_STACK_LINE(88)
	Float descent = (Float(textField->nmeGetHeight()) / Float((int)2));		HX_STACK_VAR(descent,"descent");
	HX_STACK_LINE(90)
	textField->nmeSetText(HX_CSTRING("x"));
	HX_STACK_LINE(92)
	Float xHeight = textField->nmeGetHeight();		HX_STACK_VAR(xHeight,"xHeight");
	HX_STACK_LINE(94)
	textField->nmeSetText(HX_CSTRING(" "));
	HX_STACK_LINE(95)
	Float spaceWidth = textField->nmeGetWidth();		HX_STACK_VAR(spaceWidth,"spaceWidth");
	HX_STACK_LINE(97)
