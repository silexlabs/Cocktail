...
Void ImageRenderer_obj::paintResource( ::cocktail::core::graphics::GraphicsContext graphicContext,::neash::display::BitmapData nativeBitmapData,::cocktail::core::geom::RectangleVO bounds,Float intrinsicWidth,Float intrinsicHeight,::cocktail::core::geom::RectangleVO clipRect){
{
