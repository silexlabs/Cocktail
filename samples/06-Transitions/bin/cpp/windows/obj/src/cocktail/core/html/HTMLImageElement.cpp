...
int HTMLImageElement_obj::get_naturalWidth( ){
	HX_STACK_PUSH("HTMLImageElement::get_naturalWidth","cocktail/core/html/HTMLImageElement.hx",234);
	HX_STACK_THIS(this);
	HX_STACK_LINE(235)
...
int HTMLImageElement_obj::get_naturalHeight( ){
	HX_STACK_PUSH("HTMLImageElement::get_naturalHeight","cocktail/core/html/HTMLImageElement.hx",225);
	HX_STACK_THIS(this);
	HX_STACK_LINE(226)
...
::String HTMLImageElement_obj::get_src( ){
	HX_STACK_PUSH("HTMLImageElement::get_src","cocktail/core/html/HTMLImageElement.hx",220);
	HX_STACK_THIS(this);
	HX_STACK_LINE(220)
...
{
		HX_STACK_PUSH("HTMLImageElement::onLoadError","cocktail/core/html/HTMLImageElement.hx",209);
		HX_STACK_THIS(this);
		HX_STACK_LINE(210)
...
Void HTMLImageElement_obj::onLoadComplete( ::cocktail::core::resource::AbstractResource resource){
{
		...
		HX_STACK_LINE(192)
		if (((bool((this->getAttributeNode(HX_CSTRING("height")) != null())) && bool((this->getAttributeNode(HX_CSTRING("width")) != null()))))){
			HX_STACK_LINE(193)
