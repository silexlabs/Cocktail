...
::String HTMLLinkElement_obj::set_type( ::String value){
	HX_STACK_PUSH("HTMLLinkElement::set_type","cocktail/core/html/HTMLLinkElement.hx",289);
	HX_STACK_THIS(this);
...
::String HTMLLinkElement_obj::get_type( ){
	HX_STACK_PUSH("HTMLLinkElement::get_type","cocktail/core/html/HTMLLinkElement.hx",284);
	HX_STACK_THIS(this);
	HX_STACK_LINE(284)
...
::String HTMLLinkElement_obj::set_hreflang( ::String value){
	HX_STACK_PUSH("HTMLLinkElement::set_hreflang","cocktail/core/html/HTMLLinkElement.hx",278);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(279)
...
::String HTMLLinkElement_obj::get_hreflang( ){
	HX_STACK_PUSH("HTMLLinkElement::get_hreflang","cocktail/core/html/HTMLLinkElement.hx",273);
	HX_STACK_THIS(this);
	HX_STACK_LINE(273)
	return this->getAttributeAsDOMString(HX_CSTRING("hreflang"));
}
...
::String HTMLLinkElement_obj::set_media( ::String value){
	HX_STACK_PUSH("HTMLLinkElement::set_media","cocktail/core/html/HTMLLinkElement.hx",267);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(268)
...
::String HTMLLinkElement_obj::get_media( ){
	HX_STACK_PUSH("HTMLLinkElement::get_media","cocktail/core/html/HTMLLinkElement.hx",262);
	HX_STACK_THIS(this);
	HX_STACK_LINE(262)
...
Array< ::String > HTMLLinkElement_obj::get_relList( ){
	HX_STACK_PUSH("HTMLLinkElement::get_relList","cocktail/core/html/HTMLLinkElement.hx",257);
	HX_STACK_THIS(this);
	HX_STACK_LINE(257)
...
::String HTMLLinkElement_obj::set_rel( ::String value){
	HX_STACK_PUSH("HTMLLinkElement::set_rel","cocktail/core/html/HTMLLinkElement.hx",250);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(251)
...
::String HTMLLinkElement_obj::get_rel( ){
	HX_STACK_PUSH("HTMLLinkElement::get_rel","cocktail/core/html/HTMLLinkElement.hx",245);
	HX_STACK_THIS(this);
	HX_STACK_LINE(245)
	return this->getAttributeAsDOMString(HX_CSTRING("rel"));
}
...
::String HTMLLinkElement_obj::set_href( ::String value){
	HX_STACK_PUSH("HTMLLinkElement::set_href","cocktail/core/html/HTMLLinkElement.hx",239);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(240)
...
::String HTMLLinkElement_obj::get_href( ){
	HX_STACK_PUSH("HTMLLinkElement::get_href","cocktail/core/html/HTMLLinkElement.hx",234);
	HX_STACK_THIS(this);
	HX_STACK_LINE(234)
...
bool HTMLLinkElement_obj::set_disabled( bool value){
	HX_STACK_PUSH("HTMLLinkElement::set_disabled","cocktail/core/html/HTMLLinkElement.hx",228);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(229)
