...
::neash::display::BitmapData TextInlineBox_obj::get_nativeTextBitmap( ){
...
Dynamic TextInlineBox_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 13:
		...
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"nativeTextBitmap") ) { nativeTextBitmap=inValue.Cast< ::neash::display::BitmapData >(); return inValue; }
	}
