...
::neash::ui::MultitouchInputMode MultitouchInputMode_obj::GESTURE;

::neash::ui::MultitouchInputMode MultitouchInputMode_obj::NONE;

::neash::ui::MultitouchInputMode MultitouchInputMode_obj::TOUCH_POINT;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("neash.ui.MultitouchInputMode"), hx::TCanCast< MultitouchInputMode_obj >,sStaticFields,sMemberFields,
