...
::neash::text::TextFieldType TextFieldType_obj::DYNAMIC;

::neash::text::TextFieldType TextFieldType_obj::INPUT;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("neash.text.TextFieldType"), hx::TCanCast< TextFieldType_obj >,sStaticFields,sMemberFields,
