...
{
HX_STACK_PUSH("TextEvent::new","neash/events/TextEvent.hx",14);
...
::String TextEvent_obj::toString( ){
	HX_STACK_PUSH("TextEvent::toString","neash/events/TextEvent.hx",27);
	HX_STACK_THIS(this);
	HX_STACK_LINE(27)
	return ((((((((HX_CSTRING("[TextEvent type=") + this->nmeGetType()) + HX_CSTRING(" bubbles=")) + ::Std_obj::string(this->nmeGetBubbles())) + HX_CSTRING(" cancelable=")) + ::Std_obj::string(this->nmeGetCancelable())) + HX_CSTRING(" text=")) + this->text) + HX_CSTRING("]"));
}


::neash::events::Event TextEvent_obj::clone( ){
	HX_STACK_PUSH("TextEvent::clone","neash/events/TextEvent.hx",21);
	HX_STACK_THIS(this);
	HX_STACK_LINE(21)
