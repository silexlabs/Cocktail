...
{
HX_STACK_PUSH("MouseEvent::new","neash/events/MouseEvent.hx",49);
...
{
		HX_STACK_PUSH("MouseEvent::updateAfterEvent","neash/events/MouseEvent.hx",100);
		HX_STACK_THIS(this);
	}
return null();
}
...
::neash::events::MouseEvent MouseEvent_obj::nmeCreateSimilar( ::String inType,::neash::display::InteractiveObject related,::neash::display::InteractiveObject targ){
	HX_STACK_PUSH("MouseEvent::nmeCreateSimilar","neash/events/MouseEvent.hx",82);
	HX_STACK_THIS(this);
...
::neash::events::Event MouseEvent_obj::clone( ){
	HX_STACK_PUSH("MouseEvent::clone","neash/events/MouseEvent.hx",65);
	HX_STACK_THIS(this);
	HX_STACK_LINE(65)
...
::neash::events::MouseEvent MouseEvent_obj::nmeCreate( ::String inType,Dynamic inEvent,::neash::geom::Point inLocal,::neash::display::InteractiveObject inTarget){
	HX_STACK_PUSH("MouseEvent::nmeCreate","neash/events/MouseEvent.hx",71);
	HX_STACK_ARG(inType,"inType");
