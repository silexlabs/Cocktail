...
{
HX_STACK_PUSH("ColorTransform::new","neash/geom/ColorTransform.hx",24);
...
int ColorTransform_obj::nmeSetColor( int value){
	HX_STACK_PUSH("ColorTransform::nmeSetColor","neash/geom/ColorTransform.hx",55);
	HX_STACK_THIS(this);
...
int ColorTransform_obj::nmeGetColor( ){
	HX_STACK_PUSH("ColorTransform::nmeGetColor","neash/geom/ColorTransform.hx",49);
	HX_STACK_THIS(this);
	HX_STACK_LINE(49)
...
{
		HX_STACK_PUSH("ColorTransform::concat","neash/geom/ColorTransform.hx",37);
		HX_STACK_THIS(this);
