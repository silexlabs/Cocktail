...
::neash::text::AntiAliasType AntiAliasType_obj::ADVANCED;

::neash::text::AntiAliasType AntiAliasType_obj::NORMAL;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("neash.text.AntiAliasType"), hx::TCanCast< AntiAliasType_obj >,sStaticFields,sMemberFields,
