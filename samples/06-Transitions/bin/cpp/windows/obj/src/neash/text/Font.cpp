...
{
HX_STACK_PUSH("Font::new","neash/text/Font.hx",17);
{
	HX_STACK_LINE(17)
...
Dynamic Font_obj::load( ::String inFilename){
	HX_STACK_PUSH("Font::load","neash/text/Font.hx",25);
	HX_STACK_ARG(inFilename,"inFilename");
	HX_STACK_LINE(27)
	Dynamic result = ::neash::text::Font_obj::freetype_import_font(inFilename,null(),(int)20480);		HX_STACK_VAR(result,"result");
	HX_STACK_LINE(28)
	return result;
}
...
{
	freetype_import_font= ::neash::Loader_obj::load(HX_CSTRING("freetype_import_font"),(int)3);
}
