...
{
HX_STACK_PUSH("TextFormat::new","neash/text/TextFormat.hx",29);
{
	HX_STACK_LINE(30)
	this->font = in_font;
	HX_STACK_LINE(31)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("neash.text.TextFormat"), hx::TCanCast< TextFormat_obj> ,sStaticFields,sMemberFields,
