...
{
HX_STACK_PUSH("IOErrorEvent::new","neash/events/IOErrorEvent.hx",11);
...
::String IOErrorEvent_obj::toString( ){
	HX_STACK_PUSH("IOErrorEvent::toString","neash/events/IOErrorEvent.hx",23);
	HX_STACK_THIS(this);
	HX_STACK_LINE(23)
	return ((((((((((HX_CSTRING("[IOErrorEvent type=") + this->nmeGetType()) + HX_CSTRING(" bubbles=")) + ::Std_obj::string(this->nmeGetBubbles())) + HX_CSTRING(" cancelable=")) + ::Std_obj::string(this->nmeGetCancelable())) + HX_CSTRING(" text=")) + this->text) + HX_CSTRING(" errorID=")) + this->errorID) + HX_CSTRING("]"));
}


::neash::events::Event IOErrorEvent_obj::clone( ){
	HX_STACK_PUSH("IOErrorEvent::clone","neash/events/IOErrorEvent.hx",17);
	HX_STACK_THIS(this);
	HX_STACK_LINE(17)
