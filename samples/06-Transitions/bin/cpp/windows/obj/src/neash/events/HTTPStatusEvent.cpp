...
{
HX_STACK_PUSH("HTTPStatusEvent::new","neash/events/HTTPStatusEvent.hx",12);
...
::String HTTPStatusEvent_obj::toString( ){
	HX_STACK_PUSH("HTTPStatusEvent::toString","neash/events/HTTPStatusEvent.hx",25);
	HX_STACK_THIS(this);
	HX_STACK_LINE(25)
	return ((((((((HX_CSTRING("[HTTPStatusEvent type=") + this->nmeGetType()) + HX_CSTRING(" bubbles=")) + ::Std_obj::string(this->nmeGetBubbles())) + HX_CSTRING(" cancelable=")) + ::Std_obj::string(this->nmeGetCancelable())) + HX_CSTRING(" status=")) + this->status) + HX_CSTRING("]"));
}


::neash::events::Event HTTPStatusEvent_obj::clone( ){
	HX_STACK_PUSH("HTTPStatusEvent::clone","neash/events/HTTPStatusEvent.hx",19);
	HX_STACK_THIS(this);
	HX_STACK_LINE(19)
