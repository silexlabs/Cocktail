...
::neash::text::TextFieldAutoSize TextFieldAutoSize_obj::CENTER;

::neash::text::TextFieldAutoSize TextFieldAutoSize_obj::LEFT;

::neash::text::TextFieldAutoSize TextFieldAutoSize_obj::NONE;

::neash::text::TextFieldAutoSize TextFieldAutoSize_obj::RIGHT;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("neash.text.TextFieldAutoSize"), hx::TCanCast< TextFieldAutoSize_obj >,sStaticFields,sMemberFields,
