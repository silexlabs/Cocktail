...
{
HX_STACK_PUSH("Tilesheet::new","neash/display/Tilesheet.hx",27);
{
	HX_STACK_LINE(28)
...
int flags = __o_flags.Default(0);
	HX_STACK_PUSH("Tilesheet::drawTiles","neash/display/Tilesheet.hx",59);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Tilesheet::addTileRect","neash/display/Tilesheet.hx",34);
		HX_STACK_THIS(this);
