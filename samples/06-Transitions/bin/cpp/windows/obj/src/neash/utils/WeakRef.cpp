...
{
HX_STACK_PUSH("WeakRef::new","neash/utils/WeakRef.hx",16);
...
::String WeakRef_obj::toString( ){
	HX_STACK_PUSH("WeakRef::toString","neash/utils/WeakRef.hx",46);
	HX_STACK_THIS(this);
	HX_STACK_LINE(47)
...
Dynamic WeakRef_obj::get( ){
	HX_STACK_PUSH("WeakRef::get","neash/utils/WeakRef.hx",31);
	HX_STACK_THIS(this);
	HX_STACK_LINE(32)
	if (((this->hardRef != null()))){
		HX_STACK_LINE(33)
	...
	HX_STACK_LINE(38)
	Dynamic result = ::neash::utils::WeakRef_obj::nme_weak_ref_get(this->weakRef);		HX_STACK_VAR(result,"result");
	HX_STACK_LINE(39)
	if (((result == null()))){
		HX_STACK_LINE(40)
		this->weakRef = (int)-1;
...
{
	nme_weak_ref_create= ::neash::Loader_obj::load(HX_CSTRING("nme_weak_ref_create"),(int)2);
	nme_weak_ref_get= ::neash::Loader_obj::load(HX_CSTRING("nme_weak_ref_get"),(int)1);
}
