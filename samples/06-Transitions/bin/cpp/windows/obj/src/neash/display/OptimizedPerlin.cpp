...
{
HX_STACK_PUSH("OptimizedPerlin::new","neash/display/BitmapData.hx",582);
...
{
		HX_STACK_PUSH("OptimizedPerlin::seedOffset","neash/display/BitmapData.hx",722);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("OptimizedPerlin::octFreqPers","neash/display/BitmapData.hx",703);
		HX_STACK_THIS(this);
...
Void OptimizedPerlin_obj::fill( ::neash::display::BitmapData bitmap,Float _x,Float _y,Float _z,Dynamic _){
{
		HX_STACK_PUSH("OptimizedPerlin::fill","neash/display/BitmapData.hx",590);
		HX_STACK_THIS(this);
		...
		HX_STACK_LINE(597)
		int width = bitmap->nmeGetWidth();		HX_STACK_VAR(width,"width");
		HX_STACK_LINE(598)
		int height = bitmap->nmeGetHeight();		HX_STACK_VAR(height,"height");
		HX_STACK_LINE(600)
		Array< int > p = ::neash::display::OptimizedPerlin_obj::P;		HX_STACK_VAR(p,"p");
		HX_STACK_LINE(601)
							...
							while(((_g2 < octaves))){
								...
								struct _Function_7_1{
									inline static Float Block( Float &y1,Float &x1,int &hash){
										HX_STACK_PUSH("*::closure","neash/display/BitmapData.hx",650);
										{
											HX_STACK_LINE(650)
								...
								struct _Function_7_3{
									inline static Float Block( Float &y1,int &hash,Float &x){
										HX_STACK_PUSH("*::closure","neash/display/BitmapData.hx",653);
										{
											HX_STACK_LINE(653)
								...
								struct _Function_7_5{
									inline static Float Block( Float &x1,Float &y,int &hash){
										HX_STACK_PUSH("*::closure","neash/display/BitmapData.hx",656);
										{
											HX_STACK_LINE(656)
								...
								struct _Function_7_7{
									inline static Float Block( Float &y,int &hash,Float &x){
										HX_STACK_PUSH("*::closure","neash/display/BitmapData.hx",659);
										{
											HX_STACK_LINE(659)
								...
								struct _Function_7_9{
									inline static Float Block( Float &y1,Float &x1,int &hash){
										HX_STACK_PUSH("*::closure","neash/display/BitmapData.hx",662);
										{
											HX_STACK_LINE(662)
											return (  (((hash < (int)8))) ? Float(x1) : Float(y1) );
										}
								...
								struct _Function_7_11{
									inline static Float Block( Float &y1,int &hash,Float &x){
										HX_STACK_PUSH("*::closure","neash/display/BitmapData.hx",665);
										{
											HX_STACK_LINE(665)
											return (  (((hash < (int)8))) ? Float(x) : Float(y1) );
										}
								...
								struct _Function_7_13{
									inline static Float Block( Float &x1,Float &y,int &hash){
										HX_STACK_PUSH("*::closure","neash/display/BitmapData.hx",668);
										{
											HX_STACK_LINE(668)
											return (  (((hash < (int)8))) ? Float(x1) : Float(y) );
										}
								...
								struct _Function_7_15{
									inline static Float Block( Float &y,int &hash,Float &x){
										HX_STACK_PUSH("*::closure","neash/display/BitmapData.hx",671);
										{
											HX_STACK_LINE(671)
											return (  (((hash < (int)8))) ? Float(x) : Float(y) );
										}
