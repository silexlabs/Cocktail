...
{
HX_STACK_PUSH("JoystickEvent::new","neash/events/JoystickEvent.hx",21);
...
::String JoystickEvent_obj::toString( ){
	HX_STACK_PUSH("JoystickEvent::toString","neash/events/JoystickEvent.hx",39);
	HX_STACK_THIS(this);
	HX_STACK_LINE(39)
	return ((((((((((((((((HX_CSTRING("[JoystickEvent type=") + this->nmeGetType()) + HX_CSTRING(" bubbles=")) + ::Std_obj::string(this->nmeGetBubbles())) + HX_CSTRING(" cancelable=")) + ::Std_obj::string(this->nmeGetCancelable())) + HX_CSTRING(" device=")) + this->device) + HX_CSTRING(" id=")) + this->id) + HX_CSTRING(" x=")) + this->x) + HX_CSTRING(" y=")) + this->y) + HX_CSTRING(" z=")) + this->z) + HX_CSTRING("]"));
}


::neash::events::Event JoystickEvent_obj::clone( ){
	HX_STACK_PUSH("JoystickEvent::clone","neash/events/JoystickEvent.hx",33);
	HX_STACK_THIS(this);
	HX_STACK_LINE(33)
