...
{
HX_STACK_PUSH("Listener::new","neash/events/EventDispatcher.hx",172);
{
	HX_STACK_LINE(173)
...
bool Listener_obj::Is( Dynamic inListener,bool inCapture){
	HX_STACK_PUSH("Listener::Is","neash/events/EventDispatcher.hx",187);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Listener::dispatchEvent","neash/events/EventDispatcher.hx",181);
		HX_STACK_THIS(this);
