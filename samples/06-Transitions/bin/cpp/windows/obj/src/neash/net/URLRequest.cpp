...
{
HX_STACK_PUSH("URLRequest::new","neash/net/URLRequest.hx",31);
{
	HX_STACK_LINE(32)
	if (((inURL != null()))){
		HX_STACK_LINE(33)
...
{
		HX_STACK_PUSH("URLRequest::nmePrepare","neash/net/URLRequest.hx",54);
		HX_STACK_THIS(this);
		HX_STACK_LINE(54)
...
{
		HX_STACK_PUSH("URLRequest::digestAuth","neash/net/URLRequest.hx",49);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("URLRequest::basicAuth","neash/net/URLRequest.hx",44);
		HX_STACK_THIS(this);
		HX_STACK_ARG(inUser,"inUser");
		HX_STACK_ARG(inPasswd,"inPasswd");
		HX_STACK_LINE(45)
