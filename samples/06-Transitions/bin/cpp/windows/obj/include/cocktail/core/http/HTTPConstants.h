...
class HTTPConstants_obj : public hx::Object{
	...
	public:
		...
		static Array< ::String > FORM_SUBMIT_METHODS; /* REM */ 
		static ::String URL_ENCODING; /* REM */ 
		static ::String FORM_DATA; /* REM */ 
		static ::String PLAIN_TEXT; /* REM */ 
		static Array< ::String > FORM_ENCODINGS; /* REM */ 
		static ::String HTTP; /* REM */ 
		static ::String HTTPS; /* REM */ 
