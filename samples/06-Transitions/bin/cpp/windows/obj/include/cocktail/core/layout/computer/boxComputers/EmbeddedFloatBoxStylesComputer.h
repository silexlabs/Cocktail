...
#define INCLUDED_cocktail_core_layout_computer_boxComputers_EmbeddedFloatBoxStylesComputer
...
class EmbeddedFloatBoxStylesComputer_obj : public ::cocktail::core::layout::computer::boxComputers::EmbeddedInlineBoxStylesComputer_obj{
	public:
...
#endif /* INCLUDED_cocktail_core_layout_computer_boxComputers_EmbeddedFloatBoxStylesComputer */ 
