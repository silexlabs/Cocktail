...
class HTMLConstants_obj : public hx::Object{
	...
	public:
		...
		static ::String HTML_BUTTON_TAG_NAME; /* REM */ 
		static ::String HTML_SELECT_TAG_NAME; /* REM */ 
		...
		static ::String HTML_READ_ONLY_ATTRIBUTE_NAME; /* REM */ 
		static ::String HTML_MAXLENGTH_ATTRIBUTE_NAME; /* REM */ 
		static ::String HTML_CONTENT_ATTRIBUTE_NAME; /* REM */ 
		static ::String HTML_ACTION_ATTRIBUTE_NAME; /* REM */ 
		static ::String HTML_ENCTYPE_ATTRIBUTE_NAME; /* REM */ 
		static ::String HTML_METHOD_ATTRIBUTE_NAME; /* REM */ 
		...
		static ::String INPUT_TYPE_HIDDEN; /* REM */ 
		static ::String INPUT_TYPE_TEXT; /* REM */ 
		static ::String INPUT_TYPE_PASSWORD; /* REM */ 
		static ::String INPUT_TYPE_CHECKBOX; /* REM */ 
		static ::String INPUT_TYPE_RADIO; /* REM */ 
		static ::String INPUT_TYPE_SUBMIT; /* REM */ 
		static ::String INPUT_TYPE_RESET; /* REM */ 
		static ::String INPUT_TYPE_BUTTON; /* REM */ 
		static ::String INPUT_TYPE_FILE; /* REM */ 
		static ::String INPUT_TYPE_IMAGE; /* REM */ 
		static Array< ::String > INPUT_TYPE_VALUES; /* REM */ 
		static ::String INPUT_RESET_LABEL; /* REM */ 
		static ::String INPUT_SUBMIT_LABEL; /* REM */ 
		static ::String RADIO_OR_CHECKBOX_ON; /* REM */ 
