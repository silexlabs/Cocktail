...
class NativeAudio_obj : public ::cocktail::port::base::NativeMedia_obj{
	...
	public:
		...
		virtual Void onIOError( ::neash::events::IOErrorEvent e);
		Dynamic onIOError_dyn();

		virtual Void initSound( ::String src);
		Dynamic initSound_dyn();

		virtual Void onID3DataReceived( ::neash::events::Event event);
		...
		::neash::media::SoundChannel _soundChannel; /* REM */ 
		::neash::media::Sound _sound; /* REM */ 
