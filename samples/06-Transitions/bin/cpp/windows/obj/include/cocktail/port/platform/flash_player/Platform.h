...
class Platform_obj : public ::cocktail::port::base::PlatformBase_obj{
	...
	public:
		...
		virtual Void onConfigChanged( ::cocktail::core::event::CustomEvent event);
		Dynamic onConfigChanged_dyn();
		...
		virtual ::neash::display::DisplayObjectContainer getInitialNativeLayer( );
		...
		bool _foundHollowedTag; /* REM */ 
		Array< ::cocktail::core::geom::RectangleVO > _hollowedTagsBounds; /* REM */ 
		::neash::display::Sprite hitTestingSprite; /* REM */ 
		::neash::display::Sprite _nativeLayersRootSprite; /* REM */ 
		::neash::display::Sprite _rootSprite; /* REM */ 
