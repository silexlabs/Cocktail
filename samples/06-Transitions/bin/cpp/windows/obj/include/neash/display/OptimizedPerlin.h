...
class OptimizedPerlin_obj : public hx::Object{
	...
	public:
		...
		virtual Void fill( ::neash::display::BitmapData bitmap,Float _x,Float _y,Float _z,Dynamic _);
		Dynamic fill_dyn();

		Float baseFactor; /* REM */ 
		Float iZoffset; /* REM */ 
		Float iYoffset; /* REM */ 
		Float iXoffset; /* REM */ 
		Float fPersMax; /* REM */ 
		Array< Float > aOctPers; /* REM */ 
		Array< Float > aOctFreq; /* REM */ 
		int octaves; /* REM */ 
