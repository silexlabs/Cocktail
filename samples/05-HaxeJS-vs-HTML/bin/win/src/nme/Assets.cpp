...
bool useCache = __o_useCache.Default(true);
	HX_STACK_PUSH("Assets::getBitmapData","nme/Assets.hx",41);
	HX_STACK_ARG(id,"id");
...
::native::utils::ByteArray Assets_obj::getBytes( ::String id){
	HX_STACK_PUSH("Assets::getBytes","nme/Assets.hx",54);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(54)
	return null();
}
...
::native::text::Font Assets_obj::getFont( ::String id){
	HX_STACK_PUSH("Assets::getFont","nme/Assets.hx",67);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(67)
	return null();
}
...
::format::display::MovieClip Assets_obj::getMovieClip( ::String id){
	HX_STACK_PUSH("Assets::getMovieClip","nme/Assets.hx",80);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(80)
	return null();
}
...
::native::media::Sound Assets_obj::getSound( ::String id){
	HX_STACK_PUSH("Assets::getSound","nme/Assets.hx",93);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(93)
	return null();
}
...
::String Assets_obj::getText( ::String id){
	HX_STACK_PUSH("Assets::getText","nme/Assets.hx",106);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(106)
	return null();
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("nme.Assets"), hx::TCanCast< Assets_obj> ,sStaticFields,sMemberFields,
