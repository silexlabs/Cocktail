...
::cocktail::core::event::KeyboardEvent Keyboard_obj::getKeyData( Dynamic event){
	...
	HX_STACK_LINE(67)
	::native::events::KeyboardEvent typedEvent = event;		HX_STACK_VAR(typedEvent,"typedEvent");
	HX_STACK_LINE(69)
	::String eventType;		HX_STACK_VAR(eventType,"eventType");
	HX_STACK_LINE(71)
	::String _switch_1 = (typedEvent->get_type());
	if (  ( _switch_1==::native::events::KeyboardEvent_obj::KEY_DOWN)){
		HX_STACK_LINE(73)
		eventType = HX_CSTRING("keydown");
	}
	else if (  ( _switch_1==::native::events::KeyboardEvent_obj::KEY_UP)){
		HX_STACK_LINE(76)
...
Void Keyboard_obj::removeNativeListeners( ){
{
		...
		HX_STACK_THIS(this);
		HX_STACK_LINE(54)
		::nme::Lib_obj::get_current()->removeEventListener(::native::events::KeyboardEvent_obj::KEY_DOWN,this->onNativeKeyDown_dyn(),null());
		HX_STACK_LINE(55)
		::nme::Lib_obj::get_current()->removeEventListener(::native::events::KeyboardEvent_obj::KEY_UP,this->onNativeKeyUp_dyn(),null());
	}
return null();
}
...
Void Keyboard_obj::setNativeListeners( ){
{
		...
		HX_STACK_THIS(this);
		HX_STACK_LINE(45)
		::nme::Lib_obj::get_current()->get_stage()->addEventListener(::native::events::KeyboardEvent_obj::KEY_DOWN,this->onNativeKeyDown_dyn(),null(),null(),null());
		HX_STACK_LINE(46)
		::nme::Lib_obj::get_current()->get_stage()->addEventListener(::native::events::KeyboardEvent_obj::KEY_UP,this->onNativeKeyUp_dyn(),null(),null(),null());
	}
return null();
}
