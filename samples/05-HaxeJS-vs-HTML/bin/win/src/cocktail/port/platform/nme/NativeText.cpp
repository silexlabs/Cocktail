...
::native::display::BitmapData NativeText_obj::getBitmap( ::cocktail::core::geom::RectangleVO bounds){
	HX_STACK_PUSH("NativeText::getBitmap","cocktail/port/platform/nme/NativeText.hx",49);
	HX_STACK_THIS(this);
	HX_STACK_ARG(bounds,"bounds");
	HX_STACK_LINE(50)
	::native::display::BitmapData bitmap = ::native::display::BitmapData_obj::__new(::Math_obj::round(bounds->width),::Math_obj::round(bounds->height),true,(int)0,null());		HX_STACK_VAR(bitmap,"bitmap");
	HX_STACK_LINE(51)
