...
::cocktail::core::event::TouchEvent TouchListener_obj::getTouchEvent( Dynamic event){
	...
	HX_STACK_LINE(74)
	::native::events::TouchEvent typedEvent = event;		HX_STACK_VAR(typedEvent,"typedEvent");
	HX_STACK_LINE(76)
	::String touchType;		HX_STACK_VAR(touchType,"touchType");
	HX_STACK_LINE(78)
	::String _switch_1 = (typedEvent->get_type());
	if (  ( _switch_1==::native::events::TouchEvent_obj::TOUCH_BEGIN)){
		HX_STACK_LINE(80)
		touchType = HX_CSTRING("touchstart");
	}
	else if (  ( _switch_1==::native::events::TouchEvent_obj::TOUCH_END)){
		HX_STACK_LINE(83)
		touchType = HX_CSTRING("touchend");
	}
	else if (  ( _switch_1==::native::events::TouchEvent_obj::TOUCH_MOVE)){
		HX_STACK_LINE(86)
		touchType = HX_CSTRING("touchmove");
	}
	else  {
		HX_STACK_LINE(89)
		touchType = typedEvent->get_type();
	}
;
;
	struct _Function_1_1{
		inline static Dynamic Block( ::native::events::TouchEvent &typedEvent){
...
Void TouchListener_obj::removeNativeListeners( ){
{
		...
		HX_STACK_THIS(this);
		HX_STACK_LINE(60)
		this->_platform->hitTestingSprite->removeEventListener(::native::events::TouchEvent_obj::TOUCH_BEGIN,this->onNativeTouchStart_dyn(),null());
		HX_STACK_LINE(61)
		this->_platform->hitTestingSprite->removeEventListener(::native::events::TouchEvent_obj::TOUCH_MOVE,this->onNativeTouchMove_dyn(),null());
		HX_STACK_LINE(62)
		this->_platform->hitTestingSprite->removeEventListener(::native::events::TouchEvent_obj::TOUCH_END,this->onNativeTouchEnd_dyn(),null());
	}
return null();
}
...
Void TouchListener_obj::setNativeListeners( ){
{
		...
		HX_STACK_THIS(this);
		HX_STACK_LINE(50)
		this->_platform->hitTestingSprite->addEventListener(::native::events::TouchEvent_obj::TOUCH_BEGIN,this->onNativeTouchStart_dyn(),null(),null(),null());
		HX_STACK_LINE(51)
		this->_platform->hitTestingSprite->addEventListener(::native::events::TouchEvent_obj::TOUCH_MOVE,this->onNativeTouchMove_dyn(),null(),null(),null());
		HX_STACK_LINE(52)
		this->_platform->hitTestingSprite->addEventListener(::native::events::TouchEvent_obj::TOUCH_END,this->onNativeTouchEnd_dyn(),null(),null(),null());
	}
return null();
}
