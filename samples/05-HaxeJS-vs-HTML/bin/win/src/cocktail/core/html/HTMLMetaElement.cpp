...
::String HTMLMetaElement_obj::set_content( ::String value){
	HX_STACK_PUSH("HTMLMetaElement::set_content","cocktail/core/html/HTMLMetaElement.hx",124);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(125)
	this->super::setAttribute(HX_CSTRING("content"),value);
	HX_STACK_LINE(126)
	this->updateConfig();
	HX_STACK_LINE(127)
	return value;
...
::String HTMLMetaElement_obj::get_content( ){
	HX_STACK_PUSH("HTMLMetaElement::get_content","cocktail/core/html/HTMLMetaElement.hx",119);
	HX_STACK_THIS(this);
	HX_STACK_LINE(119)
	return this->super::getAttribute(HX_CSTRING("content"));
}
...
::String HTMLMetaElement_obj::set_name( ::String value){
	HX_STACK_PUSH("HTMLMetaElement::set_name","cocktail/core/html/HTMLMetaElement.hx",112);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(113)
	this->super::setAttribute(HX_CSTRING("name"),value);
	HX_STACK_LINE(114)
	this->updateConfig();
	HX_STACK_LINE(115)
	return value;
...
::String HTMLMetaElement_obj::get_name( ){
	HX_STACK_PUSH("HTMLMetaElement::get_name","cocktail/core/html/HTMLMetaElement.hx",107);
	HX_STACK_THIS(this);
	HX_STACK_LINE(107)
	return this->super::getAttribute(HX_CSTRING("name"));
}
...
{
		HX_STACK_PUSH("HTMLMetaElement::updateConfig","cocktail/core/html/HTMLMetaElement.hx",95);
		HX_STACK_THIS(this);
		HX_STACK_LINE(95)
...
{
		HX_STACK_PUSH("HTMLMetaElement::addedToDOM","cocktail/core/html/HTMLMetaElement.hx",81);
		HX_STACK_THIS(this);
		HX_STACK_LINE(82)
...
::String HTMLMetaElement_obj::getAttribute( ::String attributeName){
	HX_STACK_PUSH("HTMLMetaElement::getAttribute","cocktail/core/html/HTMLMetaElement.hx",61);
	HX_STACK_THIS(this);
	HX_STACK_ARG(attributeName,"attributeName");
	HX_STACK_LINE(61)
	if (((attributeName == HX_CSTRING("name")))){
		HX_STACK_LINE(63)
		return this->get_name();
	}
	else{
		HX_STACK_LINE(66)
		if (((attributeName == HX_CSTRING("content")))){
			HX_STACK_LINE(67)
			return this->get_content();
		}
		else{
			HX_STACK_LINE(71)
			return this->super::getAttribute(attributeName);
		}
	}
	HX_STACK_LINE(61)
	return null();
...
Void HTMLMetaElement_obj::setAttribute( ::String attributeName,::String value){
{
		HX_STACK_PUSH("HTMLMetaElement::setAttribute","cocktail/core/html/HTMLMetaElement.hx",45);
		HX_STACK_THIS(this);
		HX_STACK_ARG(attributeName,"attributeName");
		HX_STACK_ARG(value,"value");
		HX_STACK_LINE(45)
		if (((attributeName == HX_CSTRING("name")))){
			...
			if (((attributeName == HX_CSTRING("content")))){
				...
				HX_STACK_LINE(55)
				this->super::setAttribute(attributeName,value);
			}
		}
	}
return null();
