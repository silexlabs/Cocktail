...
int EmbeddedElement_obj::get_height( ){
	HX_STACK_PUSH("EmbeddedElement::get_height","cocktail/core/html/EmbeddedElement.hx",165);
	HX_STACK_THIS(this);
	HX_STACK_LINE(166)
	::String height = this->super::getAttribute(HX_CSTRING("height"));		HX_STACK_VAR(height,"height");
	HX_STACK_LINE(167)
	if (((height == null()))){
		HX_STACK_LINE(168)
		return (int)0;
		...
		HX_STACK_LINE(172)
		return ::Std_obj::parseInt(height);
	}
	HX_STACK_LINE(167)
	return (int)0;
}
...
int EmbeddedElement_obj::set_height( int value){
	HX_STACK_PUSH("EmbeddedElement::set_height","cocktail/core/html/EmbeddedElement.hx",159);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(160)
	this->super::setAttribute(HX_CSTRING("height"),::Std_obj::string(value));
	HX_STACK_LINE(161)
	return value;
}
...
int EmbeddedElement_obj::get_width( ){
	HX_STACK_PUSH("EmbeddedElement::get_width","cocktail/core/html/EmbeddedElement.hx",146);
	HX_STACK_THIS(this);
	HX_STACK_LINE(147)
	::String width = this->super::getAttribute(HX_CSTRING("width"));		HX_STACK_VAR(width,"width");
	HX_STACK_LINE(148)
	if (((width == null()))){
		HX_STACK_LINE(149)
		return (int)0;
...
int EmbeddedElement_obj::set_width( int value){
	HX_STACK_PUSH("EmbeddedElement::set_width","cocktail/core/html/EmbeddedElement.hx",140);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(141)
	this->super::setAttribute(HX_CSTRING("width"),::Std_obj::string(value));
	HX_STACK_LINE(142)
	return value;
}
...
Dynamic EmbeddedElement_obj::get_intrinsicRatio( ){
	HX_STACK_PUSH("EmbeddedElement::get_intrinsicRatio","cocktail/core/html/EmbeddedElement.hx",131);
	HX_STACK_THIS(this);
	HX_STACK_LINE(131)
...
Dynamic EmbeddedElement_obj::get_intrinsicWidth( ){
	HX_STACK_PUSH("EmbeddedElement::get_intrinsicWidth","cocktail/core/html/EmbeddedElement.hx",126);
	HX_STACK_THIS(this);
	HX_STACK_LINE(126)
...
Dynamic EmbeddedElement_obj::get_intrinsicHeight( ){
	HX_STACK_PUSH("EmbeddedElement::get_intrinsicHeight","cocktail/core/html/EmbeddedElement.hx",121);
	HX_STACK_THIS(this);
	HX_STACK_LINE(121)
...
::String EmbeddedElement_obj::getAttribute( ::String name){
	HX_STACK_PUSH("EmbeddedElement::getAttribute","cocktail/core/html/EmbeddedElement.hx",101);
	HX_STACK_THIS(this);
	HX_STACK_ARG(name,"name");
	HX_STACK_LINE(101)
	if (((name == HX_CSTRING("height")))){
		HX_STACK_LINE(103)
		return ::Std_obj::string(this->get_height());
	}
	else{
		HX_STACK_LINE(106)
		if (((name == HX_CSTRING("width")))){
			HX_STACK_LINE(107)
			return ::Std_obj::string(this->get_width());
		}
		else{
			HX_STACK_LINE(111)
...
Void EmbeddedElement_obj::setAttribute( ::String name,::String value){
{
		HX_STACK_PUSH("EmbeddedElement::setAttribute","cocktail/core/html/EmbeddedElement.hx",85);
		HX_STACK_THIS(this);
		HX_STACK_ARG(name,"name");
		HX_STACK_ARG(value,"value");
		HX_STACK_LINE(85)
		if (((name == HX_CSTRING("height")))){
			HX_STACK_LINE(87)
			this->set_height(::Std_obj::parseInt(value));
		}
		else{
			HX_STACK_LINE(90)
			if (((name == HX_CSTRING("width")))){
				HX_STACK_LINE(91)
				this->set_width(::Std_obj::parseInt(value));
			}
			else{
				HX_STACK_LINE(95)
