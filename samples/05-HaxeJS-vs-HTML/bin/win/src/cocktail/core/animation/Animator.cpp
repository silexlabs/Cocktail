...
{
		HX_STACK_PUSH("Animator::onTransitionUpdate","cocktail/core/animation/Animator.hx",458);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Animator::onTransitionComplete","cocktail/core/animation/Animator.hx",448);
		HX_STACK_THIS(this);
		HX_STACK_ARG(transition,"transition");
		HX_STACK_LINE(448)
