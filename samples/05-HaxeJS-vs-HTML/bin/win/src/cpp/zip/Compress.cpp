...
{
HX_STACK_PUSH("Compress::new","C:\\Motion-Twin\\Haxe/std/cpp/zip/Compress.hx",31);
{
	HX_STACK_LINE(31)
...
{
		HX_STACK_PUSH("Compress::close","C:\\Motion-Twin\\Haxe/std/cpp/zip/Compress.hx",43);
		HX_STACK_THIS(this);
		HX_STACK_LINE(43)
...
{
		HX_STACK_PUSH("Compress::setFlushMode","C:\\Motion-Twin\\Haxe/std/cpp/zip/Compress.hx",39);
		HX_STACK_THIS(this);
		HX_STACK_ARG(f,"f");
		HX_STACK_LINE(39)
...
Dynamic Compress_obj::execute( ::haxe::io::Bytes src,int srcPos,::haxe::io::Bytes dst,int dstPos){
	HX_STACK_PUSH("Compress::execute","C:\\Motion-Twin\\Haxe/std/cpp/zip/Compress.hx",35);
	HX_STACK_THIS(this);
...
::haxe::io::Bytes Compress_obj::run( ::haxe::io::Bytes s,int level){
	HX_STACK_PUSH("Compress::run","C:\\Motion-Twin\\Haxe/std/cpp/zip/Compress.hx",47);
	HX_STACK_ARG(s,"s");
