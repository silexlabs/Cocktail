...
{
HX_STACK_PUSH("EOFError::new","native/errors/EOFError.hx",8);
{
	HX_STACK_LINE(8)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.errors.EOFError"), hx::TCanCast< EOFError_obj> ,sStaticFields,sMemberFields,
