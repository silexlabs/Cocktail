...
{
HX_STACK_PUSH("Error::new","native/errors/Error.hx",13);
...
::String Error_obj::toString( ){
	HX_STACK_PUSH("Error::toString","native/errors/Error.hx",28);
	HX_STACK_THIS(this);
	HX_STACK_LINE(28)
	return this->message;
}
...
::String Error_obj::getStackTrace( ){
	HX_STACK_PUSH("Error::getStackTrace","native/errors/Error.hx",21);
	HX_STACK_THIS(this);
	HX_STACK_LINE(21)
	return HX_CSTRING("");
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.errors.Error"), hx::TCanCast< Error_obj> ,sStaticFields,sMemberFields,
