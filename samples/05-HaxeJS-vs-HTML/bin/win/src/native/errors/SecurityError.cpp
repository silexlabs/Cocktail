...
{
HX_STACK_PUSH("SecurityError::new","native/errors/SecurityError.hx",8);
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.errors.SecurityError"), hx::TCanCast< SecurityError_obj> ,sStaticFields,sMemberFields,
