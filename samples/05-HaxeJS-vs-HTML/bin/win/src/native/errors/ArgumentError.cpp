...
{
HX_STACK_PUSH("ArgumentError::new","native/errors/ArgumentError.hx",5);
{
	HX_STACK_LINE(5)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.errors.ArgumentError"), hx::TCanCast< ArgumentError_obj> ,sStaticFields,sMemberFields,
