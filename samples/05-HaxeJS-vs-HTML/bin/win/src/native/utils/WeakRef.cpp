...
{
HX_STACK_PUSH("WeakRef::new","native/utils/WeakRef.hx",16);
...
::String WeakRef_obj::toString( ){
	HX_STACK_PUSH("WeakRef::toString","native/utils/WeakRef.hx",50);
	HX_STACK_THIS(this);
	HX_STACK_LINE(52)
...
Dynamic WeakRef_obj::get( ){
	HX_STACK_PUSH("WeakRef::get","native/utils/WeakRef.hx",33);
	HX_STACK_THIS(this);
	HX_STACK_LINE(35)
	if (((this->hardRef != null()))){
		HX_STACK_LINE(36)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.utils.WeakRef"), hx::TCanCast< WeakRef_obj> ,sStaticFields,sMemberFields,
