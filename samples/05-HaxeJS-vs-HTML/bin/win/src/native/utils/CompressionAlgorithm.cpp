...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.utils.CompressionAlgorithm"), hx::TCanCast< CompressionAlgorithm_obj >,sStaticFields,sMemberFields,
...
{
Static(DEFLATE) = hx::CreateEnum< CompressionAlgorithm_obj >(HX_CSTRING("DEFLATE"),0);
Static(GZIP) = hx::CreateEnum< CompressionAlgorithm_obj >(HX_CSTRING("GZIP"),3);
Static(LZMA) = hx::CreateEnum< CompressionAlgorithm_obj >(HX_CSTRING("LZMA"),2);
Static(ZLIB) = hx::CreateEnum< CompressionAlgorithm_obj >(HX_CSTRING("ZLIB"),1);
}
