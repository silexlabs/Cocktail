...
{
HX_STACK_PUSH("Transform::new","native/geom/Transform.hx",20);
{
	HX_STACK_LINE(20)
...
::native::geom::Matrix Transform_obj::set_matrix( ::native::geom::Matrix inMatrix){
	HX_STACK_PUSH("Transform::set_matrix","native/geom/Transform.hx",39);
	HX_STACK_THIS(this);
...
::native::geom::ColorTransform Transform_obj::set_colorTransform( ::native::geom::ColorTransform inTrans){
	HX_STACK_PUSH("Transform::set_colorTransform","native/geom/Transform.hx",35);
	HX_STACK_THIS(this);
...
::native::geom::ColorTransform Transform_obj::get_colorTransform( ){
	HX_STACK_PUSH("Transform::get_colorTransform","native/geom/Transform.hx",34);
	HX_STACK_THIS(this);
	HX_STACK_LINE(34)
...
Dynamic Transform_obj::__Field(const ::String &inName,bool inCallProp)
{
	...
	case 11:
		...
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"colorTransform") ) { return inCallProp ? get_colorTransform() : colorTransform; }
		break;
	case 15:
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.geom.Transform"), hx::TCanCast< Transform_obj> ,sStaticFields,sMemberFields,
