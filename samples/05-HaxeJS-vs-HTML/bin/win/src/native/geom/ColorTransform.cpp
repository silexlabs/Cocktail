...
{
HX_STACK_PUSH("ColorTransform::new","native/geom/ColorTransform.hx",19);
...
int ColorTransform_obj::set_color( int value){
	HX_STACK_PUSH("ColorTransform::set_color","native/geom/ColorTransform.hx",57);
	HX_STACK_THIS(this);
...
int ColorTransform_obj::get_color( ){
	HX_STACK_PUSH("ColorTransform::get_color","native/geom/ColorTransform.hx",50);
	HX_STACK_THIS(this);
	HX_STACK_LINE(50)
...
{
		HX_STACK_PUSH("ColorTransform::concat","native/geom/ColorTransform.hx",33);
		HX_STACK_THIS(this);
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.geom.ColorTransform"), hx::TCanCast< ColorTransform_obj> ,sStaticFields,sMemberFields,
