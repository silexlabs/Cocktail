...
{
HX_STACK_PUSH("SoundChannel::new","native/media/SoundChannel.hx",28);
{
	HX_STACK_LINE(30)
...
::native::media::SoundTransform SoundChannel_obj::set_soundTransform( ::native::media::SoundTransform inTransform){
	HX_STACK_PUSH("SoundChannel::set_soundTransform","native/media/SoundChannel.hx",164);
	HX_STACK_THIS(this);
...
::native::media::SoundTransform SoundChannel_obj::get_soundTransform( ){
	HX_STACK_PUSH("SoundChannel::get_soundTransform","native/media/SoundChannel.hx",151);
	HX_STACK_THIS(this);
	HX_STACK_LINE(153)
...
Float SoundChannel_obj::get_position( ){
	HX_STACK_PUSH("SoundChannel::get_position","native/media/SoundChannel.hx",148);
	HX_STACK_THIS(this);
	HX_STACK_LINE(148)
...
Float SoundChannel_obj::get_rightPeak( ){
	HX_STACK_PUSH("SoundChannel::get_rightPeak","native/media/SoundChannel.hx",147);
	HX_STACK_THIS(this);
	HX_STACK_LINE(147)
...
Float SoundChannel_obj::get_leftPeak( ){
	HX_STACK_PUSH("SoundChannel::get_leftPeak","native/media/SoundChannel.hx",146);
	HX_STACK_THIS(this);
	HX_STACK_LINE(146)
...
{
		HX_STACK_PUSH("SoundChannel::stop","native/media/SoundChannel.hx",131);
		HX_STACK_THIS(this);
		HX_STACK_LINE(133)
...
bool SoundChannel_obj::nmeCheckComplete( ){
	HX_STACK_PUSH("SoundChannel::nmeCheckComplete","native/media/SoundChannel.hx",61);
	HX_STACK_THIS(this);
	HX_STACK_LINE(63)
	if (((this->nmeHandle != null()))){
		HX_STACK_LINE(65)
...
Array< ::native::media::SoundChannel > SoundChannel_obj::nmeIncompleteList;
...
::native::media::SoundChannel SoundChannel_obj::createDynamic( Dynamic inSoundHandle,::native::media::SoundTransform sndTransform,::native::events::EventDispatcher dataProvider){
	HX_STACK_PUSH("SoundChannel::createDynamic","native/media/SoundChannel.hx",47);
...
bool SoundChannel_obj::nmeCompletePending( ){
	HX_STACK_PUSH("SoundChannel::nmeCompletePending","native/media/SoundChannel.hx",101);
	HX_STACK_LINE(101)
...
{
		HX_STACK_PUSH("SoundChannel::nmePollComplete","native/media/SoundChannel.hx",108);
		HX_STACK_LINE(108)
		if (((::native::media::SoundChannel_obj::nmeIncompleteList->length > (int)0))){
			HX_STACK_LINE(112)
			Array< ::native::media::SoundChannel > incomplete = Array_obj< ::native::media::SoundChannel >::__new();		HX_STACK_VAR(incomplete,"incomplete");
			HX_STACK_LINE(114)
			{
				HX_STACK_LINE(114)
				int _g = (int)0;		HX_STACK_VAR(_g,"_g");
				Array< ::native::media::SoundChannel > _g1 = ::native::media::SoundChannel_obj::nmeIncompleteList;		HX_STACK_VAR(_g1,"_g1");
				HX_STACK_LINE(114)
				while(((_g < _g1->length))){
					HX_STACK_LINE(114)
					::native::media::SoundChannel channel = _g1->__get(_g);		HX_STACK_VAR(channel,"channel");
					HX_STACK_LINE(114)
					++(_g);
					HX_STACK_LINE(116)
...
Dynamic SoundChannel_obj::__Field(const ::String &inName,bool inCallProp)
{
	...
	case 13:
		...
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"soundTransform") ) { return inCallProp ? get_soundTransform() : soundTransform; }
		break;
	case 15:
...
Dynamic SoundChannel_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 12:
		...
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"soundTransform") ) { if (inCallProp) return set_soundTransform(inValue);soundTransform=inValue.Cast< ::native::media::SoundTransform >(); return inValue; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"nmeDataProvider") ) { nmeDataProvider=inValue.Cast< ::native::events::EventDispatcher >(); return inValue; }
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"nmeIncompleteList") ) { nmeIncompleteList=inValue.Cast< Array< ::native::media::SoundChannel > >(); return inValue; }
		break;
	case 20:
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.media.SoundChannel"), hx::TCanCast< SoundChannel_obj> ,sStaticFields,sMemberFields,
...
void SoundChannel_obj::__boot()
{
	...
	nmeIncompleteList= Array_obj< ::native::media::SoundChannel >::__new();
