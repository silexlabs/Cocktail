...
{
HX_STACK_PUSH("SoundLoaderContext::new","native/media/SoundLoaderContext.hx",8);
{
}
;
	return null();
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.media.SoundLoaderContext"), hx::TCanCast< SoundLoaderContext_obj> ,sStaticFields,sMemberFields,
