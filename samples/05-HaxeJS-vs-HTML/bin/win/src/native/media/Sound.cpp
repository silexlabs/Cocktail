...
{
HX_STACK_PUSH("Sound::new","native/media/Sound.hx",31);
...
Float Sound_obj::get_length( ){
	HX_STACK_PUSH("Sound::get_length","native/media/Sound.hx",250);
	HX_STACK_THIS(this);
	HX_STACK_LINE(252)
...
bool Sound_obj::get_isBuffering( ){
	HX_STACK_PUSH("Sound::get_isBuffering","native/media/Sound.hx",242);
	HX_STACK_THIS(this);
	HX_STACK_LINE(244)
...
::native::media::ID3Info Sound_obj::get_id3( ){
	HX_STACK_PUSH("Sound::get_id3","native/media/Sound.hx",228);
	HX_STACK_THIS(this);
	HX_STACK_LINE(230)
	this->nmeCheckLoading();
	HX_STACK_LINE(232)
...
int loops = __o_loops.Default(0);
	HX_STACK_PUSH("Sound::play","native/media/Sound.hx",187);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Sound::nmeOnError","native/media/Sound.hx",178);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Sound::nmeCheckLoading","native/media/Sound.hx",153);
		HX_STACK_THIS(this);
		HX_STACK_LINE(153)
...
Float sampleRate = __o_sampleRate.Default(44100.0);
	HX_STACK_PUSH("Sound::loadPCMFromByteArray","native/media/Sound.hx",108);
	HX_STACK_THIS(this);
	...
	HX_STACK_ARG(sampleRate,"sampleRate");
{
		...
		struct _Function_1_1{
			inline static int Block( ::String &format){
				HX_STACK_PUSH("*::closure","native/media/Sound.hx",114);
				{
					HX_STACK_LINE(114)
...
;
		...
		struct _Function_1_2{
			inline static int Block( ::String &format){
				HX_STACK_PUSH("*::closure","native/media/Sound.hx",122);
				{
					HX_STACK_LINE(122)
...
bool forcePlayAsMusic = __o_forcePlayAsMusic.Default(false);
	HX_STACK_PUSH("Sound::loadCompressedDataFromByteArray","native/media/Sound.hx",94);
	HX_STACK_THIS(this);
	HX_STACK_ARG(bytes,"bytes");
	...
	HX_STACK_ARG(forcePlayAsMusic,"forcePlayAsMusic");
{
		...
		HX_STACK_LINE(97)
		this->nmeHandle = ::native::media::Sound_obj::nme_sound_from_data(bytes->b,length,forcePlayAsMusic);
		HX_STACK_LINE(99)
		if (((this->nmeHandle == null()))){
			HX_STACK_LINE(99)
...
bool forcePlayAsMusic = __o_forcePlayAsMusic.Default(false);
	HX_STACK_PUSH("Sound::load","native/media/Sound.hx",73);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Sound::close","native/media/Sound.hx",62);
		HX_STACK_THIS(this);
		HX_STACK_LINE(64)
		if (((this->nmeHandle != null()))){
			HX_STACK_LINE(65)
...
bool useWeakReference = __o_useWeakReference.Default(false);
	HX_STACK_PUSH("Sound::addEventListener","native/media/Sound.hx",45);
	HX_STACK_THIS(this);
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.media.Sound"), hx::TCanCast< Sound_obj> ,sStaticFields,sMemberFields,
