...
{
HX_STACK_PUSH("SoundTransform::new","native/media/SoundTransform.hx",12);
...
::native::media::SoundTransform SoundTransform_obj::clone( ){
	HX_STACK_PUSH("SoundTransform::clone","native/media/SoundTransform.hx",20);
	HX_STACK_THIS(this);
	HX_STACK_LINE(20)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.media.SoundTransform"), hx::TCanCast< SoundTransform_obj> ,sStaticFields,sMemberFields,
