...
{
HX_STACK_PUSH("ID3Info::new","native/media/ID3Info.hx",17);
{
}
;
	return null();
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.media.ID3Info"), hx::TCanCast< ID3Info_obj> ,sStaticFields,sMemberFields,
