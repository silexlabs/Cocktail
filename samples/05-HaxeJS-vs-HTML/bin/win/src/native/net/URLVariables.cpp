...
{
HX_STACK_PUSH("URLVariables::new","native/net/URLVariables.hx",8);
{
	HX_STACK_LINE(8)
	if (((inEncoded != null()))){
		HX_STACK_LINE(11)
...
::String URLVariables_obj::toString( ){
	HX_STACK_PUSH("URLVariables::toString","native/net/URLVariables.hx",39);
	HX_STACK_THIS(this);
	HX_STACK_LINE(41)
...
{
		HX_STACK_PUSH("URLVariables::decode","native/net/URLVariables.hx",16);
		HX_STACK_THIS(this);
