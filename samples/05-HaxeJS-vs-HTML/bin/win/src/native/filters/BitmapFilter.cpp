...
{
HX_STACK_PUSH("BitmapFilter::new","native/filters/BitmapFilter.hx",11);
{
	HX_STACK_LINE(11)
	this->type = inType;
}
...
::native::filters::BitmapFilter BitmapFilter_obj::clone( ){
	HX_STACK_PUSH("BitmapFilter::clone","native/filters/BitmapFilter.hx",18);
	HX_STACK_THIS(this);
	HX_STACK_LINE(20)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.filters.BitmapFilter"), hx::TCanCast< BitmapFilter_obj> ,sStaticFields,sMemberFields,
