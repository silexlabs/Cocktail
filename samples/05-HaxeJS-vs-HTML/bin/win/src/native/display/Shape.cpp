...
{
HX_STACK_PUSH("Shape::new","native/display/Shape.hx",8);
{
	HX_STACK_LINE(8)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.display.Shape"), hx::TCanCast< Shape_obj> ,sStaticFields,sMemberFields,
