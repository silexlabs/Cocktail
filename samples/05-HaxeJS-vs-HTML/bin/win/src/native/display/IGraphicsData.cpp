...
{
HX_STACK_PUSH("IGraphicsData::new","native/display/IGraphicsData.hx",11);
{
	HX_STACK_LINE(11)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.display.IGraphicsData"), hx::TCanCast< IGraphicsData_obj> ,sStaticFields,sMemberFields,
