...
{
HX_STACK_PUSH("InteractiveObject::new","native/display/InteractiveObject.hx",19);
{
	HX_STACK_LINE(21)
...
bool InteractiveObject_obj::get_needsSoftKeyboard( ){
	HX_STACK_PUSH("InteractiveObject::get_needsSoftKeyboard","native/display/InteractiveObject.hx",83);
	HX_STACK_THIS(this);
	HX_STACK_LINE(83)
...
bool InteractiveObject_obj::set_needsSoftKeyboard( bool inVal){
	HX_STACK_PUSH("InteractiveObject::set_needsSoftKeyboard","native/display/InteractiveObject.hx",75);
	HX_STACK_THIS(this);
...
bool InteractiveObject_obj::get_moveForSoftKeyboard( ){
	HX_STACK_PUSH("InteractiveObject::get_moveForSoftKeyboard","native/display/InteractiveObject.hx",68);
	HX_STACK_THIS(this);
	HX_STACK_LINE(68)
...
bool InteractiveObject_obj::set_moveForSoftKeyboard( bool inVal){
	HX_STACK_PUSH("InteractiveObject::set_moveForSoftKeyboard","native/display/InteractiveObject.hx",60);
	HX_STACK_THIS(this);
	HX_STACK_ARG(inVal,"inVal");
	HX_STACK_LINE(62)
...
bool InteractiveObject_obj::set_mouseEnabled( bool inVal){
	HX_STACK_PUSH("InteractiveObject::set_mouseEnabled","native/display/InteractiveObject.hx",51);
	HX_STACK_THIS(this);
	HX_STACK_ARG(inVal,"inVal");
	HX_STACK_LINE(53)
...
bool InteractiveObject_obj::get_mouseEnabled( ){
	HX_STACK_PUSH("InteractiveObject::get_mouseEnabled","native/display/InteractiveObject.hx",50);
	HX_STACK_THIS(this);
	HX_STACK_LINE(50)
	return this->nmeMouseEnabled;
}
...
bool InteractiveObject_obj::requestSoftKeyboard( ){
	HX_STACK_PUSH("InteractiveObject::requestSoftKeyboard","native/display/InteractiveObject.hx",36);
	HX_STACK_THIS(this);
	HX_STACK_LINE(36)
...
::native::display::InteractiveObject InteractiveObject_obj::nmeAsInteractiveObject( ){
	HX_STACK_PUSH("InteractiveObject::nmeAsInteractiveObject","native/display/InteractiveObject.hx",29);
	HX_STACK_THIS(this);
	HX_STACK_LINE(29)
...
Dynamic InteractiveObject_obj::__Field(const ::String &inName,bool inCallProp)
{
	...
	case 12:
		if (HX_FIELD_EQ(inName,"mouseEnabled") ) { return inCallProp ? get_mouseEnabled() : mouseEnabled; }
		break;
	case 15:
	...
	case 16:
		...
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"needsSoftKeyboard") ) { return inCallProp ? get_needsSoftKeyboard() : needsSoftKeyboard; }
		break;
	case 18:
	...
	case 19:
		...
		if (HX_FIELD_EQ(inName,"moveForSoftKeyboard") ) { return inCallProp ? get_moveForSoftKeyboard() : moveForSoftKeyboard; }
		break;
	case 21:
...
Dynamic InteractiveObject_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 12:
		if (HX_FIELD_EQ(inName,"mouseEnabled") ) { if (inCallProp) return set_mouseEnabled(inValue);mouseEnabled=inValue.Cast< bool >(); return inValue; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"nmeMouseEnabled") ) { nmeMouseEnabled=inValue.Cast< bool >(); return inValue; }
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"needsSoftKeyboard") ) { if (inCallProp) return set_needsSoftKeyboard(inValue);needsSoftKeyboard=inValue.Cast< bool >(); return inValue; }
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"doubleClickEnabled") ) { doubleClickEnabled=inValue.Cast< bool >(); return inValue; }
		break;
	case 19:
		if (HX_FIELD_EQ(inName,"moveForSoftKeyboard") ) { if (inCallProp) return set_moveForSoftKeyboard(inValue);moveForSoftKeyboard=inValue.Cast< bool >(); return inValue; }
		break;
	case 36:
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.display.InteractiveObject"), hx::TCanCast< InteractiveObject_obj> ,sStaticFields,sMemberFields,
