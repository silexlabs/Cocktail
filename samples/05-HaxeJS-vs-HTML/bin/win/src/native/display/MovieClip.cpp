...
{
HX_STACK_PUSH("MovieClip::new","native/display/MovieClip.hx",17);
{
	HX_STACK_LINE(19)
	super::__construct();
	HX_STACK_LINE(21)
...
int MovieClip_obj::get_totalFrames( ){
	HX_STACK_PUSH("MovieClip::get_totalFrames","native/display/MovieClip.hx",71);
	HX_STACK_THIS(this);
	HX_STACK_LINE(71)
...
int MovieClip_obj::get_framesLoaded( ){
	HX_STACK_PUSH("MovieClip::get_framesLoaded","native/display/MovieClip.hx",70);
	HX_STACK_THIS(this);
	HX_STACK_LINE(70)
	return this->mTotalFrames;
}
...
int MovieClip_obj::get_currentFrame( ){
	HX_STACK_PUSH("MovieClip::get_currentFrame","native/display/MovieClip.hx",69);
	HX_STACK_THIS(this);
	HX_STACK_LINE(69)
...
{
		HX_STACK_PUSH("MovieClip::stop","native/display/MovieClip.hx",55);
		HX_STACK_THIS(this);
	}
return null();
}
...
{
		HX_STACK_PUSH("MovieClip::play","native/display/MovieClip.hx",48);
		HX_STACK_THIS(this);
	}
return null();
}
...
::String MovieClip_obj::nmeGetType( ){
	HX_STACK_PUSH("MovieClip::nmeGetType","native/display/MovieClip.hx",41);
	HX_STACK_THIS(this);
	HX_STACK_LINE(41)
...
{
		HX_STACK_PUSH("MovieClip::gotoAndStop","native/display/MovieClip.hx",34);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("MovieClip::gotoAndPlay","native/display/MovieClip.hx",27);
		HX_STACK_THIS(this);
		HX_STACK_ARG(frame,"frame");
		HX_STACK_ARG(scene,"scene");
	}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.display.MovieClip"), hx::TCanCast< MovieClip_obj> ,sStaticFields,sMemberFields,
