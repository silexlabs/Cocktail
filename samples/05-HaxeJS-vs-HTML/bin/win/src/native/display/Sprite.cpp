...
{
HX_STACK_PUSH("Sprite::new","native/display/Sprite.hx",15);
{
	HX_STACK_LINE(15)
...
{
		HX_STACK_PUSH("Sprite::stopDrag","native/display/Sprite.hx",39);
		HX_STACK_THIS(this);
		HX_STACK_LINE(39)
...
bool lockCenter = __o_lockCenter.Default(false);
	HX_STACK_PUSH("Sprite::startDrag","native/display/Sprite.hx",31);
	HX_STACK_THIS(this);
...
::String Sprite_obj::nmeGetType( ){
	HX_STACK_PUSH("Sprite::nmeGetType","native/display/Sprite.hx",22);
	HX_STACK_THIS(this);
	HX_STACK_LINE(24)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.display.Sprite"), hx::TCanCast< Sprite_obj> ,sStaticFields,sMemberFields,
