...
{
HX_STACK_PUSH("Graphics::new","native/display/Graphics.hx",25);
{
	HX_STACK_LINE(25)
...
{
		HX_STACK_PUSH("Graphics::moveTo","native/display/Graphics.hx",204);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Graphics::lineTo","native/display/Graphics.hx",197);
		HX_STACK_THIS(this);
		HX_STACK_ARG(inX,"inX");
		HX_STACK_ARG(inY,"inY");
		HX_STACK_LINE(197)
...
Float miterLimit = __o_miterLimit.Default(3);
	HX_STACK_PUSH("Graphics::lineStyle","native/display/Graphics.hx",190);
	HX_STACK_THIS(this);
...
Float focalPointRatio = __o_focalPointRatio.Default(0.0);
	HX_STACK_PUSH("Graphics::lineGradientStyle","native/display/Graphics.hx",176);
	HX_STACK_THIS(this);
...
bool smooth = __o_smooth.Default(false);
	HX_STACK_PUSH("Graphics::lineBitmapStyle","native/display/Graphics.hx",169);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Graphics::endFill","native/display/Graphics.hx",162);
		HX_STACK_THIS(this);
		HX_STACK_LINE(162)
...
int blendMode = __o_blendMode.Default(0);
	HX_STACK_PUSH("Graphics::drawTriangles","native/display/Graphics.hx",154);
	HX_STACK_THIS(this);
...
int inFlags = __o_inFlags.Default(0);
	HX_STACK_PUSH("Graphics::drawTiles","native/display/Graphics.hx",142);
	HX_STACK_THIS(this);
...
::String winding = __o_winding.Default(HX_CSTRING("evenOdd"));
	HX_STACK_PUSH("Graphics::drawPath","native/display/Graphics.hx",135);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Graphics::drawRoundRect","native/display/Graphics.hx",128);
		HX_STACK_THIS(this);
		HX_STACK_ARG(inX,"inX");
		HX_STACK_ARG(inY,"inY");
...
{
		HX_STACK_PUSH("Graphics::drawRect","native/display/Graphics.hx",121);
		HX_STACK_THIS(this);
		HX_STACK_ARG(inX,"inX");
		HX_STACK_ARG(inY,"inY");
		HX_STACK_ARG(inWidth,"inWidth");
...
Float inSize = __o_inSize.Default(-1.0);
	HX_STACK_PUSH("Graphics::drawPoints","native/display/Graphics.hx",114);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Graphics::drawGraphicsDatum","native/display/Graphics.hx",107);
		HX_STACK_THIS(this);
...
Void Graphics_obj::drawGraphicsData( Array< ::native::display::IGraphicsData > graphicsData){
{
		HX_STACK_PUSH("Graphics::drawGraphicsData","native/display/Graphics.hx",95);
		HX_STACK_THIS(this);
		...
		HX_STACK_LINE(99)
		{
			...
			while(((_g < graphicsData->length))){
				HX_STACK_LINE(99)
				::native::display::IGraphicsData datum = graphicsData->__get(_g);		HX_STACK_VAR(datum,"datum");
				HX_STACK_LINE(99)
				++(_g);
				HX_STACK_LINE(100)
...
{
		HX_STACK_PUSH("Graphics::drawEllipse","native/display/Graphics.hx",88);
		HX_STACK_THIS(this);
		HX_STACK_ARG(inX,"inX");
		HX_STACK_ARG(inY,"inY");
		HX_STACK_ARG(inWidth,"inWidth");
...
{
		HX_STACK_PUSH("Graphics::drawCircle","native/display/Graphics.hx",81);
		HX_STACK_THIS(this);
		HX_STACK_ARG(inX,"inX");
		HX_STACK_ARG(inY,"inY");
...
{
		HX_STACK_PUSH("Graphics::curveTo","native/display/Graphics.hx",74);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Graphics::clear","native/display/Graphics.hx",67);
		HX_STACK_THIS(this);
		HX_STACK_LINE(67)
...
Float focalPointRatio = __o_focalPointRatio.Default(0.0);
	HX_STACK_PUSH("Graphics::beginGradientFill","native/display/Graphics.hx",53);
	HX_STACK_THIS(this);
	HX_STACK_ARG(type,"type");
	HX_STACK_ARG(colors,"colors");
	HX_STACK_ARG(alphas,"alphas");
...
Float alpha = __o_alpha.Default(1.0);
	HX_STACK_PUSH("Graphics::beginFill","native/display/Graphics.hx",46);
	HX_STACK_THIS(this);
	HX_STACK_ARG(color,"color");
	HX_STACK_ARG(alpha,"alpha");
{
...
bool repeat = __o_repeat.Default(true);
bool smooth = __o_smooth.Default(false);
	HX_STACK_PUSH("Graphics::beginBitmapFill","native/display/Graphics.hx",39);
	HX_STACK_THIS(this);
	HX_STACK_ARG(bitmap,"bitmap");
	HX_STACK_ARG(matrix,"matrix");
	HX_STACK_ARG(repeat,"repeat");
...
{
		HX_STACK_PUSH("Graphics::arcTo","native/display/Graphics.hx",32);
		HX_STACK_THIS(this);
		HX_STACK_ARG(inCX,"inCX");
		HX_STACK_ARG(inCY,"inCY");
		HX_STACK_ARG(inX,"inX");
...
int inA = __o_inA.Default(255);
	HX_STACK_PUSH("Graphics::RGBA","native/display/Graphics.hx",211);
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.display.Graphics"), hx::TCanCast< Graphics_obj> ,sStaticFields,sMemberFields,
