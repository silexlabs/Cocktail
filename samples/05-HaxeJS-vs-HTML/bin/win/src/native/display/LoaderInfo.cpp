...
{
HX_STACK_PUSH("LoaderInfo::new","native/display/LoaderInfo.hx",35);
{
	HX_STACK_LINE(37)
	...
	HX_STACK_LINE(41)
	this->dataFormat = ::native::net::URLLoaderDataFormat_obj::BINARY_dyn();
	HX_STACK_LINE(42)
	this->loaderURL = null();
	HX_STACK_LINE(45)
...
::native::utils::ByteArray LoaderInfo_obj::get_bytes( ){
	HX_STACK_PUSH("LoaderInfo::get_bytes","native/display/LoaderInfo.hx",106);
	HX_STACK_THIS(this);
	HX_STACK_LINE(106)
	return this->data;
}
...
{
		HX_STACK_PUSH("LoaderInfo::onURLLoaded","native/display/LoaderInfo.hx",92);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("LoaderInfo::load","native/display/LoaderInfo.hx",60);
		HX_STACK_THIS(this);
		...
		struct _Function_1_1{
			inline static ::String Block( ::String &extension,::native::display::LoaderInfo_obj *__this){
				HX_STACK_PUSH("*::closure","native/display/LoaderInfo.hx",67);
				{
					HX_STACK_LINE(67)
...
::native::display::LoaderInfo LoaderInfo_obj::create( ::native::display::Loader ldr){
	HX_STACK_PUSH("LoaderInfo::create","native/display/LoaderInfo.hx",50);
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.display.LoaderInfo"), hx::TCanCast< LoaderInfo_obj> ,sStaticFields,sMemberFields,
