...
{
HX_STACK_PUSH("TextEvent::new","native/events/TextEvent.hx",14);
...
::String TextEvent_obj::toString( ){
	HX_STACK_PUSH("TextEvent::toString","native/events/TextEvent.hx",30);
	HX_STACK_THIS(this);
	HX_STACK_LINE(30)
...
::native::events::Event TextEvent_obj::clone( ){
	HX_STACK_PUSH("TextEvent::clone","native/events/TextEvent.hx",23);
	HX_STACK_THIS(this);
	HX_STACK_LINE(23)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.events.TextEvent"), hx::TCanCast< TextEvent_obj> ,sStaticFields,sMemberFields,
