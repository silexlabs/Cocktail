...
{
HX_STACK_PUSH("Listener::new","native/events/EventDispatcher.hx",190);
{
	HX_STACK_LINE(192)
...
bool Listener_obj::Is( Dynamic inListener,bool inCapture){
	HX_STACK_PUSH("Listener::Is","native/events/EventDispatcher.hx",207);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Listener::dispatchEvent","native/events/EventDispatcher.hx",200);
		HX_STACK_THIS(this);
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.events.Listener"), hx::TCanCast< Listener_obj> ,sStaticFields,sMemberFields,
