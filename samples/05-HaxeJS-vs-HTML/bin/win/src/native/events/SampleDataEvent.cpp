...
{
HX_STACK_PUSH("SampleDataEvent::new","native/events/SampleDataEvent.hx",17);
...
::String SampleDataEvent_obj::toString( ){
	HX_STACK_PUSH("SampleDataEvent::toString","native/events/SampleDataEvent.hx",35);
	HX_STACK_THIS(this);
	HX_STACK_LINE(35)
...
::native::events::Event SampleDataEvent_obj::clone( ){
	HX_STACK_PUSH("SampleDataEvent::clone","native/events/SampleDataEvent.hx",28);
	HX_STACK_THIS(this);
	HX_STACK_LINE(28)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.events.SampleDataEvent"), hx::TCanCast< SampleDataEvent_obj> ,sStaticFields,sMemberFields,
