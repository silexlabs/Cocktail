...
{
HX_STACK_PUSH("FocusEvent::new","native/events/FocusEvent.hx",21);
...
::String FocusEvent_obj::toString( ){
	HX_STACK_PUSH("FocusEvent::toString","native/events/FocusEvent.hx",39);
	HX_STACK_THIS(this);
	HX_STACK_LINE(39)
...
::native::events::Event FocusEvent_obj::clone( ){
	HX_STACK_PUSH("FocusEvent::clone","native/events/FocusEvent.hx",32);
	HX_STACK_THIS(this);
	HX_STACK_LINE(32)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.events.FocusEvent"), hx::TCanCast< FocusEvent_obj> ,sStaticFields,sMemberFields,
