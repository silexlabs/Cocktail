...
{
HX_STACK_PUSH("ProgressEvent::new","native/events/ProgressEvent.hx",15);
...
::String ProgressEvent_obj::toString( ){
	HX_STACK_PUSH("ProgressEvent::toString","native/events/ProgressEvent.hx",32);
	HX_STACK_THIS(this);
	HX_STACK_LINE(32)
...
::native::events::Event ProgressEvent_obj::clone( ){
	HX_STACK_PUSH("ProgressEvent::clone","native/events/ProgressEvent.hx",25);
	HX_STACK_THIS(this);
	HX_STACK_LINE(25)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.events.ProgressEvent"), hx::TCanCast< ProgressEvent_obj> ,sStaticFields,sMemberFields,
