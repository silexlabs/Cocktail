...
{
HX_STACK_PUSH("JoystickEvent::new","native/events/JoystickEvent.hx",22);
...
::String JoystickEvent_obj::toString( ){
	HX_STACK_PUSH("JoystickEvent::toString","native/events/JoystickEvent.hx",44);
	HX_STACK_THIS(this);
	HX_STACK_LINE(44)
...
::native::events::Event JoystickEvent_obj::clone( ){
	HX_STACK_PUSH("JoystickEvent::clone","native/events/JoystickEvent.hx",37);
	HX_STACK_THIS(this);
	HX_STACK_LINE(37)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.events.JoystickEvent"), hx::TCanCast< JoystickEvent_obj> ,sStaticFields,sMemberFields,
