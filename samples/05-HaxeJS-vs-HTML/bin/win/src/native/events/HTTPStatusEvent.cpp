...
{
HX_STACK_PUSH("HTTPStatusEvent::new","native/events/HTTPStatusEvent.hx",13);
...
::String HTTPStatusEvent_obj::toString( ){
	HX_STACK_PUSH("HTTPStatusEvent::toString","native/events/HTTPStatusEvent.hx",29);
	HX_STACK_THIS(this);
	HX_STACK_LINE(29)
...
::native::events::Event HTTPStatusEvent_obj::clone( ){
	HX_STACK_PUSH("HTTPStatusEvent::clone","native/events/HTTPStatusEvent.hx",22);
	HX_STACK_THIS(this);
	HX_STACK_LINE(22)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.events.HTTPStatusEvent"), hx::TCanCast< HTTPStatusEvent_obj> ,sStaticFields,sMemberFields,
