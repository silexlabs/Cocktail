...
{
HX_STACK_PUSH("ErrorEvent::new","native/events/ErrorEvent.hx",13);
...
::String ErrorEvent_obj::toString( ){
	HX_STACK_PUSH("ErrorEvent::toString","native/events/ErrorEvent.hx",28);
	HX_STACK_THIS(this);
	HX_STACK_LINE(28)
...
::native::events::Event ErrorEvent_obj::clone( ){
	HX_STACK_PUSH("ErrorEvent::clone","native/events/ErrorEvent.hx",21);
	HX_STACK_THIS(this);
	HX_STACK_LINE(21)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.events.ErrorEvent"), hx::TCanCast< ErrorEvent_obj> ,sStaticFields,sMemberFields,
