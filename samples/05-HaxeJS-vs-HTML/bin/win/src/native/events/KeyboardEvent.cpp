...
{
HX_STACK_PUSH("KeyboardEvent::new","native/events/KeyboardEvent.hx",21);
...
::String KeyboardEvent_obj::toString( ){
	HX_STACK_PUSH("KeyboardEvent::toString","native/events/KeyboardEvent.hx",45);
	HX_STACK_THIS(this);
	HX_STACK_LINE(45)
...
::native::events::Event KeyboardEvent_obj::clone( ){
	HX_STACK_PUSH("KeyboardEvent::clone","native/events/KeyboardEvent.hx",38);
	HX_STACK_THIS(this);
	HX_STACK_LINE(38)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.events.KeyboardEvent"), hx::TCanCast< KeyboardEvent_obj> ,sStaticFields,sMemberFields,
