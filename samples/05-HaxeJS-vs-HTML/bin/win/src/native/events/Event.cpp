...
{
HX_STACK_PUSH("Event::new","native/events/Event.hx",52);
...
::String Event_obj::get_type( ){
	HX_STACK_PUSH("Event::get_type","native/events/Event.hx",132);
	HX_STACK_THIS(this);
	HX_STACK_LINE(132)
	return this->_type;
}
...
Dynamic Event_obj::set_target( Dynamic v){
	HX_STACK_PUSH("Event::set_target","native/events/Event.hx",131);
	HX_STACK_THIS(this);
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(131)
	this->_target = v;
...
Dynamic Event_obj::get_target( ){
	HX_STACK_PUSH("Event::get_target","native/events/Event.hx",130);
	HX_STACK_THIS(this);
	HX_STACK_LINE(130)
	return this->_target;
}
...
int Event_obj::get_eventPhase( ){
	HX_STACK_PUSH("Event::get_eventPhase","native/events/Event.hx",129);
	HX_STACK_THIS(this);
	HX_STACK_LINE(129)
...
Dynamic Event_obj::set_currentTarget( Dynamic v){
	HX_STACK_PUSH("Event::set_currentTarget","native/events/Event.hx",128);
	HX_STACK_THIS(this);
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(128)
...
Dynamic Event_obj::get_currentTarget( ){
	HX_STACK_PUSH("Event::get_currentTarget","native/events/Event.hx",127);
	HX_STACK_THIS(this);
	HX_STACK_LINE(127)
...
bool Event_obj::get_cancelable( ){
	HX_STACK_PUSH("Event::get_cancelable","native/events/Event.hx",126);
	HX_STACK_THIS(this);
	HX_STACK_LINE(126)
...
bool Event_obj::get_bubbles( ){
	HX_STACK_PUSH("Event::get_bubbles","native/events/Event.hx",125);
	HX_STACK_THIS(this);
	HX_STACK_LINE(125)
...
::String Event_obj::toString( ){
	HX_STACK_PUSH("Event::toString","native/events/Event.hx",111);
	HX_STACK_THIS(this);
	HX_STACK_LINE(111)
...
{
		HX_STACK_PUSH("Event::stopPropagation","native/events/Event.hx",103);
		HX_STACK_THIS(this);
		HX_STACK_LINE(103)
...
{
		HX_STACK_PUSH("Event::stopImmediatePropagation","native/events/Event.hx",95);
		HX_STACK_THIS(this);
		HX_STACK_LINE(95)
		if ((this->get_cancelable())){
			HX_STACK_LINE(98)
...
{
		HX_STACK_PUSH("Event::nmeSetPhase","native/events/Event.hx",87);
		HX_STACK_THIS(this);
...
bool Event_obj::nmeGetIsCancelledNow( ){
	HX_STACK_PUSH("Event::nmeGetIsCancelledNow","native/events/Event.hx",80);
	HX_STACK_THIS(this);
	HX_STACK_LINE(80)
...
bool Event_obj::nmeGetIsCancelled( ){
	HX_STACK_PUSH("Event::nmeGetIsCancelled","native/events/Event.hx",73);
	HX_STACK_THIS(this);
	HX_STACK_LINE(73)
...
::native::events::Event Event_obj::clone( ){
	HX_STACK_PUSH("Event::clone","native/events/Event.hx",66);
	HX_STACK_THIS(this);
	HX_STACK_LINE(66)
...
Dynamic Event_obj::__Field(const ::String &inName,bool inCallProp)
{
	...
	case 7:
		...
		if (HX_FIELD_EQ(inName,"bubbles") ) { return inCallProp ? get_bubbles() : bubbles; }
		break;
	case 8:
	...
	case 10:
		...
		if (HX_FIELD_EQ(inName,"eventPhase") ) { return inCallProp ? get_eventPhase() : eventPhase; }
		if (HX_FIELD_EQ(inName,"cancelable") ) { return inCallProp ? get_cancelable() : cancelable; }
		break;
	case 11:
		...
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"currentTarget") ) { return inCallProp ? get_currentTarget() : currentTarget; }
		break;
	case 14:
...
Dynamic Event_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 6:
		...
		if (HX_FIELD_EQ(inName,"target") ) { if (inCallProp) return set_target(inValue);target=inValue.Cast< Dynamic >(); return inValue; }
		break;
	case 7:
	...
	case 11:
		...
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"currentTarget") ) { if (inCallProp) return set_currentTarget(inValue);currentTarget=inValue.Cast< Dynamic >(); return inValue; }
		break;
	case 14:
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.events.Event"), hx::TCanCast< Event_obj> ,sStaticFields,sMemberFields,
