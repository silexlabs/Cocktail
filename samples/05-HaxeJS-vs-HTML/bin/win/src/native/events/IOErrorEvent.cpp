...
{
HX_STACK_PUSH("IOErrorEvent::new","native/events/IOErrorEvent.hx",11);
...
::String IOErrorEvent_obj::toString( ){
	HX_STACK_PUSH("IOErrorEvent::toString","native/events/IOErrorEvent.hx",25);
	HX_STACK_THIS(this);
	HX_STACK_LINE(25)
...
::native::events::Event IOErrorEvent_obj::clone( ){
	HX_STACK_PUSH("IOErrorEvent::clone","native/events/IOErrorEvent.hx",18);
	HX_STACK_THIS(this);
	HX_STACK_LINE(18)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.events.IOErrorEvent"), hx::TCanCast< IOErrorEvent_obj> ,sStaticFields,sMemberFields,
