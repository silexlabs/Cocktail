...
{
HX_STACK_PUSH("MouseEvent::new","native/events/MouseEvent.hx",49);
...
{
		HX_STACK_PUSH("MouseEvent::updateAfterEvent","native/events/MouseEvent.hx",108);
		HX_STACK_THIS(this);
	}
return null();
}
...
::String MouseEvent_obj::toString( ){
	HX_STACK_PUSH("MouseEvent::toString","native/events/MouseEvent.hx",101);
	HX_STACK_THIS(this);
	HX_STACK_LINE(101)
...
::native::events::MouseEvent MouseEvent_obj::nmeCreateSimilar( ::String inType,::native::display::InteractiveObject related,::native::display::InteractiveObject targ){
	HX_STACK_PUSH("MouseEvent::nmeCreateSimilar","native/events/MouseEvent.hx",86);
	HX_STACK_THIS(this);
...
::native::events::Event MouseEvent_obj::clone( ){
	HX_STACK_PUSH("MouseEvent::clone","native/events/MouseEvent.hx",67);
	HX_STACK_THIS(this);
	HX_STACK_LINE(67)
...
::native::events::MouseEvent MouseEvent_obj::nmeCreate( ::String inType,Dynamic inEvent,::native::geom::Point inLocal,::native::display::InteractiveObject inTarget){
	HX_STACK_PUSH("MouseEvent::nmeCreate","native/events/MouseEvent.hx",74);
	HX_STACK_ARG(inType,"inType");
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.events.MouseEvent"), hx::TCanCast< MouseEvent_obj> ,sStaticFields,sMemberFields,
