...
class SoundChannel_obj : public ::native::events::EventDispatcher_obj{
	public:
	...
	public:
		...
		::native::events::EventDispatcher nmeDataProvider; /* REM */ 
		::native::media::SoundTransform nmeTransform; /* REM */ 
		Dynamic nmeHandle; /* REM */ 
		::native::media::SoundTransform soundTransform; /* REM */ 
		Float position; /* REM */ 
		Float rightPeak; /* REM */ 
		Float leftPeak; /* REM */ 
		static int nmeDynamicSoundCount; /* REM */ 
		static Array< ::native::media::SoundChannel > nmeIncompleteList; /* REM */ 
