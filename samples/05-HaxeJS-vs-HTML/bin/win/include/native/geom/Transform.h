...
class Transform_obj : public hx::Object{
	...
	public:
		...
		::native::display::DisplayObject nmeObj; /* REM */ 
		::native::geom::Rectangle pixelBounds; /* REM */ 
		::native::geom::Matrix matrix; /* REM */ 
		::native::geom::Matrix concatenatedMatrix; /* REM */ 
		::native::geom::ColorTransform concatenatedColorTransform; /* REM */ 
