...
class Loader_obj : public ::native::display::Sprite_obj{
	public:
	...
	public:
		...
		virtual Void loadBytes( ::native::utils::ByteArray bytes);
		...
		::native::display::MovieClip nmeSWF; /* REM */ 
		::native::display::BitmapData nmeImage; /* REM */ 
		::native::display::LoaderInfo contentLoaderInfo; /* REM */ 
		::native::display::DisplayObject content; /* REM */ 
};
