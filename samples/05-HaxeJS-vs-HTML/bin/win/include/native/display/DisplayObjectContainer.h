...
class DisplayObjectContainer_obj : public ::native::display::InteractiveObject_obj{
	public:
	...
	public:
		...
		virtual Array< ::native::display::DisplayObject > getObjectsUnderPoint( ::native::geom::Point point);
		...
		Array< ::native::display::DisplayObject > nmeChildren; /* REM */ 
