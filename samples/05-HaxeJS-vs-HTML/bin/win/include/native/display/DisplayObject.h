...
class DisplayObject_obj : public ::native::events::EventDispatcher_obj{
	public:
	...
	public:
		...
		virtual Void nmeGetObjectsUnderPoint( ::native::geom::Point point,Array< ::native::display::DisplayObject > result);
		Dynamic nmeGetObjectsUnderPoint_dyn();

		virtual ::native::geom::Matrix nmeGetMatrix( );
		Dynamic nmeGetMatrix_dyn();

		virtual Void nmeGetInteractiveObjectStack( Array< ::native::display::InteractiveObject > outStack);
		...
		::native::geom::Rectangle nmeScrollRect; /* REM */ 
		::native::geom::Rectangle nmeScale9Grid; /* REM */ 
		::native::display::DisplayObjectContainer nmeParent; /* REM */ 
		int nmeID; /* REM */ 
		::native::display::Graphics nmeGraphicsCache; /* REM */ 
		...
		Float width; /* REM */ 
		bool visible; /* REM */ 
		::native::geom::Transform transform; /* REM */ 
		::native::display::Stage stage; /* REM */ 
		::native::geom::Rectangle scrollRect; /* REM */ 
		Float scaleY; /* REM */ 
		Float scaleX; /* REM */ 
		::native::geom::Rectangle scale9Grid; /* REM */ 
		Float rotation; /* REM */ 
		::native::display::DisplayObjectContainer parent; /* REM */ 
		Dynamic opaqueBackground; /* REM */ 
		::String name; /* REM */ 
		Float mouseY; /* REM */ 
		Float mouseX; /* REM */ 
		::native::display::DisplayObject mask; /* REM */ 
		Float height; /* REM */ 
		::native::display::Graphics graphics; /* REM */ 
		Dynamic filters; /* REM */ 
		::native::display::PixelSnapping pixelSnapping; /* REM */ 
		bool pedanticBitmapCaching; /* REM */ 
		bool cacheAsBitmap; /* REM */ 
		::native::display::BlendMode blendMode; /* REM */ 
		Float alpha; /* REM */ 
