...
class ImageRenderer_obj : public ::cocktail::core::renderer::EmbeddedBoxRenderer_obj{
	...
	public:
		...
		virtual Void paintResource( ::cocktail::core::graphics::GraphicsContext graphicContext,::native::display::BitmapData nativeBitmapData,::cocktail::core::geom::RectangleVO bounds,Float intrinsicWidth,Float intrinsicHeight,::cocktail::core::geom::RectangleVO clipRect);
