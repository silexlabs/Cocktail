...
var Main = function() {
	...
	haxe.Log.trace("mmmmmmmmmmmmmm",{ fileName : "Main.hx", lineNumber : 66, className : "Main", methodName : "new"});
...
Main.prototype = {
	addTransitionBox: function() {
		var _g = this;
		var transitionBox = js.Lib.document.createElement("div");
		...
		transitionBox.addEventListener("transitionend",function(e) {
			_g.transition(transitionBox);
		},false);
		transitionBox.addEventListener("webkitTransitionEnd",function(e) {
			_g.transition(transitionBox);
		},false);
		transitionBox.onclick = function(e) {
			_g.addTransitionBox();
		};
		js.Lib.document.getElementById("container").appendChild(transitionBox);
