...
viewport.ViewportTests = $hxClasses["viewport.ViewportTests"] = function() {
	this._viewport = new cocktailCore.viewport.js.Viewport();
}
viewport.ViewportTests.__name__ = ["viewport","ViewportTests"];
viewport.ViewportTests.main = function() {
	var runner = new utest.Runner();
	runner.addCase(new viewport.ViewportTests());
	utest.ui.Report.create(runner);
	runner.run();
}
viewport.ViewportTests.prototype = {
	_viewport: null
	,testViewport: function() {
		this._viewport._setOnResize(utest.Assert.createAsync(this.onViewportResize.$bind(this),6000));
		document.body.innerHTML += "Resize your window now !<br />";
	}
	,onViewportResize: function() {
		utest.Assert.isTrue(true,null,{ fileName : "ViewportTests.hx", lineNumber : 74, className : "viewport.ViewportTests", methodName : "onViewportResize"});
		document.body.innerHTML += "Rotate your device now !<br />";
		this._viewport._setOnResize(null);
		this._viewport._setOnOrientationChange(utest.Assert.createAsync(this.onViewportRotate.$bind(this),6000));
		haxe.Log.trace("Resize " + this._viewport._getWidth() + ", " + this._viewport._getHeight(),{ fileName : "ViewportTests.hx", lineNumber : 88, className : "viewport.ViewportTests", methodName : "onViewportResize"});
	}
	,onViewportRotate: function() {
		utest.Assert.isTrue(true,null,{ fileName : "ViewportTests.hx", lineNumber : 95, className : "viewport.ViewportTests", methodName : "onViewportRotate"});
		this._viewport._setOnOrientationChange(null);
		document.body.innerHTML += "Rotate " + this._viewport._getOrientation();
	}
	,__class__: viewport.ViewportTests
}
