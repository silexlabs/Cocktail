...
historyApi.HistoryTests.prototype = {
	_callbackHistoryCallback: function(e) {
		haxe.Log.trace("test history async",{ fileName : "HistoryTests.hx", lineNumber : 196, className : "historyApi.HistoryTests", methodName : "_callbackHistoryCallback"});
		var event = e;
		utest.Assert.equals("page 3",event.state.title,null,{ fileName : "HistoryTests.hx", lineNumber : 200, className : "historyApi.HistoryTests", methodName : "_callbackHistoryCallback"});
		js.Lib.window.onpopstate = null;
	}
	,_testHistoryCallback: function() {
		haxe.Log.trace("_testHistoryCallback",{ fileName : "HistoryTests.hx", lineNumber : 184, className : "historyApi.HistoryTests", methodName : "_testHistoryCallback"});
		var async = utest.Assert.createEvent($bind(this,this._callbackHistoryCallback),1000);
		js.Lib.window.onpopstate = async;
		this.history.forward();
	}
	,_callbackHistoryAddEventListener: function(e) {
		haxe.Log.trace("test history async",{ fileName : "HistoryTests.hx", lineNumber : 171, className : "historyApi.HistoryTests", methodName : "_callbackHistoryAddEventListener"});
		var event = e;
		utest.Assert.equals("page 2",event.state.title,null,{ fileName : "HistoryTests.hx", lineNumber : 175, className : "historyApi.HistoryTests", methodName : "_callbackHistoryAddEventListener"});
		js.Lib.window.removeEventListener("popstate",this.async,true);
		this.async = null;
		this._testHistoryCallback();
	}
	,_testHistoryAddEventListener: function() {
		haxe.Log.trace("_testHistoryAddEventListener",{ fileName : "HistoryTests.hx", lineNumber : 160, className : "historyApi.HistoryTests", methodName : "_testHistoryAddEventListener"});
		this.async = utest.Assert.createEvent($bind(this,this._callbackHistoryAddEventListener),1000);
		js.Lib.window.addEventListener("popstate",this.async,true);
		this.history.back();
	}
	,async: null
	,testHistoryEvents: function() {
		haxe.Log.trace("testHistoryEvents",{ fileName : "HistoryTests.hx", lineNumber : 148, className : "historyApi.HistoryTests", methodName : "testHistoryEvents"});
		this.initHistory();
		this._testHistoryAddEventListener();
	}
	,_testHistoryGoPositive: function() {
		var _g = this;
		haxe.Log.trace("testHistoryGoPositive",{ fileName : "HistoryTests.hx", lineNumber : 131, className : "historyApi.HistoryTests", methodName : "_testHistoryGoPositive"});
		this.history.go(2);
		var async = utest.Assert.createAsync(function() {
			haxe.Log.trace("test history async",{ fileName : "HistoryTests.hx", lineNumber : 137, className : "historyApi.HistoryTests", methodName : "_testHistoryGoPositive"});
			utest.Assert.equals("page 3",_g.history.state.title,null,{ fileName : "HistoryTests.hx", lineNumber : 138, className : "historyApi.HistoryTests", methodName : "_testHistoryGoPositive"});
		},1000);
		haxe.Timer.delay(async,500);
	}
	,_testHistoryGoNeg: function() {
		var _g = this;
		haxe.Log.trace("testHistoryGoNeg",{ fileName : "HistoryTests.hx", lineNumber : 116, className : "historyApi.HistoryTests", methodName : "_testHistoryGoNeg"});
		this.history.go(-2);
		var async = utest.Assert.createAsync(function() {
			haxe.Log.trace("test history async",{ fileName : "HistoryTests.hx", lineNumber : 122, className : "historyApi.HistoryTests", methodName : "_testHistoryGoNeg"});
			utest.Assert.equals("page 1",_g.history.state.title,null,{ fileName : "HistoryTests.hx", lineNumber : 123, className : "historyApi.HistoryTests", methodName : "_testHistoryGoNeg"});
	...
	,_testHistoryForward: function() {
		var _g = this;
		haxe.Log.trace("testHistoryForward",{ fileName : "HistoryTests.hx", lineNumber : 102, className : "historyApi.HistoryTests", methodName : "_testHistoryForward"});
		this.history.forward();
		var async = utest.Assert.createAsync(function() {
			haxe.Log.trace("test history async",{ fileName : "HistoryTests.hx", lineNumber : 107, className : "historyApi.HistoryTests", methodName : "_testHistoryForward"});
			utest.Assert.equals("page 3",_g.history.state.title,null,{ fileName : "HistoryTests.hx", lineNumber : 108, className : "historyApi.HistoryTests", methodName : "_testHistoryForward"});
	...
	,_testHistoryBack: function() {
		var _g = this;
		haxe.Log.trace("testHistoryBack",{ fileName : "HistoryTests.hx", lineNumber : 88, className : "historyApi.HistoryTests", methodName : "_testHistoryBack"});
		this.history.back();
		var async = utest.Assert.createAsync(function() {
			haxe.Log.trace("test history async",{ fileName : "HistoryTests.hx", lineNumber : 93, className : "historyApi.HistoryTests", methodName : "_testHistoryBack"});
			utest.Assert.equals("page 2",_g.history.state.title,null,{ fileName : "HistoryTests.hx", lineNumber : 94, className : "historyApi.HistoryTests", methodName : "_testHistoryBack"});
			_g._testHistoryForward();
		},1000);
		haxe.Timer.delay(async,500);
	}
	,testHistoryMethods: function() {
		haxe.Log.trace("testHistory",{ fileName : "HistoryTests.hx", lineNumber : 74, className : "historyApi.HistoryTests", methodName : "testHistoryMethods"});
		this.initHistory();
		utest.Assert.equals("page 3",this.history.state.title,null,{ fileName : "HistoryTests.hx", lineNumber : 82, className : "historyApi.HistoryTests", methodName : "testHistoryMethods"});
		this._testHistoryBack();
	}
	,initHistory: function() {
		this.history = js.Lib.window.history;
		if(this.history == null) throw "this browser does not support history api";
