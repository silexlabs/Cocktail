...
var event = event || {}
event.EventTests = $hxClasses["event.EventTests"] = function() {
};
event.EventTests.__name__ = ["event","EventTests"];
event.EventTests.main = function() {
	var runner = new utest.Runner();
	runner.addCase(new event.EventTests());
	utest.ui.Report.create(runner);
	runner.run();
}
event.EventTests.prototype = {
	testEvent: function() {
	}
	,__class__: event.EventTests
}
var haxe = haxe || {}
