...
cocktail.domElement.abstract.AbstractDOMElement.prototype._children = null;
cocktail.domElement.abstract.AbstractDOMElement.prototype.children = null;
...
cocktail.domElement.abstract.AbstractDOMElement.prototype.addChild = function(domElement) {
	domElement.setParent(this);
	this._children.push(domElement);
}
cocktail.domElement.abstract.AbstractDOMElement.prototype.removeChild = function(domElement) {
	domElement.setParent(null);
	this._children.remove(domElement);
}
...
cocktail.domElement.abstract.AbstractDOMElement.prototype.getChildren = function() {
...
cocktail.domElement.js.DOMElement.prototype.addChild = function(domElement) {
	cocktail.domElement.abstract.AbstractDOMElement.prototype.addChild.call(this,domElement);
...
cocktail.domElement.js.DOMElement.prototype.removeChild = function(domElement) {
	cocktail.domElement.abstract.AbstractDOMElement.prototype.removeChild.call(this,domElement);
...
cocktail.domElement.abstract.AbstractTextDOMElement = function(nativeElement) { if( nativeElement === $_ ) return; {
	if(nativeElement == null) {
		nativeElement = cocktail.nativeElement.NativeElementManager.createNativeElement(cocktail.nativeElement.NativeElementTypeValue.text);
	}
	cocktail.domElement.js.DOMElement.call(this,nativeElement);
}}
cocktail.domElement.abstract.AbstractTextDOMElement.__name__ = ["cocktail","domElement","abstract","AbstractTextDOMElement"];
cocktail.domElement.abstract.AbstractTextDOMElement.__super__ = cocktail.domElement.js.DOMElement;
for(var k in cocktail.domElement.js.DOMElement.prototype ) cocktail.domElement.abstract.AbstractTextDOMElement.prototype[k] = cocktail.domElement.js.DOMElement.prototype[k];
cocktail.domElement.abstract.AbstractTextDOMElement.prototype._text = null;
cocktail.domElement.abstract.AbstractTextDOMElement.prototype.text = null;
cocktail.domElement.abstract.AbstractTextDOMElement.prototype.addChild = function(domElement) {
	null;
}
cocktail.domElement.abstract.AbstractTextDOMElement.prototype.removeChild = function(domElement) {
	null;
}
cocktail.domElement.abstract.AbstractTextDOMElement.prototype.setText = function(text) {
	this._text = text;
	return this._text;
}
cocktail.domElement.abstract.AbstractTextDOMElement.prototype.getText = function() {
	return this._text;
}
cocktail.domElement.abstract.AbstractTextDOMElement.prototype.__class__ = cocktail.domElement.abstract.AbstractTextDOMElement;
cocktail.domElement.js.TextDOMElement = function(nativeElement) { if( nativeElement === $_ ) return; {
	cocktail.domElement.abstract.AbstractTextDOMElement.call(this,nativeElement);
}}
cocktail.domElement.js.TextDOMElement.__name__ = ["cocktail","domElement","js","TextDOMElement"];
cocktail.domElement.js.TextDOMElement.__super__ = cocktail.domElement.abstract.AbstractTextDOMElement;
for(var k in cocktail.domElement.abstract.AbstractTextDOMElement.prototype ) cocktail.domElement.js.TextDOMElement.prototype[k] = cocktail.domElement.abstract.AbstractTextDOMElement.prototype[k];
cocktail.domElement.js.TextDOMElement.prototype.setText = function(text) {
	cocktail.domElement.abstract.AbstractTextDOMElement.prototype.setText.call(this,text);
	this._nativeElement.innerHTML = text;
	return text;
}
cocktail.domElement.js.TextDOMElement.prototype.__class__ = cocktail.domElement.js.TextDOMElement;
...
cocktail.domElement.abstract.AbstractImageDOMElement.__super__ = cocktail.domElement.js.DOMElement;
for(var k in cocktail.domElement.js.DOMElement.prototype ) cocktail.domElement.abstract.AbstractImageDOMElement.prototype[k] = cocktail.domElement.js.DOMElement.prototype[k];
...
cocktail.domElement.abstract.AbstractImageDOMElement.prototype.init = function() {
	cocktail.domElement.js.DOMElement.prototype.init.call(this);
	this.setSmooth(true);
}
cocktail.domElement.abstract.AbstractImageDOMElement.prototype.addChild = function(domElement) {
	null;
}
cocktail.domElement.abstract.AbstractImageDOMElement.prototype.removeChild = function(domElement) {
	null;
}
...
if(!cocktail.font["abstract"]) cocktail.font["abstract"] = {}
cocktail.font.abstract.AbstractFontManager = function(p) { if( p === $_ ) return; {
	null;
}}
cocktail.font.abstract.AbstractFontManager.__name__ = ["cocktail","font","abstract","AbstractFontManager"];
cocktail.font.abstract.AbstractFontManager.fonts = null;
cocktail.font.abstract.AbstractFontManager.loadFont = function(url,name,successCallback,errorCallback) {
	null;
}
cocktail.font.abstract.AbstractFontManager.prototype.__class__ = cocktail.font.abstract.AbstractFontManager;
if(!cocktail.font.js) cocktail.font.js = {}
cocktail.font.js.FontManager = function(p) { if( p === $_ ) return; {
	cocktail.font.abstract.AbstractFontManager.call(this);
}}
cocktail.font.js.FontManager.__name__ = ["cocktail","font","js","FontManager"];
cocktail.font.js.FontManager.__super__ = cocktail.font.abstract.AbstractFontManager;
for(var k in cocktail.font.abstract.AbstractFontManager.prototype ) cocktail.font.js.FontManager.prototype[k] = cocktail.font.abstract.AbstractFontManager.prototype[k];
cocktail.font.js.FontManager.fonts = null;
cocktail.font.js.FontManager.loadFont = function(url,name,successCallback,errorCallback) {
	var extension = url.substr(url.lastIndexOf("."),url.length);
	var fontData = { url : url, name : name, type : cocktail.font.FontType.unknown};
	var fontTypeString = "";
	if(extension == ".ttf") {
		fontData.type = cocktail.font.FontType.ttf;
		fontTypeString = " format(\"truetype\")";
	}
	else if(extension == ".eot") {
		fontData.type = cocktail.font.FontType.eot;
		fontTypeString = "";
	}
	var styleE = js.Lib.document.createElement("style");
	styleE.innerHTML = "@font-face{font-family: " + name + " ; src: url( \"" + url + "\" )" + fontTypeString + ";}";
	js.Lib.document.getElementsByTagName("head")[0].appendChild(styleE);
	successCallback();
	if(cocktail.font.js.FontManager.fonts == null) cocktail.font.js.FontManager.fonts = new Array();
	cocktail.font.js.FontManager.fonts.push(fontData);
}
cocktail.font.js.FontManager.prototype.__class__ = cocktail.font.js.FontManager;
if(typeof font=='undefined') font = {}
font.FontTests = function(p) { if( p === $_ ) return; {
	null;
}}
...
font.FontTests.prototype.testFontLoad = function() {
	var successCallback = utest.Assert.createAsync($closure(this,"onFontLoaded"));
	cocktail.font.js.FontManager.loadFont("embed_test_font.ttf","EmbedFontTest",successCallback,$closure(this,"onFontLoadError"));
...
font.FontTests.prototype.onFontLoaded = function() {
	utest.Assert.isTrue(true,null,{ fileName : "FontTests.hx", lineNumber : 81, className : "font.FontTests", methodName : "onFontLoaded"});
	var successCallback = utest.Assert.createAsync($closure(this,"onFontLoaded2"));
	cocktail.font.js.FontManager.loadFont("embed_test_font.eot","EmbedFontTest",successCallback,$closure(this,"onFontLoadError"));
}
font.FontTests.prototype.onFontLoaded2 = function() {
	utest.Assert.isTrue(true,null,{ fileName : "FontTests.hx", lineNumber : 90, className : "font.FontTests", methodName : "onFontLoaded2"});
	var successCallback = utest.Assert.createAsync($closure(this,"onFontLoaded3"));
	cocktail.font.js.FontManager.loadFont("embed_test_font.otf","EmbedFontTest",successCallback,$closure(this,"onFontLoadError"));
}
