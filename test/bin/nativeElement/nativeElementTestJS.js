...
if(!cocktail.nativeElement.base) cocktail.nativeElement.base = {}
cocktail.nativeElement.base.NativeElementPathManagerBase = function(p) {
}
cocktail.nativeElement.base.NativeElementPathManagerBase.__name__ = ["cocktail","nativeElement","base","NativeElementPathManagerBase"];
cocktail.nativeElement.base.NativeElementPathManagerBase.prototype.getRoot = function() {
	return null;
}
cocktail.nativeElement.base.NativeElementPathManagerBase.prototype.__class__ = cocktail.nativeElement.base.NativeElementPathManagerBase;
if(!cocktail.nativeElement.js) cocktail.nativeElement.js = {}
cocktail.nativeElement.js.NativeElementPathManager = function(p) {
	if( p === $_ ) return;
	cocktail.nativeElement.base.NativeElementPathManagerBase.call(this);
}
cocktail.nativeElement.js.NativeElementPathManager.__name__ = ["cocktail","nativeElement","js","NativeElementPathManager"];
cocktail.nativeElement.js.NativeElementPathManager.__super__ = cocktail.nativeElement.base.NativeElementPathManagerBase;
for(var k in cocktail.nativeElement.base.NativeElementPathManagerBase.prototype ) cocktail.nativeElement.js.NativeElementPathManager.prototype[k] = cocktail.nativeElement.base.NativeElementPathManagerBase.prototype[k];
...
cocktail.nativeElement.NativeElementManager.getRoot = function() {
	if(cocktail.nativeElement.NativeElementManager._nativeElementPathManager == null) cocktail.nativeElement.NativeElementManager._nativeElementPathManager = new cocktail.nativeElement.js.NativeElementPathManager();
...
cocktail.nativeElement.NativeElementManager.createNativeElement = function(nativeElementType) {
	if(cocktail.nativeElement.NativeElementManager._nativeElementCreator == null) cocktail.nativeElement.NativeElementManager._nativeElementCreator = new cocktail.nativeElement.js.NativeElementCreator();
...
cocktail.nativeElement.base.NativeElementCreatorBase = function(p) {
}
cocktail.nativeElement.base.NativeElementCreatorBase.__name__ = ["cocktail","nativeElement","base","NativeElementCreatorBase"];
cocktail.nativeElement.base.NativeElementCreatorBase.prototype.createNativeElement = function(nativeElementType) {
	return null;
}
cocktail.nativeElement.base.NativeElementCreatorBase.prototype.__class__ = cocktail.nativeElement.base.NativeElementCreatorBase;
...
cocktail.nativeElement.NativeElementTypeValue = { __ename__ : ["cocktail","nativeElement","NativeElementTypeValue"], __constructs__ : ["neutral","graphic","text","image"] }
...
cocktail.nativeElement.js.NativeElementCreator = function(p) {
	if( p === $_ ) return;
	cocktail.nativeElement.base.NativeElementCreatorBase.call(this);
}
cocktail.nativeElement.js.NativeElementCreator.__name__ = ["cocktail","nativeElement","js","NativeElementCreator"];
cocktail.nativeElement.js.NativeElementCreator.__super__ = cocktail.nativeElement.base.NativeElementCreatorBase;
for(var k in cocktail.nativeElement.base.NativeElementCreatorBase.prototype ) cocktail.nativeElement.js.NativeElementCreator.prototype[k] = cocktail.nativeElement.base.NativeElementCreatorBase.prototype[k];
cocktail.nativeElement.js.NativeElementCreator.prototype.createNativeElement = function(nativeElementType) {
	var nativeElement;
	switch( (nativeElementType)[1] ) {
	case 3:
...
if(typeof nativeElement=='undefined') nativeElement = {}
nativeElement.NativeElementTests = function(p) {
}
nativeElement.NativeElementTests.__name__ = ["nativeElement","NativeElementTests"];
nativeElement.NativeElementTests.main = function() {
	var runner = new utest.Runner();
	runner.addCase(new nativeElement.NativeElementTests());
	utest.ui.Report.create(runner);
	runner.run();
}
nativeElement.NativeElementTests.prototype.testNativeElement = function() {
	var domRoot = cocktail.nativeElement.NativeElementManager.getRoot();
	utest.Assert.same(domRoot.nodeName,"BODY",null,null,{ fileName : "NativeElementTests.hx", lineNumber : 49, className : "nativeElement.NativeElementTests", methodName : "testNativeElement"});
	var nativeGraphicReference = cocktail.nativeElement.NativeElementManager.createNativeElement(cocktail.nativeElement.NativeElementTypeValue.graphic);
	utest.Assert.same(nativeGraphicReference.nodeName,"CANVAS",null,null,{ fileName : "NativeElementTests.hx", lineNumber : 57, className : "nativeElement.NativeElementTests", methodName : "testNativeElement"});
}
nativeElement.NativeElementTests.prototype.__class__ = nativeElement.NativeElementTests;
...
nativeElement.NativeElementTests.main()