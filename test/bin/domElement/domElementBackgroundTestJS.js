...
domElement.DOMElementBackgroundTests = $hxClasses["domElement.DOMElementBackgroundTests"] = function() {
}
domElement.DOMElementBackgroundTests.__name__ = ["domElement","DOMElementBackgroundTests"];
domElement.DOMElementBackgroundTests.main = function() {
	new domElement.DOMElementBackgroundTests();
}
domElement.DOMElementBackgroundTests.prototype = {
	__class__: domElement.DOMElementBackgroundTests
}
...
cocktailCore.domElement.js.LinkDOMElement.prototype = $extend(cocktailCore.domElement.abstract.AbstractLinkDOMElement.prototype,{
	setTabEnabled: function(value) {
		if(value == true) this._nativeElement.tabIndex = this.getTabIndex(); else this._nativeElement.tabIndex = -1;
		return this._tabEnabled = value;
	}
	,setHref: function(value) {
...
domElement.DOMElementBackgroundTests.main()