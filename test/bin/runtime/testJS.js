...
if(!cocktail.runtime) cocktail.runtime = {}
if(!cocktail.runtime["abstract"]) cocktail.runtime["abstract"] = {}
cocktail.runtime.abstract.AbstractViewport = function(p) {
}
...
cocktail.runtime.abstract.AbstractViewport.prototype._setOnResize = function(callbackFunction) {
...
cocktail.runtime.js.Viewport = function(p) {
	if( p === $_ ) return;
	cocktail.runtime.abstract.AbstractViewport.call(this);
}
...
runtime.ViewportTests = function(p) {
	if( p === $_ ) return;
	this._viewport = new cocktail.runtime.js.Viewport();
}
runtime.ViewportTests.__name__ = ["runtime","ViewportTests"];
runtime.ViewportTests.main = function() {
	var runner = new utest.Runner();
	runner.addCase(new runtime.ViewportTests());
