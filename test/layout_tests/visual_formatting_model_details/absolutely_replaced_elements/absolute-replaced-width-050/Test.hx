...
class Test 
{
	...
	public function new()
	{
		...
		//test += 	'<div id="div1" style="border: solid black; direction: rtl; height: 2in; width: 2in;">';
		test += 	'<div id="div1" style="direction: rtl; height: 2in; width: 2in; position: relative;">';
		test += 		'<img alt="blue 96x96" src="blue96x96.png" style="margin-left: 0.25in; margin-right: auto; left:0.25in; position: absolute; right:0.25in;"/>';
